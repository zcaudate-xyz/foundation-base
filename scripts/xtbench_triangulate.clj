...
(defn- lang-spec-files
  [lang]
  (let [base (str "src/lang/model/spec_" (name lang))]
    [(str base ".clj")
...
(defn- print-report
  ...
  (println "  language's spec/rewrite (`src/lang/model/spec_<lang>.clj` and")
  (println "  `src/lang/model/spec_<lang>/rewrite.clj`).")
  (println))

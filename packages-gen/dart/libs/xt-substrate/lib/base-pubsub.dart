...
invoke_trigger(node, stream) {
  ...
  if((() {
    var dart_truthy__51504 = (null != output) && (("Future" == (output.runtimeType).toString()) || (output.runtimeType).toString().startsWith("Future<"));
    return (null != dart_truthy__51504) && (false != dart_truthy__51504);
  })()){
    return output;
  }
  else{

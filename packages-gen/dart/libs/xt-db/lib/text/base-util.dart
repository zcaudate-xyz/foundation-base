...
collect_views(routes) {
  ...
  var arr_52414 = routes;
  for(var i52415 = 0; i52415 < arr_52414.length; ++i52415){
    var route = arr_52414[i52415];
    var view = route["view"];
...
keepf_limit(arr, pred, f, n) {
  ...
  var i = 0;
  var arr_52436 = arr;
  for(var i52437 = 0; i52437 < arr_52436.length; ++i52437){
    var e = arr_52436[i52437];
    if(i == n){
      return out;
    }
    if((() {
      var dart_truthy__52412 = pred(e);
      return (null != dart_truthy__52412) && (false != dart_truthy__52412);
    })()){
      var interim = f(e);
      if((("int" == (interim.runtimeType).toString()) || ("double" == (interim.runtimeType).toString()) || ("num" == (interim.runtimeType).toString())) || ("String" == (interim.runtimeType).toString()) || (() {
        var dart_truthy__52413 = xtd.obj_not_emptyp(interim);
        return (null != dart_truthy__52413) && (false != dart_truthy__52413);
      })()){
        out.add(interim);
        i = (i + 1);
      }

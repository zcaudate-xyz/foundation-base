...
check_args_type(args, targs) {
  var i = 0;
  var arr_52390 = targs;
  for(var i52391 = 0; i52391 < arr_52390.length; ++i52391){
    var spec = arr_52390[i52391];
    var arg = args[i];
    if(!(() {
      var dart_truthy__52389 = check_arg_type(spec["type"],arg);
      return (null != dart_truthy__52389) && (false != dart_truthy__52389);
    })()){
      return <dynamic>[
        false,
        <dynamic, dynamic>{

...
encode_sql_table(v, column_fn, opts, loop_fn) {
  ...
  var schema = v["schema"];
  if((() {
    var dart_truthy__52180 = opts["strict"];
    return (null != dart_truthy__52180) && (false != dart_truthy__52180);
  })()){
...
encode_sql_cast(v, column_fn, opts, loop_fn) {
  var value_52182 = v["args"];
  var out = value_52182[0];
  var cast = value_52182[1];
  if((() {
    var dart_truthy__52181 = opts["strict"];
    return (null != dart_truthy__52181) && (false != dart_truthy__52181);
  })()){
...
encode_sql_keyword(v, column_fn, opts, loop_fn) {
  ...
  var fargs = xtd.arr_map(arg_arr,arg_fn);
  if((() {
    var dart_truthy__52178 = xtd.arr_emptyp(fargs);
    return (null != dart_truthy__52178) && (false != dart_truthy__52178);
  })()){
...
encode_query_value(v, column_fn, opts) {
  if((("Map" == (v.runtimeType).toString()) || (v.runtimeType).toString().startsWith("_Map") || (v.runtimeType).toString().startsWith("LinkedMap")) && v.containsKey("::")){
    ...
    if((1 == v.length) && ((v[0].runtimeType).toString().startsWith("List") || (v[0].runtimeType).toString().startsWith("_GrowableList")) && (() {
      var dart_truthy__52179 = xtd.arr_every(v[0],(value) {
        return "String" == (value.runtimeType).toString();
      });
      return (null != dart_truthy__52179) && (false != dart_truthy__52179);
    })()){
...
encode_query_single_string(params, opts) {
  ...
  var arr_52185 = query_pairs;
  for(var i52186 = 0; i52186 < arr_52185.length; ++i52186){
    var e = arr_52185[i52186];
    var value_52207 = e;
    var key = value_52207[0];
    var v = value_52207[1];
    if(0 < out.length){
      out = (out + " AND ");
    }

...
treep(query) {
  return (() {
    var dart_and__52174 = (() {
      var dart_and__52173 = (query.runtimeType).toString().startsWith("List") || (query.runtimeType).toString().startsWith("_GrowableList");
      return ((null != dart_and__52173) && (false != dart_and__52173)) ? (query.length >= 2) : dart_and__52173;
    })();
    return ((null != dart_and__52174) && (false != dart_and__52174)) ? tree_paramsp(xtd.second(query)) : dart_and__52174;
  })();
}
...
normalise_tree(query) {
  if(!(() {
    var dart_truthy__52175 = treep(query);
    return (null != dart_truthy__52175) && (false != dart_truthy__52175);
  })()){
    return query;
  }
  else{
...
select_tree(schema, query, opts) {
  ...
  if((() {
    var dart_truthy__52176 = treep(query);
    return (null != dart_truthy__52176) && (false != dart_truthy__52176);
  })()){
    ...
    var where_params = xtd.arr_filter(linked,(x) {
      return (() {
        var dart_and__52177 = ("Map" == (x.runtimeType).toString()) || (x.runtimeType).toString().startsWith("_Map") || (x.runtimeType).toString().startsWith("LinkedMap");
        return ((null != dart_and__52177) && (false != dart_and__52177)) ? xtd.not_emptyp(x) : dart_and__52177;
      })();
    });

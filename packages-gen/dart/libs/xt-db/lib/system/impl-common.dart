...
sync_notify_listeners(impl, tables, event) {
  var listeners = impl["listeners"];
  for(var entry_52080 in listeners.entries){
    var listener_id = entry_52080.key;
    var handle = entry_52080.value;
    ...
    if((guard.runtimeType).toString().contains("Function") || (guard.runtimeType).toString().contains("=>") || (guard).toString().startsWith("Closure")){
      var arr_52081 = tables;
      for(var i52082 = 0; i52082 < arr_52081.length; ++i52082){
        var table = arr_52081[i52082];
        if((() {
          var dart_truthy__52076 = Function.apply((guard as Function),<dynamic>[table]);
          return (null != dart_truthy__52076) && (false != dart_truthy__52076);
        })()){
          matched = true;
        }
      };
    ...
    if(("Map" == (guard.runtimeType).toString()) || (guard.runtimeType).toString().startsWith("_Map") || (guard.runtimeType).toString().startsWith("LinkedMap")){
      var arr_52103 = tables;
      for(var i52104 = 0; i52104 < arr_52103.length; ++i52104){
        var table = arr_52103[i52104];
        ...
        if((table_guard.runtimeType).toString().contains("Function") || (table_guard.runtimeType).toString().contains("=>") || (table_guard).toString().startsWith("Closure")){
          ...
          if((() {
            var dart_truthy__52077 = table_guard(table_payload);
            return (null != dart_truthy__52077) && (false != dart_truthy__52077);
          })()){
            matched = true;
          }
        }
...
sync_process_payload(impl, payload) {
  ...
  var db_remove = payload["db/remove"];
  if((("Map" == (db_sync.runtimeType).toString()) || (db_sync.runtimeType).toString().startsWith("_Map") || (db_sync.runtimeType).toString().startsWith("LinkedMap")) && (() {
    var dart_truthy__52074 = xtd.not_emptyp(db_sync);
    return (null != dart_truthy__52074) && (false != dart_truthy__52074);
  })()){
    process_add_event(impl,db_sync);
  }
  if((("Map" == (db_remove.runtimeType).toString()) || (db_remove.runtimeType).toString().startsWith("_Map") || (db_remove.runtimeType).toString().startsWith("LinkedMap")) && (() {
    var dart_truthy__52075 = xtd.not_emptyp(db_remove);
    return (null != dart_truthy__52075) && (false != dart_truthy__52075);
  })()){
    for(var entry_52125 in db_remove.entries){
      var table_name = entry_52125.key;
      var ids = entry_52125.value;
      record_delete(impl,table_name,ids);
    };
  }

...
DartWebsocketClient(raw, defaults, state, callbacks) {
  ...
  return <dynamic, dynamic>{
    ...
    "::/protocol-impls":<dynamic, dynamic>{
        websocket.IWebsocket["on"]:<dynamic, dynamic>{
          "connect":connect_ws,
          "disconnect":disconnect_ws,
          "send":send_ws,
          "add_listeners":add_listeners_ws
        },
        websocket.IWebsocketHeartbeat["on"]:<dynamic, dynamic>{
          "start_heartbeat":start_heartbeat_ws,
          "stop_heartbeat":stop_heartbeat_ws
        }
      },
...
connect_ws(client, opts) {
  ...
  return io.WebSocket.connect(url).then((raw) {
    client["raw"] = raw;
    if((() {
      var dart_truthy__51586 = (client["defaults"])["background"];
      return (null != dart_truthy__51586) && (false != dart_truthy__51586);
    })()){
      raw.listen((message) {
...
send_ws(client, input) {
  ...
  if((() {
    var dart_truthy__51587 = defaults["background"];
    return (null != dart_truthy__51587) && (false != dart_truthy__51587);
  })()){
    raw.add(input);
    return client;
  }
  ...
  return response_future.then((message) {
    ...
    if((() {
      var dart_truthy__51588 = defaults["close_after_message"];
      return (null != dart_truthy__51588) && (false != dart_truthy__51588);
    })()){
      client["raw"] = null;
...
add_listeners_ws(client, m) {
  for(var entry_51589 in m.entries){
    var event = entry_51589.key;
    var handler = entry_51589.value;

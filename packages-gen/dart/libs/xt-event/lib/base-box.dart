...
check_event(event, path) {
  ...
  var arr_50672 = path;
  for(var i = 0; i < arr_50672.length; ++i){
    var v = arr_50672[i];
    if(v != evpath[i]){
      return false;
    }
...
set_data_raw(box, path, value) {
  var data = box["data"];
  if((() {
    var dart_truthy__50671 = xtd.arr_emptyp(path);
    return (null != dart_truthy__50671) && (false != dart_truthy__50671);
  })()){
    box["data"] = value;
  }
  else{
...
del_data(box, path) {
  ...
  var data = box["data"];
  if((() {
    var dart_truthy__50670 = del_data_raw(box,path);
    return (null != dart_truthy__50670) && (false != dart_truthy__50670);
  })()){

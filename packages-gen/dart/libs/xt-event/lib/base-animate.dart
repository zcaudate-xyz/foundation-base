...
new_derived(impl, f, arr) {
  ...
  var arr_51062 = arr;
  for(var i51063 = 0; i51063 < arr_51062.length; ++i51063){
    var v = arr_51062[i51063];
...
listen_array(impl, ref, arr, f) {
  ...
  var arr_51084 = arr;
  for(var i51085 = 0; i51085 < arr_51084.length; ++i51085){
    var ind = arr_51084[i51085];
    add_listener(ind,trigger_fn);
  };
  return Function.apply((trigger_fn as Function),<dynamic>[null]);
}
...
get_map_paths_inner(impl, m, parent, all) {
  ...
  for(var entry_51106 in m.entries){
    var k = entry_51106.key;
    var x = entry_51106.value;
    if((() {
      var dart_truthy__51061 = is_animated(x);
      return (null != dart_truthy__51061) && (false != dart_truthy__51061);
    })()){
...
get_map_input(impl, paths) {
  ...
  var arr_51107 = paths;
  for(var i51108 = 0; i51108 < arr_51107.length; ++i51108){
    var e = arr_51107[i51108];
    var value_51129 = e;
    var path = value_51129[0];
    var key = value_51129[1];
    var v = value_51129[2];
    var val = null;
    if((null != v) && (false != v)){
      val = get_value(v);
...
listen_map(impl, ref, m, f) {
  ...
  var arr_51130 = animated;
  for(var i51131 = 0; i51131 < arr_51130.length; ++i51131){
    var ind = arr_51130[i51131];
    add_listener(ind,trigger_fn);
  };
  return Function.apply((trigger_fn as Function),<dynamic>[null]);
}
...
listen_transformations(impl, ref, indicators, transformations, get_chord) {
  ...
  if(null == transformations){
    ...
    if(null == indicators){
      ...
      var dart_truthy__51060 = is_animated(indicators);
      return (null != dart_truthy__51060) && (false != dart_truthy__51060);
    })()){
    ...
    var out = <dynamic, dynamic>{};
    for(var entry_51152 in transformations.entries){
      var key = entry_51152.key;
      var subtransformations = entry_51152.value;
...
make_binary_indicator(impl, initial, tparams, type, progressing, progress_fn) {
  ...
  var trigger_fn = (flag) {
    ...
    if((() {
      var dart_truthy__51059 = Function.apply((check_fn as Function),<dynamic>[flag]);
      return (null != dart_truthy__51059) && (false != dart_truthy__51059);
    })()){

...
notify_with_promise(notify_fn, host, port, value, id, key, opts) {
  if(!(() {
    var dart_truthy__49000 = (null != value) && (("Future" == (value.runtimeType).toString()) || (value.runtimeType).toString().startsWith("Future<"));
    return (null != dart_truthy__49000) && (false != dart_truthy__49000);
  })()){

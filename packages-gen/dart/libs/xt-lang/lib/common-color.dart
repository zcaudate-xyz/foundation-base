...
hex__gtrgb(s) {
  ...
  if(!(() {
    var dart_truthy__50565 = xts.starts_withp(s,"#");
    return (null != dart_truthy__50565) && (false != dart_truthy__50565);
  })()){
...
rgb__gthsl(rgb, fallback) {
  ...
  var g = value_50567[1];
  var b = value_50567[2];
  var value = (((r > g) ? r : g) > b) ? ((r > g) ? r : g) : b;
  var whiteness = (((r < g) ? r : g) < b) ? ((r < g) ? r : g) : b;
  ...
  return <dynamic>[h,(100 < s) ? 100 : s,(100 < l) ? 100 : l];
}
...
hsl__gtrgb(hsl) {
  var value_50568 = hsl;
  var hi = value_50568[0];
  var si = value_50568[1];
  var li = value_50568[2];
  var h = hi / 360;
  var s = si / 100;
  var l = li / 100;
  if(s == 0){

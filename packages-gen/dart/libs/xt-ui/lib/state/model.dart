...
model(store, model_id) {
  var value_52996 = page_core.model_ensure(store["node"],store["space_id"],store["group_id"],model_id);
  var _group = value_52996[0];
  var current = value_52996[1];
  return current;
}
...
store_close(store) {
  ...
  var arr_53003 = listener_ids;
  for(var i53004 = 0; i53004 < arr_53003.length; ++i53004){
    var listener_id = arr_53003[i53004];

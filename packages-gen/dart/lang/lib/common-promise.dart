...
internal_settle_action(p, status, payload, drive_fn) {
  if("pending" == p["status"]){
    ...
    p["children"] = <dynamic>[];
    var arr_39592 = children;
    for(var i39593 = 0; i39593 < arr_39592.length; ++i39593){
      var entry = arr_39592[i39593];
...
internal_adopt_action(target, value, drive_fn) {
  if((() {
    var dart_truthy__39591 = promise_nativep(value);
    return (null != dart_truthy__39591) && (false != dart_truthy__39591);
  })()){
...
promise_run(value) {
  if((() {
    var dart_truthy__39590 = promise_nativep(value);
    return (null != dart_truthy__39590) && (false != dart_truthy__39590);
  })()){
    return value;
  }
  else{
...
promise_all(promises) {
  ...
  var arr_39614 = values;
  for(var i39615 = 0; i39615 < arr_39614.length; ++i39615){
    var value = arr_39614[i39615];

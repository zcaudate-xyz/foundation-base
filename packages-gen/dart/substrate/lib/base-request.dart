...
ensure_promise(value) {
  if((() {
    var dart_truthy__41896 = (null != value) && (("Future" == (value.runtimeType).toString()) || (value.runtimeType).toString().startsWith("Future<"));
    return (null != dart_truthy__41896) && (false != dart_truthy__41896);

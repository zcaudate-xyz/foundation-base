...
run_tail_call(context, refresh_deps_fn) {
  ...
  if(((null != acc) && (false != acc)) && !(() {
    var dart_truthy__41780 = acc["error"];
    return (null != dart_truthy__41780) && (false != dart_truthy__41780);
...
get_group_deps(group_id, models) {
  ...
  for(var entry_41781 in models.entries){
    var model_id = entry_41781.key;
    var model_entry = entry_41781.value;
    var deps = model_entry["deps"];
    var arr_41782 = deps ?? <dynamic>[];
    for(var i41783 = 0; i41783 < arr_41782.length; ++i41783){
      var path = arr_41782[i41783];

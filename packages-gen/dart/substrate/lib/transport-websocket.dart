...
ensure_promise(value) {
  if((() {
    var dart_truthy__41922 = (null != value) && (("Future" == (value.runtimeType).toString()) || (value.runtimeType).toString().startsWith("Future<"));
    return (null != dart_truthy__41922) && (false != dart_truthy__41922);
  })()){
    return value;
  }
  else{
  ...
  var start_fn = (listener) {
    return ((Future.sync(() => ensure_promise(resolve_socket(socket_source)))) as Future<dynamic>).then((value) async { return await Function.apply((socket) {
      ...
      if(null != current_native){
        ...
        if((() {
          var dart_truthy__41923 = socket_openp(current_socket);
          return (null != dart_truthy__41923) && (false != dart_truthy__41923);
        })()){
        ...
        if((() {
          var dart_truthy__41924 = socket_openp(current_socket);
          return (null != dart_truthy__41924) && (false != dart_truthy__41924);
        })()){
          return current_socket;
        }
        else{

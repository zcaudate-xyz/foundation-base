...
group_snapshot(node, space_id, group_id) {
  ...
  var out = <dynamic, dynamic>{};
  for(var entry_41899 in models.entries){
    var model_id = entry_41899.key;
    var model = entry_41899.value;
...
group_handle_list(space, args, request, node) {
  ...
  var out = <dynamic, dynamic>{};
  for(var entry_41900 in groups.entries){
    var group_id = entry_41900.key;
    var group = entry_41900.value;
    var models = group["models"];
...
group_handle_open(space, args, request, node) {
  ...
  var models = group["models"];
  for(var entry_41901 in models.entries){
    var model_id = entry_41901.key;
    var model = entry_41901.value;
    ensure_model_listeners(node,space_id,group_id,model_id,model);
  };
...
model_handle_proxy_call(space, args, request, node) {
  ...
  return (() async { try { return await ((Future.sync(() => ((Future.sync(() => page_core.model_remote_call(
    ...
    var value_41902 = page_core.model_ensure(node,space_id,group_id,model_id);
    var _group = value_41902[0];
    var model = value_41902[1];
    return <dynamic, dynamic>{
      "status":"ok",
...
group_create_proxy(node, space_id, group_id, snapshot, remote_spec) {
  ...
  for(var entry_41903 in snapshot.entries){
    var model_id = entry_41903.key;
    var model_snapshot = entry_41903.value;
...
model_apply_output(space, stream, node) {
  ...
  var group = page_core.group_get(node,space_id,group_id);
  if((null == group) || !(() {
    var dart_truthy__41898 = page_core.proxy_groupp(group);
    return (null != dart_truthy__41898) && (false != dart_truthy__41898);
  })()){
    return null;
  }
...
model_apply_input(space, stream, node) {
  ...
  var group = page_core.group_get(node,space_id,group_id);
  if((null == group) || !(() {
    var dart_truthy__41897 = page_core.proxy_groupp(group);
    return (null != dart_truthy__41897) && (false != dart_truthy__41897);
  })()){
    return null;
  }
  var model = xtd.get_in(group,<dynamic>["models",model_id]);

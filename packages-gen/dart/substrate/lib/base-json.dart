...
valid_framep(value) {
  ...
  var meta = value["meta"];
  if(!(() {
    var dart_truthy__41888 = frame_kindp(kind);
    return (null != dart_truthy__41888) && (false != dart_truthy__41888);
...
encode_frame(frame) {
  ...
  if(!(() {
    var dart_truthy__41889 = valid_framep(out);
    return (null != dart_truthy__41889) && (false != dart_truthy__41889);
  })()){
...
decode_frame(input) {
  ...
  if(!(() {
    var dart_truthy__41890 = valid_framep(out);
    return (null != dart_truthy__41890) && (false != dart_truthy__41890);
  })()){
    throw "invalid node json frame";
  }
  return out;

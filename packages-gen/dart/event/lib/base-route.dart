...
interim_from_url(url) {
  ...
  if(null != search){
    var arr_41613 = search.split("&");
    for(var i41614 = 0; i41614 < arr_41613.length; ++i41614){
      var pair = arr_41613[i41614];
      if(0 < pair.length){
  ...
  if((() {
    var dart_truthy__41608 = xtd.obj_emptyp(params);
    return (null != dart_truthy__41608) && (false != dart_truthy__41608);
  })()){
...
interim_to_url(interim) {
  ...
  for(var entry_41635 in scoped_params.entries){
    var key = entry_41635.key;
    var val = entry_41635.value;
    if(null != val){
...
path_to_tree(path, terminate) {
  ...
  var arr = <dynamic>[];
  var arr_41636 = path;
  for(var i = 0; i < arr_41636.length; ++i){
    var v = arr_41636[i];
...
path_from_tree(tree) {
  ...
  while((() {
    var dart_truthy__41610 = xtd.arr_not_emptyp(v);
    return (null != dart_truthy__41610) && (false != dart_truthy__41610);
  })()){
    path.add(v);
...
changed_params_raw(pparams, nparams) {
  ...
  var diff_fn = (m, other) {
    var out = <dynamic, dynamic>{};
    for(var entry_41657 in m.entries){
      var k = entry_41657.key;
      var v = entry_41657.value;
      if(v != other[k]){
        out[k] = true;
      }
    };
...
changed_path_raw(ppath, npath) {
  ...
  var changed = false;
  var arr_41658 = npath;
  for(var i41659 = 0; i41659 < arr_41658.length; ++i41659){
    var v = arr_41658[i41659];
    var pv = null;
    if(i < ppath.length){
      pv = ppath[i];
    }
...
set_url(route, url, terminate) {
  ...
  if((() {
    var dart_truthy__41609 = xtd.obj_emptyp(nparams);
    return (null != dart_truthy__41609) && (false != dart_truthy__41609);
  })()){
...
set_path(route, path, params) {
  ...
  if((() {
    var dart_truthy__41612 = xtd.obj_emptyp(nparams);
    return (null != dart_truthy__41612) && (false != dart_truthy__41612);
  })()){
    if(all_params.containsKey(pkey)){
      all_params.remove(pkey);
    }
...
set_param(route, param, value, path) {
  ...
  if(pvalue != value){
    ...
    if((() {
      var dart_truthy__41611 = xtd.obj_emptyp(pparams);
      return (null != dart_truthy__41611) && (false != dart_truthy__41611);
    })()){
      if(all_params.containsKey(pkey)){
        all_params.remove(pkey);
      }

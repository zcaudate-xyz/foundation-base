...
check_event(event, fields) {
  var arr_41680 = fields;
  for(var i41681 = 0; i41681 < arr_41680.length; ++i41681){
    var field = arr_41680[i41681];
    var arr_41702 = event["fields"];
    for(var i41703 = 0; i41703 < arr_41702.length; ++i41703){
      var evfield = arr_41702[i41703];
      if(evfield == field){
        return true;
      }
    };

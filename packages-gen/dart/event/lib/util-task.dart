...
task_load(task) {
  ...
  if((assert_fn.runtimeType).toString().contains("Function") || (assert_fn.runtimeType).toString().contains("=>") || (assert_fn).toString().startsWith("Closure")){
    if(!(() {
      var dart_truthy__41729 = Function.apply((assert_fn as Function),<dynamic>[]);
      return (null != dart_truthy__41729) && (false != dart_truthy__41729);
    })()){
...
list_incomplete(loader) {
  ...
  var out = <dynamic>[];
  var arr_41736 = order;
  for(var i41737 = 0; i41737 < arr_41736.length; ++i41737){
    var id = arr_41736[i41737];
...
list_waiting(loader) {
  ...
  var out = <dynamic>[];
  var arr_41758 = order;
  for(var i41759 = 0; i41759 < arr_41758.length; ++i41759){
    var id = arr_41758[i41759];
    var task = tasks[id];
    if((null != task) && (true != loading[id]) && (true != completed[id]) && (() {
      var dart_truthy__41728 = xtd.arr_every(task["deps"],(dep_id) {
        return true == completed[dep_id];
      });
      return (null != dart_truthy__41728) && (false != dart_truthy__41728);
    })()){
      out.add(id);
    }
  };

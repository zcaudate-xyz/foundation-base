...
DartPostgresClient(defaults, raw) {
  if(!(() {
    var dart_truthy__41991 = (__globals__["xt.lang.common_protocol/IMPLEMENTATIONS"] ??= <dynamic, dynamic>{})["dart.net.conn_postgres/DartPostgresClient"];
    return (null != dart_truthy__41991) && (false != dart_truthy__41991);
  })()){

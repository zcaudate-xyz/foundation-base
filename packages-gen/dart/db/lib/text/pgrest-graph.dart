...
compile_clause_into(prefix, clause, out) {
  var arr_42808 = xtd.arr_sort(List<dynamic>.from(( clause ?? <dynamic, dynamic>{} ).keys),(value) {
    return (value).toString();
  },(x, y) {
    return (x).toString().compareTo((y).toString()) < 0;
  });
  for(var i42809 = 0; i42809 < arr_42808.length; ++i42809){
    var key = arr_42808[i42809];
    ...
    if((("Map" == (value.runtimeType).toString()) || (value.runtimeType).toString().startsWith("_Map") || (value.runtimeType).toString().startsWith("LinkedMap")) && !((value.runtimeType).toString().startsWith("List") || (value.runtimeType).toString().startsWith("_GrowableList")) && (null == value["::"])){
      ...
      var dart_truthy__42807 = filter_operatorp(value[0]);
      return (null != dart_truthy__42807) && (false != dart_truthy__42807);
    })()){
      out.add(
...
flatten_forward_ref_clause(schema, table_name, clause) {
  ...
  for(var entry_42832 in clause.entries){
    var k = entry_42832.key;
    var v = entry_42832.value;
    if((() {
      var dart_truthy__42805 = forward_ref_columnp(schema,table_name,k);
      return (null != dart_truthy__42805) && (false != dart_truthy__42805);
...
compile_tree_select_params(params) {
  ...
  if((() {
    var dart_truthy__42806 = tree_countp(custom);
    return (null != dart_truthy__42806) && (false != dart_truthy__42806);
  })()){
    return "count";
  }
  var out = <dynamic>[];
...
compile_control_params(custom) {
  ...
  var limit = null;
  var offset = null;
  var arr_42833 = custom ?? <dynamic>[];
  for(var i42834 = 0; i42834 < arr_42833.length; ++i42834){
    var entry = arr_42833[i42834];

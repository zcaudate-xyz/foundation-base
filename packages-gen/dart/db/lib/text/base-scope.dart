...
merge_queries(q_0, q_1) {
  ...
  if((() {
    var dart_truthy__42856 = xtd.arr_emptyp(arr_0);
    return (null != dart_truthy__42856) && (false != dart_truthy__42856);
  })()){
    return arr_1;
  }
  if((() {
    var dart_truthy__42857 = xtd.arr_emptyp(arr_1);
    return (null != dart_truthy__42857) && (false != dart_truthy__42857);
  })()){
    return arr_0;
  }
  var out = <dynamic>[];
  var arr_42859 = arr_0;
  for(var i42860 = 0; i42860 < arr_42859.length; ++i42860){
    var e_0 = arr_42859[i42860];
    var arr_42881 = arr_1;
    for(var i42882 = 0; i42882 < arr_42881.length; ++i42882){
      var e_1 = arr_42881[i42882];
...
filter_plain_key(s) {
  if(null == xts.sym_ns(s)){
    return ((null != (() {
      var dart_and__42858 = s.length >= 3;
      return ((null != dart_and__42858) && (false != dart_and__42858)) ? xts.ends_withp(s,"_id") : dart_and__42858;
    })()) && (false != (() {
      var dart_and__42858 = s.length >= 3;
      return ((null != dart_and__42858) && (false != dart_and__42858)) ? xts.ends_withp(s,"_id") : dart_and__42858;
...
get_query_tables(schema, table_key, query, acc) {
  ...
  if((null != table) && (false != table)){
    acc[table_key] = true;
    for(var entry_42905 in query.entries){
      var k = entry_42905.key;
      var v = entry_42905.value;
      var e = table[k];
      if("ref" == e["type"]){
...
get_linked_tables_loop(schema, table_key, returning, acc) {
  ...
  acc[table_key] = true;
  var arr_42908 = linked;
  for(var i42909 = 0; i42909 < arr_42908.length; ++i42909){
    var arr = arr_42908[i42909];
    var attr = arr[0];
...
as_where_input(input) {
  if((() {
    var dart_truthy__42855 = xtd.is_emptyp(input);
    return (null != dart_truthy__42855) && (false != dart_truthy__42855);
  })()){
    return <dynamic>[];
  }

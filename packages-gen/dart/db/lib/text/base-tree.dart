...
tree_control_array(control) {
  if((() {
    var dart_truthy__42977 = xtd.is_emptyp(control);
    return (null != dart_truthy__42977) && (false != dart_truthy__42977);
  })()){
    return <dynamic>[];
  }
  var out = <dynamic>[];
...
tree_base(schema, table_name, sel_query, clause, returning, opts) {
  ...
  if((() {
    var dart_truthy__42976 = xtd.not_emptyp(returning);
    return (null != dart_truthy__42976) && (false != dart_truthy__42976);
  })()){
    tree.add(returning);
  }
...
tree_fill_input(tree, args, input_spec, drop_first) {
  ...
  var arr_42978 = input_spec;
  for(var i = 0; i < arr_42978.length; ++i){
    var e = arr_42978[i];
...
plan_view_check(entry, args, drop_first) {
  ...
  var value_42999 = check.check_args_length(args,targs);
  var l_ok = value_42999[0];
  var l_err = value_42999[1];
  if(!((null != l_ok) && (false != l_ok))){
    return <dynamic>[l_ok,l_err];
  }
  var value_43000 = check.check_args_type(args,targs);
  var t_ok = value_43000[0];
  var t_err = value_43000[1];
...
plan_view(schema, query_spec) {
  ...
  if((null != select_entry) && (null != return_entry)){
    var value_43001 = plan_view_check(select_entry,select_args,false);
    var s_ok = value_43001[0];
    var s_err = value_43001[1];
    if(!((null != s_ok) && (false != s_ok))){
      return <dynamic>[s_ok,s_err];
    }
    var value_43002 = plan_view_check(return_entry,return_args,true);
    var r_ok = value_43002[0];
    var r_err = value_43002[1];
    ...
    var value_43003 = plan_view_check(select_entry,select_args,false);
    var s_ok = value_43003[0];
    var s_err = value_43003[1];
    if(!((null != s_ok) && (false != s_ok))){
      return <dynamic>[s_ok,s_err];
    }
    return <dynamic>[
    ...
    var value_43004 = plan_view_check(return_entry,rargs,false);
    var r_ok = value_43004[0];
    var r_err = value_43004[1];
    if(!((null != r_ok) && (false != r_ok))){
      return <dynamic>[r_ok,r_err];
    }
    return <dynamic>[
    ...
    var value_43005 = plan_view_check(return_entry,return_args,true);
    var r_ok = value_43005[0];
    var r_err = value_43005[1];
    if(!((null != r_ok) && (false != r_ok))){
      return <dynamic>[r_ok,r_err];
    }
    return <dynamic>[

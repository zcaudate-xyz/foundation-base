...
tree_control_array(control) {
  if((() {
    var dart_truthy__42740 = xtd.is_emptyp(control);
    return (null != dart_truthy__42740) && (false != dart_truthy__42740);
  })()){
    return <dynamic>[];
  }
  var out = <dynamic>[];
...
tree_base(schema, table_name, sel_query, clause, returning, opts) {
  ...
  if((() {
    var dart_truthy__42739 = xtd.not_emptyp(returning);
    return (null != dart_truthy__42739) && (false != dart_truthy__42739);
  })()){
    tree.add(returning);
  }
...
query_fill_input(tree, args, input_spec, drop_first) {
  ...
  var arr_42741 = input_spec;
  for(var i = 0; i < arr_42741.length; ++i){
    var e = arr_42741[i];

...
ImplSupabase(client, schema, lookup, state, listeners, opts, metadata) {
  if(!(() {
    var dart_truthy__42030 = (__globals__["xt.lang.common_protocol/IMPLEMENTATIONS"] ??= <dynamic, dynamic>{})["xt.db.system.impl_supabase/ImplSupabase"];
    return (null != dart_truthy__42030) && (false != dart_truthy__42030);
  })()){
...
cmd_rpc_call_async(impl, rpc_spec, args, opts) {
  ...
  var arr_42031 = input_spec;
  for(var i = 0; i < arr_42031.length; ++i){
    var input = arr_42031[i];

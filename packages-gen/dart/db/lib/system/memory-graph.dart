...
var PULL_CHECK = <dynamic, dynamic>{
  ...
  "between":(x, start_expr, _and, end_expr) {
    return (() {
      var dart_and__42056 = x >= start_expr;
      return ((null != dart_and__42056) && (false != dart_and__42056)) ? ((_and == "and") ? (x <= end_expr) : (x <= _and)) : dart_and__42056;
    })();
  },
  "not_like":(x, expr) {
...
custom_params(custom) {
  ...
  var arr_42057 = custom ?? <dynamic>[];
  for(var i42058 = 0; i42058 < arr_42057.length; ++i42058){
    var entry = arr_42057[i42058];
    if(entry["::"] == "sql/count"){
      out["count"] = true;
    }
...
check_clause_value(record, key, clause) {
  if((() {
    var dart_truthy__42055 = xt.lang.common_string.ends_withp(key,"_id");
    return (null != dart_truthy__42055) && (false != dart_truthy__42055);
  })()){
...
where(rows, schema, table_name, where, record) {
  var clause_fn = (pair) {
    var value_42089 = pair;
    var k = value_42089[0];
    var clause = value_42089[1];
  ...
  if((where.runtimeType).toString().contains("Function") || (where.runtimeType).toString().contains("=>") || (where).toString().startsWith("Closure")){
    ...
    var dart_truthy__42053 = xtd.is_emptyp(where);
    return (null != dart_truthy__42053) && (false != dart_truthy__42053);
  })()){
    return true;
  }
...
data_field(record, key) {
  if((() {
    var dart_truthy__42054 = xt.lang.common_string.ends_withp(key,"_id");
    return (null != dart_truthy__42054) && (false != dart_truthy__42054);
  })()){
    var base_key = key.substring(0 - 0,key.length - 3);
...
project_record(rows, schema, tree, record, opts, pull_entries_fn) {
  ...
  var out = <dynamic, dynamic>{};
  var arr_42094 = data;
  for(var i42095 = 0; i42095 < arr_42094.length; ++i42095){
    var key = arr_42094[i42095];
    out[key] = data_field(record,key);
  };
  var arr_42116 = links;
  for(var i42117 = 0; i42117 < arr_42116.length; ++i42117){
    var link = arr_42116[i42117];
...
pull_entries(rows, schema, tree, entries, opts) {
  ...
  if((() {
    var dart_truthy__42052 = custom["count"];
    return (null != dart_truthy__42052) && (false != dart_truthy__42052);
  })()){

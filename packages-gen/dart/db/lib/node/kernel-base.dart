...
kernel_teardown_single(node, service_id) {
  var impl = substrate.get_service(node,service_id);
  if((() {
    var dart_truthy__43035 = protocol.protocol_implements(impl,"xt.db.system.impl_common/ISourceLifecycle");
    return (null != dart_truthy__43035) && (false != dart_truthy__43035);
  })()){
...
kernel_init_main(node, config, schema, lookup) {
  if((() {
    var dart_truthy__43034 = kernel_check_exists(node,config);
    return (null != dart_truthy__43034) && (false != dart_truthy__43034);
  })()){
...
dataview_prep_tree(impl, dataview) {
  ...
  var value_43038 = base_tree.plan_view(schema,xtd.obj_assign(
    <dynamic, dynamic>{"select_args":<dynamic>[],"return_args":<dynamic>[]},
    dataview
  ));
  var ok = value_43038[0];
  var tree = value_43038[1];
  if(!((null != ok) && (false != ok))){
...
dataview_create_model(primary_id, dataview, model) {
  ...
  return <dynamic, dynamic>{
    "handler":(context) {
        ...
        var value_43039 = base_tree.plan_view(schema,xtd.obj_assign(xtd.obj_assign(
          <dynamic, dynamic>{"select_args":<dynamic>[],"return_args":<dynamic>[]},
          args[0]
        ),dataview));
        var ok = value_43039[0];
        var tree = value_43039[1];
        if(!((null != ok) && (false != ok))){
          throw <dynamic, dynamic>{
            "__type__":"xt.exception",
            "message":"Invalid Dataview",

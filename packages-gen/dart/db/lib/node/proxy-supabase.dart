...
init_proxy_handlers(node) {
  var arr_43040 = ACTIONS;
  for(var i43041 = 0; i43041 < arr_43040.length; ++i43041){
    var action = arr_43040[i43041];
    substrate.register_handler(node,action,proxy_util.request_proxy,null);
  };
  var arr_43062 = ATTACH_ACTIONS;
  for(var i43063 = 0; i43063 < arr_43062.length; ++i43063){
    var action = arr_43062[i43063];

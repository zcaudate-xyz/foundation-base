...
(l/script :xtalk
  {:export [MODULE] :require [[js.cell.service.db-view :as db-view] [xt.lang.spec-base :as xt] [xt.lang.common-data :as xtd] [xt.lang.common-tree :as xtt] [xt.db.instance :as xdb] [xt.db.text.base-check :as check] [xt.db.instance.cache-view :as cache-view]]})

...
(def.xt get-space-page page/space-get-page)
(def.xt ensure-space-page page/space-ensure-page)
(def.xt set-space-page page/space-set-page)
(def.xt page-group-get page/group-get)
(def.xt page-group-ensure page/group-ensure)
(def.xt page-model-ensure page/model-ensure)
(def.xt page-add-group-attach page/group-add-attach)
(def.xt page-add-group page/group-add)
(def.xt page-remove-group page/group-remove)
(def.xt page-remove-model page/model-remove)
...
(def.xt page-trigger-group page/group-trigger)
(def.xt page-trigger-model page/model-trigger)
(def.xt page-trigger-all page/space-trigger-all)
(def.xt add-raw-page-callback page/raw-callback-add)
(def.xt remove-raw-page-callback page/raw-callback-remove)

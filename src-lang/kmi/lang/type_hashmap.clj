...
(defn.xt hashmap-to-iter
  ...
  (return (xt/x:iter-from-arr
           (-/hashmap-collect-pairs (xt/x:get-key hashmap "_root") []))))
...
(defn.xt hashmap-from-array
  "creates a hashmap from alternating entries in an array"
  {:added "4.1"}
  [input]
...
(defn.xt hashmap
  ...
  {:added "4.1"}
  [(:.. args)]
  (return (-/hashmap-from-array args)))

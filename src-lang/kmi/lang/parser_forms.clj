...
(defn.xt read-list
  ...
  {:added "4.1"}
  [reader read-fn]
  (return (list/list-from-array (-/read-delimited reader ")" read-fn))))

(defn.xt read-vector
  "reads a vector form"
  {:added "4.1"}
  [reader read-fn]
  (return (vec/vector-from-array (-/read-delimited reader "]" read-fn))))
...
(defn.xt read-map
  ...
  (return (hm/hashmap-from-array items)))

(defn.xt read-set
  "reads a set form"
  {:added "4.1"}
  [reader read-fn]
  (return (hs/hashset-from-array (-/read-delimited reader "}" read-fn))))
...
(defn.xt read-quote
  ...
  {:added "4.1"}
  [reader read-fn]
  (return (list/list-from-array [(sym/symbol nil "quote")
...
(defn.xt read-syntax-quote
  ...
  {:added "4.1"}
  [reader read-fn]
  (return (list/list-from-array [(sym/symbol nil "syntax-quote")
                                 (-/read-required reader read-fn)])))
...
(defn.xt read-deref
  ...
  {:added "4.1"}
  [reader read-fn]
  (return (list/list-from-array [(sym/symbol nil "deref")
                                 (-/read-required reader read-fn)])))
...
(defn.xt read-unquote-splicing
  ...
  {:added "4.1"}
  [reader read-fn]
  (return (list/list-from-array [(sym/symbol nil "unquote-splicing")
                                 (-/read-required reader read-fn)])))
...
(defn.xt read-unquote
  ...
  (if (== "@" (rdr/peek-char reader))
    ...
    (return (list/list-from-array [(sym/symbol nil "unquote")
                                   (-/read-required reader read-fn)]))))
...
(defn.xt read-var-quote
  ...
  {:added "4.1"}
  [reader read-fn]
  (return (list/list-from-array [(sym/symbol nil "var")
                                 (-/read-required reader read-fn)])))

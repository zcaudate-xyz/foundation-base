...
| Generate JavaScript, Lua, Python, Go, SQL, Solidity, or other code | [Lang introduction](https://zcaudate.xyz/foundation-base/lang/introduction.html) |
...
| Run generated code in external runtimes | [Lang runtimes](https://zcaudate.xyz/foundation-base/lang/lang-runtime.html) |
...
Lang goes beyond printing syntax. Language books, grammars, modules, pointers, and runtime adapters make it possible to inspect, test, and execute generated code from the same Clojure workflow.

### Build the standalone Lang CLI

Build an AOT-compiled uberjar from the Lang sources in the current checkout:
...
`.build/lang-uberjar/target/lang-4.1.5-standalone.jar`. It does not require
Leiningen or a Foundation Base checkout at runtime:

```bash
java -jar .build/lang-uberjar/target/lang-4.1.5-standalone.jar languages
java -jar .build/lang-uberjar/target/lang-4.1.5-standalone.jar \
  emit js '[(+ 1 2 3)]'
printf '[(* 6 7)]\n' | java -jar \
  .build/lang-uberjar/target/lang-4.1.5-standalone.jar emit lua -
```
...
- [Lang overview](https://zcaudate.xyz/foundation-base/lang/index.html)
- [Introduction](https://zcaudate.xyz/foundation-base/lang/introduction.html)
- [Basic walkthrough](https://zcaudate.xyz/foundation-base/lang/walkthrough-basic.html) — [source](src-doc/walkthrough/std_lang_00_basic.clj)
- [Multiple-language walkthrough](https://zcaudate.xyz/foundation-base/lang/walkthrough-multi.html) — [source](src-doc/walkthrough/std_lang_01_multi.clj)
- [Live runtime walkthrough](https://zcaudate.xyz/foundation-base/lang/walkthrough-live.html) — [source](src-doc/walkthrough/std_lang_02_live.clj)
...
- [`Lang Language Tooling`](wiki/Lang-Language-Tooling.md)

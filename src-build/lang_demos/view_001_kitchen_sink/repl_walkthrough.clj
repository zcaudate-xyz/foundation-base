;; repl_walkthrough.clj — Step-through guide for lang-demos.view-001-kitchen-sink.build
;;
...
(ns lang-demos.view-001-kitchen-sink.repl-walkthrough
  (:require [std.lib.env :as env]
            [std.lib.os :as os]
            [std.make :as make]
            [std.make.project :as project]
            [lang-demos.view-001-kitchen-sink.build :as build]))
...
(ns-publics 'lang-demos.view-001-kitchen-sink.build)
...
;; If you edit lang-demos.view-001-kitchen-sink.app and want to rebuild only the
;; targets that declare it as a trigger, use build-triggered.
(project/build-triggered 'lang-demos.view-001-kitchen-sink.app)

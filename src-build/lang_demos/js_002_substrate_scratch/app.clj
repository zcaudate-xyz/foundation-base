(ns lang-demos.js-002-substrate-scratch.app
  (:require [lang.core :as l]))

(l/script :js
  {:import [["https://esm.sh/react@18.3.1" :as React]
            ["https://esm.sh/react-dom@18.3.1/client" :as ReactDOM]]
   :require [[lang-demos.js-002-substrate-scratch.main :as demo]
  ...
  (return
   [:main {:className "shell"}
    [:section {:className "hero"}
     ...
     [:p "The schema bindings and model descriptors are emitted from Lang DSL and derive from postgres.sample.scratch-v3."]]

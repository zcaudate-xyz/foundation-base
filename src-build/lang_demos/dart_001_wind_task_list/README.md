...
```bash
lein run -m lang-demos.dart-001-wind-task-list.build build
lein run -m lang-demos.dart-001-wind-task-list.build build-macos
lein run -m lang-demos.dart-001-wind-task-list.build test
lein run -m lang-demos.dart-001-wind-task-list.build run-linux
lein run -m lang-demos.dart-001-wind-task-list.build run-macos
lein run -m lang-demos.dart-001-wind-task-list.build run-web
```

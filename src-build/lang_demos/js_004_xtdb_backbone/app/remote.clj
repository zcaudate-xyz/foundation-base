...
(defn.js default-session-config
  []
  (return
   {"browser_node_id" "lang-demos.js-004-xtdb-backbone-webapp"
    "shared_space" "demo/shared"
    "model_id" "lang-demos.js-004-xtdb-backbone/summary"
    "model_spec" nil}))
  ...
  (return
   (substrate/node-create
    {"id" (or (xt/x:get-key config "browser_node_id")
              "lang-demos.js-004-xtdb-backbone-webapp")})))

(defn.js create-page-node
  []
  (return (substrate/node-create {"id" "lang-demos.js-004-xtdb-backbone-page-node"})))

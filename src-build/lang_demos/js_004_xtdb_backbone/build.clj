   ...
   '[(var path (require "path"))
     (:= (. module exports)
         {:mode "production"
          ...
          :output {:filename "lang-demos.js-004-xtdb-backbone-worker.js"
  ...
  {:tag "lang-demos.js-004-xtdb-backbone"
   ...
   {:setup [{:type :makefile
            ...
            {:type :package.json
             :target "sharedworker"
             :main {"license" "ISC"
                    "name" "lang-demos.js-004-xtdb-backbone-sharedworker"
                    "private" true
                    "main" "src/main.js"
   ...
   [{:type :raw
     ...
     :main (fn []
             (l/with:cache-none
               [(l/emit-script
                 '(do (lang-demos.js-004-xtdb-backbone.app.sharedworker/runtime-init))
                 {:lang :js
                  :layout :full})]))}

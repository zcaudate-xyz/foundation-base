(ns code.gen.core-test
  (:use code.test)
  (:require [code.gen.core :as c]))

^{:refer code.gen.core/data-list->blocks :added "4.0"}
(fact "TODO")

^{:refer code.gen.core/data->block :added "4.0"}
(fact "TODO")

^{:refer code.gen.core/splice-data->blocks :added "4.0"}
(fact "TODO")

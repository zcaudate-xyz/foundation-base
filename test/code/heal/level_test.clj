...
(fact "prepares the block entries for a file"
  ...
  (level/group-blocks-prep-entries
   (code.heal.parse/parse-delimiters
    (str/join-lines
     ["(:? ()"
      "    ())"
      "    nil {})"]))
   (code.heal.parse/parse-lines
    (str/join-lines
     ["(:? ()"
      "    ())"
      "    nil {})"])))
  ...
  (level/get-errored
   (str/join-lines
    [""
     "    {(stateName) (Object.assign {} (. component.states [stateName])"
     "       {:description description})}"]))
  => [{:errors [{:char "(", :line 2, :col 18, :type :open, :style :paren, :depth 0, :index 0, :correct? false}],
       :lines ["                 (Object.assign {} (. component.states [stateName])"],
       :at {:lead {:char "(", :line 2, :col 18, :type :open, :style :paren},
            :line [2 2], :level 3, :col 18}}]
...
^{:refer code.heal.level/heal-content-print :added "4.0"}
(fact "TODO")

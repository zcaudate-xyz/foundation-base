(ns code.mcp.heal.form-test
  (:require [code.mcp.heal.form :refer :all])
  (:use code.test))
...
(fact "gets the dsl dependencies"
  ...
  (get-dsl-deps-fn "(ns my.ns (:require [tahto.core :as l] [std.lib :as h])) (l/script :lua {:require [[xt.lang.common-lib :as k]]})")

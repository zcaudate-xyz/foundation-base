(ns code.mcp.tool.lang-lang-test
  (:require [code.mcp.tool.lang-lang :as lang.core]
            [code.test :refer :all]))

^{:refer code.mcp.tool.lang-lang/lang-emit-as-safe :added "4.1"}

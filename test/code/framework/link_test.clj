...
(fact "splits runtime namespaces into dedicated packages"
  (let [entries          (collect-entries -packages- -lookups-)
        lang-entries     (set (get-in entries '[xyz.zcaudate/lang :entries]))
    ...
    [(boolean (lang-entries [:clj 'lang.runtime.postgres]))
     (boolean (lang-entries [:clj 'lang.runtime.solidity]))
     (boolean (lang-entries [:clj 'lang.runtime.solidity.client]))
     (boolean (lang-entries [:clj 'lang.runtime.graal]))
     (boolean (lang-entries [:clj 'lang.runtime.jep]))
     (boolean (lang-entries [:clj 'lang.runtime.redis]))
     (boolean (lang-entries [:clj 'lang.runtime.nginx]))
     (boolean (lang-entries [:clj 'lang.runtime.nginx.config]))
     (boolean (lang-entries [:clj 'xt.lang.common-lib]))

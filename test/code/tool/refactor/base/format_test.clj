...
^{:refer code.tool.refactor.base.format/remove-consecutive-blank-lines :added "3.0"}
...
^{:refer code.tool.refactor.base.format/insert-missing-whitespace :added "3.0"}
...
^{:refer code.tool.refactor.base.format/align-keys :added "3.0"}
...
^{:refer code.tool.refactor.base.format/sort-keys :added "3.0"}
(fact "Sorts map keys"
...
^{:refer code.tool.refactor.base.format/align-to-indent :added "3.0"}

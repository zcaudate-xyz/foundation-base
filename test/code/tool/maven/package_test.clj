...
^{:refer code.tool.maven.package/pom-properties :added "3.0"}
...
^{:refer code.tool.maven.package/coordinate->tree :added "3.0"}
...
^{:refer code.tool.maven.package/repository->tree :added "3.0"}
...
^{:refer code.tool.maven.package/license->tree :added "3.0"}
...
^{:refer code.tool.maven.package/generate-manifest :added "3.0"}
...
^{:refer code.tool.maven.package/generate-project-clj :added "4.0"}
...
^{:refer code.tool.maven.package/package :added "3.0"}
...
^{:refer code.tool.maven.package/infer :added "3.0"}

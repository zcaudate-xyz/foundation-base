...
^{:refer std.object.element.util/set-field :added "3.0"}
(fact "base function to set the field value of a particular object")

^{:refer std.object.element.util/param-arg-match :added "3.0"}
...
^{:refer std.object.element.util/param-float-match :added "3.0"}
...
^{:refer std.object.element.util/is-congruent :added "3.0"}
...
^{:refer std.object.element.util/throw-arg-exception :added "3.0"}
...
^{:refer std.object.element.util/box-args.primitives :added "3.0" :adopt true}

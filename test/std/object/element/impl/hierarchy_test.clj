...
^{:refer std.object.element.impl.hierarchy/has-method :added "3.0"}
...
^{:refer std.object.element.impl.hierarchy/methods-with-same-name-and-count :added "3.0"}
...
^{:refer std.object.element.impl.hierarchy/origins :added "3.0"}

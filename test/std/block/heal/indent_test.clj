...
[:h 
 ...
 []")))
  ...
  (def ^:dynamic *dlm3*
    (parse/pair-delimiters
     (parse/parse-delimiters (slurp "test-data/std.block.heal/cases/001_basic.block"))))

(ns std.block.heal.legacy-test
  (:use code.test)
  (:require [std.block.heal.legacy :as core]
            [std.block.heal.parse :as parse]
            [std.block.heal.print :as print]
            [std.lib :as h]))

^{:refer std.block.heal.legacy/heal-mismatch :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-append :added "4.0"}
(fact "appends at the "
  ^:hidden
...
^{:refer std.block.heal.legacy/heal-remove :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-close-heavy-single-pass :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-close-heavy :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-open-heavy-single-pass :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-open-heavy :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-legacy-raw :added "4.0"}
...
^{:refer std.block.heal.legacy/heal-legacy :added "4.0"}

...
^{:refer std.lang.model-annex.spec-php/is-capitalized? :added "4.1"}
(fact "checks if string is capitalized"
  (spec-php/is-capitalized? "Abc") => true
  (spec-php/is-capitalized? "abc") => false)

^{:refer std.lang.model-annex.spec-php/php-symbol :added "4.1"}
...
^{:refer std.lang.model-annex.spec-php/php-invoke-args :added "4.1"}
(fact "emit php invoke args"
  (spec-php/php-invoke-args '[1 2] spec-php/+grammar+ {})
  => "1, 2")

^{:refer std.lang.model-annex.spec-php/php-invoke :added "4.1"}
(fact "emit php function call"
  (spec-php/php-invoke '(f 1 2) spec-php/+grammar+ {})
  => "f(1, 2)")

^{:refer std.lang.model-annex.spec-php/php-var :added "4.1"}
(fact "emit php variable declaration"
  (spec-php/php-var '(var a 10))
  => '(:= a 10))

^{:refer std.lang.model-annex.spec-php/php-defn :added "4.1"}
...
^{:refer std.lang.model-annex.spec-php/php-array :added "4.1"}
(fact "emit php array"
...
^{:refer std.lang.model-annex.spec-php/php-dot :added "4.1"}
(fact "emit php object access ->"
  (spec-php/php-dot '(. obj prop))
  => '(:- "obj->prop"))

^{:refer std.lang.model-annex.spec-php/php-new :added "4.1"}
(fact "emit new Class()"

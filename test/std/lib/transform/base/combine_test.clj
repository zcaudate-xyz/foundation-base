...
^{:refer std.lib.transform.base.combine/combine-value :added "3.0"}
...
^{:refer std.lib.transform.base.combine/combine-set :added "3.0"}
...
^{:refer std.lib.transform.base.combine/combine-internal :added "3.0"}
...
^{:refer std.lib.transform.base.combine/combine :added "3.0"}
...
^{:refer std.lib.transform.base.combine/decombine :added "3.0"}

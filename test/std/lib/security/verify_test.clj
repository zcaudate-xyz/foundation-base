...
^{:refer std.lib.security.verify/init-hmac :added "3.0"}
(comment "initializes the hmac algorithm")

^{:refer std.lib.security.verify/hmac :added "3.0" :class [:security/verify]}
...
^{:refer std.lib.security.verify/sign :added "3.0" :class [:security/verify]}
...
^{:refer std.lib.security.verify/verify :added "3.0" :class [:security/verify]}

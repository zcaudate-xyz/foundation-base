...
(fact "render ascii"
  (let [output (render [:div {:class "w-20 h-5 border"} "hello"])]
    (std.string.common/includes? output "+------------------+") => true
    (std.string.common/includes? output "|hello             |") => true))
...
(fact "render complex layout: sidebar"
  (let [layout [:div {:class "flex w-40 h-10 border"}
    ...
    (std.string.common/includes? output "+--------++------------------+") => true
    (std.string.common/includes? output "||Side") => true
    (std.string.common/includes? output "||Main") => true))
...
(fact "render complex layout: card"
  (let [card [:div {:class "flex flex-col w-30 h-12 border"}
        ...
        output (render card)]
    (std.string.common/includes? output "+--------------------------+") => true ;; Top border of image
    (std.string.common/includes? output "||Img") => true
    (std.string.common/includes? output "||Title") => true))

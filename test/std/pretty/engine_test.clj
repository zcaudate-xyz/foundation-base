...
^{:refer std.pretty.engine/serialize-node-line :added "3.0"}
(fact "creates a :line operation"

  (serialize-node-line [:line])
  => [{:op :line, :inline " ", :terminate ""}])

^{:refer std.pretty.engine/serialize-node-break :added "3.0"}
(fact "creates a :break operation"

  (serialize-node-break [:break])
  => [{:op :break}])

^{:refer std.pretty.engine/serialize-node-group :added "3.0"}
...
^{:refer std.pretty.engine/serialize-node-nest :added "3.0"}
...
^{:refer std.pretty.engine/serialize-node-align :added "3.0"}
...
^{:refer std.pretty.engine/annotate-right :added "3.0"}
...
^{:refer std.pretty.engine/annotate-begin :added "3.0"}
...
^{:refer std.pretty.engine/format-nodes :added "3.0"}
...
^{:refer std.pretty.engine/pprint-document :added "3.0"}

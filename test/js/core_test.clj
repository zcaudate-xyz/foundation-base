...
^{:refer js.core/timeout :added "4.0" :unchecked true}
(fact "creates a timeout call")

^{:refer js.core/isWeb :added "4.0" :unchecked true}
...
^{:refer js.core/asyncFn :added "4.0" :unchecked true}
(fact "creates an async function")

^{:refer js.core/import-missing :added "4.0" :unchecked true}
(fact "generates all depenent imports missing from current namespace")

^{:refer js.core/import-set-global :added "4.0" :unchecked true}
(fact "sets all dependent imports to global")

^{:refer js.core/arrayify :added "4.0" :unchecked true}
(fact "makes an array"
...
^{:refer js.core/module:demos :added "4.0" :unchecked true}

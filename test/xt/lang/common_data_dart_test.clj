...
(fact
 ...
 ^{:hidden true}
 (!.dart [(k/arrayify 1) (k/arrayify [1])])
 =>
 [[1] [1]])
...
(fact
 "sets item in object"
 ^{:hidden true}
 [(!.dart (var a {:a {:b {:c 1}}}) (k/set-in a ["a" "b"] 2) a)
  (!.dart (var a {:a {:b {:c 1}}}) (k/set-in a ["a" "d"] 2) a)]
 =>
 [{"a" {"b" 2}} {"a" {"d" 2, "b" {"c" 1}}}])
...
(fact
 ...
 ^{:hidden true}
 (!.dart (k/obj-diff {:a 1, :b 2} {:a 1, :c 2}))
 =>
 {"c" 2})

(ns
 xtbench.dart.lang.common-runtime-test
 (:use code.test)
 (:require [std.lang :as l] [xt.lang.common-runtime :as rt]))

(l/script-
 :dart
 {:runtime :twostep, :require [[xt.lang.common-runtime :as rt]]})
...
(fact
 ...
 ^{:hidden true}
 (!.dt [(rt/xt-exists?) (rt/xt-ensure) (rt/xt-exists?)])
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.dt [(do (rt/xt-purge) (rt/xt-create)) (rt/xt-current)])
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.dt (rt/xt-purge) [(rt/xt-current) (rt/xt-ensure) (rt/xt-current)])
 =>
 (contains-in
  [nil
   {"config" {}, "spaces" {}, "::" "xt"}
...
(fact
 ...
 ^{:hidden true}
 (!.dt (rt/xt-ensure) [(rt/xt-purge) (rt/xt-current)])
 =>
 (contains-in [{"config" {}, "spaces" {}, "::" "xt"} nil]))

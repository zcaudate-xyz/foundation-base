(ns
 xtbench.lua.lang.common-runtime-test
 (:use code.test)
...
(fact
 ...
 ^{:hidden true}
 (!.lua [(rt/xt-exists?) (rt/xt-ensure) (rt/xt-exists?)])
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.lua [(do (rt/xt-purge) (rt/xt-create)) (rt/xt-current)])
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.lua (rt/xt-purge) [(rt/xt-current) (rt/xt-ensure) (rt/xt-current)])
 =>
 (contains-in
  [nil
   {"config" {}, "spaces" {}, "::" "xt"}
...
(fact
 ...
 ^{:hidden true}
 (!.lua (rt/xt-ensure) [(rt/xt-purge) (rt/xt-current)])
 =>
...
(fact
 ...
 =>
 [[true] [true {"host" "127.0.0.1", "port" 1234}]])

(ns
 xtbench.lua.lang.event-view-test
 (:require
  [std.json :as json]
  [std.lang :as l]
...
(fact
 ...
 ^{:hidden true}
 (!.lua ((view/wrap-args k/identity) {:args [1]}))
 =>
 1)
...
(fact
 ...
 ^{:hidden true}
 (!.lua (view/parse-args {:input {:data [1 2 3]}}))
 =>
 [1 2 3])
...
(fact
 ...
 (notify/wait-on
  ...
  (view/add-listener
   v
   "a1"
   (fn [res] (repl/notify (xtd/tree-get-data res))))
  (view/set-input v 1))
 =>
 (contains-in
  {"type" "view.input",

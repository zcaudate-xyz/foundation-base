(ns
 xtbench.python.lang.common-runtime-test
 (:use code.test)
...
(fact
 ...
 ^{:hidden true}
 (!.py [(rt/xt-exists?) (rt/xt-ensure) (rt/xt-exists?)])
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.py [(do (rt/xt-purge) (rt/xt-create)) (rt/xt-current)])
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.py (rt/xt-purge) [(rt/xt-current) (rt/xt-ensure) (rt/xt-current)])
 =>
 (contains-in
  [nil
   {"config" {}, "spaces" {}, "::" "xt"}
...
(fact
 ...
 ^{:hidden true}
 (!.py (rt/xt-ensure) [(rt/xt-purge) (rt/xt-current)])
 =>
 (contains-in [{"config" {}, "spaces" {}, "::" "xt"} nil]))

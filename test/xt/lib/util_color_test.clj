...
^{:refer xt.lib.util-color/named->rgb :added "4.0"}
...
^{:refer xt.lib.util-color/hex->n :added "4.0"}
(fact "hex to rgb val"
...
^{:refer xt.lib.util-color/n->hex :added "4.0"}
...
^{:refer xt.lib.util-color/hex->rgb :added "4.0"}
...
^{:refer xt.lib.util-color/rgb->hex :added "4.0"}
...
^{:refer xt.lib.util-color/rgb->hue :added "4.0"}
(fact "helper function for rgb->hsl")

^{:refer xt.lib.util-color/rgb->hsl :added "4.0"}
...
^{:refer xt.lib.util-color/hue->v :added "4.0"}
(fact "converts a hue to a value"

  (color/hue->v 20 30 0)
  => 20)

^{:refer xt.lib.util-color/hsl->rgb :added "4.0"}
...
^{:refer xt.lib.util-color/named->hsl :added "4.0"}
...
^{:refer xt.lib.util-color/named->hex :added "4.0"}
...
^{:refer xt.lib.util-color/hex->hsl :added "4.0"}

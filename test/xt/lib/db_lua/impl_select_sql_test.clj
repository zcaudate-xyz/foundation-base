(ns xt.lib.db-lua.impl-select-sql-test
...
^{:refer xt.lib.db-lua.impl-select-sql-test/CONNECTION :adopt true :added "4.0"}
(fact "CONNECTED"
...
^{:refer xt.lib.db-lua.impl-select-sql-test/QUERY :adopt true :added "4.0"}

(ns xt.lib.db-lua.impl-sql-test
...
(l/script- :lua
  {:runtime :basic
   ...
   :require [[xt.lib.db.impl-sql :as impl-sql]
...
^{:refer xt.lib.db.impl-sql/CANARY :adopt true :added "4.0"}
...
^{:refer xt.lib.db.impl-sql/sql-process-event-remove.lua :adopt true :added "4.0"
  :setup [(!.lua
...
^{:refer xt.lib.db.impl-sql/sql-gen-delete :added "4.0"}
...
^{:refer xt.lib.db.impl-sql/sql-process-event-sync :added "4.0"}
(fact "processes event sync data from database")

^{:refer xt.lib.db.impl-sql/sql-process-event-remove :added "4.0"
  :setup [(!.lua
           (xtd/arr-sort (impl-sql/sql-process-event-sync
                          INSTANCE
                          "add"
...
^{:refer xt.lib.db.impl-sql/sql-pull-sync :added "4.0"
  :setup [(def +account+
            (contains-in
             [{"is_official" 0,
               "nickname" "root",
...
^{:refer xt.lib.db.impl-sql/sql-delete-sync :added "4.0"}
(fact "deletes sync data from sql db")

^{:refer xt.lib.db.impl-sql/sql-clear :added "4.0"}

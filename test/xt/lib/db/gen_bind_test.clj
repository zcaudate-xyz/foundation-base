(ns xt.lib.db.gen-bind-test
  (:require [rt.postgres.test.scratch-v1 :as scratch]
            [xt.lib.db.gen-bind :as bind]
            [xt.lib.db.sample-data-test :as sample-data]
            [xt.lib.db.sample-user-test :as sample-user])
  (:use code.test))

^{:refer xt.lib.db.gen-bind/tmpl-route :added "4.0"}
...
^{:refer xt.lib.db.gen-bind/tmpl-view :added "4.0"}
...
^{:refer xt.lib.db.gen-bind/route-list :added "4.0"}
(fact "lists all routes"

  (bind/route-list)
  => vector?)

^{:refer xt.lib.db.gen-bind/view-list :added "4.0"}
...
^{:refer xt.lib.db.gen-bind/route-map :added "4.0"}

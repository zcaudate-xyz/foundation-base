...
^{:refer xt.lib.db.sql-manage/table-create.sqlite :adopt true :added "4.0"}
...
^{:refer xt.lib.db.sql-manage/table-create-column :added "4.0"}
...
^{:refer xt.lib.db.sql-manage/table-create :added "4.0"
...
^{:refer xt.lib.db.sql-manage/table-create-all :added "4.0"}
...
^{:refer xt.lib.db.sql-manage/table-drop :added "4.0"}
...
^{:refer xt.lib.db.sql-manage/table-drop-all :added "4.0"
  :setup [(def +drop-all+

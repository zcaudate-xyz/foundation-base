...
^{:refer xt.lib.db.sql-sqlite/CANARY :adopt true :added "4.0"}
...
^{:refer xt.lib.db.sql-sqlite/CANARY.schema :adopt true :added "4.0"}
...
^{:refer xt.lib.db.sql-sqlite/CANARY.data :adopt true :added "4.0"}
(fact "ensures that the results are the same"

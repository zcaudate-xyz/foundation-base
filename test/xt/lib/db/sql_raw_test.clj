...
(l/script- :js
  {:runtime :basic
   :require [[xt.lib.db.sql-raw :as raw]
...
^{:refer xt.lib.db.sql-raw/raw-delete :added "4.0"}
...
^{:refer xt.lib.db.sql-raw/raw-insert-array :added "4.0"}
...
^{:refer xt.lib.db.sql-raw/raw-insert :added "4.0"}
...
^{:refer xt.lib.db.sql-raw/raw-upsert :added "4.0"}
...
^{:refer xt.lib.db.sql-raw/raw-upsert.more :adopt true :added "4.0"
  :setup [(def +input+
            (prose/|
             "INSERT INTO Currency"
             " (id, name, type)"
...
^{:refer xt.lib.db.sql-raw/raw-update :added "4.0"}
...
^{:refer xt.lib.db.sql-raw/raw-select :added "4.0"}

...
^{:refer xt.lib.db.supabase/payload->xdb-events :added "4.1.3"}
(fact "translates canonical supabase payloads to xt.lib.db events"
...
;;
;; Integration: apply to sqlite-backed xt.lib.db
;;

^{:refer xt.lib.db.supabase/apply-payload :added "4.1.3"}
(fact "applies supabase payload to local xt.lib.db (sqlite)"
...
^{:refer xt.lib.db.supabase/attach-events :added "4.1.3"}
...
^{:refer xt.lib.db.supabase/snake->kebab :added "4.1"}
(fact "TODO")

^{:refer xt.lib.db.supabase/normalize-row :added "4.1"}
(fact "TODO")
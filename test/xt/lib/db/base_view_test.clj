...
^{:refer xt.lib.db.base-view/all-overview :added "4.0"}
...
^{:refer xt.lib.db.base-view/all-keys :added "4.0"}
...
^{:refer xt.lib.db.base-view/all-methods :added "4.0"
  :setup [(def +methods+

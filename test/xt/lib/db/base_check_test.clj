...
(l/script- :js
  {:runtime :oneshot
   ...
   :require [[xt.lib.db.base-check :as chk]
...
^{:refer xt.lib.db.base-check/is-uuid? :added "4.0"}
...
^{:refer xt.lib.db.base-check/check-arg-type :added "4.0"}
...
^{:refer xt.lib.db.base-check/check-args-type :added "4.0"}
...
^{:refer xt.lib.db.base-check/check-args-length :added "4.0"}

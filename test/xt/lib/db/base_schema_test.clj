...
^{:refer xt.lib.db.base-schema/get-ident-id :added "4.0"}
(fact "gets the ident id for a schema entry")

^{:refer xt.lib.db.base-schema/list-tables :added "4.0"}
(fact "list tables"
...
^{:refer xt.lib.db.base-schema/get-cached-schema :added "4.0"}
(fact "get lookup"
...
^{:refer xt.lib.db.base-schema/create-data-keys :added "4.0"}
...
^{:refer xt.lib.db.base-schema/create-ref-keys :added "4.0"}
...
^{:refer xt.lib.db.base-schema/create-rev-keys :added "4.0"}
...
^{:refer xt.lib.db.base-schema/create-table-entries :added "4.0"}
(fact "creates the table keys")

^{:refer xt.lib.db.base-schema/create-defaults :added "4.0"}
(fact "creates defaults from sql inputs")

^{:refer xt.lib.db.base-schema/create-all-keys :added "4.0"
              ...
              {"ident" "owner",
               ...
               {"key" "owner",
                ...
                {"lang" "postgres",
                 "id" "UserAccount",
                 "section" "code",
                 "module" "xt.lib.db.sample-user-test"},
                "type" "forward",
                "rident" "wallets",
                "rval" "wallets",
                "ns" "UserAccount",
...
^{:refer xt.lib.db.base-schema/get-all-keys :added "4.0"
  :setup [(def +all-org+
            {"table"
             [{"ident" "id",
               "primary" true,
...
^{:refer xt.lib.db.base-schema/data-keys :added "4.0"}
(fact "gets data keys"
...
^{:refer xt.lib.db.base-schema/ref-keys :added "4.0"}
(fact "gets ref keys"
...
^{:refer xt.lib.db.base-schema/ref-id-keys :added "4.0"}
...
^{:refer xt.lib.db.base-schema/rev-keys :added "4.0"}
(fact "gets rev keys"
...
^{:refer xt.lib.db.base-schema/table-defaults :added "4.0"}
(fact "gets the table defaults")

^{:refer xt.lib.db.base-schema/table-entries :added "4.0"}
(fact "gets the table entries")

^{:refer xt.lib.db.base-schema/table-columns :added "4.0"
  :setup [(def +out+
...
^{:refer xt.lib.db.base-schema/create-table-order :added "4.0"
  :setup [(def +ordered+
            ["UserAccount"
             "UserProfile"
             "UserNotification"
...
^{:refer xt.lib.db.base-schema/table-order :added "4.0"}
...
^{:refer xt.lib.db.base-schema/table-coerce :added "4.0"}

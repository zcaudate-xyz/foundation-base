...
(l/script- :js
  {:runtime :basic
   :require [[xt.lib.db.sql-view :as v]
...
^{:refer xt.lib.db.sql-view/tree-select.organisation-all-as-admin
...
^{:refer xt.lib.db.sql-view/tree-return.organisation-view-default :adopt true :added "4.0"
  :setup [(def +return+
...
^{:refer xt.lib.db.sql-view/query-select.organisation-all-as-admin :adopt true :added "4.0"
  :setup [(def +select+
            (pg/bind-view user/organisation-all-as-admin))
	          (def +out+
	            [["Organisation"
...
^{:refer xt.lib.db.sql-view/tree-base.control :adopt true :added "4.0"
  :setup [(def +out+
            ["RegionCountry"
             {"custom"
...
^{:refer xt.lib.db.sql-view/tree-control-array :added "4.0"
  :setup [(def +out+
            [{"args"
              [{"args" [{"::" "sql/column", "name" "name"}],
                "::" "sql/tuple"}],
...
^{:refer xt.lib.db.sql-view/tree-base :added "4.0"
  :setup [(def +out+
            ["Currency"
             {"custom" [],
              "where"
...
^{:refer xt.lib.db.sql-view/tree-count :added "4.0"
  :setup [(def +count+
...
^{:refer xt.lib.db.sql-view/tree-select :added "4.0"
  :setup [(def +select+
            (pg/bind-view data/currency-by-type))
          (def +tree+
            ["Currency"
...
^{:refer xt.lib.db.sql-view/tree-return :added "4.0"
  :setup [(def +return+
...
^{:refer xt.lib.db.sql-view/tree-combined :added "4.0"
  :setup [(def +select+
            (pg/bind-view user/organisation-all-as-admin))
          (def +return+
...
^{:refer xt.lib.db.sql-view/query-fill-input :added "4.0"
  :setup [(def +out+
            ["Organisation"
             {"custom" [],
              "where" [],
...
^{:refer xt.lib.db.sql-view/query-select :added "4.0"
  :setup [(def +select+
...
^{:refer xt.lib.db.sql-view/query-count :added "4.0"
  :setup [(def +select+
            (pg/bind-view data/currency-all-crypto))
          (def +out+
            [["Currency"
...
^{:refer xt.lib.db.sql-view/query-return :added "4.0"
  :setup [(def +return+
...
^{:refer xt.lib.db.sql-view/query-return-bulk :added "4.0"}
...
^{:refer xt.lib.db.sql-view/query-combined :added "4.0"
  :setup [(def +select+
            (pg/bind-view data/currency-all-crypto))
          (def +return+
            (pg/bind-view data/currency-info))

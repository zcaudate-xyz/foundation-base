(ns
 xtbench.lua.runtime.type-hashset-test
...
(fact
 ...
 ^{:hidden true}
 (!.lua (hs/hashset-to-array (hs/hashset "a" "b")))
 =>
 ["b" "a"])
...
(fact
 ...
 ^{:hidden true}
 (!.lua (it/arr< (hs/hashset-to-iter (hs/hashset "a" "b"))))
 =>
 ["b" "a"])
...
(fact
 ...
 ^{:hidden true}
 (!.lua (hs/hashset-show (hs/hashset "a" "b")))
 =>
 #"\#\{(?:\"a\", \"b\"|\"b\", \"a\")\}")

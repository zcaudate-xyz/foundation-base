(ns
 xtbench.lua.runtime.type-hashmap-test
...
(fact
 ...
 ^{:hidden true}
 (!.lua (hm/hashmap-to-array (hm/hashmap "a" 1 "b" 2)))
 =>
 [["b" 2] ["a" 1]])
...
(fact
 ...
 ^{:hidden true}
 (!.lua (hm/hashmap-keys (hm/hashmap "a" 1 "b" 2)))
 =>
 ["b" "a"])
...
(fact
 ...
 ^{:hidden true}
 (!.lua (hm/hashmap-vals (hm/hashmap "a" 1 "b" 2)))
 =>
 [2 1])
...
(fact
 ...
 ^{:hidden true}
 (!.lua (hm/hashmap-show (hm/hashmap "a" 1 "b" 2)))
 =>
 #"\{(?:\"a\" 1, \"b\" 2|\"b\" 2, \"a\" 1)\}")

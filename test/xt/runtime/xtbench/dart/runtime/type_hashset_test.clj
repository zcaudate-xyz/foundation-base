(ns
 xtbench.dart.runtime.type-hashset-test
...
(fact
 ...
 ^{:hidden true}
 (!.dt (hs/hashset-to-array (hs/hashset "a" "b")))
 =>
 ["b" "a"])
...
(fact
 ...
 ^{:hidden true}
 (!.dt (it/arr< (hs/hashset-to-iter (hs/hashset "a" "b"))))
 =>
 ["b" "a"])
...
(fact
 ...
 ^{:hidden true}
 (!.dt (hs/hashset-show (hs/hashset "a" "b")))
 =>
 #"\#\{(?:\"a\", \"b\"|\"b\", \"a\")\}")

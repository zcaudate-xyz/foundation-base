(ns
 xtbench.dart.runtime.interface-common-test
...
(fact
 "nth coll"
 ^{:hidden true}
 (!.dt [(v/nth (vec/vector 1 2 3) 0) (v/nth (vec/vector 1 2 3) 2)])
 =>
 [1 3])
...
(fact
 "to iter"
 ^{:hidden true}
 (!.dt (it/arr< (v/to-iter (vec/vector 1 2 3))))
 =>
 [1 2 3])
...
(fact
 "to array"
 ^{:hidden true}
 (!.dt (v/to-array (vec/vector 1 2 3)))
 =>
 [1 2 3])

(ns
 xtbench.js.runtime.common-hash-test
...
(fact
 "hashes an iterator"
 ^{:hidden true}
 (!.js (hash/hash-iter (it/range [0 100]) hash/hash-native))
 =>
 3373073)
...
(fact
 "hashes an integer"
 ^{:hidden true}
 (!.js [(hash/hash-integer 1) (hash/hash-integer 16777217)])
 =>
 [1 1])
...
(fact
 "hashes a boolean"
 ^{:hidden true}
 (!.js [(hash/hash-boolean true) (hash/hash-boolean false)])
 =>
 [1 -1])
...
(fact
 ...
 ^{:hidden true}
 (!.js [(hash/native-class "abc") (hash/native-class {"::" "demo"})])
 =>
 ["string" "demo"])

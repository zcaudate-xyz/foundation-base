(ns
 xtbench.python.runtime.parser-test
...
(fact
 ...
 ^{:hidden true}
 (!.py (var reader (rdr/create "bc]")) (pc/read-token reader "a"))
 =>
 "abc")
...
(fact
 ...
 ^{:hidden true}
 (!.py (pc/interpret-token (rdr/create "") "12a"))
 =>
 (throws))
...
(fact
 ...
 ^{:hidden true}
 (!.py (var reader (rdr/create "1 2]")) (p/read-delimited reader "]"))
 =>
 [1 2])
...
(fact
 "reads list forms"
 ^{:hidden true}
 (!.py (list/list-to-array (p/read-list (rdr/create "1 2 3)"))))
 =>
 [1 2 3])
...
(fact
 "reads vector forms"
 ^{:hidden true}
 (!.py (. (p/read-vector (rdr/create "1 2 3]")) (to-array)))
 =>
 [1 2 3])
...
(fact
 ...
 ^{:hidden true}
 (!.py (p/read-map (rdr/create ":a 1 :b}")))
 =>
 (throws))
...
(fact
 ...
 ^{:hidden true}
 (!.py (p/read-dispatch (rdr/create "?x")))
 =>
 (throws))
...
(fact
 ...
 =>
 (throws)
 (!.py (p/read (rdr/create "^:tag")))
 =>
 (throws)
 (!.py (p/read (rdr/create "#'")))
 =>
 (throws)
 (!.py (p/read (rdr/create "#_skip")))
 =>
 (throws))

(ns
 xtbench.python.runtime.type-syntax-test
...
(fact
 ...
 ^{:hidden true}
 (!.py ((syn/syntax-wrap k/identity) {:_value 1}))
 =>
 1)
...
(fact
 ...
 (!.py
  ...
  [(tc/is-syntax? out) (tc/count out) (syn/get-metadata out)])
 =>
 [true 3 "hello"])
...
(fact
 ...
 (!.py
  [(syn/get-metadata nil)
   (syn/get-metadata (syn/syntax-create 1 "hello"))])
 =>
 [nil "hello"])

^{:refer xt.runtime.type-syntax/syntax, :added "4.0"}
(fact
 "creates or unwraps syntax values"
 ^{:hidden true}
 (!.py

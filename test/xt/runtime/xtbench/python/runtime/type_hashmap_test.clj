(ns
 xtbench.python.runtime.type-hashmap-test
...
(fact
 ...
 ^{:hidden true}
 (!.py (hm/hashmap-to-array (hm/hashmap "a" 1 "b" 2)))
 =>
 [["b" 2] ["a" 1]])
...
(fact
 ...
 ^{:hidden true}
 (!.py (hm/hashmap-keys (hm/hashmap "a" 1 "b" 2)))
 =>
 ["b" "a"])
...
(fact
 ...
 ^{:hidden true}
 (!.py (hm/hashmap-vals (hm/hashmap "a" 1 "b" 2)))
 =>
 [2 1])
...
(fact
 ...
 ^{:hidden true}
 (!.py (hm/hashmap-show (hm/hashmap "a" 1 "b" 2)))
 =>
 #"\{(?:\"a\" 1, \"b\" 2|\"b\" 2, \"a\" 1)\}")

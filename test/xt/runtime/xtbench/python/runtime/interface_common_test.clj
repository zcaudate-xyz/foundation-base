(ns
 xtbench.python.runtime.interface-common-test
...
(fact
 "nth coll"
 ^{:hidden true}
 (!.py [(v/nth (vec/vector 1 2 3) 0) (v/nth (vec/vector 1 2 3) 2)])
 =>
 [1 3])
...
(fact
 "to iter"
 ^{:hidden true}
 (!.py (it/arr< (v/to-iter (vec/vector 1 2 3))))
 =>
 [1 2 3])
...
(fact
 "to array"
 ^{:hidden true}
 (!.py (v/to-array (vec/vector 1 2 3)))
 =>
 [1 2 3])

(ns
 xtbench.python.runtime.type-vector-test
...
(fact
 ...
 ^{:hidden true}
 (!.py (it/arr< (v/vector-to-iter (v/vector 1 2 3 4))))
 =>
 [1 2 3 4])
...
(fact
 ...
 ^{:hidden true}
 (!.py (v/vector-to-array (v/vector 1 2 3 4)))
 =>
 [1 2 3 4])
...
(fact
 ...
 ^{:hidden true}
 (!.py (v/vector-to-array (v/vector-empty (v/vector [1 2 3 4]))))
 =>
 [])
...
(fact
 ...
 ^{:hidden true}
 (!.py (v/vector-to-array (v/vector-push-last v/EMPTY_VECTOR 1)))
 =>
 [1])
...
(fact
 "creates a vector"
 ^{:hidden true}
 (!.py (v/vector-create (node/node-create nil []) 0 node/BITS []))
 =>
 {"_tail" [],
  "::" "vector",
  "_size" 0,

(ns
 xtbench.python.runtime.type-vector-node-test
...
(fact
 ...
 ^{:hidden true}
 (!.py [(node/impl-mask -1) (node/impl-mask 5) (node/impl-mask 32)])
 =>
 [31 5 0])
...
(fact
 "clones the node"
 ^{:hidden true}
 (!.py (node/node-clone (node/node-create 1 [1 2 3 4])))
 =>
 {"edit_id" 1, "children" [1 2 3 4], "::" "vector.node"})
...
(fact
 ...
 ^{:hidden true}
 (!.py (node/node-editable-root (node/node-create 1 [1 2 3 4])))
 =>
 (contains-in
...
(fact
 ...
 ^{:hidden true}
 (!.py (node/ensure-editable (node/node-create nil [1 2 3])))
 =>
 (throws))
...
(fact
 ...
 ^{:hidden true}
 (!.py (node/ensure-persistent (node/node-create 1 [])))
 =>
...
(fact
 "new path"
 ^{:hidden true}
 (!.py (node/node-new-path nil 5 (node/node-create nil [1 2 3])))
 =>

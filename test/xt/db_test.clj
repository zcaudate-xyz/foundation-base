...
^{:refer xt.lib.db/process-triggers :added "4.0"
  :setup [(bootstrap-js)]}
...
^{:refer xt.lib.db/add-trigger :added "4.0"
  :setup [(bootstrap-js)]}
...
^{:refer xt.lib.db/remove-trigger :added "4.0"}
(fact "removes the trigger")

^{:refer xt.lib.db/db-trigger :added "4.0"}
(fact "performs the trigger")

^{:refer xt.lib.db/db-create :added "4.0"}
(fact "creates the db")

^{:refer xt.lib.db/queue-event :added "4.0"}
(fact "queues an event to the db")

^{:refer xt.lib.db/sync-event :added "4.0"}
(fact "syncs an event to the db")

^{:refer xt.lib.db/db-exec-sync :added "4.0"}
...
^{:refer xt.lib.db/db-pull-sync :added "4.0"
  :setup [(bootstrap-js)
          (def +countries+
...
^{:refer xt.lib.db/db-delete-sync :added "4.0"}
(fact "deletes rows from the db")

^{:refer xt.lib.db/db-clear :added "4.0"}
(fact "clears the db")

^{:refer xt.lib.db/add-view-trigger :added "4.0"}
(fact "adds a view trigger to the db")


^{:refer xt.lib.db/get-dbtype :added "4.1"}
(fact "TODO")
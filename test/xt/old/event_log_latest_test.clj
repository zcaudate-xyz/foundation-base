(ns xt.old.event-log-latest-test
...
(l/script- :js
  {:runtime :basic
   :require [[xt.lang.common-lib :as k]
             ...
             [xt.old.event-log-latest :as log-latest]
...
^{:refer xt.old.event-log-latest/new-log-latest :added "4.0"}
...
^{:refer xt.old.event-log-latest/clear-cache :added "4.0"}
...
^{:refer xt.old.event-log-latest/queue-latest :added "4.0"}

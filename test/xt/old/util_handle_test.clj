...
^{:refer xt.old.util-handle/plugin-timing :added "4.0"}
(fact "plugin timing"
...
^{:refer xt.old.util-handle/plugin-counts :added "4.0"}
(fact "plugin counts"
...
^{:refer xt.old.util-handle/to-handle-callback :added "4.0"}
...
^{:refer xt.old.util-handle/new-handle :added "4.0"}

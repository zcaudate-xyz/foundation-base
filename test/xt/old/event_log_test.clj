...
^{:refer xt.old.event-log/new-log :added "4.0"}
...
^{:refer xt.old.event-log/get-count :added "4.0"}
(fact "gets the current count")

^{:refer xt.old.event-log/get-last :added "4.0"}
(fact "gets the last log entry")

^{:refer xt.old.event-log/get-head :added "4.0"}
(fact "gets `n` elements from beginning")

^{:refer xt.old.event-log/get-filtered :added "4.0"}
(fact "filters entries using predicate")

^{:refer xt.old.event-log/get-tail :added "4.0"}
(fact "gets `n` elements from tail")

^{:refer xt.old.event-log/get-slice :added "4.0"}
(fact "gets a slice of the log entries")

^{:refer xt.old.event-log/clear :added "4.0"}
(fact "clears all processed entries")

^{:refer xt.old.event-log/clear-cache :added "4.0"}
...
^{:refer xt.old.event-log/list-listeners :adopt true :added "4.0"}
...
^{:refer xt.old.event-log/add-listener :added "4.0"}
...
^{:refer xt.old.event-log/remove-listener :adopt true :added "4.0"}

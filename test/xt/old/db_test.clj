...
^{:refer xt.old.db/process-triggers :added "4.0"
  :setup [(bootstrap-js)]}
...
^{:refer xt.old.db/add-trigger :added "4.0"
  :setup [(bootstrap-js)]}
...
^{:refer xt.old.db/remove-trigger :added "4.0"}
(fact "removes the trigger")

^{:refer xt.old.db/db-trigger :added "4.0"}
(fact "performs the trigger")

^{:refer xt.old.db/db-create :added "4.0"}
(fact "creates the db")

^{:refer xt.old.db/queue-event :added "4.0"}
(fact "queues an event to the db")

^{:refer xt.old.db/sync-event :added "4.0"}
(fact "syncs an event to the db")

^{:refer xt.old.db/db-exec-sync :added "4.0"}
...
^{:refer xt.old.db/db-pull-sync :added "4.0"
  :setup [(bootstrap-js)
          (def +countries+
...
^{:refer xt.old.db/db-delete-sync :added "4.0"}
(fact "deletes rows from the db")

^{:refer xt.old.db/db-clear :added "4.0"}
(fact "clears the db")

...
^{:refer xt.old.util-loader/new-task :added "4.0"}
...
^{:refer xt.old.util-loader/task-load :added "4.0"}
(fact "loads a task"
...
^{:refer xt.old.util-loader/task-unload :added "4.0"}
(fact "unloads a task"
...
^{:refer xt.old.util-loader/new-loader-blank :added "4.0"}
(fact "creates a blank loader")

^{:refer xt.old.util-loader/add-tasks :added "4.0"}
(fact "add tasks to a loader")

^{:refer xt.old.util-loader/new-loader :added "4.0"}
...
^{:refer xt.old.util-loader/list-loading :added "4.0"}
(fact "lists all loading ids")

^{:refer xt.old.util-loader/list-completed :added "4.0"}
(fact "lists all completed ids")

^{:refer xt.old.util-loader/list-incomplete :added "4.0"}
...
^{:refer xt.old.util-loader/list-waiting :added "4.0"}
(fact "lists all waiting ids")

^{:refer xt.old.util-loader/load-tasks-single :added "4.0"}
...
^{:refer xt.old.util-loader/load-tasks :added "4.0"}
(fact "load tasks"
...
^{:refer xt.old.util-loader/unload-tasks :added "4.0"}
(fact "unload tasks")

^{:refer xt.old.util-loader/load-tasks.global :adopt true :added "4.0"}
(fact "load tasks"

...
^{:refer xt.old.event-view/list-listeners :adopt true :added "4.0"}
...
^{:refer xt.old.event-view/pipeline-run-remote.errored :adopt true :added "4.0"}
...
^{:refer xt.old.event-view/wrap-args :added "4.0"}
...
^{:refer xt.old.event-view/check-disabled :added "4.0"}
...
^{:refer xt.old.event-view/parse-args :added "4.0"}
...
^{:refer xt.old.event-view/create-view :added "4.0"
  :setup [(def +out+
            (contains-in
...
^{:refer xt.old.event-view/trigger-listeners :added "4.0"}
...
^{:refer xt.old.event-view/get-current :added "4.0"}
(fact "gets the current view output")

^{:refer xt.old.event-view/is-disabled :added "4.0"}
(fact "checks that the view is disabled")

^{:refer xt.old.event-view/is-errored :added "4.0"}
(fact "checks that output is errored")

^{:refer xt.old.event-view/is-pending :added "4.0"}
(fact "checks that output is pending")

^{:refer xt.old.event-view/get-time-elapsed :added "4.0"}
(fact "gets time elapsed of output")

^{:refer xt.old.event-view/get-time-updated :added "4.0"}
(fact "gets time updated of output")

^{:refer xt.old.event-view/get-success :added "4.0"}
...
^{:refer xt.old.event-view/set-output-disabled :added "4.0"}
(fact "sets the output disabled flag")

^{:refer xt.old.event-view/set-pending :added "4.0"}
(fact "sets the output pending time")

^{:refer xt.old.event-view/set-elapsed :added "4.0"}
(fact "sets the output elapsed time")

^{:refer xt.old.event-view/init-view :added "4.0"}
(fact "initialises view")

^{:refer xt.old.event-view/pipeline-prep :added "4.0"}
(fact "prepares the pipeline")

^{:refer xt.old.event-view/pipeline-set :added "4.0"}
(fact "sets the pipeline")

^{:refer xt.old.event-view/pipeline-call :added "4.0"}
(fact "calls the pipeline with async function")

^{:refer xt.old.event-view/pipeline-run-impl :added "4.0"}
(fact "runs the pipeline")

^{:refer xt.old.event-view/pipeline-run :added "4.0"}
(fact "runs the pipeline"
...
^{:refer xt.old.event-view/pipeline-run-force :added "4.0"}
(fact "runs the pipeline via sync or remote paths")

^{:refer xt.old.event-view/pipeline-run-remote :added "4.0"}
...
^{:refer xt.old.event-view/pipeline-run-sync :added "4.0"}
...
^{:refer xt.old.event-view/get-with-lookup :added "0.1"}
...
^{:refer xt.old.event-view/sorted-lookup :added "0.1"}
...
^{:refer xt.old.event-view/group-by-lookup :added "0.1"}

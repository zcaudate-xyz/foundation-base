...
^{:refer xt.old.db.base-util/collect-routes :added "4.0"
...
^{:refer xt.old.db.base-util/collect-routes-object :added "4.0"}
(fact "collects routes from an object input")

^{:refer xt.old.db.base-util/collect-views :added "4.0"
  :setup [(def +views+
...
^{:refer xt.old.db.base-util/merge-views :added "4.0"}
(fact "merges multiple views together")

^{:refer xt.old.db.base-util/keepf-limit :added "4.0"}
...
^{:refer xt.old.db.base-util/lu-nested :added "4.0"}
...
^{:refer xt.old.db.base-util/lu-map :added "4.0"}

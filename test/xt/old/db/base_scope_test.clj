...
^{:refer xt.old.db.base-scope/get-data-columns.more :adopt true :added "4.0"}
...
^{:refer xt.old.db.base-scope/get-tree.more :adopt true :added "4.0"}
(fact "MORE CHECKS"
...
^{:refer xt.old.db.base-scope/merge-queries :added "4.0"}
...
^{:refer xt.old.db.base-scope/filter-scope :added "4.0"}
...
^{:refer xt.old.db.base-scope/filter-plain :added "4.0"}
...
^{:refer xt.old.db.base-scope/get-data-columns :added "4.0"
  :setup [(def +out+
...
^{:refer xt.old.db.base-scope/get-query-tables :added "4.0"}
...
^{:refer xt.old.db.base-scope/get-link-columns :added "4.0"}
(fact "get columns for given keys"
...
^{:refer xt.old.db.base-scope/get-linked-tables :added "4.0"}
...
^{:refer xt.old.db.base-scope/as-where-input :added "4.0"}
(fact "when empty, returns an empty array")

^{:refer xt.old.db.base-scope/get-tree :added "4.0"}

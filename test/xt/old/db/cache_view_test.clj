...
(l/script- :js
  {:runtime :basic
   :require [[xt.old.db.cache-view :as v]
...
^{:refer xt.old.db.cache-view/tree-select :added "4.0"
  :setup [(def +select+
...
^{:refer xt.old.db.cache-view/tree-return :added "4.0"
  :setup [(def +return+
...
^{:refer xt.old.db.cache-view/tree-combined :added "4.0"}
...
^{:refer xt.old.db.cache-view/query-fill-input :added "4.0"}
(fact "fills the input for args")

^{:refer xt.old.db.cache-view/query-select :added "4.0"}
...
^{:refer xt.old.db.cache-view/query-return :added "4.0"}
...
^{:refer xt.old.db.cache-view/query-combined :added "4.0"}

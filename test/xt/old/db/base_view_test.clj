...
(def +views+
  (mapv (comp pg/bind-view deref resolve second)
        (concat (pg/list-view 'xt.old.db.sample-data-test :select)
                (pg/list-view 'xt.old.db.sample-data-test :return)
                (pg/list-view 'xt.old.db.sample-user-test :select)
                (pg/list-view 'xt.old.db.sample-user-test :return))))

^{:refer xt.old.db.base-view/all-overview :added "4.0"}
...
^{:refer xt.old.db.base-view/all-keys :added "4.0"}
...
^{:refer xt.old.db.base-view/all-methods :added "4.0"
  :setup [(def +methods+

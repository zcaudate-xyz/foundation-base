...
^{:refer xt.old.db.impl-cache/cache-process-event-sync :added "4.0"}
(fact "processes event sync data from database")

^{:refer xt.old.db.impl-cache/cache-process-event-remove :added "4.0"
  :setup [(!.js

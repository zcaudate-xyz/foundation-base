(ns xt.old.db.gen-bind-test
  (:require [rt.postgres.test.scratch-v1 :as scratch]
            [xt.old.db.gen-bind :as bind]
            [xt.old.db.sample-data-test :as sample-data]
            [xt.old.db.sample-user-test :as sample-user])
  (:use code.test))

^{:refer xt.old.db.gen-bind/tmpl-route :added "4.0"}
...
^{:refer xt.old.db.gen-bind/tmpl-view :added "4.0"}
...
^{:refer xt.old.db.gen-bind/route-list :added "4.0"}
(fact "lists all routes"

  (bind/route-list)
  => vector?)

^{:refer xt.old.db.gen-bind/view-list :added "4.0"}

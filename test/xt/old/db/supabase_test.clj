...
^{:refer xt.old.db.supabase/payload->xdb-events :added "4.1.3"}
(fact "translates canonical supabase payloads to xt.old.db events"
...
^{:refer xt.old.db.supabase/attach-events :added "4.1.3"}
...
^{:refer xt.old.db.supabase/normalize-row :added "4.1"}
(fact "TODO")
...
^{:refer xt.old.db.base-check/is-uuid? :added "4.0"}
...
^{:refer xt.old.db.base-check/check-arg-type :added "4.0"}
...
^{:refer xt.old.db.base-check/check-args-type :added "4.0"}
...
^{:refer xt.old.db.base-check/check-args-length :added "4.0"}

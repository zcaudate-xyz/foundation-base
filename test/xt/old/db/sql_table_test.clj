...
^{:refer xt.old.db.sql-table/table-update-single :added "4.0"}
...
^{:refer xt.old.db.sql-table/table-insert-single :added "4.0"}
...
^{:refer xt.old.db.sql-table/table-delete-single :added "4.0"}
...
^{:refer xt.old.db.sql-table/table-upsert-single :added "4.0"}
...
^{:refer xt.old.db.sql-table/table-filter-id :added "4.0"}
(fact "predicate for flat entry")

^{:refer xt.old.db.sql-table/table-get-data :added "4.0"}
(fact "gets data flat entry")

^{:refer xt.old.db.sql-table/table-emit-flat :added "4.0"}
(fact "emit util for insert and upsert")

^{:refer xt.old.db.sql-table/table-insert :added "4.0"
  :setup [(def +inserts+
            [(prose/|
              "INSERT INTO UserAccount"
...
^{:refer xt.old.db.sql-table/table-upsert :added "4.0"
  :setup [(def +upserts+
            [(prose/|
              "INSERT INTO UserAccount"
              " (id, nickname, password_hash, password_salt, password_updated, is_super, is_suspended, is_official)"

(ns xt.old.db.sql-util-test
  (:require [std.lang :as l])
  (:use code.test))

(l/script- :js
  {:runtime :basic
   :require [[xt.old.db.sql-util :as ut]
...
^{:refer xt.old.db.sql-util/encode-query-string.more :adopt true :added "4.0"}
...
^{:refer xt.old.db.sql-util/sqlite-json-values :added "4.0"}
...
^{:refer xt.old.db.sql-util/sqlite-json-keys :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-bool :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-number :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-operator :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-json :added "4.0"}
(fact "encodes a json value")

^{:refer xt.old.db.sql-util/encode-value :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-arg :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-column :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-tuple :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-table :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-cast :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-keyword :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-fn :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql-select :added "4.0"}
...
^{:refer xt.old.db.sql-util/encode-sql :added "4.0"
  :setup [(def +inputs+
            [{"::" "sql/column"
                :name "hello"}
             {"::" "sql/cast"
...
^{:refer xt.old.db.sql-util/encode-loop-fn :added "4.0"}
(fact "loop function to encode")

^{:refer xt.old.db.sql-util/encode-query-value :added "4.1"}
(fact "TODO")

^{:refer xt.old.db.sql-util/encode-query-segment :added "4.0"
  :setup [(def +out+
            ["name = 'hello'"
             "name != 'hell''o'"
             "name in ('hello', 'hello')"
...
^{:refer xt.old.db.sql-util/encode-query-single-string :added "4.0"}
(fact "helper for encode-query-string")

^{:refer xt.old.db.sql-util/encode-query-string :added "4.0"}
...
^{:refer xt.old.db.sql-util/LIMIT :added "4.0"}
...
^{:refer xt.old.db.sql-util/OFFSET :added "4.0"}
...
^{:refer xt.old.db.sql-util/ORDER-BY :added "4.0"}
...
^{:refer xt.old.db.sql-util/ORDER-SORT :added "4.0"}
(fact "creates an ORDER BY keyword"
...
^{:refer xt.old.db.sql-util/default-quote-fn :added "4.0"}
...
^{:refer xt.old.db.sql-util/default-return-format-fn :added "4.0"}
...
^{:refer xt.old.db.sql-util/default-table-fn :added "4.0"}
...
^{:refer xt.old.db.sql-util/postgres-wrapper-fn :added "4.0"}
...
^{:refer xt.old.db.sql-util/postgres-opts :added "4.0"}
...
^{:refer xt.old.db.sql-util/sqlite-return-format-fn :added "4.0"}
(fact "sqlite return format function")

^{:refer xt.old.db.sql-util/sqlite-to-boolean :added "4.0"}
...
^{:refer xt.old.db.sql-util/sqlite-opts :added "4.0"}

(ns xt.old.db.base-flatten-test
...
^{:refer xt.old.db.base-flatten/flatten-get-links :added "4.0"}
(fact "flatten links"
...
^{:refer xt.old.db.base-flatten/flatten-merge :added "4.0"}
(fact "flatten data"
...
^{:refer xt.old.db.base-flatten/flatten-node :added "4.0"}
(fact "flatten node"
...
^{:refer xt.old.db.base-flatten/flatten-node.account :adopt true :added "4.0"
...
^{:refer xt.old.db.base-flatten/flatten-node.profile :adopt true :added "4.0"
...
^{:refer xt.old.db.base-flatten/flatten-linked :added "4.0"
...
^{:refer xt.old.db.base-flatten/flatten-obj :added "4.0"
  :setup [(def +user-full+
            (contains-in
             {"UserProfile"
              {"c4643895-b0ce-44cc-b07b-2386bf18d43b"
...
^{:refer xt.old.db.base-flatten/flatten :added "4.0"}
...
^{:refer xt.old.db.base-flatten/flatten-bulk :added "4.0"}

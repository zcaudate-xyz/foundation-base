...
^{:refer xt.old.event-box/make-box :added "4.0"}
(fact "creates a box"
...
^{:refer xt.old.event-box/check-event :added "4.0"}
...
^{:refer xt.old.event-box/add-listener :added "4.0"}
...
^{:refer xt.old.event-box/get-data :added "4.0"}
(fact "gets the current data in the box")

^{:refer xt.old.event-box/set-data-raw :added "4.0"}
...
^{:refer xt.old.event-box/set-data :added "4.0"}
...
^{:refer xt.old.event-box/del-data-raw :added "4.0"}
...
^{:refer xt.old.event-box/del-data :added "4.0"}
...
^{:refer xt.old.event-box/reset-data :added "4.0"}
...
^{:refer xt.old.event-box/merge-data :added "4.0"}
...
^{:refer xt.old.event-box/append-data :added "4.0"}
(fact "merges the data in the box"

...
(l/script- :js
  {:runtime :basic
   :require [[xt.lang.common-lib :as k]
             ...
             [xt.old.util-validate :as validate]]})
...
^{:refer xt.old.util-validate/validate-step :added "4.0"}
...
^{:refer xt.old.util-validate/validate-field :added "4.0"}
...
^{:refer xt.old.util-validate/create-result :added "4.0"}

(ns xt.old.db-lua.impl-sql-test
...
^{:refer xt.old.db.impl-sql/CANARY :adopt true :added "4.0"}
...
^{:refer xt.old.db.impl-sql/sql-process-event-remove.lua :adopt true :added "4.0"
  :setup [(!.lua
...
^{:refer xt.old.db.impl-sql/sql-gen-delete :added "4.0"}
...
^{:refer xt.old.db.impl-sql/sql-process-event-sync :added "4.0"}
(fact "processes event sync data from database")

^{:refer xt.old.db.impl-sql/sql-process-event-remove :added "4.0"
  :setup [(!.lua
           (xtd/arr-sort (impl-sql/sql-process-event-sync
                          INSTANCE
                          "add"
...
^{:refer xt.old.db.impl-sql/sql-pull-sync :added "4.0"
  :setup [(def +account+
            (contains-in
             [{"is_official" 0,
               "nickname" "root",
...
^{:refer xt.old.db.impl-sql/sql-delete-sync :added "4.0"}
(fact "deletes sync data from sql db")

^{:refer xt.old.db.impl-sql/sql-clear :added "4.0"}

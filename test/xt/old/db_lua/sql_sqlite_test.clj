(ns xt.old.db-lua.sql-sqlite-test
...
^{:refer xt.old.db-lua.sql-sqlite/CANARY :adopt true :added "4.0"}
...
^{:refer xt.old.db-lua.sql-sqlite/TABLE-CREATE :adopt true :added "4.0"}
(fact "creates tables"

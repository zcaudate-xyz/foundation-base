(ns xt.old.sys.cache-throttle-test
...
^{:refer xt.old.sys.cache-throttle/throttle-key :added "0.1"}
...
^{:refer xt.old.sys.cache-throttle/throttle-create :added "0.1"}
...
^{:refer xt.old.sys.cache-throttle/throttle-run-async :added "0.1"}
...
^{:refer xt.old.sys.cache-throttle/throttle-run :added "0.1"}
(fact "runs a throttle"

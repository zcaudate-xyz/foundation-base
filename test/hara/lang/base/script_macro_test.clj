...
^{:refer hara.lang.base.script-macro/body-arglists :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-in :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-prep :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-def$-fn :added "4.0"}
(fact "interns a fragment macro"
  ...
  (impl/with:library [+library+]
    (macro/intern-def$-fn :lua
                          ...
                          {:time 1
                           :line 1}))
  => #'hara.lang.base.script-macro-test/hello
  ...
  => (contains {:section :fragment,
                ...
                :display :default,
                :form 'hello,
                :namespace 'hara.lang.base.script-macro-test})
...
^{:refer hara.lang.base.script-macro/intern-def$ :added "4.0"}
(fact "intern a def fragment macro"

  (macro/intern-def$ :x "hello")
  => #'hara.lang.base.script-macro-test/def$.hello
...
^{:refer hara.lang.base.script-macro/intern-defmacro-fn :added "4.0"}
  ...
  (impl/with:library [+library+]
    (macro/intern-defmacro-fn
     ...
     (with-meta
       ...
       '{:module L.core})
     {}))
  => #'hara.lang.base.script-macro-test/make-array-0
...
^{:refer hara.lang.base.script-macro/intern-defmacro :added "4.0"}
(fact "the intern macro function"

  (macro/intern-defmacro :x "hello")
  => #'hara.lang.base.script-macro-test/defmacro.hello
  ...
  (impl/with:library [+library+]
    ...
    (defmacro.hello
      divide [x y]
      (list '/ x y)))
  => #'hara.lang.base.script-macro-test/divide
...
^{:refer hara.lang.base.script-macro/call-thunk :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-!-fn :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-! :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-free-fn :added "4.0"}
...
^{:refer hara.lang.base.script-macro/intern-free :added "4.0"}
(fact "creates a defptr macro"

  (macro/intern-free :lua "hello")
  => #'hara.lang.base.script-macro-test/defptr.hello)

^{:refer hara.lang.base.script-macro/intern-top-level-fn :added "4.0"}
  ...
  (impl/with:library [+library+]
    (macro/intern-top-level-fn
     ...
     (with-meta
       ...
       {:module 'L.core})
     {}))
  => #'hara.lang.base.script-macro-test/add-more
...
^{:refer hara.lang.base.script-macro/intern-top-level :added "4.0"}
(fact "interns a top level macro"
  ...
  (impl/with:library [+library+]
    ^{:module L.core}
    (def.hello abc 1))
  => #'hara.lang.base.script-macro-test/abc
...
^{:refer hara.lang.base.script-macro/intern-defmacro-rt-fn :added "4.0"}
...
^{:refer hara.lang.base.script-macro/defmacro.! :added "4.0"}

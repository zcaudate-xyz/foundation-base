...
^{:refer hara.lang.base.pointer/ptr-invoke-meta :added "4.0"}
(fact "prepares the meta for a pointer"

  (ptr-invoke-meta +ptr+ {})
  => map?)

^{:refer hara.lang.base.pointer/rt-macro-opts :added "4.0"}
(fact "creates the default macro-opts for a runtime"

  (rt-macro-opts :lua)
  => map?)

^{:refer hara.lang.base.pointer/ptr-invoke-string :added "4.0"}
(fact "emits the invoke string"

  (ptr-invoke-string +ptr+ [1 2] {:layout :full})
  => "1 + 2")

^{:refer hara.lang.base.pointer/ptr-invoke-script :added "4.0"}
...
^{:refer hara.lang.base.pointer/ptr-intern :added "4.0"}
(fact "interns the symbol into the workspace environment"
  (ptr-intern *ns* 'foo {:lang :lua}) => #'hara.lang.base.pointer-test/foo)

^{:refer hara.lang.base.pointer/ptr-output-json :added "4.0"}
(fact "extracetd function from ptr-output"
  (ptr-output-json {"type" "data" "value" 1}) => 1)

^{:refer hara.lang.base.pointer/ptr-output :added "4.0"}
...
^{:refer hara.lang.base.pointer/ptr-invoke :added "4.0"}

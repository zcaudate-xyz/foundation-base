...
^{:refer hara.lang.base.book/get-base-entry :added "4.0"}
...
^{:refer hara.lang.base.book/get-module :added "4.0"}
(fact "gets the module"

  (b/get-module +sample+ 'L.core)
  => module/book-module?)

^{:refer hara.lang.base.book/get-code-deps :added "4.0"}
...
^{:refer hara.lang.base.book/get-deps :added "4.0"}
...
^{:refer hara.lang.base.book/get-deps-native :added "4.0"}
...
^{:refer hara.lang.base.book/list-entries :added "4.0"}
...
^{:refer hara.lang.base.book/book-string :added "4.0"}
(fact "shows the book string"

  (b/book-string +sample+)
  => "#book [:lua] {L.core {:code 1, :fragment 1}}")

^{:refer hara.lang.base.book/book? :added "4.0"}
...
^{:refer hara.lang.base.book/book-merge :added "4.0"}
...
^{:refer hara.lang.base.book/book-from :added "4.0"}
...
^{:refer hara.lang.base.book/check-compatible-lang :added "4.0"
  :setup [(def +redis+
            (b/book-merge (b/book {:lang    :lua.redis
                                   :meta    (:meta +book+)
                                   :grammar (:grammar +book+)
...
^{:refer hara.lang.base.book/assert-compatible-lang :added "4.0"}
...
^{:refer hara.lang.base.book/set-module :added "4.0"}
...
^{:refer hara.lang.base.book/put-module :added "4.0"}
...
^{:refer hara.lang.base.book/delete-module :added "4.0"}
...
^{:refer hara.lang.base.book/delete-modules :added "4.0"}
...
^{:refer hara.lang.base.book/has-module? :added "4.0"}
...
^{:refer hara.lang.base.book/assert-module :added "4.0"}
...
^{:refer hara.lang.base.book/set-entry :added "4.0"}
...
^{:refer hara.lang.base.book/put-entry :added "4.0"}
...
^{:refer hara.lang.base.book/has-entry? :added "4.0"}
(fact "checks that book has an entry"

  (b/has-entry? +redis+ 'L.core :fragment 'identity)
  => true)

^{:refer hara.lang.base.book/assert-entry :added "4.0"}
(fact "asserts that module exists"
...
^{:refer hara.lang.base.book/delete-entry :added "4.0"}
...
^{:refer hara.lang.base.book/module-create-filename :added "4.0"}
(fact "creates a filename for module"

  (b/module-create-filename +redis+ 'redis.core)
  => "core.lua")

^{:refer hara.lang.base.book/module-create-check :added "4.0"}
...
^{:refer hara.lang.base.book/module-create-requires :added "4.0"}
(fact "creates a map for the requires"
  (b/module-create-requires '[[L.core :as u]])
  => '{L.core {:as u, :id L.core}})

^{:refer hara.lang.base.book/module-export-requires :added "4.1"}
...
^{:refer hara.lang.base.book/module-specialize :added "4.1"}
...
^{:refer hara.lang.base.book/module-create :added "4.0"}
...
(comment
  ...
  ^{:refer hara.lang.base.book/module-create-bundled :added "4.0"}

...
^{:refer hara.lang.base.impl-entry/create-common :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/create-code-raw :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/create-code-base :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/hydrate-form :added "4.1"}
...
^{:refer hara.lang.base.impl-entry/create-code-hydrate :added "4.0"
  :setup [(def +entry+
            (entry/create-code-base
             '(defn add-fn
                [a b]
...
^{:refer hara.lang.base.impl-entry/create-code :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/create-fragment :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/create-fragment-hydrate :added "4.0"}
(fact "hydrates the forms"
  "placeholder for tests")

^{:refer hara.lang.base.impl-entry/create-macro :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/with:cache-none :added "4.0"}
(fact "skips the cache"
  (entry/with:cache-none entry/*cache-none*) => true)

^{:refer hara.lang.base.impl-entry/with:cache-force :added "4.0"}
(fact "forces the cache to update"
  (entry/with:cache-force entry/*cache-force*) => true)

^{:refer hara.lang.base.impl-entry/emit-entry-raw :added "4.0"
...
^{:refer hara.lang.base.impl-entry/emit-entry-cached :added "4.0"
  :setup [(def +book+
            (-> prep/+book-min+
...
^{:refer hara.lang.base.impl-entry/emit-entry-label :added "4.0"}
...
^{:refer hara.lang.base.impl-entry/emit-entry :added "4.0"}

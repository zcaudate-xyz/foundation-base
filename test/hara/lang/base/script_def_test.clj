(ns hara.lang.base.script-def-test
  (:require [hara.lang.base.script-def :refer :all]
            [std.lib.foundation :as f])
  (:use code.test))

^{:refer  hara.lang.base.script-def/tmpl-entry :added "4.0"}
...
^{:refer  hara.lang.base.script-def/tmpl-macro :added "4.0"}
(fact "forms for various argument types"

...
^{:refer hara.lang.base.runtime/default-tags-ptr :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-deref-ptr :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-invoke-ptr :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-init-ptr :added "4.0"}
(fact "will init pointer if there is a :rt/init key"
  (rt/default-init-ptr {:lang :lua} {}) => nil)

^{:refer hara.lang.base.runtime/default-display-ptr :added "4.0"}
...
^{:refer hara.lang.base.runtime/rt-default :added "4.0"}
...
^{:refer hara.lang.base.runtime/rt-null :added "4.1"}
(fact "creates a default null runtime"
  (select-keys (rt/rt-null {}) [:lang])
  => {:lang :null})

^{:refer hara.lang.base.runtime/install-lang! :added "4.0"}
(fact "installs a language within `std.lib.context`"
  (rt/install-lang! :lua) => (any map? vector?))

^{:refer hara.lang.base.runtime/install-type! :added "4.0"}
...
^{:refer hara.lang.base.runtime/return-format-simple :added "4.0"}
(fact "format forms for return"

  (rt/return-format-simple [1 2 3])
  => '(1 2 (return 3)))

^{:refer hara.lang.base.runtime/return-format :added "4.0"}
(fact "standard format for return"

  (rt/return-format '[1 2 (:= x 3)])
  => '(1 2 (:= x 3)))

^{:refer hara.lang.base.runtime/return-wrap-invoke :added "4.0"}
(fact "wraps forms to be invoked"

  (rt/return-wrap-invoke '[1 2 (:= x 3)])
  => '((quote ((fn [] 1 2 (:= x 3))))))

^{:refer hara.lang.base.runtime/normalize-body-forms :added "4.1"}
...
^{:refer hara.lang.base.runtime/return-transform :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-invoke-script :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-lifecycle-prep :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-scaffold-setup-for :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-scaffold-setup-to :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-scaffold-imports :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-lifecycle-fn :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-setup-module-emit :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-setup-module-basic :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-teardown-module-basic :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-setup-module :added "4.0"}
...
^{:refer hara.lang.base.runtime/default-teardown-module :added "4.0"}
...
^{:refer hara.lang.base.runtime/multistage-invoke :added "4.0"}
...
^{:refer hara.lang.base.runtime/multistage-setup-for :added "4.0"}
...
^{:refer hara.lang.base.runtime/multistage-setup-to :added "4.0"}
...
^{:refer hara.lang.base.runtime/multistage-teardown-for :added "4.0"}
...
^{:refer hara.lang.base.runtime/multistage-teardown-at :added "4.0"}
...
^{:refer hara.lang.base.runtime/multistage-teardown-to :added "4.0"}

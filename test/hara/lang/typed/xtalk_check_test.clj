(ns hara.lang.typed.xtalk-check-test
  (:use code.test)
  (:require [hara.lang.typed.xtalk-check :refer :all]
...
^{:refer hara.lang.typed.xtalk-check/function-env :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-check/check-fn-def :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-check/check-function :added "4.1"}

  ...
  => '{:ns hara.model.spec-xtalk-typed-fixture
       ...
       :functions [{:name "find-user"
                   ...
                   {:name "wrong-user-name"
                    ...
                    :output {:kind :named :name hara.model.spec-xtalk-typed-fixture/User}}
...
(fact "provides function report examples"
  (do
    (types/clear-registry!)
    {:ok (get-function-report 'hara.model.spec-xtalk-typed-fixture/find-user)
     :bad (-> (get-function-report 'hara.model.spec-xtalk-typed-fixture/wrong-user-name)
              (update :errors
                      (fn [errors]
                        (mapv #(select-keys % [:tag :expected :actual])
                              errors))))})
  => '{:ok {:function hara.model.spec-xtalk-typed-fixture/find-user
            :declared {:inputs [{:name users
                                 :type {:kind :named :name hara.model.spec-xtalk-typed-fixture/UserMap}}
                                {:name id
            ...
            :return {:kind :maybe
                     :item {:kind :named :name hara.model.spec-xtalk-typed-fixture/User}}
            :errors []}
       :bad {:function hara.model.spec-xtalk-typed-fixture/wrong-user-name
...
(fact "provides namespace report examples"
  (do
    (types/clear-registry!)
    (let [report (check-namespace 'hara.model.spec-xtalk-typed-fixture)]
      {:namespace (:namespace report)
       :functions (mapv (fn [{:keys [function return errors]}]
                        ...
                        (:functions report))}))
  => '{:namespace hara.model.spec-xtalk-typed-fixture
       :functions [{:function hara.model.spec-xtalk-typed-fixture/find-user
                    :return {:kind :maybe
                             :item {:kind :named :name hara.model.spec-xtalk-typed-fixture/User}}
                    :error-tags []}
                   {:function hara.model.spec-xtalk-typed-fixture/wrong-user-name
                    :return {:kind :primitive :name :xt/str}
                    :error-tags [:return-type-mismatch]}
                   {:function hara.model.spec-xtalk-typed-fixture/find-user-wrong-key
                    :return {:kind :maybe
                             :item {:kind :named :name hara.model.spec-xtalk-typed-fixture/User}}

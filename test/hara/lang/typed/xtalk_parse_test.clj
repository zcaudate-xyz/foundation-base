(ns hara.lang.typed.xtalk-parse-test
  (:use code.test)
  (:require [hara.lang.typed.xtalk-common :as types]
            [hara.lang.typed.xtalk-parse :refer :all]))
...
^{:refer hara.lang.typed.xtalk-parse/defmacro? :added "4.1"}
(fact "detects defmacro.xt forms"
  [(defmacro? '(defmacro.xt f []))
   (defmacro? '(defn.xt f []))]
  => [true false])

^{:refer hara.lang.typed.xtalk-parse/defvalue? :added "4.1"}
(fact "detects def.xt forms"
  [(defvalue? '(def.xt Value 1))
   (defvalue? '(defn.xt f []))]
  => [true false])

^{:refer hara.lang.typed.xtalk-parse/parse-ns-name :added "4.1"}
(fact "extracts namespace names from form streams"
  (parse-ns-name '[(comment x) (ns sample.core) (def x 1)])
  => 'sample.core)

^{:refer hara.lang.typed.xtalk-parse/extract-aliases :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/parse-decl-preamble :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/parse-defspec :added "4.1"}
(fact "parses defspec forms"
  (:name (parse-defspec '(defspec.xt User :xt/str) 'sample.route {}))
  => "User")

^{:refer hara.lang.typed.xtalk-parse/parse-callable-items :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/multi-callable-items? :added "4.1"}
(fact "TODO")

^{:refer hara.lang.typed.xtalk-parse/parse-defn :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/parse-defmacro :added "4.1"}
(fact "parses defmacro.xt forms"
  (get-in (parse-defmacro '(defmacro.xt add [a b] (list '+ a b)) 'sample.route {}) [:body-meta :macro])
  => true)

^{:refer hara.lang.typed.xtalk-parse/parse-defvalue :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/merge-spec-inputs :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/attach-function-spec :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/attach-value-spec :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/spec-map-by-kind :added "4.1"}
...
^{:refer hara.lang.typed.xtalk-parse/analyze-file-raw :added "4.1"}

(ns hara.lang.typed.xtalk-test
  (:use code.test)
  (:require [hara.lang.typed.xtalk :refer :all]
...
^{:refer hara.lang.typed.xtalk/register-spec-form! :added "4.1"}
(fact "registers spec forms directly"
  (do
    (clear-registry!)
    (:name (register-spec-form! 'hara.lang.typed.xtalk-test/LocalId :xt/str {})))
  => "LocalId")

^{:refer hara.lang.typed.xtalk/defspec.xt :added "4.1"}
(fact "defspec macro registers specs in the current ns"
  (do
    (clear-registry!)
    (eval '(hara.lang.typed.xtalk/defspec.xt MacroSpec :xt/int))
    (-> (get-spec 'hara.lang.typed.xtalk-test/MacroSpec) :type types/type->data))
  => '{:kind :primitive :name :xt/int})

^{:refer hara.lang.typed.xtalk/clear-registry! :added "4.1"}
...
^{:refer hara.lang.typed.xtalk/register-type! :added "4.1"}
(fact "register-type delegates to common registry"
  (do
    (clear-registry!)
    (register-type! 'hara.lang.typed.xtalk-test/ManualType
                    (types/make-spec-def 'hara.lang.typed.xtalk-test 'ManualType types/+bool-type+ {}))
    (-> (get-spec 'hara.lang.typed.xtalk-test/ManualType) :type types/type->data))
  => '{:kind :primitive :name :xt/bool})

^{:refer hara.lang.typed.xtalk/get-type :added "4.1"}
...
^{:refer hara.lang.typed.xtalk/get-value :added "4.1"}
...
^{:refer hara.lang.typed.xtalk/list-values :added "4.1"}
...
^{:refer hara.lang.typed.xtalk/analyze-and-register! :added "4.1"}

(ns tahto.core.rewrite.statement-test
  (:use code.test)
  (:require [tahto.core.rewrite.statement :as stmt]))

^{:refer tahto.core.rewrite.statement/rewrite-for-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-cond-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-branch-control :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-branch-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-do-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-var-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-return-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-if-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-when-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-while-statement :added "4.1"}
...
^{:refer tahto.core.rewrite.statement/rewrite-defn-statement :added "4.1"}

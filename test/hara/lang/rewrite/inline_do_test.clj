(ns tahto.core.rewrite.inline-do-test
  (:use code.test)
  (:require [tahto.core.rewrite.inline-do :as inline]))

^{:refer tahto.core.rewrite.inline-do/do-expression? :added "4.0"}
...
^{:refer tahto.core.rewrite.inline-do/rewrite-inline-do-list :added "4.0"}
...
^{:refer tahto.core.rewrite.inline-do/rewrite-inline-do :added "4.1"}
...
^{:refer tahto.core.rewrite.inline-do/rewrite-inline-do :added "4.0"

...
^{:refer hara.lang.manage/lib-overview-format :added "4.0"}
...
^{:refer hara.lang.manage/lib-overview :added "4.0"}
(fact "specifies lib overview task"
  (impl/with:library [+library+]
    (lib-overview :all))
  => coll?)

^{:refer hara.lang.manage/lib-module-env :added "4.0"}
(fact "compiles the lib-module task environment"

  (lib-module-env nil)
  => map?)

^{:refer hara.lang.manage/lib-module-filter :added "4.0"}
...
^{:refer hara.lang.manage/lib-module-overview-format :added "4.0"}
...
^{:refer hara.lang.manage/lib-module-overview :added "4.0"}
(fact "lists all modules"
  (impl/with:library [+library+]
    (lib-module-overview :all))
  => coll?)

^{:refer hara.lang.manage/lib-module-entries-format-section :added "4.0"}
(fact "formats either code or fragment section"
  (lib-module-entries-format-section (l/get-module +library+ :lua 'L.core) :code {})
  => string?)

^{:refer hara.lang.manage/lib-module-entries-format :added "4.0"}
...
^{:refer hara.lang.manage/lib-module-entries :added "4.0"}
(fact "outputs module entries"
  (impl/with:library [+library+]
    (lib-module-entries :all))
  => coll?)

^{:refer hara.lang.manage/lib-module-purge-fn :added "4.0"}
(fact "the purge module function"
  (lib-module-purge-fn 'L.core {:lang :lua} (:modules (l/get-book +library+ :lua)) nil)
  => anything)

^{:refer hara.lang.manage/lib-module-purge :added "4.0"}
(fact "purges modules"
  (impl/with:library [+library+]
    (lib-module-purge :all {:lang :lua}))
  => coll?)

^{:refer hara.lang.manage/lib-module-unused-fn :added "4.0"}
...
^{:refer hara.lang.manage/lib-module-unused :added "4.0"}
(fact "lists unused modules"
  (impl/with:library [+library+]
    (lib-module-unused :all))
  => coll?)

^{:refer hara.lang.manage/lib-module-missing-line-number-fn :added "4.0"}
...
^{:refer hara.lang.manage/lib-module-missing-line-number :added "4.0"}
(fact "lists modules with entries that are missing line numbers (due to inproper macros)"
  (impl/with:library [+library+]
    (lib-module-missing-line-number :all))
  => coll?)

^{:refer hara.lang.manage/lib-module-incorrect-alias-fn :added "4.0"}
...
^{:refer hara.lang.manage/lib-module-incorrect-alias :added "4.0"}

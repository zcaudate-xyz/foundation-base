(ns hara.lang.base.type-shared-test
  (:require [hara.lang :as l]
            [hara.lang.base.type-shared :as shared])
  (:use code.test))

^{:refer hara.lang.base.type-shared/get-groups :added "4.0"}
...
^{:refer hara.lang.base.type-shared/get-group-count :added "4.0"}
...
^{:refer hara.lang.base.type-shared/update-group-count :added "4.0"
...
^{:refer hara.lang.base.type-shared/get-group-instance :added "4.0"}
(fact "gets the group instance"
  (shared/set-group-instance :test :id {:a 1})
  (shared/get-group-instance :test :id)
  => {:a 1})

^{:refer hara.lang.base.type-shared/set-group-instance :added "4.0"}
(fact "sets the group instance"
  (shared/set-group-instance :test :id {:a 2})
  (shared/get-group-instance :test :id)
  => {:a 2})

^{:refer hara.lang.base.type-shared/update-group-instance :added "4.0"}
(fact "updates the group instance"
  (shared/update-group-instance :test :id (fn [m] (assoc m :b 2)))
  (shared/get-group-instance :test :id)
  => {:a 2 :b 2})

^{:refer hara.lang.base.type-shared/restart-group-instance :added "4.0"}
...
^{:refer hara.lang.base.type-shared/rt-is-shared? :added "4.0"}
(fact "checks if a runtime is shared"
  (shared/rt-is-shared? (shared/rt-shared:create {}))
  => true)

^{:refer hara.lang.base.type-shared/rt-get-inner :added "4.0"}
...
(comment
  ...
  (require '[hara.runtime.basic.impl.script :as script]))

(ns hara.lang.interface.type-shared-test
  (:require [hara.lang :as l]
            [hara.lang.interface.type-shared :as shared])
  (:use code.test))

^{:refer hara.lang.interface.type-shared/get-groups :added "4.0"}
...
^{:refer hara.lang.interface.type-shared/get-group-count :added "4.0"}
...
^{:refer hara.lang.interface.type-shared/update-group-count :added "4.0"
...
^{:refer hara.lang.interface.type-shared/get-group-instance :added "4.0"}
(fact "gets the group instance"
  (shared/set-group-instance :test :id {:a 1})
  (shared/get-group-instance :test :id)
  => {:a 1})

^{:refer hara.lang.interface.type-shared/set-group-instance :added "4.0"}
(fact "sets the group instance"
  (shared/set-group-instance :test :id {:a 2})
  (shared/get-group-instance :test :id)
  => {:a 2})

^{:refer hara.lang.interface.type-shared/update-group-instance :added "4.0"}
(fact "updates the group instance"
  (shared/update-group-instance :test :id (fn [m] (assoc m :b 2)))
  (shared/get-group-instance :test :id)
  => {:a 2 :b 2})

^{:refer hara.lang.interface.type-shared/restart-group-instance :added "4.0"}
...
^{:refer hara.lang.interface.type-shared/remove-group-instance :added "4.0"}
(fact "removes the group instance"
  (shared/remove-group-instance :test :id)
  (shared/get-group-instance :test :id)
  => nil)

^{:refer hara.lang.interface.type-shared/start-shared :added "4.0"}
(fact "starts a shared runtime client"
  (shared/start-shared {:id :id :client {:type :test :constructor (fn [cfg] {:started true})} :config {}})
  (shared/get-group-instance :test :id)
  => {:started true})

^{:refer hara.lang.interface.type-shared/stop-shared :added "4.0"
  :setup [(reset! shared/*groups* {})]}
...
^{:refer hara.lang.interface.type-shared/rt-shared:create :added "4.0"}
(fact "creates a shared runtime client"
  (shared/rt-shared:create {:rt/id :id :rt/client {:type :test} :a 1})
  => (contains {:id :id :config {:a 1}}))

^{:refer hara.lang.interface.type-shared/rt-shared :added "4.0"}
...
^{:refer hara.lang.interface.type-shared/rt-is-shared? :added "4.0"}
(fact "checks if a runtime is shared"
  (shared/rt-is-shared? (shared/rt-shared:create {}))
  => true)

^{:refer hara.lang.interface.type-shared/rt-get-inner :added "4.0"}
...
(comment
  ...
  (require '[hara.rt.basic.impl.script :as script]))

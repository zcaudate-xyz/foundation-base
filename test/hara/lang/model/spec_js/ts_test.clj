(ns hara.lang.model.spec-js.ts-test
  (:use code.test)
  (:require [clojure.string :as str]
             [hara.lang.model.spec-js.ts :refer :all]
...
(fact "does not duplicate same-name callable specs in declaration output"
  (let [out (-> 'hara.lang.model.spec-xtalk-typed-fixture
...
^{:refer hara.lang.model.spec-js.ts/valid-ts-ident? :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/sanitize-ts-ident :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/named-ts-ident :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/export-ts-ident :added "4.1"}
(fact "creates export TypeScript identifier"
  (export-ts-ident "my-type")
  => "my_type")

^{:refer hara.lang.model.spec-js.ts/ns->module-path :added "4.1"}
(fact "converts namespace to module path"
  (ns->module-path 'my.ns)
  => "./my/ns")

^{:refer hara.lang.model.spec-js.ts/quoted-prop :added "4.1"}
(fact "quotes property name"
  (quoted-prop "hello-world")
  => "\"hello-world\"")

^{:refer hara.lang.model.spec-js.ts/prop-ident :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/unwrap-maybe :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-record-fields :added "4.1"}
(fact "emits TypeScript record fields"
  (emit-record-fields [{:name "foo" :type {:kind :primitive :name :xt/str} :optional? false}]
                      'my.ns)
  => "  foo: string;")

^{:refer hara.lang.model.spec-js.ts/emit-open-record :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-ts-type :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/collect-type-refs :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/fn-type :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/analysis-import-groups :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-import-item :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-import-declaration :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-imports :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-spec-declaration :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-function-arg :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-function-declaration :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emit-value-declaration :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/emitted-specs :added "4.1"}
(fact "filters specs shadowed by callable and value declarations"
  (mapv :name (emitted-specs sample-analysis))
  => ["User" "UserMap"])

^{:refer hara.lang.model.spec-js.ts/emit-analysis-declarations :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/declaration-output-path :added "4.1"}
...
^{:refer hara.lang.model.spec-js.ts/module-dts-artifact :added "4.1"}
(fact "builds declaration artifacts alongside runtime output"
  (let [{:keys [output body]}
        (module-dts-artifact {:main 'hara.lang.model.spec-xtalk-typed-fixture
...
^{:refer hara.lang.model.spec-js.ts/emit-namespace-declarations :added "4.1"}

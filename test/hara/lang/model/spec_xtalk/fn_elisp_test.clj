(ns hara.lang.model.spec-xtalk.fn-elisp-test
  (:require [hara.lang :as l]
             [hara.lang.model.spec-elisp]
             [hara.lang.model.spec-xtalk.fn-elisp :refer :all])
  (:use code.test))

^{:refer hara.lang.model.spec-xtalk.fn-elisp/+elisp-promise+ :added "4.1"}
...
^{:refer hara.lang.model.spec-xtalk.fn-elisp/elisp-tf-x-async-run :added "4.1"}
(fact "elisp async run emits a lower-level thread primitive"
  (l/emit-as :elisp [(elisp-tf-x-async-run '[_ thunk])])
  => #"make-thread")

^{:refer hara.lang.model.spec-xtalk.fn-elisp/elisp-tf-x-print :added "4.1"}
(fact "prints values"
  (elisp-tf-x-print '(x:print "hello"))
  => '(progn (princ "hello") nil))

^{:refer hara.lang.model.spec-xtalk.fn-elisp/elisp-tf-x-len :added "4.1"}
(fact "gets length"

...
^{:refer hara.lang.type-notify/has-sink? :added "4.0"
...
^{:refer hara.lang.type-notify/get-sink :added "4.0"
...
^{:refer hara.lang.type-notify/clear-sink :added "4.0"
  :setup [(notify/get-sink +server+ "abc")]}
(fact "clears a sink"
...
^{:refer hara.lang.type-notify/add-listener :added "4.0"}
...
^{:refer hara.lang.type-notify/remove-listener :added "4.0"}
...
^{:refer hara.lang.type-notify/get-oneshot-id :added "4.0"}
(fact "registers a oneshot id for the app server"

  (notify/get-oneshot-id +server+)
  => #"oneshot")

^{:refer hara.lang.type-notify/remove-oneshot-id :added "4.0"}
...
^{:refer hara.lang.type-notify/clear-oneshot-sinks :added "4.0"
...
^{:refer hara.lang.type-notify/process-print :added "4.0"}
...
^{:refer hara.lang.type-notify/process-capture :added "4.0"}
(fact "processes `capture` id option"
  (notify/process-capture {:a 1})
  (last @notify/*notify-capture*)
  => {:a 1})

^{:refer hara.lang.type-notify/process-message :added "4.0"}
...
^{:refer hara.lang.type-notify/handle-notify-http :added "4.0"}
(fact "handler for http request")

^{:refer hara.lang.type-notify/start-notify-http :added "4.0"}
...
^{:refer hara.lang.type-notify/stop-notify-http :added "4.0"}
(fact "stops http server"
  (notify/stop-notify-http +server+)
  @(:http-instance +server+) => nil)

^{:refer hara.lang.type-notify/handle-notify-socket :added "4.0"}
(fact "handler for socket request")

^{:refer hara.lang.type-notify/start-notify-socket :added "4.0"}
(fact "starts socket server"
  (notify/start-notify-socket +server+)
  @(:socket-instance +server+) => map?)

^{:refer hara.lang.type-notify/stop-notify-socket :added "4.0"}
(fact "stops socket server"
  (notify/stop-notify-socket +server+)
  @(:socket-instance +server+) => nil)

^{:refer hara.lang.type-notify/start-notify :added "4.0"
...
^{:refer hara.lang.type-notify/stop-notify :added "4.0"}
(fact "stops both servers"
  (notify/stop-notify +server+)
  @(:http-instance +server+) => nil
  @(:socket-instance +server+) => nil)

^{:refer hara.lang.type-notify/notify-server:create :added "4.0"}
(fact "creates notify serve "
  (notify/notify-server:create {})
  => map?)

^{:refer hara.lang.type-notify/notify-server :added "4.0"}
(fact "create and start notify server"
  (component/stop (notify/notify-server {}))
  => map?)

^{:refer hara.lang.type-notify/default-notify :added "4.0"}
(fact "gets the default notify server"

  (notify/default-notify)
  => map?)

^{:refer hara.lang.type-notify/default-notify:reset :added "4.0"}
(fact "resets the default notify server"
  (notify/default-notify:reset)
  => map?)

^{:refer hara.lang.type-notify/watch-oneshot :added "4.0"}

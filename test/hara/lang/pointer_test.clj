(ns tahto.core.pointer-test
  (:require [std.json :as json]
            [tahto.base.book :as book]
tahto/lang/pointer_test.clj:4:            [tahto.common.emit-prep-lua-test :as prep]
            [tahto.core.impl-entry :as entry]
            [tahto.core.library :as lib]
            [tahto.core.library-snapshot :as snap]
            [tahto.core.pointer :refer :all]
tahto/lang/pointer_test.clj:9:            [tahto.common.util :as ut]
...
^{:refer tahto.core.pointer/ptr-display :added "4.0"}
...
^{:refer tahto.core.pointer/ptr-invoke-meta :added "4.0"}
(fact "prepares the meta for a pointer"

  (ptr-invoke-meta +ptr+ {})
  => map?)

^{:refer tahto.core.pointer/rt-macro-opts :added "4.0"}
(fact "creates the default macro-opts for a runtime"

  (rt-macro-opts :lua)
  => map?)

^{:refer tahto.core.pointer/ptr-invoke-string :added "4.0"}
(fact "emits the invoke string"

  (ptr-invoke-string +ptr+ [1 2] {:layout :full})
  => "1 + 2")

^{:refer tahto.core.pointer/ptr-invoke-script :added "4.0"}
...
^{:refer tahto.core.pointer/ptr-intern :added "4.0"}
(fact "interns the symbol into the workspace environment"
  (ptr-intern *ns* 'foo {:lang :lua}) => #'tahto.core.pointer-test/foo)

^{:refer tahto.core.pointer/ptr-output-json :added "4.0"}
...
^{:refer tahto.core.pointer/ptr-output :added "4.0"}
...
^{:refer tahto.core.pointer/ptr-invoke :added "4.0"}

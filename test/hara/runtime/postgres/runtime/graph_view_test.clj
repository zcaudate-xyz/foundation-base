...
(fact "creates a select function"
  ...
  (view/defsel.pg ^{:- [scratch/Task]
    ...
    task-by-name
    {:name i-name})
  => #'hara.runtime.postgres.runtime.graph-view-test/task-by-name

  (:static/view @hara.runtime.postgres.runtime.graph-view-test/task-by-name)
  => '{:args [:name i-name],
...
(fact "creates a returns function"
  ...
  (view/defret.pg ^{:- [scratch/Task]}
    ...
    [:uuid i-task-id]
    #{:*/data})
  #'hara.runtime.postgres.runtime.graph-view-test/task-basic

  (:static/view @hara.runtime.postgres.runtime.graph-view-test/task-basic)
  => '{:args [:uuid i-task-id],
       :table hara.runtime.postgres.test.scratch-v1/Task,
       :key :Task,
       :type :return,

(ns hara.runtime.postgres.base.grammar.common-tracker-test
  (:require [hara.runtime.postgres.base.grammar.common-tracker :as tracker]
            [hara.runtime.postgres.test.scratch-v1 :as scratch])
  (:use code.test))

^{:refer hara.runtime.postgres.base.grammar.common-tracker/tracker-string :added "4.1"}
...
^{:refer hara.runtime.postgres.base.grammar.common-tracker/add-tracker :added "4.0"}
...
^{:refer hara.runtime.postgres.base.grammar.common-tracker/tracker-map-in :added "4.0"}
...
^{:refer hara.runtime.postgres.base.grammar.common-tracker/tracker-map-modify :added "4.0"}

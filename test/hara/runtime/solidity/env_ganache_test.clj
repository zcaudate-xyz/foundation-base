(ns hara.runtime.solidity.env-ganache-test
  (:require [clojure.string :as string]
            [hara.runtime.solidity.env-ganache :refer :all]
            [std.fs :as fs]
            [std.lib.env :as env]
...
(fact "starts the ganache service via hardhat"
...
(fact "stops the ganache service via hardhat"
  (with-redefs [fs/create-directory (fn [_] nil)
                os/sh fake-sh
...
^{:refer hara.runtime.solidity.env-ganache/start-hardhat-server :added "4.0"}
...
^{:refer hara.runtime.solidity.env-ganache/stop-hardhat-server :added "4.0"}

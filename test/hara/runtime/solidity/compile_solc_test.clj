(ns hara.runtime.solidity.compile-solc-test
...
^{:refer hara.runtime.solidity.compile-solc/compile-base-code :added "4.0"}
...
^{:refer hara.runtime.solidity.compile-solc/compile-ptr-prep-open-method :added "4.0"}
...
^{:refer hara.runtime.solidity.compile-solc/compile-ptr-prep :added "4.0"}
(fact "exports a ptr"

  (compile/compile-ptr-prep test:hello)
  => vector?)

^{:refer hara.runtime.solidity.compile-solc/compile-ptr-code :added "4.0"}
(fact "compiles the pointer to code"

  (compile/compile-ptr-code test:hello)
  => string?)

^{:refer hara.runtime.solidity.compile-solc/compile-module-prep :added "4.0"}
...
^{:refer hara.runtime.solidity.compile-solc/compile-module-code :added "4.0"}
...
^{:refer hara.runtime.solidity.compile-solc/compile-single-sol :added "4.0"}
...
^{:refer hara.runtime.solidity.compile-solc/compile-all-sol :added "4.0"}
...
^{:refer hara.runtime.solidity.compile-solc/compile-rt-prep :added "4.0"}
(fact "creates a runtime"
  ;; complex setup
  )

^{:refer hara.runtime.solidity.compile-solc/compile-rt-eval :added "4.0"}
(fact "evals form in the runtime"
  ;; complex setup
  )

^{:refer hara.runtime.solidity.compile-solc/compile-rt-abi :added "4.0"}
(fact "compiles the contract-abi"
  ;; complex setup
  )

^{:refer hara.runtime.solidity.compile-solc/compile-all-abi :added "4.0"}
(fact "compiles the abis"
  ;; complex setup
  )

^{:refer hara.runtime.solidity.compile-solc/create-base-entry :added "4.0"}
(fact "creates either a pointer or module entry"
  ;; complex setup
  )

^{:refer hara.runtime.solidity.compile-solc/create-pointer-entry :added "4.0"}
(fact "creates a pointer entry"
  ;; complex setup
  )

^{:refer hara.runtime.solidity.compile-solc/create-module-entry :added "4.0"}

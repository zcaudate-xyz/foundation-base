tahto/runtime/neovim/impl_test.clj:1:(ns tahto.runtime.neovim.impl-test
  (:require [tahto.core :as h]
tahto/runtime/neovim/impl_test.clj:3:            [tahto.runtime.neovim.impl :as impl]
            [std.lib.env :as env])
  (:use code.test))

(fact:global {:skip (not (env/program-exists? "nvim"))})

tahto/runtime/neovim/impl_test.clj:9:^{:refer tahto.runtime.neovim.impl/neovim-exec :added "4.1"}
(fact "resolves the neovim executable"
  (impl/neovim-exec)
  => string?)

tahto/runtime/neovim/impl_test.clj:14:^{:refer tahto.runtime.neovim.impl/lua-eval-wrap :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:22:^{:refer tahto.runtime.neovim.impl/start-neovim :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:34:^{:refer tahto.runtime.neovim.impl/raw-eval-neovim :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:44:^{:refer tahto.runtime.neovim.impl/raw-eval-neovim :added "4.1"
...
tahto/runtime/neovim/impl_test.clj:56:^{:refer tahto.runtime.neovim.impl/invoke-ptr-neovim :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:68:^{:refer tahto.runtime.neovim.impl/neovim:create :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:75:^{:refer tahto.runtime.neovim.impl/neovim :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:85:^{:refer tahto.runtime.neovim.impl/value->clj :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:105:^{:refer tahto.runtime.neovim.impl/pack-request :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:115:^{:refer tahto.runtime.neovim.impl/stop-neovim :added "4.1"}
(fact "returns the runtime when stopping"
  (let [rt (impl/neovim:create {})]
    (identical? (impl/stop-neovim rt) rt))
  => true)

tahto/runtime/neovim/impl_test.clj:121:^{:refer tahto.runtime.neovim.impl/next-msgid :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:129:^{:refer tahto.runtime.neovim.impl/send-request :added "4.1"}
...
tahto/runtime/neovim/impl_test.clj:143:^{:refer tahto.runtime.neovim.impl/rt-neovim-string :added "4.1"}
(fact "produces the runtime string representation"
  (impl/rt-neovim-string {:id :foo})
  => "#rt.neovim[:foo]")

tahto/runtime/neovim/impl_test.clj:148:^{:refer tahto.runtime.neovim.impl/neovim-shared:create :added "4.1"}
(fact "creates a shared neovim runtime client"
  (let [shared (impl/neovim-shared:create {})]
    [(boolean shared)
tahto/runtime/neovim/impl_test.clj:152:     (= :tahto/rt.neovim (-> shared :client :type))
     (:temp shared)])
  => [true true true])

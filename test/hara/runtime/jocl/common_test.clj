tahto/runtime/jocl/common_test.clj:1:(ns tahto.runtime.jocl.common-test
  (:refer-clojure :exclude [to-array])
  (:use code.test)
tahto/runtime/jocl/common_test.clj:4:  (:require [tahto.runtime.jocl :refer :all]
tahto/runtime/jocl/common_test.clj:5:            [tahto.runtime.jocl.env :as jocl-env]))
...
tahto/runtime/jocl/common_test.clj:13:^{:refer tahto.runtime.jocl.common/parse-spec :added "3.0"}
...
tahto/runtime/jocl/common_test.clj:26:^{:refer tahto.runtime.jocl.common/entry-spec :added "3.0"}
...
tahto/runtime/jocl/common_test.clj:37:^{:refer tahto.runtime.jocl.common/with-error :added "3.0"}
(fact "helper function for creation within context")

tahto/runtime/jocl/common_test.clj:40:^{:refer tahto.runtime.jocl.common/cl-context :added "3.0"}
(fact "creates a cl context"

  (cl-context)
  => org.jocl.cl_context)

tahto/runtime/jocl/common_test.clj:46:^{:refer tahto.runtime.jocl.common/cl-queue :added "3.0"}
(fact "creates a command queue (within a context)"

  (cl-queue (cl-context) (device:gpu))
  => org.jocl.cl_command_queue)

tahto/runtime/jocl/common_test.clj:52:^{:refer tahto.runtime.jocl.common/cl-program :added "3.0"}
...
tahto/runtime/jocl/common_test.clj:61:^{:refer tahto.runtime.jocl.common/cl-kernel :added "3.0"}

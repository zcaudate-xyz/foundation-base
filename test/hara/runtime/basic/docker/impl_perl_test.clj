tahto/runtime/basic/docker/impl_perl_test.clj:1:(ns tahto.runtime.basic.docker.impl-perl-test
tahto/runtime/basic/docker/impl_perl_test.clj:2:  (:require [tahto.runtime.basic.docker.registry :as registry]
            [std.lib.env :as env]
            [tahto.core :as l]
...
tahto/runtime/basic/docker/impl_perl_test.clj:15:;; Run with: RT_BASIC_DOCKER_TESTS=true lein test :only tahto.runtime.basic.docker.impl-perl-test
;;
...
tahto/runtime/basic/docker/impl_perl_test.clj:26:            (System/getenv "TAHTO_NO_DOCKER"))
  :setup [(l/rt:restart)]
  :teardown [(l/rt:stop)]})

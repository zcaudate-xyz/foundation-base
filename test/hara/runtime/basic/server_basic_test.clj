(ns hara.runtime.basic.server-basic-test
  (:require [hara.runtime.basic.server-basic :refer :all]
            [std.concurrent :as cc])
  (:use code.test))

^{:refer hara.runtime.basic.server-basic/get-port :added "4.0"}
(fact "gets the port given lang and id"
  (with-redefs [hara.runtime.basic.server-basic/*env* (atom {})]
    (start-server "test-port" :lua nil)
    (get-port {:lang :lua :id "test-port"})
    => integer?
    (stop-server "test-port" :lua)))

^{:refer hara.runtime.basic.server-basic/wait-ready :added "4.0"}
(fact "wait until server is ready"
  (with-redefs [hara.runtime.basic.server-basic/*env* (atom {})]
    (start-server "test-wait" :lua nil)
    ;; Ensure start-server populated the env
    (get-in @hara.runtime.basic.server-basic/*env* [:lua "test-wait"]) => map?
...
^{:refer hara.runtime.basic.server-basic/run-basic-server :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/get-encoding :added "4.0"}
(fact "gets the encoding to use"

  (get-encoding :json)
  => map?)

^{:refer hara.runtime.basic.server-basic/get-relay :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/ping-relay :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/raw-eval-basic-server :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/create-basic-server :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/start-server :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/get-server :added "4.0"}
...
^{:refer hara.runtime.basic.server-basic/stop-server :added "4.0"}
(fact "stops a server"
  (with-redefs [hara.runtime.basic.server-basic/*env* (atom {})]

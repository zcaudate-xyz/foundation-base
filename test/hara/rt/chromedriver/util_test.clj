(ns hara.rt.chromedriver.util-test
  (:use code.test)
  (:require [hara.rt.chromedriver.util :as util]
            [hara.rt.chromedriver.connection :as conn]
            [hara.rt.chromedriver.connection-test :as conn-test]))

(fact:global
 {:setup    [(conn-test/restart-scaffold)]
  :teardown [(conn-test/stop-scaffold)]})

^{:refer hara.rt.chromedriver.util/runtime-evaluate :added "4.0"
  :setup [(def +conn+
...
^{:refer hara.rt.chromedriver.util/page-navigate :added "4.0"}
...
^{:refer hara.rt.chromedriver.util/page-capture-screenshot :added "4.0"}

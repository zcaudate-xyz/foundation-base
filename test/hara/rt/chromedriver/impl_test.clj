(ns hara.rt.chromedriver.impl-test
  (:use code.test)
  (:require [hara.rt.chromedriver.impl :as impl]
            [std.lib :as h]
...
^{:refer hara.rt.chromedriver.impl/start-browser-bench :added "4.0"
...
^{:refer hara.rt.chromedriver.impl/start-browser-container :added "4.0"}
(fact "starts a browser container")

^{:refer hara.rt.chromedriver.impl/start-browser :added "4.0"
  :setup [(def +rt+ (impl/browser:create {:lang :js}))]
  :teardown [(h/stop +rt+)]}
...
^{:refer hara.rt.chromedriver.impl/stop-browser-raw :added "4.0"}
(fact "stops the browser")

^{:refer hara.rt.chromedriver.impl/raw-eval-browser :added "4.0"}
(fact "evaluates the browser"
  (impl/raw-eval-browser @+browser+ "1 + 1")
  => 2)

^{:refer hara.rt.chromedriver.impl/invoke-ptr-browser :added "4.0"}
...
^{:refer hara.rt.chromedriver.impl/browser:create :added "4.0"}
(fact "creates a browser")

^{:refer hara.rt.chromedriver.impl/browser :added "4.0"}
(fact "starts the browser")

^{:refer hara.rt.chromedriver.impl/wrap-browser-state :added "4.0"}

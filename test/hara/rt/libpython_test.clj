(ns hara.rt.libpython-test
  (:require [libpython-clj2.python :as python]
            [hara.rt.libpython :as lp]
...
^{:refer hara.rt.libpython/TESTING :added "3.0"}
(fact "performs an exec expression"
  ;; Skips actual python exec
  )

^{:refer hara.rt.libpython/eval-raw :added "3.0"}
(fact "performs an exec expression"
...
^{:refer hara.rt.libpython/eval-libpython :added "4.0"}
...
^{:refer hara.rt.libpython/invoke-libpython :added "4.0"}
(fact "invokes a pointer in the runtime"
  ;; delegates
  )

^{:refer hara.rt.libpython/start-libpython :added "3.0"}
(fact "starts the libpython runtime"
  (with-redefs [python/initialize! (fn [] nil)]
    (lp/start-libpython {}))
  => {})

^{:refer hara.rt.libpython/stop-libpython :added "3.0"}
(fact "stops the libpython runtime"
  (lp/stop-libpython {}) => {})

^{:refer hara.rt.libpython/rt-libpython:create :added "4.0"}
(fact "creates a libpython runtime"
  (lp/rt-libpython:create {:lang :js})
  => map?)

^{:refer hara.rt.libpython/rt-libpython :added "4.0"}

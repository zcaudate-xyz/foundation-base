(ns hara.runtime.basic.type-basic-test
  (:require [hara.runtime.basic.impl.process-js :as js]
            ...
            [hara.runtime.basic.type-basic :refer :all]
            [hara.runtime.basic.type-bench :as bench]
            [hara.runtime.basic.type-container :as container]
            [std.lib.component :as component])
  (:use code.test))

^{:refer hara.runtime.basic.type-basic/start-basic :added "4.0"}
(fact "starts the basic rt"
  ...
  (with-redefs [server/start-server (fn [& _] {:port 1234})
                ...
                hara.runtime.basic.type-oneshot/rt-oneshot-setup (fn [& _] [nil {} nil])
...
^{:refer hara.runtime.basic.type-basic/default-container-backup? :added "4.1"}
...
^{:refer hara.runtime.basic.type-basic/local-exec-available? :added "4.1"}
(fact "local-exec-available? checks the first command token"

  (with-redefs [hara.runtime.basic.type-common/program-exists? (fn [s] (= s "php"))]
...
^{:refer hara.runtime.basic.type-basic/stop-basic :added "4.0"}
...
^{:refer hara.runtime.basic.type-basic/raw-eval-basic :added "4.0"}
...
^{:refer hara.runtime.basic.type-basic/invoke-ptr-basic :added "4.0"}
(fact "invoke for basic rt")

^{:refer hara.runtime.basic.type-basic/rt-basic-string :added "4.0"}
...
^{:refer hara.runtime.basic.type-basic/rt-basic-port :added "4.0"}
...
^{:refer hara.runtime.basic.type-basic/rt-basic:create :added "4.0"}
(fact "creates a basic rt"

  (with-redefs [hara.runtime.basic.type-common/get-options (fn [& _] {})]
    (rt-basic:create {:lang :test}))
  => map?)

^{:refer hara.runtime.basic.type-basic/rt-basic :added "4.0"}

(ns hara.rt.basic.type-common-test
  (:require [hara.rt.basic.impl.process-lua :as lua]
            [hara.rt.basic.type-common :as common :refer :all])
  (:use code.test))

^{:refer hara.rt.basic.type-common/get-context-options :added "4.0"}
...
^{:refer hara.rt.basic.type-common/clear-context-options :added "4.0"}
...
^{:refer hara.rt.basic.type-common/put-context-options :added "4.0"
...
^{:refer hara.rt.basic.type-common/set-context-options :added "4.0"
  :setup [(common/clear-context-options :lua :test.raw)]}
...
^{:refer hara.rt.basic.type-common/available-runtimes :added "4.1"}
...
^{:refer hara.rt.basic.type-common/valid-context! :added "4.1"}
...
^{:refer hara.rt.basic.type-common/require-runtime! :added "4.0"}
...
^{:refer hara.rt.basic.type-common/program-exists? :added "4.0"}
(fact  "checks if an executable exists"

  (program-exists? "ls")
  => true)

^{:refer hara.rt.basic.type-common/get-program-options :added "4.0"}
...
^{:refer hara.rt.basic.type-common/put-program-options :added "4.0"}
...
^{:refer hara.rt.basic.type-common/swap-program-options :added "4.0"}
...
^{:refer hara.rt.basic.type-common/get-program-default :added "4.0"}
(fact "gets the default program"

  (get-program-default :lua :oneshot nil)
  => :luajit)

^{:refer hara.rt.basic.type-common/get-program-flags :added "4.0"}
(fact "gets program flags"

  (get-program-flags :lua :luajit)
  => map?)

^{:refer hara.rt.basic.type-common/get-program-exec :added "4.0"}
(fact "gets running parameters for program"

  (get-program-exec :lua :oneshot :luajit)
  => ["luajit" "-e"])

^{:refer hara.rt.basic.type-common/get-options :added "4.0"}

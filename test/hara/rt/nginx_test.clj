(ns hara.rt.nginx-test
  (:require [lua.nginx :as n]
            [net.http :as http]
            [hara.rt.nginx :refer :all]
            [hara.rt.nginx.config :as config]
            [hara.rt.nginx.script :as script]
            [std.fs :as fs]
            [hara.lang :as l]
...
^{:refer hara.rt.nginx/error-logs :added "4.0"}
...
^{:refer hara.rt.nginx/access-logs :added "4.0"}
...
^{:refer hara.rt.nginx/nginx-conf :added "4.0"}
...
^{:refer hara.rt.nginx/dir-tree :added "4.0"}
(fact "gets the running nginx access log"
  (with-redefs [l/rt:inner (constantly {:state (atom [nil "path"])})
                fs/list (constantly [])]
    (dir-tree)
...
^{:refer hara.rt.nginx/all-nginx-ports :added "4.0"}
...
^{:refer hara.rt.nginx/make-temp :added "4.0"}
...
^{:refer hara.rt.nginx/start-test-server-shell :added "4.0"}
...
^{:refer hara.rt.nginx/start-test-server-container :added "4.0"}
...
^{:refer hara.rt.nginx/start-test-server :added "4.0"}
...
^{:refer hara.rt.nginx/kill-single-nginx :added "4.0"}
...
^{:refer hara.rt.nginx/kill-all-nginx :added "4.0"}
...
^{:refer hara.rt.nginx/stop-test-server :added "4.0"}
...
^{:refer hara.rt.nginx/raw-eval-nginx :added "4.0"}
...
^{:refer hara.rt.nginx/invoke-ptr-nginx :added "4.0"}
(fact "evaluates lua ptr and arguments"
  ;; delegates
  )

^{:refer hara.rt.nginx/nginx:create :added "4.0"}
...
^{:refer hara.rt.nginx/nginx :added "4.0"}

(ns hara.rt.postgres.test.scratch-v2-test
  (:require [hara.rt.postgres.base.typed.typed-parse :as parse]
            [hara.rt.postgres.test.scratch-v2 :refer :all])
  (:use code.test))
...
^{:refer hara.rt.postgres.test.scratch-v2/as-array :added "4.1"}
...
^{:refer hara.rt.postgres.test.scratch-v2/TaskCache :added "4.1"}
...
^{:refer hara.rt.postgres.test.scratch-v2/Task :added "4.1"}
...
^{:refer hara.rt.postgres.test.scratch-v2/Entry :added "4.1"}
...
^{:refer hara.rt.postgres.test.scratch-v2/insert-entry :added "4.1"}

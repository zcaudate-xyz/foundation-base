(ns hara.rt.postgres.base.grammar.common-tracker-test
  (:require [hara.rt.postgres.base.grammar.common-tracker :as tracker]
            [hara.rt.postgres.test.scratch-v1 :as scratch])
  (:use code.test))

^{:refer hara.rt.postgres.base.grammar.common-tracker/tracker-string :added "4.1"}
...
^{:refer hara.rt.postgres.base.grammar.common-tracker/add-tracker :added "4.0"}
...
^{:refer hara.rt.postgres.base.grammar.common-tracker/tracker-map-in :added "4.0"}
...
^{:refer hara.rt.postgres.base.grammar.common-tracker/tracker-map-modify :added "4.0"}

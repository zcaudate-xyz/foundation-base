(ns hara.rt.solidity.client-test
  (:require [hara.rt.basic :as basic]
            ...
            [hara.rt.solidity.compile-solc :as solc]
...
^{:refer hara.rt.solidity.client/check-node-connection :added "4.0"}
...
^{:refer hara.rt.solidity.client/contract-fn-name :added "4.0"}
(fact "gets the name of a pointer"
  (with-redefs [l/emit-symbol (fn [_ s] (str s))]
    (client/contract-fn-name {:id 'test:hello}))
  => "test:hello")

^{:refer hara.rt.solidity.client/create-web3-node :added "4.0"}
(fact "creates the node runtime"
  ;; Complex setup
  )

^{:refer hara.rt.solidity.client/start-web3 :added "4.0"}
...
^{:refer hara.rt.solidity.client/stop-web3 :added "4.0"}
...
^{:refer hara.rt.solidity.client/raw-eval-web3 :added "4.0"}
(fact "disables raw-eval for solidity"
  (client/raw-eval-web3 {} "body")
  => (throws))

^{:refer hara.rt.solidity.client/invoke-ptr-web3-check :added "4.0"}
...
^{:refer hara.rt.solidity.client/invoke-ptr-web3-call :added "4.0"}
...
^{:refer hara.rt.solidity.client/invoke-ptr-web3 :added "4.0"}
...
^{:refer hara.rt.solidity.client/rt-web3-string :added "4.0"}
...
^{:refer hara.rt.solidity.client/rt-web3:create :added "4.0"}
(fact "creates a runtime"
  (client/rt-web3:create {})
  => map?)

^{:refer hara.rt.solidity.client/rt-web3 :added "4.0"}
...
(comment
  (hara.rt.solidity.env-ganache/stop-ganache-server)
  (hara.rt.solidity.env-ganache/rt:start-ganache-server)
  )

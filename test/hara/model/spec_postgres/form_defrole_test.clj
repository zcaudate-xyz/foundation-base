(ns hara.model.spec-postgres.form-defrole-test
  (:require [hara.model.spec-postgres.common :as common]
            [hara.model.spec-postgres.form-defrole :refer :all]
            [hara.lang :as l])
  (:use code.test))

^{:refer hara.model.spec-postgres.form-defrole/pg-defrole-access :added "4.0"}
(fact "creates defrole access form"

  (pg-defrole-access {:select ['table]} 'role {})
  => vector?)

^{:refer hara.model.spec-postgres.form-defrole/pg-defrole :added "4.0"}

tahto/model/annex/spec_php_test.clj:1:(ns tahto.model.annex.spec-php-test
  (:use code.test)
  (:require [tahto.core :as l]
            [tahto.core.impl :as impl]
tahto/model/annex/spec_php_test.clj:5:            [tahto.model.annex.spec-php :as spec-php]))

(l/script :php)

tahto/model/annex/spec_php_test.clj:9:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"}
(fact "emits explicit PHP variables and collections"
  (l/emit-as :php ['(var $value {:a [1 2 3]})])
  => "$value = ['a' => [1,2,3]]")

tahto/model/annex/spec_php_test.clj:14:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:21:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:28:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:39:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:49:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:57:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:67:^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"
...
tahto/model/annex/spec_php_test.clj:76:^{:refer tahto.model.annex.spec-php/php-emit-input-rest :added "4.1"}
(fact "emits a PHP variadic parameter"
tahto/model/annex/spec_php_test.clj:78:  (with-redefs [tahto.common.emit-common/*emit-fn*

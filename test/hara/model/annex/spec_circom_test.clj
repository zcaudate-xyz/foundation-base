(ns hara.model.annex.spec-circom-test
  (:use code.test)
  (:require [clojure.string :as str]
            [hara.lang.impl :as impl]
            [hara.model.annex.spec-circom :refer :all]))

^{:refer hara.model.annex.spec-circom/format-string :added "4.1"}
...
^{:refer hara.model.annex.spec-circom/tf-template :added "4.1"}
...
^{:refer hara.model.annex.spec-circom/tf-component :added "4.1"}
(fact "transforms component instantiation"
  (first (tf-component '(component c (MyTemplate 1 2))))
  => :%)

^{:refer hara.model.annex.spec-circom/tf-signal :added "4.1"}
...
^{:refer hara.model.annex.spec-circom/tf-constraint :added "4.1"}
...
^{:refer hara.model.annex.spec-circom/tf-for :added "4.1"}

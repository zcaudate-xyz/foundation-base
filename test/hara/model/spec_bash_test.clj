...
^{:refer hara.lang.model-spec-bash/CANARY :guard true :adopt true :added "3.0"}
(fact "PRELIM CHECKS"
...
^{:refer hara.model.spec-bash/PLAYGROUND :adopt true :added "4.0"
  :setup [(hara.lang.type-notify/clear-sink (l/default-notify)
                                                      "test")]}
(fact "various features"

  ;; NOTIFY
  (do (def +p+ (hara.lang.type-notify/watch-oneshot (l/default-notify)
                                                             100
                                                             "test"))

tahto/typed/xtalk_common_test.clj:1:(ns tahto.typed.xtalk-common-test
  (:use code.test)
tahto/typed/xtalk_common_test.clj:3:  (:require [tahto.typed.xtalk-common :refer :all]))
...
tahto/typed/xtalk_common_test.clj:32:^{:refer tahto.typed.xtalk-common/primitive-type :added "4.1"}
(fact "builds primitive type maps"
  (primitive-type :xt/str)
  => '{:kind :primitive :name :xt/str})

tahto/typed/xtalk_common_test.clj:37:^{:refer tahto.typed.xtalk-common/snake-case-string :added "4.1"}
(fact "normalizes dash names to snake case"
  (snake-case-string "route-path")
  => "route_path")

tahto/typed/xtalk_common_test.clj:42:^{:refer tahto.typed.xtalk-common/maybe-type :added "4.1"}
(fact "wraps maybe types"
  (maybe-type +str-type+)
  => '{:kind :maybe :item {:kind :primitive :name :xt/str}})

tahto/typed/xtalk_common_test.clj:47:^{:refer tahto.typed.xtalk-common/union-type :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:53:^{:refer tahto.typed.xtalk-common/source-loc :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:60:^{:refer tahto.typed.xtalk-common/type-key :added "4.1"}
(fact "builds namespaced type keys"
  [(type-key 'sample.route 'User)
   (type-key nil 'User)]
  => '[sample.route/User User])

tahto/typed/xtalk_common_test.clj:66:^{:refer tahto.typed.xtalk-common/valid-key? :added "4.1"}
(fact "accepts only namespaced symbols as registry keys"
  [(valid-key? 'sample.route/User)
   (valid-key? 'User)]
  => [true false])

tahto/typed/xtalk_common_test.clj:72:^{:refer tahto.typed.xtalk-common/clear-registry! :added "4.1"}
(fact "clears registry state"
  (do (populate!) (clear-registry!) (count (list-entries)))
  => 0)

tahto/typed/xtalk_common_test.clj:77:^{:refer tahto.typed.xtalk-common/make-registry-entry :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:82:^{:refer tahto.typed.xtalk-common/get-entry :added "4.1"}
(fact "gets registry entries"
  (do (populate!) (some? (get-entry 'sample.route/User)))
  => true)

tahto/typed/xtalk_common_test.clj:87:^{:refer tahto.typed.xtalk-common/entry-declarations :added "4.1"}
(fact "extracts present declarations from an entry"
  (do (populate!) (keys (entry-declarations (get-entry 'sample.route/User))))
  => '(:spec))

tahto/typed/xtalk_common_test.clj:92:^{:refer tahto.typed.xtalk-common/entry-kinds :added "4.1"}
(fact "lists declaration kinds"
  (do (populate!) (vec (entry-kinds (get-entry 'sample.route/find-user))))
  => [:fn])

tahto/typed/xtalk_common_test.clj:97:^{:refer tahto.typed.xtalk-common/entry-primary :added "4.1"}
(fact "returns primary entry declaration"
  (do (populate!) (:name (entry-primary (get-entry 'sample.route/User))))
  => "User")

tahto/typed/xtalk_common_test.clj:102:^{:refer tahto.typed.xtalk-common/entry-primary-kind :added "4.1"}
(fact "returns primary declaration kind"
  (do (populate!) (entry-primary-kind (get-entry 'sample.route/ScopeMap)))
  => :value)

tahto/typed/xtalk_common_test.clj:107:^{:refer tahto.typed.xtalk-common/get-declaration :added "4.1"}
(fact "gets specific declarations by kind"
  (do (populate!) (:name (get-declaration 'sample.route/find-user :fn)))
  => "find-user")

tahto/typed/xtalk_common_test.clj:112:^{:refer tahto.typed.xtalk-common/get-spec :added "4.1"}
(fact "gets registered specs"
  (do (populate!) (:name (get-spec 'sample.route/User)))
  => "User")

tahto/typed/xtalk_common_test.clj:117:^{:refer tahto.typed.xtalk-common/get-function :added "4.1"}
(fact "gets registered functions"
  (do (populate!) (:name (get-function 'sample.route/find-user)))
  => "find-user")

tahto/typed/xtalk_common_test.clj:122:^{:refer tahto.typed.xtalk-common/get-macro :added "4.1"}
(fact "gets registered macros"
  (do (populate!) (:name (get-macro 'sample.route/expand)))
  => "expand")

tahto/typed/xtalk_common_test.clj:127:^{:refer tahto.typed.xtalk-common/get-value :added "4.1"}
(fact "gets registered values"
  (do (populate!) (:name (get-value 'sample.route/ScopeMap)))
  => "ScopeMap")

tahto/typed/xtalk_common_test.clj:132:^{:refer tahto.typed.xtalk-common/get-type :added "4.1"}
(fact "gets primary typed declarations"
  (do (populate!) (:name (get-type 'sample.route/find-user)))
  => "find-user")

tahto/typed/xtalk_common_test.clj:137:^{:refer tahto.typed.xtalk-common/list-specs :added "4.1"}
(fact "lists specs"
  (do (populate!) (count (list-specs)))
  => 1)

tahto/typed/xtalk_common_test.clj:142:^{:refer tahto.typed.xtalk-common/list-functions :added "4.1"}
(fact "lists functions"
  (do (populate!) (count (list-functions)))
  => 1)

tahto/typed/xtalk_common_test.clj:147:^{:refer tahto.typed.xtalk-common/list-macros :added "4.1"}
(fact "lists macros"
  (do (populate!) (count (list-macros)))
  => 1)

tahto/typed/xtalk_common_test.clj:152:^{:refer tahto.typed.xtalk-common/list-values :added "4.1"}
(fact "lists values"
  (do (populate!) (count (list-values)))
  => 1)

tahto/typed/xtalk_common_test.clj:157:^{:refer tahto.typed.xtalk-common/list-entries :added "4.1"}
(fact "lists registry entries"
  (do (populate!) (count (list-entries)))
  => 4)

tahto/typed/xtalk_common_test.clj:162:^{:refer tahto.typed.xtalk-common/register-entry! :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:170:^{:refer tahto.typed.xtalk-common/register-spec! :added "4.1"}
(fact "registers specs"
  (do (clear-registry!) (register-spec! 'sample.route/User (sample-spec)) (some? (get-spec 'sample.route/User)))
  => true)

tahto/typed/xtalk_common_test.clj:175:^{:refer tahto.typed.xtalk-common/register-function! :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:180:^{:refer tahto.typed.xtalk-common/register-macro! :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:185:^{:refer tahto.typed.xtalk-common/register-value! :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:190:^{:refer tahto.typed.xtalk-common/make-spec-def :added "4.1"}
(fact "constructs spec defs"
  (sample-spec)
  => '{:ns "sample.route" :name "User" :type {:kind :primitive :name :xt/str} :spec-meta {:doc "user"}
       :file "sample.clj" :line 10 :column 5})

tahto/typed/xtalk_common_test.clj:196:^{:refer tahto.typed.xtalk-common/make-arg :added "4.1"}
(fact "constructs args"
  (make-arg 'id +str-type+ [:rest])
  => '{:name id :type {:kind :primitive :name :xt/str} :modifiers [:rest]})

tahto/typed/xtalk_common_test.clj:201:^{:refer tahto.typed.xtalk-common/make-fn-def :added "4.1"}
(fact "constructs fn defs"
  (:name (sample-fn))
  => "find-user")

tahto/typed/xtalk_common_test.clj:206:^{:refer tahto.typed.xtalk-common/make-value-def :added "4.1"}
(fact "constructs value defs"
  (:raw-value (sample-value))
  => {:a 1})

tahto/typed/xtalk_common_test.clj:211:^{:refer tahto.typed.xtalk-common/spec-def? :added "4.1"}
(fact "detects spec defs"
  (spec-def? (sample-spec))
  => true)

tahto/typed/xtalk_common_test.clj:216:^{:refer tahto.typed.xtalk-common/fn-def? :added "4.1"}
(fact "detects non-macro fn defs"
  (fn-def? (sample-fn))
  => true)

tahto/typed/xtalk_common_test.clj:221:^{:refer tahto.typed.xtalk-common/macro-def? :added "4.1"}
(fact "detects macro defs"
  (macro-def? (sample-macro))
  => true)

tahto/typed/xtalk_common_test.clj:226:^{:refer tahto.typed.xtalk-common/generator-def? :added "4.1"}
(fact "detects generator defs"
  (generator-def? (sample-generator))
  => true)

tahto/typed/xtalk_common_test.clj:231:^{:refer tahto.typed.xtalk-common/value-def? :added "4.1"}
(fact "detects value defs"
  (value-def? (sample-value))
  => true)

tahto/typed/xtalk_common_test.clj:236:^{:refer tahto.typed.xtalk-common/declaration-kind :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:244:^{:refer tahto.typed.xtalk-common/field-key :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:251:^{:refer tahto.typed.xtalk-common/likely-type-symbol? :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:258:^{:refer tahto.typed.xtalk-common/resolve-type-symbol :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:264:^{:refer tahto.typed.xtalk-common/normalize-record-field :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:271:^{:refer tahto.typed.xtalk-common/normalize-apply-target :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:276:^{:refer tahto.typed.xtalk-common/normalize-type :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:292:^{:refer tahto.typed.xtalk-common/normalize-return-meta :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:297:^{:refer tahto.typed.xtalk-common/fn-type :added "4.1"}
...
tahto/typed/xtalk_common_test.clj:304:^{:refer tahto.typed.xtalk-common/type->data :added "4.1"}
(fact "converts typed records to plain data"
  (type->data (sample-spec))
  => '{:ns "sample.route" :name "User" :type {:kind :primitive :name :xt/str}})

tahto/typed/xtalk_common_test.clj:309:^{:refer tahto.typed.xtalk-common/type-string :added "4.1"}
(fact "renders type data as strings"
  (boolean (re-find #":xt/str" (type-string +str-type+)))
  => true)

tahto/typed/xtalk_common_test.clj:314:^{:refer tahto.typed.xtalk-common/current-function-symbol :added "4.1"}

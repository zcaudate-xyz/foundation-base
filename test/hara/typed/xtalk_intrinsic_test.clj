(ns hara.typed.xtalk-intrinsic-test
  (:use code.test)
  (:require [hara.typed.xtalk-common :as types]
            [hara.typed.xtalk-intrinsic :refer :all]))
...
^{:refer hara.typed.xtalk-intrinsic/first-item :added "4.1"}
(fact "returns first tuple item"
  (:type (first-item '(intrinsic pair) {} (callbacks)))
  => '{:kind :primitive :name :xt/str})

^{:refer hara.typed.xtalk-intrinsic/second-item :added "4.1"}
(fact "returns second tuple item"
  (:type (second-item '(intrinsic pair) {} (callbacks)))
  => '{:kind :primitive :name :xt/int})

^{:refer hara.typed.xtalk-intrinsic/const-fn :added "4.1"}
...
^{:refer hara.typed.xtalk-intrinsic/obj-assign :added "4.1"}
...
^{:refer hara.typed.xtalk-intrinsic/make-container :added "4.1"}
...
^{:refer hara.typed.xtalk-intrinsic/blank-container :added "4.1"}
...
^{:refer hara.typed.xtalk-intrinsic/infer-intrinsic :added "4.1"}
(fact "dispatches intrinsic rules by symbol"
  [(-> (infer-intrinsic '(hara.typed.xtalk-intrinsic/arrayify numbers) {} (callbacks)) :type)
   (infer-intrinsic '(hara.typed.xtalk-intrinsic/missing numbers) {} (callbacks))]

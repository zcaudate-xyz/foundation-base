tahto/typed/xtalk_form_test.clj:1:(ns tahto.typed.xtalk-form-test
  (:use code.test)
tahto/typed/xtalk_form_test.clj:3:  (:require [tahto.typed.xtalk-common :as types]
tahto/typed/xtalk_form_test.clj:4:            [tahto.typed.xtalk-form :refer :all]
tahto/typed/xtalk_form_test.clj:5:            [tahto.typed.xtalk-infer :refer [infer-type]]))

(def +ctx+ {:ns 'sample.route :aliases '{k xt.lang.common-lib} :infer infer-type})

tahto/typed/xtalk_form_test.clj:9:^{:refer tahto.typed.xtalk-form/infer-map :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:17:^{:refer tahto.typed.xtalk-form/infer-vector :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:24:^{:refer tahto.typed.xtalk-form/infer-binding-form :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:34:^{:refer tahto.typed.xtalk-form/infer-let :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:41:^{:refer tahto.typed.xtalk-form/infer-if :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:48:^{:refer tahto.typed.xtalk-form/infer-ternary :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:55:^{:refer tahto.typed.xtalk-form/infer-or :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:60:^{:refer tahto.typed.xtalk-form/infer-when :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:67:^{:refer tahto.typed.xtalk-form/infer-cond :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:74:^{:refer tahto.typed.xtalk-form/infer-while :added "4.1"}
(fact "models while as nil-returning"
  (types/type->data (:type (infer-while '(while true 1) +ctx+)))
  => '{:kind :primitive :name :xt/nil})

tahto/typed/xtalk_form_test.clj:79:^{:refer tahto.typed.xtalk-form/infer-yield :added "4.1"}
(fact "models yield as nil-returning"
  (types/type->data (:type (infer-yield '(yield "a") +ctx+)))
  => '{:kind :primitive :name :xt/nil})

tahto/typed/xtalk_form_test.clj:84:^{:refer tahto.typed.xtalk-form/infer-anon-fn :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:91:^{:refer tahto.typed.xtalk-form/merge-record-fields :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:98:^{:refer tahto.typed.xtalk-form/merge-open-types :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:107:^{:refer tahto.typed.xtalk-form/infer-obj-assign :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:114:^{:refer tahto.typed.xtalk-form/arrayify-type :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:122:^{:refer tahto.typed.xtalk-form/infer-make-container :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:134:^{:refer tahto.typed.xtalk-form/infer-blank-container :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:142:^{:refer tahto.typed.xtalk-form/apply-default-type :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:149:^{:refer tahto.typed.xtalk-form/infer-fixed-output :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:156:^{:refer tahto.typed.xtalk-form/infer-obj-vals :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:166:^{:refer tahto.typed.xtalk-form/infer-obj-pairs :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:178:^{:refer tahto.typed.xtalk-form/infer-obj-clone :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:185:^{:refer tahto.typed.xtalk-form/infer-arr-clone :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:195:^{:refer tahto.typed.xtalk-form/infer-get-key :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:201:^{:refer tahto.typed.xtalk-form/infer-get-idx :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:207:^{:refer tahto.typed.xtalk-form/infer-get-path :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:218:^{:refer tahto.typed.xtalk-form/infer-dot :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:227:^{:refer tahto.typed.xtalk-form/infer-free :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:234:^{:refer tahto.typed.xtalk-form/infer-keyword-call :added "4.1"}
...
tahto/typed/xtalk_form_test.clj:240:^{:refer tahto.typed.xtalk-form/infer-body :added "4.1"}

tahto/seedgen/common_meta_test.clj:1:(ns tahto.seedgen.common-meta-test
  (:use code.test)
tahto/seedgen/common_meta_test.clj:3:  (:require [tahto.seedgen.common-meta :refer :all]))

tahto/seedgen/common_meta_test.clj:5:^{:refer tahto.seedgen.common-meta/normalize-runtime-lang :added "4.1"}
...
tahto/seedgen/common_meta_test.clj:12:^{:refer tahto.seedgen.common-meta/runtime-lang-config :added "4.1"}
...
tahto/seedgen/common_meta_test.clj:28:^{:refer tahto.seedgen.common-meta/runtime-script-lang :added "4.1"}
...
tahto/seedgen/common_meta_test.clj:34:^{:refer tahto.seedgen.common-meta/runtime-dispatch-symbol :added "4.1"}
...
tahto/seedgen/common_meta_test.clj:40:^{:refer tahto.seedgen.common-meta/runtime-type :added "4.1"}
(fact "returns the runtime type for a language"
  (runtime-type :js) => :basic
  (runtime-type :dart) => :twostep
  (runtime-type :unknown) => nil)

tahto/seedgen/common_meta_test.clj:46:^{:refer tahto.seedgen.common-meta/runtime-check-mode :added "4.1"}
...
tahto/seedgen/common_meta_test.clj:52:^{:refer tahto.seedgen.common-meta/runtime-suite-groups :added "4.1"}
...
tahto/seedgen/common_meta_test.clj:61:^{:refer tahto.seedgen.common-meta/runtime-lang-suffix :added "4.1"}

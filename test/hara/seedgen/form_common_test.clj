tahto/seedgen/form_common_test.clj:1:(ns tahto.seedgen.form-common-test
  (:use code.test)
  (:require [std.block.base :as block]
            [std.block.navigate :as nav]
tahto/seedgen/form_common_test.clj:5:            [tahto.seedgen.form-common :refer :all]))
...
tahto/seedgen/form_common_test.clj:21:^{:refer tahto.seedgen.form-common/target-normalize-langs :added "4.1"}
...
tahto/seedgen/form_common_test.clj:34:^{:refer tahto.seedgen.form-common/nav-meta-block? :added "4.1"}
...
tahto/seedgen/form_common_test.clj:41:^{:refer tahto.seedgen.form-common/nav-meta :added "4.1"}
...
tahto/seedgen/form_common_test.clj:52:^{:refer tahto.seedgen.form-common/nav-body :added "4.1"}
...
tahto/seedgen/form_common_test.clj:59:^{:refer tahto.seedgen.form-common/nav-top-levels :added "4.1"}
...
tahto/seedgen/form_common_test.clj:66:^{:refer tahto.seedgen.form-common/nav-entry :added "4.1"}
...
tahto/seedgen/form_common_test.clj:75:^{:refer tahto.seedgen.form-common/nav-map-value :added "4.1"}
...
tahto/seedgen/form_common_test.clj:86:^{:refer tahto.seedgen.form-common/nav-vector-items :added "4.1"}
...
tahto/seedgen/form_common_test.clj:98:^{:refer tahto.seedgen.form-common/item-line-key :added "4.1"}
(fact "reduces line maps to a sortable coordinate tuple"
  (item-line-key {:row 3 :col 4 :end-row 5 :end-col 6})
  => [3 4 5 6])

tahto/seedgen/form_common_test.clj:103:^{:refer tahto.seedgen.form-common/item-form :added "4.1"}
(fact "returns the stored block for an item entry"
  (let [[fact-nav] (sample-top-navs)]
    (-> fact-nav nav-entry item-form block/block-string))
  => "^{:refer demo/example\n  :setup [(!.js (+ 1 2))\n          (!.lua (+ 1 2))]}\n(fact \"demo\"\n  (!.js (+ 1 2))\n  => 3)")

tahto/seedgen/form_common_test.clj:109:^{:refer tahto.seedgen.form-common/item-line :added "4.1"}
(fact "returns the original line map for an item entry"
  (let [[fact-nav] (sample-top-navs)]
    (-> fact-nav nav-entry item-line (select-keys [:row :col])))
  => {:row 1 :col 1})

tahto/seedgen/form_common_test.clj:115:^{:refer tahto.seedgen.form-common/item-string :added "4.1"}
(fact "renders an item block back to source text"
  (let [[fact-nav] (sample-top-navs)]
    (-> fact-nav nav-entry item-string))
  => "^{:refer demo/example\n  :setup [(!.js (+ 1 2))\n          (!.lua (+ 1 2))]}\n(fact \"demo\"\n  (!.js (+ 1 2))\n  => 3)")

tahto/seedgen/form_common_test.clj:121:^{:refer tahto.seedgen.form-common/item-value :added "4.1"}
(fact "returns the EDN value represented by an item block"
  (let [[fact-nav] (sample-top-navs)]
    (-> fact-nav nav-entry item-value first))
  => 'fact)

tahto/seedgen/form_common_test.clj:127:^{:refer tahto.seedgen.form-common/item-lang :added "4.1"}
...
tahto/seedgen/form_common_test.clj:134:^{:refer tahto.seedgen.form-common/item-sort :added "4.1"}
...
tahto/seedgen/form_common_test.clj:144:^{:refer tahto.seedgen.form-common/item-classify-langs :added "4.1"}
...
tahto/seedgen/form_common_test.clj:156:^{:refer tahto.seedgen.form-common/item-runtime-map :added "4.1"}

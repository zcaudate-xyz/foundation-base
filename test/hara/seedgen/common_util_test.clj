tahto/seedgen/common_util_test.clj:1:(ns tahto.seedgen.common-util-test
  (:use code.test)
  (:require [clojure.string :as str]
tahto/seedgen/common_util_test.clj:4:            [tahto.seedgen.common-util :refer :all]
            [std.fs :as fs]))

tahto/seedgen/common_util_test.clj:7:^{:refer tahto.seedgen.common-util/require-alias :added "4.1"}
(fact "extracts the :as alias for a require target"
  (require-alias '[tahto.core :as l] 'tahto.core) => 'l
  (require-alias '[tahto.core] 'tahto.core) => nil
  (require-alias '[clojure.string :as str] 'tahto.core) => nil
  (require-alias 'tahto.core 'tahto.core) => nil)

tahto/seedgen/common_util_test.clj:14:^{:refer tahto.seedgen.common-util/seedgen-script-heads :added "4.1"}
(fact "discovers script- heads from a namespace form"
  (seedgen-script-heads '(ns sample
                           (:require [tahto.core :as l])))
  => #{'tahto.core/script- 'l/script-}

  (seedgen-script-heads '(ns sample)) => #{'tahto.core/script-})

tahto/seedgen/common_util_test.clj:22:^{:refer tahto.seedgen.common-util/seedgen-root-langs :added "4.1"}
...
tahto/seedgen/common_util_test.clj:38:^{:refer tahto.seedgen.common-util/seedgen-dispatch-map :added "4.1"}
...
tahto/seedgen/common_util_test.clj:46:^{:refer tahto.seedgen.common-util/seedgen-dispatch-tag-map :added "4.1"}
...
tahto/seedgen/common_util_test.clj:54:^{:refer tahto.seedgen.common-util/seedgen-normalize-runtime-lang :added "4.1"}
...
tahto/seedgen/common_util_test.clj:60:^{:refer tahto.seedgen.common-util/seedgen-dispatch-tag :added "4.1"}
...
tahto/seedgen/common_util_test.clj:66:^{:refer tahto.seedgen.common-util/seedgen-default-runtime :added "4.1"}
...
tahto/seedgen/common_util_test.clj:71:^{:refer tahto.seedgen.common-util/seedgen-dispatch-lang :added "4.1"}
...
tahto/seedgen/common_util_test.clj:77:^{:refer tahto.seedgen.common-util/seedgen-runtime-reference-lang :added "4.1"}
...
tahto/seedgen/common_util_test.clj:84:^{:refer tahto.seedgen.common-util/seedgen-runtime-dispatch-langs :added "4.1"}
...
tahto/seedgen/common_util_test.clj:91:^{:refer tahto.seedgen.common-util/seedgen-form-lang :added "4.1"}
...
tahto/seedgen/common_util_test.clj:97:^{:refer tahto.seedgen.common-util/seedgen-fact-forms :added "4.1"}
...
tahto/seedgen/common_util_test.clj:119:^{:refer tahto.seedgen.common-util/seedgen-base-config :added "4.1"}
...
tahto/seedgen/common_util_test.clj:135:^{:refer tahto.seedgen.common-util/seedgen-lang-config :added "4.1"}
...
tahto/seedgen/common_util_test.clj:153:^{:refer tahto.seedgen.common-util/seedgen-lang-entry :added "4.1"}
...
tahto/seedgen/common_util_test.clj:170:^{:refer tahto.seedgen.common-util/seedgen-root-entry :added "4.1"}
...
tahto/seedgen/common_util_test.clj:182:^{:refer tahto.seedgen.common-util/seedgen-suppressed-langs :added "4.1"}
...
tahto/seedgen/common_util_test.clj:192:^{:refer tahto.seedgen.common-util/seedgen-coverage-langs :added "4.1"}
...
tahto/seedgen/common_util_test.clj:202:^{:refer tahto.seedgen.common-util/seedgen-display-lang :added "4.1"}
...
tahto/seedgen/common_util_test.clj:209:^{:refer tahto.seedgen.common-util/seedgen-skip? :added "4.1"}

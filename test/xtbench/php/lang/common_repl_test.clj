(ns
 xtbench.php.lang.common-repl-test
 (:require
  [std.json :as json]
  [std.lang :as l]
...
(fact
 ...
 ^{:hidden true}
 (decode-output
  (!.php (k/return-encode {:data [1 2 3]} "<id>" "<key>")))
 =>
...
(fact
 ...
 ^{:hidden true}
 (decode-output (!.php (k/return-wrap (fn:> 1))))
 =>
...
(fact
 ...
 ^{:hidden true}
 (notify/wait-on :php ((. (k/<!) ["success"]) 1))
 =>
 1)

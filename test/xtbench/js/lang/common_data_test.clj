(ns xtbench.js.lang.common-data-test
...
(fact "finds the intersection between map lookups"
      ...
      (set (!.js (xtd/obj-intersection {:a true, :b true} {:b true, :c true})))
  => #{"b"})
...
(fact "finds the difference between two map lookups"
  ...
  (set (!.js (xtd/obj-difference {:a true, :b true} {:b true, :c true})))
  => #{"c"})
...
(fact "keeps items in an array if output is not nil" (!.js (xtd/arr-keep [1 2 3 4] (fn [x] (if (== 0 (mod x 2)) (return (* x 10)) (return nil))))) => [20 40])
...
(fact "applies a transform across the values of an object, keeping non-nil values" (!.js (xtd/obj-keep {:a 1 :b 2 :c 3} (fn [x] (if (== 0 (mod x 2)) (return (* x 10)) (return nil))))) => {"b" 20})

...
(fact
 ...
 (!.js (var lu (xtd/lu-create)) (xtd/lu-get lu "missing"))
 =>
 nil)
...
(fact
 ...
 (!.js [(xtd/arrayify 1) (xtd/arrayify [1])])
 =>
 [[1] [1]])
...
(fact "reverses the array" (!.js (xtd/arr-reverse [1 2 3])) => [3 2 1])
...
(fact
 ...
 (!.js [(xtd/obj-empty? {}) (xtd/obj-empty? {:a 1})])
 =>
 [true false])
...
(fact
 ...
 (!.js [(xtd/obj-not-empty? {}) (xtd/obj-not-empty? {:a 1})])
 =>
 [false true])

^{:refer xt.lang.common-data/obj-first-key, :added "4.1"}
(fact "gets the first key" (!.js (xtd/obj-first-key {:a 1})) => "a")

^{:refer xt.lang.common-data/obj-first-val, :added "4.1"}
(fact "gets the first val" (!.js (xtd/obj-first-val {:a 1})) => 1)
...
(fact
 "obj del all"
 (!.js (var out {:a 1, :b 2}) (xtd/obj-del-all out) out)
 =>
 {})
...
(fact
 "sets item in object"
 [(!.js (var a {:a {:b {:c 1}}}) (xtd/set-in a ["a" "b"] 2) a)
  (!.js (var a {:a {:b {:c 1}}}) (xtd/set-in a ["a" "d"] 2) a)]
 =>
 [{"a" {"b" 2}} {"a" {"b" {"c" 1}, "d" 2}}])
...
(fact
 ...
 (!.js (xtd/from-flat ["a" 1 "b" 2] xtd/set-pair-step {}))
 =>
 {"a" 1, "b" 2})
...
(fact
 ...
 (!.js [(xtd/clone-shallow nil) (xtd/clone-shallow 1)])
 =>
 [nil 1])

(ns
 xtbench.js.lang.common-spec-test
 (:use code.test)
 (:require
  [clojure.set :as set]
  [std.lang :as l]
...
(l/script-
 :js
 {:runtime :basic, :require [[xt.lang.spec-base :as xt]]})
...
(fact
 ...
 (!.js (xt/x:get-idx [10 20 30] (xt/x:offset 0)))
 =>
 10)
...
(fact
 ...
 (!.js (var out [10 20 30]) (xt/x:set-idx out (xt/x:offset 1) 99) out)
 =>
 [10 99 30])
...
(fact
 ...
 (!.js
  (do (var out [0 1 2 3]) (xt/x:arr-remove out (xt/x:offset 1)) out))
 =>
 [0 1 3])
...
(fact
 ...
 (!.js (var out [1 2 3]) (xt/x:arr-push out 4) out)
 =>
 [1 2 3 4])
...
(fact
 ...
 (!.js (var out [1 2 3 4]) (xt/x:arr-pop out))
 =>
 4)
...
(fact
 ...
 (!.js (var out [1 2 3]) (xt/x:arr-push-first out 0) out)
 =>
 [0 1 2 3])
...
(fact
 ...
 (!.js (var out [0 1 2 3]) (xt/x:arr-pop-first out))
 =>
 0)
...
(fact
 ...
 (!.js (var out [1 2 3]) (xt/x:arr-insert out (xt/x:offset 1) 9) out)
 =>
 [1 9 2 3])
...
(fact
 ...
 (!.js (xt/x:arr-slice [1 2 3] (xt/x:offset 0) (xt/x:offset 1)))
 =>
 [2])

^{:refer xt.lang.spec-base/x:arr-reverse, :added "4.1"}
(fact "reverses an array" (!.js (xt/x:arr-reverse [1 2 3])) => [3 2 1])

^{:refer xt.lang.spec-base/x:cat, :added "4.1"}
(fact
 "concatenates strings"
 (!.js (xt/x:cat "hello" "-" "world"))
 =>
 "hello-world")

^{:refer xt.lang.spec-base/x:len, :added "4.1"}
(fact "gets the collection length" (!.js (xt/x:len [1 2 3])) => 3)

^{:refer xt.lang.spec-base/x:to-string, :added "4.1"}
(fact "converts a value to a string" (!.js (xt/x:to-string 12)) => "12")

^{:refer xt.lang.spec-base/x:to-number, :added "4.1"}
(fact
 "converts a string to a number"
 (!.js (xt/x:to-number "12.5"))
 =>
 12.5)

^{:refer xt.lang.spec-base/x:not-nil?, :added "4.1"}
(fact "checks for non-nil values" (!.js (xt/x:not-nil? 0)) => true)

^{:refer xt.lang.spec-base/x:nil?, :added "4.1"}
(fact "checks for nil values" (!.js (xt/x:nil? nil)) => true)

^{:refer xt.lang.spec-base/x:is-string?, :added "4.1"}
(fact "recognises strings" (!.js (xt/x:is-string? "abc")) => true)

^{:refer xt.lang.spec-base/x:is-number?, :added "4.1"}
(fact "recognises numbers" (!.js (xt/x:is-number? 1.5)) => true)

^{:refer xt.lang.spec-base/x:is-integer?, :added "4.1"}
(fact "recognises integers" (!.js (xt/x:is-integer? 2)) => true)

^{:refer xt.lang.spec-base/x:is-boolean?, :added "4.1"}
(fact "recognises booleans" (!.js (xt/x:is-boolean? true)) => true)

^{:refer xt.lang.spec-base/x:is-object?, :added "4.1"}
(fact "recognises objects" (!.js (xt/x:is-object? {:a 1})) => true)

^{:refer xt.lang.spec-base/x:is-array?, :added "4.1"}
(fact "recognises arrays" (!.js (xt/x:is-array? [1 2])) => true)

^{:refer xt.lang.spec-base/x:add, :added "4.1"}
(fact "adds numbers" (!.js (xt/x:add 1 2 3)) => 6)

^{:refer xt.lang.spec-base/x:sub, :added "4.1"}
(fact "subtracts numbers" (!.js (xt/x:sub 10 3 2)) => 5)

^{:refer xt.lang.spec-base/x:mul, :added "4.1"}
(fact "multiplies numbers" (!.js (xt/x:mul 2 3 4)) => 24)

^{:refer xt.lang.spec-base/x:div, :added "4.1"}
(fact "divides numbers" (!.js (xt/x:div 20 5)) => (approx 4))

^{:refer xt.lang.spec-base/x:neg, :added "4.1"}
(fact "negates a number" (!.js (xt/x:neg 2)) => -2)

^{:refer xt.lang.spec-base/x:inc, :added "4.1"}
(fact "increments a number" (!.js (xt/x:inc 2)) => 3)

^{:refer xt.lang.spec-base/x:dec, :added "4.1"}
(fact "decrements a number" (!.js (xt/x:dec 2)) => 1)

^{:refer xt.lang.spec-base/x:zero?, :added "4.1"}
(fact "checks whether a number is zero" (!.js (xt/x:zero? 0)) => true)
...
(fact "checks whether a number is even" (!.js (xt/x:even? 4)) => true)

^{:refer xt.lang.spec-base/x:odd?, :added "4.1"}
(fact "checks whether a number is odd" (!.js (xt/x:odd? 5)) => true)

^{:refer xt.lang.spec-base/x:eq, :added "4.1"}
(fact "checks equality" (!.js (xt/x:eq 2 2)) => true)

^{:refer xt.lang.spec-base/x:neq, :added "4.1"}
(fact "checks inequality" (!.js (xt/x:neq 2 3)) => true)

^{:refer xt.lang.spec-base/x:lt, :added "4.1"}
(fact "checks less than" (!.js (xt/x:lt 2 3)) => true)

^{:refer xt.lang.spec-base/x:lte, :added "4.1"}
(fact "checks less than or equal" (!.js (xt/x:lte 3 3)) => true)

^{:refer xt.lang.spec-base/x:gt, :added "4.1"}
(fact "checks greater than" (!.js (xt/x:gt 4 3)) => true)

^{:refer xt.lang.spec-base/x:gte, :added "4.1"}
(fact "checks greater than or equal" (!.js (xt/x:gte 4 4)) => true)

^{:refer xt.lang.spec-base/x:has-key?, :added "4.1"}
(fact
 "checks whether an object has a key"
 (!.js (var obj {:a 1}) (xt/x:has-key? obj "a"))
 =>
 true)
...
(fact
 ...
 (!.js (xt/x:get-key {} "missing" "fallback"))
 =>
 "fallback")
...
(fact
 ...
 (!.js (xt/x:get-path {:nested {:b 2}} ["nested" "b"]))
 =>
 2)
...
(fact
 ...
 (!.js (var out {:a 1}) (xt/x:set-key out "b" 2) out)
 =>
 {"a" 1, "b" 2})
...
(fact
 ...
 (!.js (var out {:a 1}) (xt/x:copy-key out {:a 9} ["c" "a"]) out)
 =>
 {"a" 1, "c" 9})
...
(fact
 "assigns object keys"
 (!.js (xt/x:obj-assign {:a 1} {:b 2}))
 =>
 {"a" 1, "b" 2})

^{:refer xt.lang.spec-base/x:obj-from-pairs, :added "4.1"}
(fact
 "creates an object from pairs"
 (!.js (xt/x:obj-from-pairs [["a" 1] ["b" 2]]))
 =>
 {"a" 1, "b" 2})

^{:refer xt.lang.spec-base/x:str-len, :added "4.1"}
(fact "gets the string length" (!.js (xt/x:str-len "hello")) => 5)

^{:refer xt.lang.spec-base/x:str-pad-left, :added "4.1"}
(fact
 "pads a string on the left"
 (!.js (xt/x:str-pad-left "7" 3 "0"))
 =>
 "007")
...
(fact
 ...
 (!.js (xt/x:str-starts-with "hello" "he"))
 =>
 true)
...
(fact
 ...
 (!.js (xt/x:str-ends-with "hello" "lo"))
 =>
 true)
...
(fact
 ...
 (!.js (xt/x:str-index-of "hello/world" "/" 0))
 =>
 6)
...
(fact
 "gets a substring"
 (!.js (xt/x:str-substring "hello/world" 3 8))
 =>
 "llo/wo")
...
(fact
 "maps an array"
 (!.js (xt/x:arr-map [1 2 3] (fn [e] (return (* e 2)))))
 =>
 [2 4 6])
...
(fact
 "filters an array"
 (!.js (xt/x:arr-filter [1 2 3 4] (fn [e] (return (xt/x:even? e)))))
 =>
 [2 4])

^{:refer xt.lang.spec-base/x:arr-keep, :added "4.1"}
(fact
...
(fact
 ...
 (!.js (xt/x:is-function? (fn [x] (return x))))
 =>
 true)
...
(defn-
 common-spec-publics
 []
 (->> (ns-publics 'xt.lang.spec-base) keys sort vec))
...
(fact
 ...
 (let
  ...
  (mapv
   (fn* [p1__12379#] (boolean (re-find (re-pattern p1__12379#) text)))
...
(fact
 ...
 (!.js (var out {:a 1, :b 2}) (xt/x:del (. out ["a"])) out)
 =>
 {"b" 2})
...
(fact
 ...
 (!.js (var obj {:id 1}) (xt/x:lu-eq obj obj))
 =>
 true)
...
(fact "computes absolute values" (!.js (xt/x:m-abs -3)) => 3)

^{:refer xt.lang.spec-base/x:m-acos, :added "4.1"}
(fact "computes inverse cosine" (!.js (xt/x:m-acos 1)) => (approx 0))

^{:refer xt.lang.spec-base/x:m-asin, :added "4.1"}
(fact "computes inverse sine" (!.js (xt/x:m-asin 0)) => (approx 0))

^{:refer xt.lang.spec-base/x:m-atan, :added "4.1"}
(fact "computes inverse tangent" (!.js (xt/x:m-atan 0)) => (approx 0))

^{:refer xt.lang.spec-base/x:m-ceil, :added "4.1"}
(fact "rounds numbers upward" (!.js (xt/x:m-ceil 1.2)) => 2)

^{:refer xt.lang.spec-base/x:m-cos, :added "4.1"}
(fact "computes cosine" (!.js (xt/x:m-cos 0)) => (approx 1))

^{:refer xt.lang.spec-base/x:m-cosh, :added "4.1"}
(fact "computes hyperbolic cosine" (!.js (xt/x:m-cosh 0)) => (approx 1))
...
(fact "rounds numbers downward" (!.js (xt/x:m-floor 1.8)) => 1)
...
(fact "computes the maximum value" (!.js (xt/x:m-max 3 5)) => 5)

^{:refer xt.lang.spec-base/x:m-mod, :added "4.1"}
(fact "computes modulo values" (!.js (xt/x:m-mod 10 3)) => 1)

^{:refer xt.lang.spec-base/x:m-min, :added "4.1"}
(fact "computes the minimum value" (!.js (xt/x:m-min 3 5)) => 3)

^{:refer xt.lang.spec-base/x:m-pow, :added "4.1"}
(fact "raises numbers to a power" (!.js (xt/x:m-pow 2 4)) => 16)

^{:refer xt.lang.spec-base/x:m-quot, :added "4.1"}
(fact "computes integer quotients" (!.js (xt/x:m-quot 7 2)) => 3)

^{:refer xt.lang.spec-base/x:m-sin, :added "4.1"}
(fact "computes sine" (!.js (xt/x:m-sin 0)) => (approx 0))

^{:refer xt.lang.spec-base/x:m-sinh, :added "4.1"}
(fact "computes hyperbolic sine" (!.js (xt/x:m-sinh 0)) => (approx 0))

^{:refer xt.lang.spec-base/x:m-sqrt, :added "4.1"}
(fact "computes square roots" (!.js (xt/x:m-sqrt 9)) => (approx 3))

^{:refer xt.lang.spec-base/x:m-tan, :added "4.1"}
(fact "computes tangent" (!.js (xt/x:m-tan 0)) => (approx 0))
...
(fact
 ...
 (!.js (var out {:a 1, :b 2}) (xt/x:del-key out "a") out)
 =>
 {"b" 2})
...
^{:refer xt.lang.spec-base/x:str-format, :added "4.1"}
(fact
...
(fact
 ...
 (!.js (xt/x:arr-every [2 4 6] (fn [e] (return (xt/x:even? e)))))
 =>
 true)
...
(fact
 ...
 (!.js (xt/x:arr-some [1 3 4] (fn [e] (return (xt/x:even? e)))))
 =>
 true)
...
(fact
 ...
 (!.js (xt/x:arr-foldl [1 2 3] (fn [out e] (return (+ out e))) 0))
 =>
 6)
...
(fact "computes bitwise and" (!.js (xt/x:bit-and 6 3)) => 2)

^{:refer xt.lang.spec-base/x:bit-or, :added "4.1"}
(fact "computes bitwise or" (!.js (xt/x:bit-or 6 3)) => 7)

^{:refer xt.lang.spec-base/x:bit-lshift, :added "4.1"}
(fact "computes bitwise left shifts" (!.js (xt/x:bit-lshift 3 2)) => 12)
...
(fact "computes bitwise xor" (!.js (xt/x:bit-xor 6 3)) => 5)
...
^{:refer xt.lang.spec-base/x:debug-client-basic, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:debug-client-ws, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:server-basic, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:server-ws, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:socket-connect, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:socket-send, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:socket-close, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:ws-connect, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:ws-send, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:ws-close, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:notify-http, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:notify-socket, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:thread-join, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:with-delay, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:start-interval, :added "4.1"}
(fact
...
^{:refer xt.lang.spec-base/x:stop-interval, :added "4.1"}
(fact

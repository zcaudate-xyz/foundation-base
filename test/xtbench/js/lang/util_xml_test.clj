...
(fact
 "to node to tree"
 ^{:hidden true}
 (!.js (xml/to-tree (xml/parse-xml "<a/>")))
 =>
 ["a"]
 (!.js (xml/to-tree (xml/parse-xml "<a>1</a>")))
 =>
 ["a" "1"]
 (!.js (xml/to-tree (xml/parse-xml "<a><b></b></a>")))
 =>
 ["a" ["b"]]
 (!.js (xml/to-tree (xml/parse-xml "<a>1<b>2</b>3</a>")))
 =>
 ["a" "1" ["b" "2"] "3"]
 (!.js
  (xml/to-tree
...
(fact
 "to node params"
 ^{:hidden true}
 (!.js (xml/to-string-params (tab [:a 1])))
 =>
 " a=1")
...
(fact
 "node to string"
 ^{:hidden true}
 (!.js (xml/to-string {"tag" "helo:test", "params" {}, "children" []}))
 =>
 "<helo:test></helo:test>"
 (!.js
  (xml/to-string
 ...
 (!.js (xml/to-string (xml/from-tree ["B"])))
 =>
 "<B></B>"
 (!.js
  (xml/to-string

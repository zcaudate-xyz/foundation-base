...
(fact
 ...
 ^{:hidden true}
 (!.js (var rows {}) (data/merge-bulk rows (@! +full-core+) nil))
 =>
 map?
 (!.js (var rows {}) (data/merge-bulk rows (@! +full-contact+) nil))
 =>
 map?
 (!.js (var rows {}) (data/merge-bulk rows (@! +full-org-notify+) nil))
 =>
 map?
 (!.js (var rows {}) (data/merge-bulk rows (@! +full-wallets+) nil))
 =>
 map?
 (!.js (var rows {}) (data/merge-bulk rows (@! +full-no-wallets+) nil))
 =>
 map?)
...
(fact
 ...
 ^{:hidden true}
 (!.js (var rows {}) (data/merge-bulk rows (@! +flattened-full+) nil))
 =>
 map?
 (!.js
  (var rows {})

...
(fact:global
 {:setup [(l/rt:restart) (do (l/rt:scaffold :js) true)],
  :teardown [(l/rt:stop)]})
...
(fact
 ...
 ^{:hidden true}
 (!.js (v/tree-control-array {:limit 20, :order-by ["name"]}))
 =>
 +out+)
...
(fact
 ...
 ^{:hidden true}
 (!.js (v/tree-count sample/Schema (@! +count+) {} {}))
 =>
 +tree+)

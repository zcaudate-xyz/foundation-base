(ns xtbench.ruby.lang.common-string-test
  (:use code.test)
...
(fact "splits a long string"
  ...
  (!.rb (xts/split-long nil 10))
  => (any [] {})

  (!.rb (xts/split-long "" 10))
  => (any [] {})

  (!.rb (xts/split-long (@! +s+) 10))
  => +out+)
...
(fact "gets the string description for a given tag"
  ...
  (!.rb (xts/tag-string "user.account/login"))
  => "account login")

...
(l/script-
 :lua
 {:runtime :basic, :require [[xt.lang.common-lib :as k]]})
...
(fact
 ...
 (!.lua [(k/type-native "hello") (k/type-native 1)])
 =>
 ["string" "number"])

^{:refer xt.lang.common-lib/type-class, :added "4.1"}
(fact "compiles the type-class helper" (!.lua true) => true)

^{:refer xt.lang.common-lib/to-string, :added "4.1"}
(fact "converts a value to a string" (!.lua (k/to-string 42)) => "42")

^{:refer xt.lang.common-lib/to-number, :added "4.1"}
(fact
 "converts a string to a number"
 (!.lua (k/to-number "42.5"))
 =>
 42.5)
...
(fact
 ...
 (!.lua [(k/is-boolean? true) (k/is-boolean? 1)])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/is-integer? 4) (k/is-integer? 4.5)])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/is-number? 4) (k/is-number? "4")])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/is-string? "hello") (k/is-string? 1)])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/is-function? (fn:> [x] x)) (k/is-function? 1)])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/is-array? [1 2 3]) (k/is-array? {:a 1})])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/is-object? {:a 1}) (k/is-object? [1 2 3])])
 =>
 [true false])
...
(fact
 ...
 (!.lua
  (var
   mt
   (k/proto-create {:hello (fn:> [v] (. v world)), :world "hello"}))
  (var a {})
...
(fact
 ...
 (!.lua (var _ (fn [obj] (k/proto-tostring obj))) true)
 =>
 true)

^{:refer xt.lang.common-lib/noop, :added "4.1"}
(fact "returns nil" (!.lua (k/noop)) => nil)

^{:refer xt.lang.common-lib/identity, :added "4.1"}
(fact "returns the input value" (!.lua (k/identity 1)) => 1)

^{:refer xt.lang.common-lib/T, :added "4.1"}
(fact "always returns true" (!.lua (k/T "anything")) => true)

^{:refer xt.lang.common-lib/F, :added "4.1"}
(fact "always returns false" (!.lua (k/F "anything")) => false)

^{:refer xt.lang.common-lib/add, :added "4.1"}
(fact "adds two numbers" (!.lua (k/add 1 2)) => 3)

^{:refer xt.lang.common-lib/sub, :added "4.1"}
(fact "subtracts two numbers" (!.lua (k/sub 5 3)) => 2)

^{:refer xt.lang.common-lib/mul, :added "4.1"}
(fact "multiplies two numbers" (!.lua (k/mul 3 4)) => 12)

^{:refer xt.lang.common-lib/div, :added "4.1"}
(fact "divides two numbers" (!.lua (k/div 10 4)) => 2.5)

^{:refer xt.lang.common-lib/gt, :added "4.1"}
(fact
 "checks whether the first number is greater"
 (!.lua [(k/gt 3 2) (k/gt 2 3)])
 =>
 [true false])
...
(fact
 ...
 (!.lua [(k/gte 3 2) (k/gte 3 3) (k/gte 2 3)])
 =>
 [true true false])
...
(fact
 ...
 (!.lua [(k/lte 2 3) (k/lte 3 3) (k/lte 3 2)])
 =>
 [true true false])

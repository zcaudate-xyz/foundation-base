(ns xtbench.lua.lang.common-lib-test
...
(fact "creates the prototype map" (!.lua (var mt (k/proto-create {:hello (fn:> [v] (. v world)) :world "hello"})) (var a {}) (k/proto-set a mt nil) (. a (hello))) => "hello")

(fact "gets the prototype map from an object" (!.lua (var mt (k/proto-create {:world "hello"})) (var a {}) (k/proto-set a mt nil) (== (k/proto-get a nil) mt)) => true)

(fact "sets the prototype map onto an object" (!.lua (var mt (k/proto-create {:hello (fn:> [v] (. v world)) :world "hello"})) (var a {}) (k/proto-set a mt nil) (. a (hello))) => "hello")

(fact "compiles the runtime tostring helper" (!.lua (var _ (fn [obj] (k/proto-tostring obj))) true) => true)

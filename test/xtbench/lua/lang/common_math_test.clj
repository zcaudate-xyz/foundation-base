(ns
 xtbench.lua.lang.common-math-test
 (:use code.test)
...
(fact
 "returns the cosine"
 (!.lua [(xtm/cos 0) (xtm/cos 3.1415926535898)])
 =>
...
(fact
 ...
 (!.lua [(xtm/floor 1.8) (xtm/floor -1.2)])
 =>
 [1 -2])
...
(fact
 ...
 (!.lua [(xtm/log10 1) (xtm/log10 1000)])
 =>
...
(fact
 ...
 (!.lua [(xtm/max 3 7) (xtm/max 3 7 5 1)])
 =>
 [7 7])
...
(fact
 ...
 (!.lua [(xtm/min 3 7) (xtm/min 3 7 5 1)])
 =>
 [3 1])
...
(fact
 "returns the sine"
 (!.lua [(xtm/sin 0) (xtm/sin 1.5707963267949)])
 =>
...
(fact
 "returns the tangent"
 (!.lua [(xtm/tan 0) (xtm/tan 0.78539816339745)])
 =>
 (contains [(approx 0) (approx 1)]))
...
(fact
 ...
 (!.lua [(xtm/mod-pos -1 5) (xtm/mod-pos 6 5)])
 =>
 [4 1])
...
(fact
 ...
 (!.lua [(xtm/gcd 54 24) (xtm/gcd 10 0)])
 =>
 [6 10])
...
(fact
 ...
 (!.lua [(xtm/mix 0 10 0.5) (xtm/mix 10 20 0.25)])
 =>
 [5 12.5])
...
(fact
 ...
 (!.lua [(xtm/sign -10) (xtm/sign 0) (xtm/sign 10)])
 =>
 [-1 0 1])
...
(fact
 ...
 (!.lua [(xtm/round 1.2) (xtm/round 1.7) (xtm/round 2.5)])
 =>
 [1 2 3])
...
(fact
 ...
 (!.lua [(xtm/clamp 0 10 -3) (xtm/clamp 0 10 7) (xtm/clamp 0 10 12)])
 =>
 [0 7 10])

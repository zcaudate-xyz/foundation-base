...
(fact "memoize for functions of single argument" (!.lua (var state {"n" 0}) (var f (xtd/memoize-key (fn [x] (do (xtd/set-pair-step state "n" (+ 1 (xt/x:get-key state "n" 0))) (return (* x 10)))))) [(f 2) (f 2) (f 3) (xt/x:get-key state "n")]) => [20 20 30 2])

(ns xtbench.scheme.lang.common-string-test
  (:use code.test)
...
(fact "splits a long string"
  ...
  (!.scheme (xts/split-long nil 10))
  => (any [] {})

  (!.scheme (xts/split-long "" 10))
  => (any [] {})

  (!.scheme (xts/split-long (@! +s+) 10))
  => +out+)
...
(fact "gets the string description for a given tag"
  ...
  (!.scheme (xts/tag-string "user.account/login"))
  => "account login")

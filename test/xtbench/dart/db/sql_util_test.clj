...
(fact
 ...
 ^{:hidden true}
 (!.dt (ut/sqlite-json-values "'[1,2,3,4]'"))
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.dt [(ut/encode-bool true) (ut/encode-bool false)])
 =>
 ["TRUE" "FALSE"])
...
(fact
 ...
 ^{:hidden true}
 (!.dt [(ut/encode-number 100000000000)])
 =>
 ["'100000000000'"])
...
(fact
 ...
 ^{:hidden true}
 (!.dt (ut/default-table-fn "hello" {:hello {:schema "test.schema"}}))
 =>
 "\"test.schema\".\"hello\"")
...
(fact
 ...
 ^{:hidden true}
 (!.dt (ut/postgres-wrapper-fn "SELECT * FROM <TABLE>" 2))
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.dt [(ut/sqlite-to-boolean 0) (ut/sqlite-to-boolean 1)])
 =>
 [false true])

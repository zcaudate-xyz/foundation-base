(ns
 xtbench.dart.db.base-schema-test
...
(fact
 "list tables"
 ^{:hidden true}
 (def +tables+ (!.dt (sch/list-tables sample/Schema)))
 (!.dt (sch/list-tables sample/Schema))
 =>
 +tables+)
...
(fact
 "creates data keys"
 ^{:hidden true}
 (!.dt (sch/create-data-keys sample/Schema "Currency"))
 =>
 ["id"
  "type"
  "symbol"
...
(fact
 "creates rev keys"
 ^{:hidden true}
 (set (!.dt (sch/create-rev-keys sample/Schema "UserAccount")))
 =>
 #{"organisations"
   "profile"
   "privileges"
...
(fact
 "creates all keys"
 ^{:hidden true}
 (!.dt (sch/create-all-keys sample/Schema "Wallet"))
 =>
 +all-wallet+)
...
(fact
 ...
 ^{:hidden true}
 (!.dt (sch/create-table-order sample/SchemaLookup))
 =>
 +ordered+)
...
(fact
 ...
 ^{:hidden true}
 (!.dt (sch/table-order sample/SchemaLookup))
 =>
 +ordered+)

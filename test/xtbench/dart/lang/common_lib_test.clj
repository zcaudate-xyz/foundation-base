(ns xtbench.dart.lang.common-lib-test (:require [std.lang :as l]) (:use code.test))

(l/script- :dart {:runtime :twostep, :require [[xt.lang.common-lib :as k]]})
...
(fact "converts a string to a number" (!.dt (k/to-number "42.5")) => 42.5)

^{:refer xt.lang.common-lib/nil?, :added "4.1"}
(fact "checks whether a value is nil" (!.dt [(k/nil? nil) (k/nil? 0)]) => [true false])

^{:refer xt.lang.common-lib/not-nil?, :added "4.1"}
(fact "checks whether a value is not nil" (!.dt [(k/not-nil? nil) (k/not-nil? 0)]) => [false true])
...
(fact "checks if a value is numeric" (!.dt [(k/is-number? 4) (k/is-number? "4")]) => [true false])
...
^{:refer xt.lang.common-lib/noop, :added "4.1"} (fact "returns nil" (!.dt (k/noop)) => nil)
...
^{:refer xt.lang.common-lib/add, :added "4.1"} (fact "adds two numbers" (!.dt (k/add 1 2)) => 3)
...
(fact "checks whether the first number is greater" (!.dt [(k/gt 3 2) (k/gt 2 3)]) => [true false])

^{:refer xt.lang.common-lib/lt, :added "4.1"}
(fact "checks whether the first number is smaller" (!.dt [(k/lt 2 3) (k/lt 3 2)]) => [true false])
...
(fact "checks numeric equality" (!.dt [(k/eq 3 3) (k/eq 3 2)]) => [true false])

^{:refer xt.lang.common-lib/neq, :added "4.1"}
(fact "checks numeric inequality" (!.dt [(k/neq 3 3) (k/neq 3 2)]) => [false true])

^{:refer xt.lang.common-lib/neg, :added "4.1"}
(fact "returns the negated number" (!.dt (k/neg 3)) => -3)

^{:refer xt.lang.common-lib/inc, :added "4.1"} (fact "increments a number" (!.dt (k/inc 1)) => 2)

^{:refer xt.lang.common-lib/dec, :added "4.1"} (fact "decrements a number" (!.dt (k/dec 1)) => 0)

^{:refer xt.lang.common-lib/zero?, :added "4.1"}
(fact "checks whether a number is zero" (!.dt [(k/zero? 0) (k/zero? 1)]) => [true false])

^{:refer xt.lang.common-lib/pos?, :added "4.1"}
(fact "checks whether a number is positive" (!.dt [(k/pos? 1) (k/pos? -1)]) => [true false])

^{:refer xt.lang.common-lib/neg?, :added "4.1"}
(fact "checks whether a number is negative" (!.dt [(k/neg? -1) (k/neg? 1)]) => [true false])

^{:refer xt.lang.common-lib/even?, :added "4.1"}
(fact "checks whether a number is even" (!.dt [(k/even? 2) (k/even? 3)]) => [true false])

^{:refer xt.lang.common-lib/odd?, :added "4.1"}
(fact "checks whether a number is odd" (!.dt [(k/odd? 2) (k/odd? 3)]) => [false true])

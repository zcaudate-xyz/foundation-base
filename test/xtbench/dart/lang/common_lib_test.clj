...
(fact "gets the prototype map from an object" (!.dt (var mt (k/proto-create {:world "hello"})) (var a {}) (k/proto-set a mt nil) (== (k/proto-get a nil) mt)) => true)

(fact "compiles the runtime tostring helper" (!.dt (var _ (fn [obj] (k/proto-tostring obj))) true) => true)

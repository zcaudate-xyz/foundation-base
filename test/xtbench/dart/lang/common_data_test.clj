(ns xtbench.dart.lang.common-data-test
...
(fact "constructs a lookup given keys"
  ...
  (!.dt (xtd/obj-keys (xtd/arr-lookup ["a" "b"])))
...
(fact "gets nested keys"
  ...
  (!.dt (xtd/obj-keys-nested {:a {:b 1, :c 2}} []))
  => (just [[["a" "b"] 1]
            [["a" "c"] 2]]
           :in-any-order))

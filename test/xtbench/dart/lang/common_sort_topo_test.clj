(ns
 xtbench.dart.lang.common-sort-topo-test
 (:require [std.lang :as l])
 (:use code.test))

(l/script-
 :dart
 {:runtime :twostep, :require [[xt.lang.common-sort-topo :as topo]]})
...
(fact
 ...
 (!.dt (var out {}) (topo/sort-edges-build out ["a" "b"]) out)
 =>
...
(fact
 ...
 (!.dt (topo/sort-edges [["a" "b"] ["b" "c"] ["c" "d"] ["d" "e"]]))
 =>
 ["a" "b" "c" "d" "e"])

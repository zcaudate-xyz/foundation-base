(ns
 xtbench.python.db.sql-util-test
...
(fact
 ...
 ^{:hidden true}
 (!.py (ut/sqlite-json-values "'[1,2,3,4]'"))
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.py [(ut/encode-bool true) (ut/encode-bool false)])
 =>
 ["TRUE" "FALSE"])
...
(fact
 ...
 ^{:hidden true}
 (!.py [(ut/encode-number 100000000000)])
 =>
 ["'100000000000'"])
...
(fact
 ...
 ^{:hidden true}
 (!.py (xt/x:json-encode 100000000000000000))
 (!.py (xt/x:json-encode 100000000000000000))
 (!.py (string.format "%0.f" 100000000000000000))
 (!.py
  [(ut/encode-value nil)
...
(fact
 ...
 ^{:hidden true}
 (!.py (ut/default-table-fn "hello" {:hello {:schema "test.schema"}}))
 =>
 "\"test.schema\".\"hello\"")
...
(fact
 ...
 ^{:hidden true}
 (!.py (ut/postgres-wrapper-fn "SELECT * FROM <TABLE>" 2))
 =>
...
(fact
 ...
 ^{:hidden true}
 (!.py [(ut/sqlite-to-boolean 0) (ut/sqlite-to-boolean 1)])
 =>
 [false true])

(ns
 xtbench.python.db.cache-util-test
...
(fact
 ...
 ^{:hidden true}
 (!.py (var rows {}) (data/merge-bulk rows (@! +full-core+) nil))
 =>
 map?
 (!.py (var rows {}) (data/merge-bulk rows (@! +full-contact+) nil))
 =>
 map?
 (!.py (var rows {}) (data/merge-bulk rows (@! +full-org-notify+) nil))
 =>
 map?
 (!.py (var rows {}) (data/merge-bulk rows (@! +full-wallets+) nil))
 =>
 map?
 (!.py (var rows {}) (data/merge-bulk rows (@! +full-no-wallets+) nil))
 =>
 map?)

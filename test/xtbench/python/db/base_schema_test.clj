(ns
 xtbench.python.db.base-schema-test
...
(fact
 "list tables"
 ^{:hidden true}
 (def +tables+ (!.py (sch/list-tables sample/Schema)))
 (!.py (sch/list-tables sample/Schema))
 =>
 +tables+)
...
(fact
 "creates all keys"
 ^{:hidden true}
 (!.py (sch/create-all-keys sample/Schema "Wallet"))
 =>
 +all-wallet+)
...
(fact
 ...
 ^{:hidden true}
 (!.py (sch/create-table-order sample/SchemaLookup))
 =>
 +ordered+)
...
(fact
 ...
 ^{:hidden true}
 (!.py (sch/table-order sample/SchemaLookup))
 =>
 +ordered+)

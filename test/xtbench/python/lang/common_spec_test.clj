...
(fact
 ...
 (!.py (xt/x:get-idx [10 20 30] (xt/x:offset 0)))
 =>
 10)
...
(fact
 ...
 (!.py (var out [10 20 30]) (xt/x:set-idx out (xt/x:offset 1) 99) out)
 =>
 [10 99 30])
...
(fact
 ...
 (!.py (var out [1 2 3]) (xt/x:arr-push out 4) out)
 =>
 [1 2 3 4])
...
(fact
 ...
 (!.py (var out [1 2 3 4]) (xt/x:arr-pop out))
 =>
 4)
...
(fact
 ...
 (!.py (var out [1 2 3]) (xt/x:arr-push-first out 0) out)
 =>
 [0 1 2 3])
...
(fact
 ...
 (!.py (var out [0 1 2 3]) (xt/x:arr-pop-first out))
 =>
 0)
...
(fact
 ...
 (!.py (var out [1 2 3]) (xt/x:arr-insert out (xt/x:offset 1) 9) out)
 =>
 [1 9 2 3])
...
(fact
 ...
 (!.py (xt/x:arr-slice [1 2 3] (xt/x:offset 0) (xt/x:offset 1)))
 =>
 [1])

^{:refer xt.lang.common-spec/x:arr-reverse, :added "4.1"}
(fact "reverses an array" (!.py (xt/x:arr-reverse [1 2 3])) => [3 2 1])
...
(fact "gets the collection length" (!.py (xt/x:len [1 2 3])) => 3)
...
(fact
 ...
 (!.py (xt/x:obj-from-pairs [["a" 1] ["b" 2]]))
 =>
 {"a" 1, "b" 2})
...
(fact
 ...
 (!.py (xt/x:str-index-of "hello/world" "/" 0))
 =>
 5)
...
(fact
 "gets a substring"
 (!.py (xt/x:str-substring "hello/world" 3 8))
 =>
 "lo/wo")
...
(fact
 "filters an array"
 (!.py (xt/x:arr-filter [1 2 3 4] (fn [e] (return (xt/x:even? e)))))
 =>
 [2 4])
...
(fact "uses the grammar base offset" (!.py (xt/x:offset 10)) => 10)
...
(fact "uses the length grammar offset" (!.py (xt/x:offset-len 10)) => 9)
...
(fact
 ...
 (!.py (var obj {:id 1}) (xt/x:lu-eq obj obj))
 =>
 true)
...
(fact
 ...
 (!.py (xt/x:arr-foldl [1 2 3] (fn [out e] (return (+ out e))) 0))
 =>
 6)

...
(fact
 ...
 (!.py (var lu (xtd/lu-create)) (xtd/lu-get lu "missing"))
 =>
 nil)
...
(fact "first" (!.py (xtd/first [1 2 3])) => 1)
...
(fact
 ...
 (!.py [(xtd/nth [1 2 3] 0) (xtd/nth [1 2 3] 2)])
 =>
 [1 3])
...
(fact
 ...
 (!.py [(xtd/arrayify 1) (xtd/arrayify [1])])
 =>
 [[1] [1]])

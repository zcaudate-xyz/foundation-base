(ns rt.postgres.runtime.client-impl-test
  (:require [lib.jdbc :as jdbc]
            [lib.postgres :as base]
            [lib.postgres.connection :as conn]
            [rt.postgres.runtime.client :as client]
...
^{:refer rt.postgres.runtime.client-impl/raw-eval-pg-return :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/raw-eval-pg :added "4.0"
...
^{:refer rt.postgres.runtime.client-impl/init-ptr-pg :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"
                                         :mode :dev}))]
  :teardown (component/stop -pg-)}
...
^{:refer rt.postgres.runtime.client-impl/prepend-select-check-form :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/prepend-select-check :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg-single :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}
(fact "invokes single "
  ^:hidden
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg-transform-let-fn :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg-transform-try-fn :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg-transform-prep :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg-transform :added "4.0"}
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg-block :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}
...
^{:refer rt.postgres.runtime.client-impl/invoke-ptr-pg :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}

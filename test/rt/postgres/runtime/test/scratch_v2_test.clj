(ns rt.postgres.test.scratch-v2-test
  (:require [rt.postgres.base.typed.typed-parse :as parse]
            [rt.postgres.test.scratch-v2 :refer :all])
  (:use code.test))
...
^{:refer rt.postgres.test.scratch-v2/as-array :added "4.1"}
...
^{:refer rt.postgres.test.scratch-v2/TaskCache :added "4.1"}
...
^{:refer rt.postgres.test.scratch-v2/Task :added "4.1"}
...
^{:refer rt.postgres.test.scratch-v2/Entry :added "4.1"}
...
^{:refer rt.postgres.test.scratch-v2/insert-entry :added "4.1"}

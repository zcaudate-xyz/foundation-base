(ns rt.postgres.runtime.client-test
...
^{:refer rt.postgres.runtime.client/setup-module :adopt true :added "4.0"}
(fact "creates a postgres runtime"
  ;; Only checking function existance/stub as we mock everything
  )

^{:refer rt.postgres.runtime.client/rt-postgres:create :added "4.0"}
(fact "creates a postgres runtime"
  (client/rt-postgres:create {})
  => map?)

^{:refer rt.postgres.runtime.client/rt-postgres :added "4.0"}
(fact "creates and startn a postgres runtime"
  (with-redefs [base/start-pg (fn [pg] (assoc pg :started true))]
    (client/rt-postgres {}))
  => (contains {:started true}))

^{:refer rt.postgres.runtime.client/rt-add-notify :added "4.0"}
...
^{:refer rt.postgres.runtime.client/rt-remove-notify :added "4.0"}
...
^{:refer rt.postgres.runtime.client/rt-list-notify :added "4.0"}
...
^{:refer rt.postgres.runtime.client/rt-pg-string :added "4.1"}

(ns rt.postgres.entity-v1-test
  (:require [rt.postgres.entity-v1 :refer :all]
...
^{:refer rt.postgres.entity-v1/E-check-input :added "4.1"}
(fact "checks E input"
...
^{:refer rt.postgres.entity-v1/E-entity-class-fields :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-addon-columns-single :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-addon-columns-match :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-addon-columns :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-class-link-columns :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-class-columns :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-class-merge :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-main-track :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-main :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E-main-spec :added "4.1"}
...
^{:refer rt.postgres.entity-v1/E :added "4.1"}

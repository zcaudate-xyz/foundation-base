(ns rt.postgres.base.compile.server-api-test
  (:require [rt.postgres.base.compile-test :as fixtures]
            [rt.postgres.base.compile.server-api :refer :all]
            [rt.postgres.base.compile.server-db :as server-db])
  (:use code.test))

(fixtures/ensure-fixtures!)

^{:refer rt.postgres.base.compile.server-api/xtalk-contract-input :added "4.1"}
...
^{:refer rt.postgres.base.compile.server-api/target-entry :added "4.1"}
...
^{:refer rt.postgres.base.compile.server-api/emit-target :added "4.1"}
...
^{:refer rt.postgres.base.compile.server-api/emit-targets :added "4.1"}
...
^{:refer rt.postgres.base.compile.server-api/list-targets :added "4.1"}

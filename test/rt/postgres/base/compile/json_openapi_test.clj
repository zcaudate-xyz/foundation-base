(ns rt.postgres.base.compile.json-openapi-test
  (:require [rt.postgres.base.compile.json-openapi :as compile.openapi]
            [rt.postgres.base.typed.typed-common :as types]
            [rt.postgres.base.typed.typed-parse :as parse]
            [rt.postgres.base.typed.typed-common-test]
            [rt.postgres.test.scratch-v2])
  (:use code.test))

^{:refer rt.postgres.base.compile.json-openapi/shape->openapi :added "0.1"}
...
^{:refer rt.postgres.base.compile.json-openapi/fn->openapi :added "0.1"}
...
^{:refer rt.postgres.base.compile.json-openapi/generate-openapi :added "0.1"}
(fact "generate-openapi creates full OpenAPI spec from namespace"
  (let [spec (compile.openapi/generate-openapi 'rt.postgres.base.typed.typed-common-test (constantly true))]
    (contains? spec :openapi) => true
    (contains? spec :paths) => true
    (contains? spec :components) => true))

^{:refer rt.postgres.base.compile.json-openapi/generate-openapi :added "0.1"}
(fact "generate-openapi generates correct OpenAPI spec for rt.postgres.test.scratch-v2"
...
^{:refer rt.postgres.base.compile.json-openapi/field->openapi :added "4.1"}
...
^{:refer rt.postgres.base.compile.json-openapi/arg->openapi :added "4.1"}

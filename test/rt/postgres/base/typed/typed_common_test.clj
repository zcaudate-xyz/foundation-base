(ns rt.postgres.base.typed.typed-common-test
  (:use code.test)
  (:require [rt.postgres.base.typed.typed-common :as types]))

^{:refer rt.postgres.base.typed.typed-common/normalize-key :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/emitted-key :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/typescript-key :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/type-ref? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/table-def? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/enum-def? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/fn-def? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/jsonb-shape? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/jsonb-path? :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/jsonb-merge? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/jsonb-array? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/type-union? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/binding-context? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/primitive? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/table? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/enum? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/ref? :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/valid-key? :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/register-type! :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/get-type :added "0.1"}
(fact "get-type returns nil for non-existent types"
  (types/clear-registry!)
  (types/get-type 'NonExistentType) => nil)

^{:refer rt.postgres.base.typed.typed-common/clear-registry! :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/type-key :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/empty-typed :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/add-typed :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/analysis->typed :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/merge-typed :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-type-ref :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-enum-def :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-column-def :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-table-def :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-fn-def :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-jsonb-shape :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-jsonb-merge :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-jsonb-array :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-type-union :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-jsonb-path :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-jsonb-inference :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/make-context :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/push-scope :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/pop-scope :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/add-binding :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/lookup-binding :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/get-var-shape :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/set-var-shape :added "0.1"}
(fact "set-var-shape sets shape for variable"
  (let [shape (types/make-jsonb-shape {"id" :uuid})
        ctx (types/set-var-shape (types/make-context) 'user shape)]
    (get-in ctx [:jsonb-shapes 'user]) => shape))

^{:refer rt.postgres.base.typed.typed-common/get-var-path :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/set-var-path :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/empty-jsonb-shape :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/shape-at-path :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-common/add-key :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/get-key-type :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/has-key? :added "0.1"}
(fact "has-key? checks if key exists in shape"
  (let [shape (types/make-jsonb-shape {"id" :uuid "name" :text})]
    (types/has-key? shape "id") => true
    (types/has-key? shape "missing") => false))

^{:refer rt.postgres.base.typed.typed-common/merge-shapes :added "0.1"}
...
^{:refer rt.postgres.base.typed.typed-common/flatten-shape :added "0.1"}

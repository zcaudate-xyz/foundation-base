(ns rt.postgres.base.typed.typed-resolve-test
  (:use code.test)
  (:require [rt.postgres.base.typed.typed-common :as types]
            [rt.postgres.base.typed.typed-resolve :as typed-resolve]))

^{:refer rt.postgres.base.typed.typed-resolve/app-name-from-static :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-resolve/fn-ref->fn-sym :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-resolve/fn-ref->app-name :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-resolve/resolve-called-fn :added "4.1"}
...
^{:refer rt.postgres.base.typed.typed-resolve/resolve-function-def :added "4.1"}

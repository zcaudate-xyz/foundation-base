(ns rt.postgres.base.client-impl-test
...
^{:refer rt.postgres.base.client-impl/raw-eval-pg :added "4.0"
...
^{:refer rt.postgres.base.client-impl/init-ptr-pg :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"
                                         :mode :dev}))]
  :teardown (component/stop -pg-)}
...
^{:refer rt.postgres.base.client-impl/invoke-ptr-pg-single :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}
(fact "invokes single "
  ^:hidden
...
^{:refer rt.postgres.base.client-impl/invoke-ptr-pg-block :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}

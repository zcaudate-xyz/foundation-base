(ns rt.postgres.base.grammar.entity-util-test
  (:require [rt.postgres.base.grammar.entity-util :refer :all])
  (:use code.test))
...
^{:refer rt.postgres.base.grammar.entity-util/default-application :added "4.1"}
(fact "default-application is resolved via the runtime module metadata"
  (with-redefs [default-application (fn [& _] :app/demo)]
    (default-application))
  => :app/demo)

^{:refer rt.postgres.base.grammar.entity-util/default-ns-str :added "4.1"}
(fact "default-ns-str reads the configured app namespace"
  (with-demo-app
    #(default-ns-str :app/demo))
  => "demo.ns")

^{:refer rt.postgres.base.grammar.entity-util/init-default-ns-str :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-id-v1 :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-id-v4 :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-id-text :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-name :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-code :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-image :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-color :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-tags :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-log :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-log-entry :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-detail :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-boolean :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-class :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-ref :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/type-class-ref :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/normalise-ref :added "4.1"}
(fact "normalise-ref preserves symbols"
  (normalise-ref 'demo.core/User)
  => 'demo.core/User)

^{:refer rt.postgres.base.grammar.entity-util/default-fields :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/init-addons :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/get-addon :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/add-addon :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/addons-remove :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/get-tracking :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/get-tracking-columns :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/get-access :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity-util/fill-priority :added "4.1"}

...
^{:refer rt.postgres.base.grammar.meta/has-index :added "4.0"}
(fact "cheks for the existence of an index"
  (has-index "idx" "schema")
  => vector?)

^{:refer rt.postgres.base.grammar.meta/get-extensions :added "4.0"}
(fact "gets import forms"
  (get-extensions {:native {:ext {:seed true}}})
  => '(:ext))

^{:refer rt.postgres.base.grammar.meta/create-extension :added "4.0"}
(fact "makes create extension forms"
  (create-extension :ext)
  => vector?)

^{:refer rt.postgres.base.grammar.meta/drop-extension :added "4.0"}
...
^{:refer rt.postgres.base.grammar.meta/has-schema :added "4.0"}
(fact "checks that schema exists"
  (has-schema "schema")
  => list?)

^{:refer rt.postgres.base.grammar.meta/create-schema :added "4.0"}
(fact "creates a schema"
  (create-schema "schema")
  => vector?)

^{:refer rt.postgres.base.grammar.meta/drop-schema :added "4.0"}
(fact "drops a schema"
  (drop-schema "schema")
  => vector?)

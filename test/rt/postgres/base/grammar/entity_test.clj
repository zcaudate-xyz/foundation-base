(ns rt.postgres.base.grammar.entity-test
  (:use code.test)
  (:require [rt.postgres.base.grammar.entity :as et :refer :all]
...
^{:refer rt.postgres.base.grammar.entity/E-check-input :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-main-spec :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-addon-columns-single :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-class-columns :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-addon-columns :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-class-merge :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-main-track :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-main :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/parse-class :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/basis-for :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/local-support-columns :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/target-support-columns :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/project-support-columns :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/column->coord :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/required-basis-for-plan :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/allowed-target? :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/public-input->basis :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/target-info :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-known-addon-keys :added "4.1"}
(fact "E-known-addon-keys reads the registered application addon set"
  (with-test-entity-v2
    (et/E-known-addon-keys :app) => #{:rev :social :detail}))

^{:refer rt.postgres.base.grammar.entity/E-addon-bool-shorthand :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/basis-kind-for :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/plan-addon-relation :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/plan-entity-relation :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/plan-link-relation :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/coordinate-column :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-basis-compatible? :added "4.1"}
...
^{:refer rt.postgres.base.grammar.entity/E-resolve-basis :added "4.1"}

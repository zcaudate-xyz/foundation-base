(ns rt.postgres.base.grammar.form-deftype-hydrate-test
  (:require [rt.postgres.base.application :as app]
            [rt.postgres.base.grammar.form-deftype-hydrate :refer :all])
  (:use code.test))
...
^{:refer rt.postgres.base.grammar.form-deftype-hydrate/pg-deftype-hydrate-check-link :added "4.1"}
...
^{:refer rt.postgres.base.grammar.form-deftype-hydrate/pg-deftype-hydrate-process-sql :added "4.1"}
...
^{:refer rt.postgres.base.grammar.form-deftype-hydrate/pg-deftype-hydrate-process-ref :added "4.1"}
...
^{:refer rt.postgres.base.grammar.form-deftype-hydrate/pg-deftype-hydrate-process-enum :added "4.1"}
...
^{:refer rt.postgres.base.grammar.form-deftype-hydrate/pg-deftype-hydrate :added "4.1"}
(fact "pg-deftype-hydrate adds schema metadata to the form"
  (with-demo-links
    #(with-redefs [rt.postgres.base.grammar.common/pg-hydrate-module-static
...
^{:refer rt.postgres.base.grammar.form-deftype-hydrate/pg-deftype-hydrate-hook :added "4.1"}

...
^{:refer rt.postgres.base.grammar.common/pg-linked-token :added "4.0"}
...
^{:refer rt.postgres.base.grammar.common/pg-linked :added "4.0"}
...
^{:refer rt.postgres.base.grammar.common/pg-defpublication :added "4.1"}
(fact "defpublication block"
  (common/pg-defpublication '(defpublication pub [:all]))
  => '(do [:drop-publication-if-exists pub]
          [:create-publication pub :for :all :tables]))

^{:refer rt.postgres.base.grammar.common/pg-subscription-format :added "4.1"}
(fact "formats subscription"
  (common/pg-subscription-format '(defsubscription sub [conn pub] {}))
  => vector?)

^{:refer rt.postgres.base.grammar.common/pg-defsubscription :added "4.1"}

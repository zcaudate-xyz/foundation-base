(ns rt.postgres.base.grammar.gen-bind-test
...
^{:refer rt.postgres.base.grammar.gen-bind/transform-query :added "4.0"
...
(fact "lists all apis"
  ...
  => '[[ping rt.postgres.test.scratch-v1/ping]
       [ping-ok rt.postgres.test.scratch-v1/ping-ok]
       [echo rt.postgres.test.scratch-v1/echo]])
...
(fact  "lists all debug apis"
  ...
  => '[[as-array rt.postgres.test.scratch-v1/as-array]
       [as-upper rt.postgres.test.scratch-v1/as-upper]
       [addf rt.postgres.test.scratch-v1/addf]
       [subf rt.postgres.test.scratch-v1/subf]
       [mulf rt.postgres.test.scratch-v1/mulf]
...
(fact "lists all function forms"
  ...
  => '[[as-array rt.postgres.test.scratch-v1/as-array]
       [entry-all rt.postgres.test.scratch-v1/entry-all]
       [entry-by-name rt.postgres.test.scratch-v1/entry-by-name]
       [entry-default rt.postgres.test.scratch-v1/entry-default]
       [as-upper rt.postgres.test.scratch-v1/as-upper]
       [ping rt.postgres.test.scratch-v1/ping]
       [ping-ok rt.postgres.test.scratch-v1/ping-ok]
       [echo rt.postgres.test.scratch-v1/echo]

(ns rt.postgres.base.typed-test
  (:require [rt.postgres.base.typed.typed-common :as types]
            [rt.postgres.base.typed.typed-parse :as parse]
            [rt.postgres.test.scratch-v2 :as scratch]
...
^{:refer rt.postgres.base.typed/analyze-namespace :added "4.1"}
...
^{:refer rt.postgres.base.typed/analyze-and-register! :added "4.1"}
...
^{:refer rt.postgres.base.typed/make-function-report :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-function-report :added "4.1"}
...
^{:refer rt.postgres.base.typed/Type :added "4.1"}
...
^{:refer rt.postgres.base.typed/inferred->shape :added "4.1"}
...
^{:refer rt.postgres.base.typed/format-shape :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-report :added "4.1"}
(fact "get-app-function-report runs infer reporting against an app typed payload"
  (let [typed-payload (types/analysis->typed
    ...
    (with-redefs [rt.postgres.base.application/app-typed (fn [_] typed-payload)]
      (let [report (typed-analysis/get-app-function-report "demo"
                                                  'rt.postgres.test.scratch-v2/insert-entry)]
        (get-in report [:function :name]) => "insert-entry"
        (get-in report [:analysis :mutating]) => true))))

^{:refer rt.postgres.base.typed/get-function-report-json :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-report-json :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-function-def :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-def :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-function-input-shape :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-input-shape :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-function-input-schema :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-input-schema :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-function-output-shape :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-output-shape :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-function-output-schema :added "4.1"}
...
^{:refer rt.postgres.base.typed/get-app-function-output-schema :added "4.1"}
...
^{:refer rt.postgres.base.typed/report-json :added "4.1"}
...
^{:refer rt.postgres.base.typed/make-function-json :added "4.1"}
...
^{:refer rt.postgres.base.typed/make-openapi :added "4.1"}
...
^{:refer rt.postgres.base.typed/make-json-schema :added "4.1"}
...
^{:refer rt.postgres.base.typed/make-typescript :added "4.1"}
...
^{:refer rt.postgres.base.typed/app-name-from-static :added "4.1"}
(fact "app-name-from-static normalizes app metadata"
  (typed-analysis/app-name-from-static ["demo"]) => "demo"
  (typed-analysis/app-name-from-static "demo") => "demo")

^{:refer rt.postgres.base.typed/fn-ref->app-name :added "4.1"}
...
^{:refer rt.postgres.base.typed/arg-type :added "4.1"}
...
^{:refer rt.postgres.base.typed/enrich-function-arg-roles :added "4.1"}
...
^{:refer rt.postgres.base.typed/jsonb-arg? :added "4.1"}
...
^{:refer rt.postgres.base.typed/format-primitive :added "4.1"}
...
^{:refer rt.postgres.base.typed/build-input-schemas :added "4.1"}
...
^{:refer rt.postgres.base.typed/build-output-schema :added "4.1"}
...
(fact "Type uses app typed registry when available"
  ...
  (let [table (types/make-table-def "test" "Foo"
    ...
    (with-redefs [rt.postgres.base.application/app
                  (fn [_] {:dummy true})
                  rt.postgres.base.application/app-typed

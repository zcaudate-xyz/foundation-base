(ns scaffold.supabase.event-host-util-test
...
^{:refer scaffold.supabase.event-host-util/request-event :added "4.1.4"}
...
^{:refer scaffold.supabase.event-host-util/shell-command :added "4.1"}
(fact "joins shell command parts with spaces"
  (event-host-util/shell-command "echo" "hello" "world")
  => "echo hello world")

^{:refer scaffold.supabase.event-host-util/supabase-shell-command :added "4.1"}
(fact "prefixes shell commands with the configured docker compose invocation"
  (event-host-util/supabase-shell-command "up" "-d")
  => "docker-compose -p foundation-base-local --env-file .env -f docker-compose.yml up -d")

^{:refer scaffold.supabase.event-host-util/startup-shell-command :added "4.1"}
(fact "builds a startup script that checks postgres and starts docker compose"
  (let [cmd (event-host-util/startup-shell-command)]
    [(str/includes? cmd "docker-compose -p foundation-base-local --env-file .env -f docker-compose.yml up -d")
     (str/includes? cmd "127.0.0.1")
     (str/includes? cmd "55122")])
  => [true true true])

^{:refer scaffold.supabase.event-host-util/init-live-postgres-runtime! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/pg-rt :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/supabase-status-env :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/parse-shell-env :added "4.1"}
(fact "parses shell env output into a map"
  (event-host-util/parse-shell-env "API_URL=\"http://localhost\"\nSERVICE_ROLE_KEY=abc\n\n")
  => {"API_URL" "http://localhost"
      "SERVICE_ROLE_KEY" "abc"})

^{:refer scaffold.supabase.event-host-util/http-get :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/pg-exec-best-effort! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/sql-literal :added "4.1"}
(fact "quotes sql string literals and escapes apostrophes"
  (event-host-util/sql-literal "it's live")
  => "'it''s live'")

^{:refer scaffold.supabase.event-host-util/ensure-scratch-entry-table! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/grant-scratch-schema! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/enable-scratch-entry-realtime! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/reload-postgrest! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/cleanup-scratch-entry! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/setup-scratch-entry! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/ensure-public-entry-table! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/enable-public-entry-realtime! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/wait-postgrest-schema! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/cleanup-public-entry! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/setup-public-entry! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/send-realtime-broadcast! :added "4.1"}
...
^{:refer scaffold.supabase.event-host-util/send-realtime-request! :added "4.1"}

(ns tahto.typed-test
  ...
  (:use code.test)
  (:require [tahto.typed :refer :all]
            [tahto.typed.xtalk-common :as types]))

^{:refer tahto.typed/namespace-aliases :added "4.1"}
(fact "returns alias to namespace name map"
  (namespace-aliases (find-ns 'tahto.typed-test))
  => '{types tahto.typed.xtalk-common})

^{:refer tahto.typed/register-spec-form! :added "4.1"}
...
^{:refer tahto.typed/defspec.xt :added "4.1"}
(fact "defines a spec via macro"
  (do
    (types/clear-registry!)
    (defspec.xt Item :xt/int)
    (types/type->data (:type (spec-def (load-registry) 'tahto.typed-test/Item))))
  => '{:kind :primitive :name :xt/int})

^{:refer tahto.typed/load-file :added "4.1"}
(fact "creates an xtalk typed context from a source file"
  (let [ctx (load-file "test/tahto/model/spec_xtalk_typed_fixture.clj")]
    [(:domain ctx)
     (some? (entry ctx 'tahto.model.spec-xtalk-typed-fixture/find-user))])
  => [:xtalk true])

^{:refer tahto.typed/load-ns :added "4.1"}
(fact "creates an xtalk typed context from a namespace"
  (let [ctx (load-ns 'tahto.model.spec-xtalk-typed-fixture)]
    [(:domain ctx)
     (some? (entry ctx 'tahto.model.spec-xtalk-typed-fixture/find-user))
     (pos? (count (entries ctx)))])
  => [:xtalk true true])

^{:refer tahto.typed/spec-def :added "4.1"}
(fact "returns declarations from an xtalk context"
  (let [ctx (load-ns 'tahto.model.spec-xtalk-typed-fixture)]
    [(:name (spec-def ctx 'tahto.model.spec-xtalk-typed-fixture/User))
     (:name (function-def ctx 'tahto.model.spec-xtalk-typed-fixture/find-user))
     (nil? (macro-def ctx 'tahto.model.spec-xtalk-typed-fixture/find-user))
     (nil? (value-def ctx 'tahto.model.spec-xtalk-typed-fixture/find-user))])
  => ["User" "find-user" true true])

^{:refer tahto.typed/declaration :added "4.1"}
...
^{:refer tahto.typed/function-report :added "4.1"}
(fact "checks a function through an xtalk typed context"
  (let [report (function-report (load-ns 'tahto.model.spec-xtalk-typed-fixture)
                                'tahto.model.spec-xtalk-typed-fixture/find-user)]
    [(:function report) (:errors report)])
  => '[tahto.model.spec-xtalk-typed-fixture/find-user []])

^{:refer tahto.typed/function-input :added "4.1"}
(fact "returns xtalk function input and output types from context"
  (let [ctx (load-ns 'tahto.model.spec-xtalk-typed-fixture)]
    [(function-input ctx 'tahto.model.spec-xtalk-typed-fixture/find-user 'id)
     (function-output ctx 'tahto.model.spec-xtalk-typed-fixture/find-user)])
  => '[{:kind :primitive :name :xt/str}
       {:kind :maybe :item {:kind :named :name tahto.model.spec-xtalk-typed-fixture/User}}])

^{:refer tahto.typed/namespace-report :added "4.1"}
(fact "checks every function in an xtalk context namespace"
  (let [report (namespace-report (load-ns 'tahto.model.spec-xtalk-typed-fixture))]
    [(:namespace report)
     (some #(= 'tahto.model.spec-xtalk-typed-fixture/find-user (:function %))
           (:functions report))])
  => '[tahto.model.spec-xtalk-typed-fixture true])
...
^{:refer tahto.typed/load-analysis :added "4.1"}
...
^{:refer tahto.typed/load-registry :added "4.1"}
...
^{:refer tahto.typed/with-context-registry :added "4.1"}
...
^{:refer tahto.typed/entries :added "4.1"}
...
^{:refer tahto.typed/entry :added "4.1"}
...
^{:refer tahto.typed/macro-def :added "4.1"}
...
^{:refer tahto.typed/value-def :added "4.1"}
...
^{:refer tahto.typed/function-def :added "4.1"}
...
^{:refer tahto.typed/function-output :added "4.1"}

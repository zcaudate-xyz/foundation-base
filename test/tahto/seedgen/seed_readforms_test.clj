(ns tahto.seedgen.form-parse-test
  (:use code.test)
  (:require [code.project :as project]
            [std.block.base :as block]
            [std.block.navigate :as nav]
            [tahto.seedgen.form-common :as form-common]
            [tahto.seedgen.form-parse :as seed-readforms]))
...
^{:refer tahto.seedgen.form-parse/class-empty :added "4.1"}
(fact "returns an empty classification map"
  (seed-readforms/class-empty) => {:root [] :derived [] :scaffold []})

^{:refer tahto.seedgen.form-parse/class-explicit :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/form-script? :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/class-form :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/class-navs :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/class-merge :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/check-arrow? :added "4.1"}
(fact "recognizes assertion arrow symbols"
  (seed-readforms/check-arrow? '=>) => true
  (seed-readforms/check-arrow? '=>*) => true
  (seed-readforms/check-arrow? '+) => false)

^{:refer tahto.seedgen.form-parse/check-classify :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/fact-classify-meta :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/fact-config-nav :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/global-context :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/entry-enrich :added "4.1"}
...
^{:refer tahto.seedgen.form-parse/seedgen-readforms :added "4.1"}

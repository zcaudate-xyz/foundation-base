(ns tahto.seedgen.common-meta-test
  (:use code.test)
  (:require [tahto.seedgen.common-meta :refer :all]))

^{:refer tahto.seedgen.common-meta/normalize-runtime-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-meta/runtime-lang-config :added "4.1"}
...
^{:refer tahto.seedgen.common-meta/runtime-script-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-meta/runtime-dispatch-symbol :added "4.1"}
...
^{:refer tahto.seedgen.common-meta/runtime-type :added "4.1"}
(fact "returns the runtime type for a language"
  (runtime-type :js) => :basic
  (runtime-type :dart) => :twostep
  (runtime-type :unknown) => nil)

^{:refer tahto.seedgen.common-meta/runtime-check-mode :added "4.1"}
...
^{:refer tahto.seedgen.common-meta/runtime-suite-groups :added "4.1"}
...
^{:refer tahto.seedgen.common-meta/runtime-lang-suffix :added "4.1"}

(ns tahto.seedgen.cli-test
  (:require [tahto.seedgen.cli :as cli])
  (:use code.test))

^{:refer tahto.seedgen.cli/collect-selector :added "4.1"}
...
^{:refer tahto.seedgen.cli/parse-test-args :added "4.1"}
...
^{:refer tahto.seedgen.cli/parse-command-args :added "4.1"}
...
^{:refer tahto.seedgen.cli/seedgen-test :added "4.1"}
...
^{:refer tahto.seedgen.cli/failure-tree :added "4.1"}
...
^{:refer tahto.seedgen.cli/-main :added "4.1"}
(fact "is the CLI entry point"
  (var? #'cli/-main) => true
  (:doc (meta #'cli/-main)) => "main entry point for lein seedgen")

^{:refer tahto.seedgen.cli/seedgen-todos :added "4.1"}

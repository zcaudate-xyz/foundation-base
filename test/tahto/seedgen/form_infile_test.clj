(ns tahto.seedgen.form-infile-test
  (:use code.test)
...
^{:refer tahto.seedgen.form-infile/root-script-meta-langs :added "4.1"}
...
^{:refer tahto.seedgen.form-infile/render-top-level-target :added "4.1"}
(fact "renders a file for a single target language"
  (run-render-target) => [true true true true true true])

^{:refer tahto.seedgen.form-infile/seedgen-langadd :added "4.1" :timeout 300000}
(fact "adds seedgen runtimes back from the seedgen root form"
  ...
  (let [tmp (java.io.File/createTempFile "seedgen-langadd-r" ".clj")
    ...
    (try
      ...
      (finally
        (.delete tmp))))
  => [#{:js :r}
      "(ns sample.add-test\n  (:use code.test)\n  (:require [tahto.core :as l]))\n\n^{:seedgen/root {:all true, :langs [:js :r]}}\n(l/script- :js {:runtime :basic})\n\n(l/script- :r {:runtime :basic})\n\n^{:refer xt.lang.spec-base/example.A :added \"4.1\"}\n(fact \"runtime specific branches\"\n\n  (!.js (+ 1 2 3))\n  => 6\n\n  (!.R (+ 1 2 3))\n  => 6)\n"]
  ...
  (let [tmp (java.io.File/createTempFile "seedgen-langadd-dart" ".clj")
    ...
    (try
      ...
      (finally
        (.delete tmp))))
  => "(ns sample.add-test\n  (:use code.test)\n  (:require [tahto.core :as l]))\n\n^{:seedgen/root {:all true, :langs [:js :dart]}}\n(l/script- :js {:runtime :basic})\n\n(l/script- :dart {:runtime :twostep})\n\n^{:refer xt.lang.spec-base/example.A :added \"4.1\"}\n(fact \"runtime specific branches\"\n\n  (!.js (+ 1 2 3))\n  => 6\n\n  (!.dt (+ 1 2 3))\n  => 6)\n"
...
^{:refer tahto.seedgen.form-infile/seedgen-langremove :added "4.1"}

(ns tahto.seedgen.metrics-test
  (:require [tahto.seedgen.metrics :refer :all])
  (:use code.test))

^{:refer tahto.seedgen.metrics/test-record :added "4.1"}
...
^{:refer tahto.seedgen.metrics/aggregate-records :added "4.1"}
...
^{:refer tahto.seedgen.metrics/update-index :added "4.1"}

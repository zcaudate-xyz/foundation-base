(ns tahto.seedgen.form-common-test
  (:use code.test)
  (:require [std.block.base :as block]
            [std.block.navigate :as nav]
            [tahto.seedgen.form-common :refer :all]))
...
^{:refer tahto.seedgen.form-common/target-normalize-langs :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-meta-block? :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-meta :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-body :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-top-levels :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-entry :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-map-value :added "4.1"}
...
^{:refer tahto.seedgen.form-common/nav-vector-items :added "4.1"}
...
^{:refer tahto.seedgen.form-common/item-sort :added "4.1"}
...
^{:refer tahto.seedgen.form-common/item-classify-langs :added "4.1"}
...
^{:refer tahto.seedgen.form-common/item-runtime-map :added "4.1"}

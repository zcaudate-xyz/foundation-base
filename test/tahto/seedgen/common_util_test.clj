(ns tahto.seedgen.common-util-test
  (:use code.test)
  (:require [clojure.string :as str]
            [tahto.seedgen.common-util :refer :all]
            [std.fs :as fs]))

^{:refer tahto.seedgen.common-util/require-alias :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-script-heads :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-root-langs :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-dispatch-map :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-dispatch-tag-map :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-normalize-runtime-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-dispatch-tag :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-default-runtime :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-dispatch-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-runtime-reference-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-runtime-dispatch-langs :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-form-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-fact-forms :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-base-config :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-lang-config :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-lang-entry :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-root-entry :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-suppressed-langs :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-coverage-langs :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-display-lang :added "4.1"}
...
^{:refer tahto.seedgen.common-util/seedgen-skip? :added "4.1"}

(ns tahto.seedgen.common-infile-test
  (:use code.test)
  (:require [code.project :as project]
            [tahto.seedgen.common-infile :as seed-infile]))

^{:refer tahto.seedgen.common-infile/seedgen-root :added "4.1"}
...
^{:refer tahto.seedgen.common-infile/seedgen-list :added "4.1"}
...
^{:refer tahto.seedgen.common-infile/seedgen-incomplete :added "4.1"}

(ns tahto.seedgen.form-bench-test
  (:use code.test)
  (:require [clojure.string :as str]
            [std.fs :as fs]
            [tahto.seedgen.form-bench :as form-bench]))

^{:refer tahto.seedgen.form-bench/seedgen-benchlist :added "4.1"}
...
^{:refer tahto.seedgen.form-bench/seedgen-benchadd :added "4.1"
...
^{:refer tahto.seedgen.form-bench/seedgen-benchremove :added "4.1"}

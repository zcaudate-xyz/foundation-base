(ns tahto.runtime.solidity-test
...
^{:refer tahto.runtime.solidity/exec-rt-web3 :added "4.0"}
...
^{:refer tahto.runtime.solidity/rt:print :added "4.0"}
...
^{:refer tahto.runtime.solidity/rt:deploy-ptr :added "4.0"}
(fact "deploys a ptr a contract"
  ;; Requires web3
  )

^{:refer tahto.runtime.solidity/rt:deploy :added "4.0"}
(fact "deploys current namespace as contract"
  ;; Requires web3
  )

^{:refer tahto.runtime.solidity/rt:contract :added "4.0"}
(fact "gets the contract"
  ;; Requires web3
  )

^{:refer tahto.runtime.solidity/rt:bytecode-size :added "4.0"}

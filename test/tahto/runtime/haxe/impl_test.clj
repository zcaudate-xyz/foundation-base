(ns tahto.runtime.haxe.impl-test
  (:require [tahto.runtime.haxe.impl :as impl]
...
^{:refer tahto.runtime.haxe.impl/haxe-exec :added "4.1"}
(fact "resolves the haxe executable"
  (impl/haxe-exec)
  => string?)

^{:refer tahto.runtime.haxe.impl/raw-eval-haxe :added "4.1"}
...
^{:refer tahto.runtime.haxe.impl/start-haxe :added "4.1"}
...
^{:refer tahto.runtime.haxe.impl/stop-haxe :added "4.1"}
(fact "stops a haxe runtime without error"
  (let [rt (impl/haxe:create {})]
    (= rt (impl/stop-haxe rt)))
  => true)

^{:refer tahto.runtime.haxe.impl/haxe:create :added "4.1"}
...
^{:refer tahto.runtime.haxe.impl/haxe :added "4.1"}

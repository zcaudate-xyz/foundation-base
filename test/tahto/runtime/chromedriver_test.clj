(ns tahto.runtime.chromedriver-test
  (:use code.test)
  (:require [tahto.runtime.chromedriver :as chromedriver]
             [tahto.core :as l]
             [std.lib :as h]
             [std.lib.env :as env]))
...
^{:refer tahto.runtime.chromedriver-test/browser-eval :added "4.0"}
(fact "chromedriver evaluates !.js expressions"

  (!.js (+ 1 2 3))
  => 6)

^{:refer tahto.runtime.chromedriver/goto :added "4.0"
...
^{:refer tahto.runtime.chromedriver/tab-create :added "4.0"
...
^{:refer tahto.runtime.chromedriver/with-tab :added "4.0"
  :setup [(def +main+
...
^{:refer tahto.runtime.chromedriver/current-tab :added "4.0"
...
^{:refer tahto.runtime.chromedriver/tab-list :added "4.0"
...
^{:refer tahto.runtime.chromedriver/tab-switch :added "4.0"
...
^{:refer tahto.runtime.chromedriver/tab-close :added "4.0"

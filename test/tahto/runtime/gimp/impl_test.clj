(ns tahto.runtime.gimp.impl-test
...
^{:refer tahto.runtime.gimp.impl/gimp-bootstrap :added "4.1"}
...
^{:refer tahto.runtime.gimp.impl/gimp-exec :added "4.1"}
(fact "resolves the gimp executable"
  (impl/gimp-exec)
  => string?)

^{:refer tahto.runtime.gimp.impl/start-gimp :added "4.1"}
...
^{:refer tahto.runtime.gimp.impl/stop-gimp :added "4.1"}
...
^{:refer tahto.runtime.gimp.impl/invoke-ptr-gimp :added "4.1"}
...
^{:refer tahto.runtime.gimp.impl/gimp:create :added "4.1"}

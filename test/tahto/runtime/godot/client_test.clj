(ns tahto.runtime.godot.client-test
  (:require [tahto.core :as h]
            [tahto.core.type-shared :as shared]
            [tahto.runtime.godot.client :as client]
...
^{:refer tahto.runtime.godot.client/client:create :added "4.1"}
...
^{:refer tahto.runtime.godot.client/raw-eval-godot :added "4.1"}
...
^{:refer tahto.runtime.godot.client/invoke-ptr-godot :added "4.1"}
...
^{:refer tahto.runtime.godot.client/godot:create :added "4.1"}
...
^{:refer tahto.runtime.godot.client/godot :added "4.1"}
...
^{:refer tahto.runtime.godot.client/godot-shared:create :added "4.1"}

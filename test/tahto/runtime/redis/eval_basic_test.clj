(ns tahto.runtime.redis.eval-basic-test
  (:require [lib.redis.bench :as bench]
             [lib.redis.script :as script]
             [tahto.runtime.redis.eval-basic :refer :all]
             [tahto.core :as l]
...
^{:refer tahto.runtime.redis.eval-basic/rt-exception :added "4.0"}
...
^{:refer tahto.runtime.redis.eval-basic/redis-raw-eval :added "4.0"}
...
^{:refer tahto.runtime.redis.eval-basic/redis-body-transform :added "4.0"}
...
^{:refer tahto.runtime.redis.eval-basic/redis-invoke-ptr-basic :added "4.0"}

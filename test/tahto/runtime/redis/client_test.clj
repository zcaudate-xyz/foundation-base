(ns tahto.runtime.redis.client-test
  (:require [lib.redis.bench :as bench]
            ...
            [tahto.runtime.redis.eval-basic :as eval-basic]
            [tahto.runtime.redis.eval-script :as eval-script]
...
^{:refer tahto.runtime.redis.client/client-steps :added "3.0"}
(fact "clients steps for start up and shutdown")

^{:refer tahto.runtime.redis.client/client-start :added "4.0"}
(fact "starts the client")

^{:refer tahto.runtime.redis.client/client:create :added "3.0"}
...
^{:refer tahto.runtime.redis.client/client :added "3.0"}
...
^{:refer tahto.runtime.redis.client/test:client :added "3.0"}
...
^{:refer tahto.runtime.redis.client/invoke-ptr-redis :added "4.0"}

(ns tahto.runtime.graal-test
  (:require [tahto.runtime.graal :refer :all]
            [tahto.core :as l]
...
(l/script- :js
  {:runtime :graal
   :require [[xt.lang.common-lib :as k]] :test-mode true})

(fact:global
 {:setup [(l/rt:restart)]
  :teardown [(l/rt:stop)]})

^{:refer tahto.runtime.graal/eval-raw.test :adopt true :added "3.0"}
(fact "EVAL"
...
^{:refer tahto.runtime.graal/add-resource-path :added "3.0"
...
^{:refer tahto.runtime.graal/add-system-path :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer tahto.runtime.graal/make-raw :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer tahto.runtime.graal/close-raw :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
(fact "closes the base graal context"
  (close-raw +js+)
  => nil)

^{:refer tahto.runtime.graal/raw-lang :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer tahto.runtime.graal/eval-raw :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer tahto.runtime.graal/unwrap :added "4.1"}
...
^{:refer tahto.runtime.graal/eval-graal :added "4.0"}
...
^{:refer tahto.runtime.graal/invoke-graal :added "4.0"}
...
^{:refer tahto.runtime.graal/start-graal :added "3.0"}
(fact "starts the graal runtime"
  (start-graal (rt-graal:create {:lang :js}))
  => rt-graal?)

^{:refer tahto.runtime.graal/stop-graal :added "3.0"}
(fact "stops the graal runtime"
  (stop-graal (start-graal (rt-graal:create {:lang :js})))
  => rt-graal?)

^{:refer tahto.runtime.graal/rt-graal:create :added "4.0"}
...
^{:refer tahto.runtime.graal/rt-graal :added "3.0"}

(ns tahto.runtime.vscode.impl-test
...
^{:refer tahto.runtime.vscode.impl/vscode-exec :added "4.1"}
...
^{:refer tahto.runtime.vscode.impl/js-eval-wrap :added "4.1"}
...
^{:refer tahto.runtime.vscode.impl/start-vscode :added "4.1" :timeout 60000}
...
^{:refer tahto.runtime.vscode.impl/raw-eval-vscode :added "4.1" :timeout 60000}
...
^{:refer tahto.runtime.vscode.impl/invoke-ptr-vscode :added "4.1" :timeout 60000}
...
^{:refer tahto.runtime.vscode.impl/vscode:create :added "4.1"}
...
^{:refer tahto.runtime.vscode.impl/vscode :added "4.1" :timeout 60000}
...
^{:refer tahto.runtime.vscode.impl/stop-vscode :added "4.1"}
(fact "returns the runtime when stopping"
  (let [rt (impl/vscode:create {})]
    (identical? (impl/stop-vscode rt) rt))
  => true)

^{:refer tahto.runtime.vscode.impl/next-msgid :added "4.1"}
...
^{:refer tahto.runtime.vscode.impl/send-request :added "4.1" :timeout 60000}
...
^{:refer tahto.runtime.vscode.impl/vscode-shared:create :added "4.1"}

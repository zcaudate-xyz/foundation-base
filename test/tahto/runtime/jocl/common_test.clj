(ns tahto.runtime.jocl.common-test
  (:refer-clojure :exclude [to-array])
  (:use code.test)
  (:require [tahto.runtime.jocl :refer :all]
...
^{:refer tahto.runtime.jocl.common/parse-spec :added "3.0"}
...
^{:refer tahto.runtime.jocl.common/entry-spec :added "3.0"}
...
^{:refer tahto.runtime.jocl.common/with-error :added "3.0"}
(fact "helper function for creation within context")

^{:refer tahto.runtime.jocl.common/cl-context :added "3.0"}
(fact "creates a cl context"

  (cl-context)
  => org.jocl.cl_context)

^{:refer tahto.runtime.jocl.common/cl-queue :added "3.0"}
(fact "creates a command queue (within a context)"

  (cl-queue (cl-context) (device:gpu))
  => org.jocl.cl_command_queue)

^{:refer tahto.runtime.jocl.common/cl-program :added "3.0"}
...
^{:refer tahto.runtime.jocl.common/cl-kernel :added "3.0"}

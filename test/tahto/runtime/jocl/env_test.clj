(ns tahto.runtime.jocl.env-test
  (:use code.test)
  (:require [tahto.runtime.jocl.env :refer :all]))

^{:refer tahto.runtime.jocl.env/opencl-available? :added "4.1"}
(fact "returns a boolean indicating OpenCL availability"
  (boolean? (opencl-available?))
  => true)

^{:refer tahto.runtime.jocl.env/cl-field :added "4.1"}
...
^{:refer tahto.runtime.jocl.env/with-stubs :added "4.1"}
...
^{:refer tahto.runtime.jocl.env/with-script-stubs :added "4.1"}
(fact "expands based on OpenCL availability"
...
^{:refer tahto.runtime.jocl.env/when-available :added "4.1"}
(fact "expands based on OpenCL availability"

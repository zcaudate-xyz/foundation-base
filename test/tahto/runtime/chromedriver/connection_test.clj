(ns tahto.runtime.chromedriver.connection-test
  (:use code.test)
  (:require [tahto.runtime.chromedriver.connection :as conn]
            [tahto.runtime.chromedriver.impl :as impl]
            [std.lib :as h]))
...
^{:refer tahto.runtime.chromedriver.connection/gen-id :added "4.0"}
(fact "generates an id"

  (conn/gen-id {})
  => integer?)

^{:refer tahto.runtime.chromedriver.connection/send :added "4.0"
  :setup [(def +conn+
...
^{:refer tahto.runtime.chromedriver.connection/ws-url :added "4.0"}
(fact "gets the ws-url"

  (conn/ws-url {:port (:port (start-scaffold))})
  => string?)

^{:refer tahto.runtime.chromedriver.connection/conn-process :added "4.0"}
...
^{:refer tahto.runtime.chromedriver.connection/conn-attach :added "4.0"
  :setup [(def +conn+
...
^{:refer tahto.runtime.chromedriver.connection/conn-create-raw :added "4.0"}
(fact "connection function (can error on OSX)")

^{:refer tahto.runtime.chromedriver.connection/conn-create :added "4.0"
  :setup [(def +conn+
            (conn/conn-create {:port (:port (start-scaffold))
                               :attach :new}))
          (def +conn2+
...
^{:refer tahto.runtime.chromedriver.connection/conn-close :added "4.0"}

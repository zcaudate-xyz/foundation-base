(ns tahto.runtime.chromedriver.e2e-tabs-test
  (:use code.test)
...
^{:refer tahto.runtime.chromedriver.e2e-tabs-test/workflow-basic-switch :added "4.0"
...
^{:refer tahto.runtime.chromedriver.e2e-tabs-test/workflow-sequential-tabs :added "4.0"
...
^{:refer tahto.runtime.chromedriver.e2e-tabs-test/workflow-tab-isolation :added "4.0"
...
^{:refer tahto.runtime.chromedriver.e2e-tabs-test/workflow-temporary-tab :added "4.0"
...
^{:refer tahto.runtime.chromedriver.e2e-tabs-test/workflow-compare-tabs :added "4.0"

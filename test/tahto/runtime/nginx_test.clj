(ns tahto.runtime.nginx-test
  (:require [lua.nginx :as n]
            [net.http :as http]
            [tahto.runtime.nginx :refer :all]
            [tahto.runtime.nginx.config :as config]
            [tahto.runtime.nginx.script :as script]
            [std.fs :as fs]
            [tahto.core :as l]
...
^{:refer tahto.runtime.nginx/error-logs :added "4.0"}
...
^{:refer tahto.runtime.nginx/access-logs :added "4.0"}
...
^{:refer tahto.runtime.nginx/nginx-conf :added "4.0"}
...
^{:refer tahto.runtime.nginx/dir-tree :added "4.0"}
(fact "gets the running nginx access log"
  (with-redefs [l/rt:inner (constantly {:state (atom [nil "path"])})
                fs/list (constantly [])]
    (dir-tree)
...
^{:refer tahto.runtime.nginx/all-nginx-ports :added "4.0"}
...
^{:refer tahto.runtime.nginx/all-nginx-active :added "4.0"}
(fact "gets all active nginx processes for a port"
  (with-redefs [all-nginx-ports (constantly {80 #{123}})]
    (all-nginx-active 80)
    => #{123}))

^{:refer tahto.runtime.nginx/make-conf :added "4.0"}
...
^{:refer tahto.runtime.nginx/make-temp :added "4.0"}
...
^{:refer tahto.runtime.nginx/start-test-server-shell :added "4.0"}
...
^{:refer tahto.runtime.nginx/start-test-server-container :added "4.0"}
...
^{:refer tahto.runtime.nginx/start-test-server :added "4.0"}
...
^{:refer tahto.runtime.nginx/kill-single-nginx :added "4.0"}
...
^{:refer tahto.runtime.nginx/kill-all-nginx :added "4.0"}
...
^{:refer tahto.runtime.nginx/stop-test-server :added "4.0"}
...
^{:refer tahto.runtime.nginx/raw-eval-nginx :added "4.0"}
...
^{:refer tahto.runtime.nginx/invoke-ptr-nginx :added "4.0"}
(fact "evaluates lua ptr and arguments"
  ;; delegates
  )

^{:refer tahto.runtime.nginx/nginx:create :added "4.0"}
...
^{:refer tahto.runtime.nginx/nginx :added "4.0"}

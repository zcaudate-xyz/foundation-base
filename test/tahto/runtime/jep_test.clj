(ns tahto.runtime.jep-test
  (:require [tahto.runtime.jep :as jep :refer :all]
             [tahto.runtime.jep.bootstrap :as bootstrap]
...
^{:refer tahto.runtime.jep/jep-bus :added "3.0"
...
^{:refer tahto.runtime.jep/make-interpreter :added "3.0"
  :setup [(mapv (fn [itp]
...
^{:refer tahto.runtime.jep/close-interpreter :added "3.0"}
(fact "closes the shared interpreter"
  (let [itp (jep/make-interpreter)]
    (close-interpreter itp)
    (contains? @jep/*interpreters* itp) => false))

^{:refer tahto.runtime.jep/eval-exec-interpreter :added "3.0"
  :setup [(mapv (fn [itp]
                  (f/suppress (jep/close-interpreter itp)))
                @jep/*interpreters*)]}
...
^{:refer tahto.runtime.jep/eval-get-interpreter :added "3.0"}
(fact "gets a value from the interpreter"
  (jep:temp-interpreter itp
                        (eval-get-interpreter itp "1 + 1"))
  => 2)

^{:refer tahto.runtime.jep/jep:temp-interpreter :added "3.0"}
(fact "gets a value from the interpreter"
  (jep:temp-interpreter itp
                        (eval-get-interpreter itp "1 + 1"))
  => 2)

^{:refer tahto.runtime.jep/jep-handler :added "3.0"}
...
^{:refer tahto.runtime.jep/eval-command-jep :added "3.0"
...
^{:refer tahto.runtime.jep/eval-command-fn :added "3.0"
  :setup    [(def +jep+ (component/start (jep/rt-jep:create {})))]
  :teardown [(component/stop +jep+)]}
...
^{:refer tahto.runtime.jep/start-jep :added "3.0"}
...
^{:refer tahto.runtime.jep/stop-jep :added "3.0"}
...
^{:refer tahto.runtime.jep/kill-jep :added "3.0"}
(fact "kills the jep runtime"
  (let [jep (component/start (rt-jep:create {}))]
    (kill-jep jep)))

^{:refer tahto.runtime.jep/invoke-ptr-jep :added "4.0"}
...
^{:refer tahto.runtime.jep/rt-jep:create :added "3.0"}
(fact "creates a componentizable runtime"
  (rt-jep:create {})
  => rt-jep?)

^{:refer tahto.runtime.jep/rt-jep :added "3.0"}

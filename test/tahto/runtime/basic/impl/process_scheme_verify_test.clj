(ns tahto.runtime.basic.impl.process-scheme-verify-test
...
(l/script :scheme
  tahto.runtime.basic.impl.process-scheme-verify-test
  {:runtime :verify})

^{:refer tahto.runtime.basic.impl.process-scheme/CANARY :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-scheme/!.scheme :added "4.0"}

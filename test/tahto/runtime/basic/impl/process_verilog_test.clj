(ns tahto.runtime.basic.impl.process-verilog-test
  (:require [clojure.string]
            [tahto.core :as l]
            [tahto.runtime.basic.impl.process-verilog :refer :all]
            [std.lib.env :as env]
            [std.lib.os :as os])
  (:use code.test))

^{:refer tahto.runtime.basic.impl.process-verilog/transform-form :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-verilog/sh-exec-verilog :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-verilog-test/CANARY-IVERILOG :adopt true :added "4.1"}

(ns tahto.runtime.basic.impl.process-dart-test
  (:require [clojure.string :as str]
             [tahto.runtime.basic.impl.process-dart :refer :all]
             [tahto.core :as l]
             [std.lib.os :as os]
             [std.lib.env :as env]
             [std.fs :as fs])
...
^{:refer tahto.runtime.basic.impl.process-dart/normalize-dart-source :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-dart/ensure-dart-imports :added "4.1"}
(fact "hoists required Dart imports for standalone scripts"
  (ensure-dart-imports "void main() {\n  print(math.max(1, 2));\n  print(jsonEncode({\"a\": 1}));\n}")
  => "import 'dart:convert';\nimport 'dart:math' as math;\n\nvoid main() {\n  print(math.max(1, 2));\n  print(jsonEncode({\"a\": 1}));\n}")


^{:refer tahto.runtime.basic.impl.process-dart/sh-exec-dart :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-dart/transform-form :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-dart/dart-package-imports :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-dart/dart-package-root :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-dart/dart-pubspec :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-dart/ensure-dart-package-context :added "4.1"}

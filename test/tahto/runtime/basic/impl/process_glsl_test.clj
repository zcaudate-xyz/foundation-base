(ns tahto.runtime.basic.impl.process-glsl-test
  (:require [tahto.core :as l]
            [tahto.runtime.basic.impl.process-glsl :as glsl]
...
(l/script :glsl
  tahto.runtime.basic.impl.process-glsl-test
  {:runtime :oneshot})

^{:refer tahto.runtime.basic.impl.process-glsl/transform-form-run :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/glsl-oneshot :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/transform-form-verify :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/rt-glsl:create :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/!.gl :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/glsl-sh-exec :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/raw-eval-glsl :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-glsl/invoke-ptr-glsl :added "4.0"}

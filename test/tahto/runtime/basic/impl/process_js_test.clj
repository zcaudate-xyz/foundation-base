(ns tahto.runtime.basic.impl.process-js-test
  (:require [clojure.string]
            [tahto.runtime.basic.impl.process-js :refer :all]
            [tahto.core :as l]
            [std.lib.env :as env])
  (:use code.test))
...
^{:refer tahto.runtime.basic.impl.process-js/CANARY :adopt true :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-js/node-path :added "4.1"}

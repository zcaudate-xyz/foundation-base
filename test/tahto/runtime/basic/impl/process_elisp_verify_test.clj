(ns tahto.runtime.basic.impl.process-elisp-verify-test
...
(l/script :elisp
  tahto.runtime.basic.impl.process-elisp-verify-test
  {:runtime :verify})

^{:refer tahto.runtime.basic.impl.process-elisp/CANARY :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-elisp/!.elisp :added "4.0"}

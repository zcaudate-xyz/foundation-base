(ns tahto.runtime.basic.impl.process-lua-test
  (:require [tahto.runtime.basic.impl.process-lua :refer :all]
            [tahto.core :as l])
  (:use code.test))
...
^{:refer tahto.runtime.basic.impl.process-lua/CANARY :adopt true  :added "4.0"}
(fact "EVALUATE lua code"
  
  (!.lua (+ 1 2 3 4))
  => 10)

^{:refer tahto.runtime.basic.impl.process-lua/default-oneshot-wrap :adopt true :added "4.0"}
(fact "wraps with the eval wrapper"

  (default-oneshot-wrap "1")
  => string?)

^{:refer tahto.runtime.basic.impl.process-lua/default-basic-client :adopt true :added "4.0"}
(fact "wraps with the eval wrapper"

  (default-basic-client 19000)
  => string?)

^{:refer tahto.runtime.basic.impl.process-lua/default-basic-client :added "4.1"
...
^{:refer tahto.runtime.basic.impl.process-lua/default-body-wrap :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-lua/normalize-forms :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-lua/default-body-transform :added "4.0"}
...
^{:refer tahto.runtime.basic.impl.process-lua/lua-basic-script-globalize-entry :added "4.1"}

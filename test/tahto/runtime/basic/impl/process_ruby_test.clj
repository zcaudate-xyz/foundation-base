(ns tahto.runtime.basic.impl.process-ruby-test
  (:require [tahto.runtime.basic.impl.process-ruby :refer :all]
            [std.lib.env :as env]
...
^{:refer tahto.runtime.basic.impl.process-ruby/CANARY :adopt true :added "4.0"}
...
^{:refer tahto.base.preprocess-staging/to-staging :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-ruby/default-body-wrap :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-ruby/normalize-forms :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-ruby/default-body-transform :added "4.1"}

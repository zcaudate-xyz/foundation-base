(ns tahto.runtime.basic.impl.process-gdscript-test
  (:require [tahto.core :as l]
            [tahto.core.impl :as impl]
            [tahto.model.spec-gdscript]
            [tahto.runtime.basic.impl.process-gdscript :as gd]
            [std.fs :as fs]
            [std.lib.env :as env]
            [std.lib.os :as os])
  (:use code.test))
...
^{:refer tahto.runtime.basic.impl.process-gdscript/default-body-transform :added "4.1"}
(fact "wraps body forms for return"
  (impl/emit-as :gdscript [(gd/default-body-transform '[(:= a 1) (+ a 2)] {:bulk true})])
  => "a = 1\nreturn a + 2")

^{:refer tahto.runtime.basic.impl.process-gdscript/default-oneshot-wrap :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-gdscript/sh-exec-gdscript :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-gdscript/ensure-project! :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-gdscript/wrap-godot-eval :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-gdscript/transform-form-verify :added "4.1"}
(fact "wraps emitted GDScript in a SceneTree script for syntax checking"
  (gd/transform-form-verify '[(:= a 1)] {})
  => '(:- "extends SceneTree\n\n\n\nfunc _init():\n  a = 1"))

^{:refer tahto.runtime.basic.impl.process-gdscript/default-oneshot-in :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-gdscript/default-oneshot-out :added "4.1"}
...
^{:refer tahto.runtime.basic.impl.process-gdscript/verify-exec-gdscript :added "4.1"}

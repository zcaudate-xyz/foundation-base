(ns tahto.runtime.basic.type-container-test
  (:require [tahto.runtime.basic.type-container :as container]
            [tahto.runtime.basic.type-oneshot :as oneshot]
            [lib.docker :as docker])
  (:use code.test))

^{:refer tahto.runtime.basic.type-container/start-container-process :added "4.0"}
...
^{:refer tahto.runtime.basic.type-container/start-container :added "4.1"}
...
^{:refer tahto.runtime.basic.type-container/stop-container :added "4.0"}

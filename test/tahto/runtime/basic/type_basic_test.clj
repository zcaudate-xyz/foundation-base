(ns tahto.runtime.basic.type-basic-test
  (:require [tahto.runtime.basic.impl.process-js :as js]
            [tahto.runtime.basic.impl.process-lua :as lua]
            [tahto.runtime.basic.server-basic :as server]
            [tahto.runtime.basic.type-basic :refer :all]
            [tahto.runtime.basic.type-bench :as bench]
            [tahto.runtime.basic.type-container :as container]
            [std.lib.component :as component])
  (:use code.test))

^{:refer tahto.runtime.basic.type-basic/start-basic :added "4.0"}
(fact "starts the basic rt"
  ...
  (with-redefs [server/start-server (fn [& _] {:port 1234})
                ...
                tahto.runtime.basic.type-oneshot/rt-oneshot-setup (fn [& _] [nil {} nil])
                tahto.runtime.basic.type-common/get-options (fn [& _] {})]
    (start-basic (rt-basic:create {:lang :test :id "test-start" :program nil :make nil :exec nil})))
  => map?)

^{:refer tahto.runtime.basic.type-basic/default-container-backup? :added "4.1"}
...
^{:refer tahto.runtime.basic.type-basic/local-exec-available? :added "4.1"}
(fact "local-exec-available? checks the first command token"

  (with-redefs [tahto.runtime.basic.type-common/program-exists? (fn [s] (= s "php"))]
...
^{:refer tahto.runtime.basic.type-basic/start-basic :added "4.1"
...
(fact "start-basic falls back to container when local exec is unavailable and backup is enabled"
  ...
  (with-redefs [server/start-server (fn [& _] {:port 1234})
                ...
                tahto.runtime.basic.type-common/get-options (fn [& _] {})
                tahto.runtime.basic.type-oneshot/rt-oneshot-setup (fn [& _]
                                                         [:php
                                                          {:container {:image "ghcr.io/zcaudate-xyz/foundation-base/rt-basic-php:latest"}
                                                           :container-backup true}
                                                          ["php" "-r"]])
                tahto.runtime.basic.type-common/program-exists? (fn [_] false)]
...
^{:refer tahto.runtime.basic.type-basic/stop-basic :added "4.0"}
...
^{:refer tahto.runtime.basic.type-basic/raw-eval-basic :added "4.0"}
...
^{:refer tahto.runtime.basic.type-basic/invoke-ptr-basic :added "4.0"}
(fact "invoke for basic rt")

^{:refer tahto.runtime.basic.type-basic/rt-basic-string :added "4.0"}
...
^{:refer tahto.runtime.basic.type-basic/rt-basic-port :added "4.0"}
...
^{:refer tahto.runtime.basic.type-basic/rt-basic:create :added "4.0"}
(fact "creates a basic rt"

  (with-redefs [tahto.runtime.basic.type-common/get-options (fn [& _] {})]
    (rt-basic:create {:lang :test}))
  => map?)

^{:refer tahto.runtime.basic.type-basic/rt-basic :added "4.0"}

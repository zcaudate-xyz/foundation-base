(ns tahto.runtime.basic.type-twostep-test
  (:require [tahto.runtime.basic.impl.process-c]
            [tahto.runtime.basic.impl-annex.process-rust]
            [tahto.runtime.basic.type-common :as common]
            [tahto.runtime.basic.type-twostep :as p]
            [std.fs :as fs]
            [std.lib.os :as os]
            [std.lib.env :as env])
  (:use code.test))
...
(^{:refer tahto.runtime.basic.type-twostep-test/CANARY-GCC :adopt true :added "4.0"}
...
(^{:refer tahto.runtime.basic.type-twostep-test/CANARY-RUSTC :adopt true :added "4.0"}
...
^{:refer tahto.runtime.basic.type-twostep/sh-exec :added "4.0"}
...
^{:refer tahto.runtime.basic.type-twostep/local-exec-available? :added "4.1"}
...
^{:refer tahto.runtime.basic.type-twostep/sh-exec-docker :added "4.1"}
...
^{:refer tahto.runtime.basic.type-twostep/sh-exec-portable :added "4.1"}
...
^{:refer tahto.runtime.basic.type-twostep/raw-eval-twostep :added "4.0"}
...
^{:refer tahto.runtime.basic.type-twostep/invoke-ptr-twostep :added "4.0"}
(fact "invokes twostep pointer")

^{:refer tahto.runtime.basic.type-twostep/rt-twostep-setup :added "4.0"}
...
^{:refer tahto.runtime.basic.type-twostep/rt-twostep:create :added "4.0"}
...
^{:refer tahto.runtime.basic.type-twostep/rt-twostep :added "4.0"}

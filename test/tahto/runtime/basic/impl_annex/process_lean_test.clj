(ns tahto.runtime.basic.impl-annex.process-lean-test
  (:use code.test)
  (:require [clojure.string :as str]
            [tahto.runtime.basic.impl-annex.process-lean :refer :all]
            [tahto.runtime.basic.type-twostep :as twostep]
            [std.fs :as fs]
            [std.lib.os :as os]))

^{:refer tahto.runtime.basic.impl-annex.process-lean/sh-exec-lean :added "4.1"}
...
^{:refer tahto.runtime.basic.impl-annex.process-lean/sh-exec-lean-docker :added "4.1"}
...
^{:refer tahto.runtime.basic.impl-annex.process-lean/sh-exec-lean-portable :added "4.1"}
...
^{:refer tahto.runtime.basic.impl-annex.process-lean/transform-form :added "4.1"}

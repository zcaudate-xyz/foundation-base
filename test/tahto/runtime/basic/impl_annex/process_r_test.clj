(ns tahto.runtime.basic.impl-annex.process-r-test
  (:require [tahto.runtime.basic.impl-annex.process-r :refer :all]
...
^{:refer tahto.runtime.basic.impl-annex.process-r/CANARY :adopt true :added "4.0"}
...
^{:refer tahto.runtime.basic.impl-annex.process-r/default-oneshot-wrap  :adopt true :added "4.0"}
(fact "creates the oneshot form"

  (default-oneshot-wrap 1)
  => string?)

^{:refer tahto.runtime.basic.impl-annex.process-r/default-basic-client  :adopt true :added "4.0"}
(fact "creates the oneshot form"

  (default-basic-client 19000)
  => string?)

^{:refer tahto.runtime.basic.impl-annex.process-r/default-oneshot-trim :added "4.0"}
(fact "trim for oneshot"

  (default-oneshot-trim "{\"type\":\"data\",\"return\":\"number\",\"value\":1}")
  => "{\"type\":\"data\",\"return\":\"number\",\"value\":1}")

^{:refer tahto.runtime.basic.impl-annex.process-r/CANARY :adopt true :added "4.1"
...
^{:refer tahto.runtime.basic.impl-annex.process-r/default-body-transform :added "4.0"}

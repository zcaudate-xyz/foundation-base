(ns tahto.runtime.basic.impl-annex.process-haskell-test
  (:use code.test)
  (:require [tahto.runtime.basic.impl-annex.process-haskell :refer :all]))

^{:refer tahto.runtime.basic.impl-annex.process-haskell/transform-form :added "4.1"}

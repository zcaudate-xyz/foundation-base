(ns tahto.runtime.basic.impl-annex.process-rust-test
  (:require [tahto.runtime.basic.impl-annex.process-rust :refer :all]
            [std.lib.env :as env]
            [tahto.core :as l])
  (:use code.test))
...
^{:refer tahto.runtime.basic.impl-annex.process-rust/transform-form :added "4.0"}
...
^{:refer tahto.runtime.basic.impl-annex.process-rust-test/CANARY-RUSTC :adopt true :added "4.0"}

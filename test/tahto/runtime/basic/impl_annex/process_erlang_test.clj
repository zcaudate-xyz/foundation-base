(ns tahto.runtime.basic.impl-annex.process-erlang-test
  (:require [clojure.string :as str]
            [tahto.runtime.basic.impl-annex.process-erlang :refer :all]
            [tahto.core :as l])
  (:use code.test))

^{:refer tahto.runtime.basic.impl-annex.process-erlang/default-body-transform :added "4.1"}
...
^{:refer tahto.runtime.basic.impl-annex.process-erlang/erlang-basic-client-forms :added "4.1"}

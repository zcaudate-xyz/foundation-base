(ns tahto.runtime.basic.impl-annex.process-perl-test
  (:require [tahto.runtime.basic.impl-annex.process-perl :refer :all]
...
^{:refer tahto.runtime.basic.impl-annex.process-perl/CANARY :adopt true :added "4.0"}
...
^{:refer tahto.runtime.basic.impl-annex.process-perl/default-body-transform :added "4.1"}
...
^{:refer tahto.runtime.basic.impl-annex.process-perl/perl-body-wrap :added "4.0"}
...
^{:refer tahto.runtime.basic.impl-annex.process-perl/default-basic-body-transform :added "4.0"}
...
^{:refer tahto.runtime.basic.impl-annex.process-perl/default-basic-client :added "4.1"}

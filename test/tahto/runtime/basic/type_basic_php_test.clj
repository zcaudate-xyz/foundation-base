(ns tahto.runtime.basic.type-basic-php-test
  (:use code.test)
  (:require [tahto.runtime.basic.impl-annex.process-php]
            [tahto.runtime.basic.type-basic :as p]
            [std.lib.env :as env]
            [tahto.core :as l]
...
^{:refer tahto.runtime.basic.type-basic-php-test/CANARY-PHP :adopt true :added "4.1"}
...
^{:refer tahto.runtime.basic.type-basic/invoke-ptr-basic :added "4.1"}

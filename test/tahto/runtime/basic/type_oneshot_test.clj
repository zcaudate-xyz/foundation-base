(ns tahto.runtime.basic.type-oneshot-test
  (:require [tahto.runtime.basic.impl.process-js :as js]
             [tahto.runtime.basic.impl.process-lua :as lua]
             [tahto.runtime.basic.impl.process-python :as py]
             [tahto.runtime.basic.impl-annex.process-r :as r]
             [tahto.runtime.basic.type-oneshot :as p]
             [std.json :as json]
            ...
            [tahto.core.pointer :as ptr]
             ...
             [tahto.model.spec-js :as spec-js]
             [tahto.model.spec-lua :as spec-lua]
             [tahto.model.spec-python :as spec-py]
             [tahto.model.annex.spec-r :as spec-r]
             [std.lib.env :as env]
...
^{:refer tahto.runtime.basic.type-oneshot/invoke-ptr-oneshot.compile :adopt true :added "4.0"}
...
^{:refer tahto.runtime.basic.type-oneshot/sh-exec :added "4.0"}
...
^{:refer tahto.runtime.basic.type-oneshot/raw-eval-oneshot :added "4.0"}
...
^{:refer tahto.runtime.basic.type-oneshot/invoke-ptr-oneshot :added "4.0"}
...
^{:refer tahto.runtime.basic.type-oneshot/rt-oneshot-setup :added "4.0"}
(fact "helper function for preparing oneshot params"

  (p/rt-oneshot-setup :lua :resty {} nil)
  => vector?)

^{:refer tahto.runtime.basic.type-oneshot/rt-oneshot:create :added "4.0"}
...
^{:refer tahto.runtime.basic.type-oneshot/rt-oneshot :added "4.0"

(ns tahto.runtime.basic.type-websocket-test
  (:require [tahto.runtime.basic.server-websocket :as ws]
            [tahto.runtime.basic.type-basic :as basic]
            [tahto.runtime.basic.type-common :as common]
            [tahto.runtime.basic.type-websocket :refer :all]
            [std.lib.component :as component])
  (:use code.test))

^{:refer tahto.runtime.basic.type-websocket/start-websocket :added "4.0"}
...
^{:refer tahto.runtime.basic.type-websocket/rt-websocket:create :added "4.0"}
(fact "creates a websocket runtime"
  (with-redefs [common/get-options (fn [& _] {})]
    (rt-websocket:create {:lang :js}))
  => map?)

^{:refer tahto.runtime.basic.type-websocket/rt-websocket :added "4.0"}

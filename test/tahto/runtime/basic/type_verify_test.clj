(ns tahto.runtime.basic.type-verify-test
  (:use code.test)
  (:require [tahto.runtime.basic.type-verify :refer :all]
            [std.lib.os :as os]
            [std.fs :as fs]))

^{:refer tahto.runtime.basic.type-verify/verify-exec-oneshot :added "4.1"}
...
^{:refer tahto.runtime.basic.type-verify/verify-exec-file :added "4.1"}
...
^{:refer tahto.runtime.basic.type-verify/verify-exec-twostep :added "4.1"}

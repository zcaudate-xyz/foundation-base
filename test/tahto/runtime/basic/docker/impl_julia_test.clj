(ns tahto.runtime.basic.docker.impl-julia-test
...
;;
;; Uses the project-owned tahto.runtime.basic Julia image with JSON preinstalled.
;;
...
;; Run with: RT_BASIC_DOCKER_TESTS=true lein test :only tahto.runtime.basic.docker.impl-julia-test
;;

(ns tahto.runtime.basic.docker.impl-r-test
...
;;
;; Uses the project-owned tahto.runtime.basic R image.
...
;; Run with: RT_BASIC_DOCKER_TESTS=true lein test :only tahto.runtime.basic.docker.impl-r-test
;;
...
^{:refer tahto.runtime.basic.docker.impl-r-test/r-docker-bootstrap :added "4.0"}

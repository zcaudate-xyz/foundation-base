(ns tahto.runtime.nix.script-test
  (:require [tahto.runtime.nix.script :refer :all])
  (:use code.test))

^{:refer tahto.runtime.nix.script/emit-nix :added "4.0"}
...
^{:refer tahto.runtime.nix.script/write :added "4.0"}
...
^{:refer tahto.runtime.nix.script/write-fn :added "4.0"}
...
^{:refer tahto.runtime.nix.script/write-full :added "4.0"}

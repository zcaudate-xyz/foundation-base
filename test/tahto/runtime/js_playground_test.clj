(ns tahto.runtime.js-playground-test
  (:require [tahto.runtime.js-playground :refer :all]
            [std.json :as json]
...
^{:refer tahto.runtime.js-playground/rt-js-playground:create :added "4.0"}
...
^{:refer tahto.runtime.js-playground/start-js-playground :added "4.0"}
...
^{:refer tahto.runtime.js-playground/play-url :added "4.0"}
...
^{:refer tahto.runtime.js-playground/raw-eval-js-playground :added "4.0"}
...
^{:refer tahto.runtime.js-playground/rt-js-playground :added "4.0"}
...
^{:refer tahto.runtime.js-playground/playground-client-script :added "4.0"}
...
^{:refer tahto.runtime.js-playground/page-html :added "4.1"}
...
^{:refer tahto.runtime.js-playground/stop-js-playground :added "4.1"}
...
^{:refer tahto.runtime.js-playground/invoke-ptr-js-playground :added "4.1"}
...
^{:refer tahto.runtime.js-playground/rt-js-playground-string :added "4.1"}
...
^{:refer tahto.runtime.js-playground/play-file :added "4.1"}
...
^{:refer tahto.runtime.js-playground/play-page :added "4.1"}

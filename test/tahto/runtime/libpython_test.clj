(ns tahto.runtime.libpython-test
  (:require [libpython-clj2.python :as python]
            [tahto.runtime.libpython :as lp]
...
^{:refer tahto.runtime.libpython/TESTING :added "3.0"}
(fact "performs an exec expression"
  ;; Skips actual python exec
  )

^{:refer tahto.runtime.libpython/eval-raw :added "3.0"}
(fact "performs an exec expression"
...
^{:refer tahto.runtime.libpython/eval-libpython :added "4.0"}
...
^{:refer tahto.runtime.libpython/invoke-libpython :added "4.0"}
(fact "invokes a pointer in the runtime"
  ;; delegates
  )

^{:refer tahto.runtime.libpython/start-libpython :added "3.0"}
(fact "starts the libpython runtime"
  (with-redefs [python/initialize! (fn [] nil)]
    (lp/start-libpython {}))
  => {})

^{:refer tahto.runtime.libpython/stop-libpython :added "3.0"}
(fact "stops the libpython runtime"
  (lp/stop-libpython {}) => {})

^{:refer tahto.runtime.libpython/rt-libpython:create :added "4.0"}
(fact "creates a libpython runtime"
  (lp/rt-libpython:create {:lang :js})
  => map?)

^{:refer tahto.runtime.libpython/rt-libpython :added "4.0"}

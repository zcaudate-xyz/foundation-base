(ns tahto.runtime.blender.impl-test
  (:require [tahto.core :as h]
            [tahto.core.type-shared :as shared]
            [tahto.runtime.blender.impl :as impl]
            [std.lib.env :as env])
  (:use code.test))

(fact:global {:skip (not (env/program-exists? "blender"))})

^{:refer tahto.runtime.blender.impl/blender-exec :added "4.1"}
(fact "resolves the blender executable"
  (impl/blender-exec)
  => string?)

^{:refer tahto.runtime.blender.impl/blender-bootstrap :added "4.1"}
...
^{:refer tahto.runtime.blender.impl/start-blender :added "4.1"}
...
^{:refer tahto.runtime.blender.impl/invoke-ptr-blender :added "4.1"}
...
^{:refer tahto.runtime.blender.impl/blender:create :added "4.1"}
...
^{:refer tahto.runtime.blender.impl/blender-shared :added "4.1"}
...
^{:refer tahto.runtime.blender.impl/stop-blender :added "4.1"}
...
^{:refer tahto.runtime.blender.impl/blender-shared:create :added "4.1"}

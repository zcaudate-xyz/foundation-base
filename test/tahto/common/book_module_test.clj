(ns tahto.common.book-module-test
  (:require [xt.lang.common-promise]
            ...
            [js.blessed.frame]
            [tahto.core :as l]
            [tahto.common.book-module :refer :all]
            [tahto.core.impl :as impl])
  (:use code.test))

(def +library+ (impl/clone-default-library))

^{:refer tahto.common.book-module/book-module? :added "4.0"}
...
^{:refer tahto.common.book-module/polyfill-default-alias :added "4.1"}
...
^{:refer tahto.common.book-module/module-derived-view :added "4.1"}
...
^{:refer tahto.common.book-module/resolve-module-view :added "4.1"}
...
^{:refer tahto.common.book-module/module-deps-code :added "4.0"}
...
^{:refer tahto.common.book-module/module-deps-all :added "4.1"}
...
^{:refer tahto.common.book-module/module-deps-native :added "4.0"}
...
^{:refer tahto.common.book-module/module-deps-fragment :added "4.0"}
...
^{:refer tahto.common.book-module/module-entries :added "4.0"}

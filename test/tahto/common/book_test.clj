(ns tahto.common.book-test
  (:require [tahto.common.book :as b]
            [tahto.common.book-entry :as entry]
...
^{:refer tahto.common.book/get-base-entry :added "4.0"}
...
^{:refer tahto.common.book/get-module :added "4.0"}
(fact "gets the module"

  (b/get-module +sample+ 'L.core)
  => module/book-module?)

^{:refer tahto.common.book/get-code-deps :added "4.0"}
...
^{:refer tahto.common.book/get-code-entry-view :added "4.1"}
...
^{:refer tahto.common.book/get-deps :added "4.0"}
...
^{:refer tahto.common.book/get-deps-native :added "4.0"}
...
^{:refer tahto.common.book/list-entries :added "4.0"}
...
^{:refer tahto.common.book/book-string :added "4.0"}
(fact "shows the book string"

  (b/book-string +sample+)
  => "#book [:lua] {L.core {:code 1, :fragment 1}}")

^{:refer tahto.common.book/book? :added "4.0"}
...
^{:refer tahto.common.book/book-merge :added "4.0"}
...
^{:refer tahto.common.book/book-from :added "4.0"}
...
^{:refer tahto.common.book/check-compatible-lang :added "4.0"
  :setup [(def +redis+
            (b/book-merge (b/book {:lang    :lua.redis
                                   :meta    (:meta +book+)
                                   :grammar (:grammar +book+)
...
^{:refer tahto.common.book/assert-compatible-lang :added "4.0"}
...
^{:refer tahto.common.book/set-module :added "4.0"}
...
^{:refer tahto.common.book/put-module :added "4.0"}
...
^{:refer tahto.common.book/delete-module :added "4.0"}
...
^{:refer tahto.common.book/delete-modules :added "4.0"}
...
^{:refer tahto.common.book/has-module? :added "4.0"}
...
^{:refer tahto.common.book/assert-module :added "4.0"}
...
^{:refer tahto.common.book/set-entry :added "4.0"}
...
^{:refer tahto.common.book/put-entry :added "4.0"}
...
^{:refer tahto.common.book/has-entry? :added "4.0"}
(fact "checks that book has an entry"

  (b/has-entry? +redis+ 'L.core :fragment 'identity)
  => true)

^{:refer tahto.common.book/assert-entry :added "4.0"}
(fact "asserts that module exists"
...
^{:refer tahto.common.book/delete-entry :added "4.0"}
...
^{:refer tahto.common.book/module-create-filename :added "4.0"}
(fact "creates a filename for module"

  (b/module-create-filename +redis+ 'redis.core)
  => "core.lua")

^{:refer tahto.common.book/module-create-check :added "4.0"}
...
^{:refer tahto.common.book/module-create-requires :added "4.0"}
(fact "creates a map for the requires"
  (b/module-create-requires '[[L.core :as u]])
  => '{L.core {:as u, :id L.core}})

^{:refer tahto.common.book/module-normalize-implements :added "4.1"}
...
^{:refer tahto.common.book/module-export-requires :added "4.1"}
...
^{:refer tahto.common.book/module-export-imports :added "4.1"}
...
^{:refer tahto.common.book/module-specialize-symbol :added "4.1"}
...
^{:refer tahto.common.book/module-specialize-form :added "4.1"}
...
^{:refer tahto.common.book/module-specialize-entry :added "4.1"}
...
^{:refer tahto.common.book/module-specialize-bindings :added "4.1"}
...
^{:refer tahto.common.book/module-specialize :added "4.1"}
...
^{:refer tahto.common.book/module-create :added "4.0"}
...
(comment
  ...
  ^{:refer tahto.common.book/module-create-bundled :added "4.0"}

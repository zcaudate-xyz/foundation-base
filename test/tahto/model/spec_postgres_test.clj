(ns tahto.model.spec-postgres-test
  (:use code.test)
  (:require [postgres.core :as pg]
            [tahto.model.spec-postgres :refer :all]
...
^{:refer tahto.model.spec-postgres/CANARY :adopt true :added "4.0"}
...
^{:refer tahto.model.spec-postgres/CANARY.select :adopt true :added "4.0"}
(fact "BASIC SELECT"
...
^{:refer tahto.model.spec-postgres/CANARY.json :adopt true :added "4.0"}

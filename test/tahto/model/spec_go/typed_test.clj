(ns tahto.model.spec-go.typed-test
  (:use code.test)
  (:require [clojure.string :as str]
            [tahto.model.spec-go.typed :refer :all]))
...
^{:refer tahto.model.spec-go.typed/sanitize-ident :added "4.1"}
(fact "sanitizes go identifiers"
  [(sanitize-ident "hello-world")
   (sanitize-ident "123hello")]
  => ["hello_world" "_123hello"])

^{:refer tahto.model.spec-go.typed/capitalize-ident :added "4.1"}
(fact "capitalizes go identifiers"
  [(capitalize-ident "display-name")
   (capitalize-ident "")]
  => ["Display_name" "X"])

^{:refer tahto.model.spec-go.typed/named-go-ident :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/maybe-go-type :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/lossy-go-type :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emit-go-type :added "4.1"}
(fact "emits go types"
...
^{:refer tahto.model.spec-go.typed/emit-struct-field :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emit-struct-type :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emit-spec-declaration :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emit-function-declaration :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emit-value-declaration :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emitted-specs :added "4.1"}
(fact "filters specs shadowed by callable and value declarations"
  (mapv :name (emitted-specs sample-analysis))
  => ["User" "UserMap"])

^{:refer tahto.model.spec-go.typed/emit-analysis-declarations :added "4.1"}
...
^{:refer tahto.model.spec-go.typed/emit-namespace-declarations :added "4.1"}

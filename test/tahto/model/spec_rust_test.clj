(ns tahto.model.annex.spec-rust-test
  (:require [std.fs :as fs]
            ...
            [tahto.model.annex.spec-rust :refer :all]
            [std.lib.os :as os]
...
^{:refer tahto.model.annex.spec-rust/rst-typesystem :added "4.0"}
(fact "emits rust typesystem syntax")

^{:refer tahto.model.annex.spec-rust/rst-vector :added "4.0"}
(fact "emits rust vector syntax")

^{:refer tahto.model.annex.spec-rust/rst-attributes :added "4.0"}
(fact "emits rust attributes")

^{:refer tahto.model.annex.spec-rust/rst-defenum :added "4.0"}
(fact "emits rust enum definition")

^{:refer tahto.model.annex.spec-rust/rst-deftrait :added "4.0"}
(fact "emits rust trait definition")

^{:refer tahto.model.annex.spec-rust/rst-defimpl :added "4.0"}
(fact "emits rust impl definition")

^{:refer tahto.model.annex.spec-rust/rst-new :added "4.0"}
(fact "emits rust new expression")

^{:refer tahto.model.annex.spec-rust/rst-exec :added "4.0"}
(fact "emits rust exec block")

^{:refer tahto.model.annex.spec-rust/rst-defstruct :added "4.0"}

(ns tahto.model.spec-dart-test
  (:require [tahto.core :as l]
            [tahto.model.spec-dart :as spec-dart]
            [xt.event.base-route])
  (:use code.test))
...
^{:refer tahto.model.spec-dart/dart-map-key :added "4.1"}
...
^{:refer tahto.model.spec-dart/dart-fn :added "4.1"}
(fact "emits dart functions")

^{:refer tahto.model.spec-dart/dart-var :added "4.1"}
...
^{:refer tahto.model.spec-dart/dart-tf-let-bind :added "4.1"}
(fact "transforms dart let bindings")

^{:refer tahto.model.spec-dart/tf-for-object :added "4.1"}
(fact "transforms for:object loops")

^{:refer tahto.model.spec-dart/tf-for-array :added "4.1"}
(fact "transforms for:array loops")

^{:refer tahto.model.spec-dart/tf-for-iter :added "4.1"}
(fact "transforms for:iter loops")

^{:refer tahto.model.spec-dart/dart-tf-ternary :added "4.1"}
(fact "transforms dart ternary expressions")


^{:refer tahto.model.spec-dart/dart-string :added "4.1"}
(fact "emits dart strings")

^{:refer tahto.model.spec-dart/+meta+ :added "4.1"}
...
^{:refer tahto.model.spec-dart/dart-emit-input-rest :added "4.1"}

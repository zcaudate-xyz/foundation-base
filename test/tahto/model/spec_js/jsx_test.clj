(ns tahto.model.spec-js.jsx-test
  (:require [tahto.model.spec-js :as js]
            [tahto.model.spec-js.jsx :refer :all]
            [std.string.prose :as prose])
  (:use code.test))

^{:refer tahto.model.spec-js.jsx/jsx-key-fn :added "4.0"}
(fact "converts jsx key")

^{:refer tahto.model.spec-js.jsx/jsx-arr-prep :added "4.0"}
...
^{:refer tahto.model.spec-js.jsx/jsx-standardise-params :added "4.0"}
(fact "converts back to a :className a :class"

  (jsx-standardise-params {:class ["hello" "world"]})
  => {:className "hello world"})

^{:refer tahto.model.spec-js.jsx/jsx-arr-norm :added "4.0"}
(fact "normalises the jsx array"

  (jsx-arr-norm [:div])
  => [:div {} nil])

^{:refer tahto.model.spec-js.jsx/emit-jsx-map-params :added "4.0"}
...
^{:refer tahto.model.spec-js.jsx/emit-jsx-set-params :added "4.0"}
...
^{:refer tahto.model.spec-js.jsx/emit-jsx-params :added "4.0"}
...
^{:refer tahto.model.spec-js.jsx/emit-jsx-inner :added "4.0"}
(fact "emits the inner blocks for a jsx form")

^{:refer tahto.model.spec-js.jsx/emit-jsx-raw :added "4.0"}
...
^{:refer tahto.model.spec-js.jsx/emit-jsx :added "4.0"}

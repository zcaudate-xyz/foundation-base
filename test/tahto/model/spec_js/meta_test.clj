(ns tahto.model.spec-js.meta-test
  (:require [tahto.core :as l]
            [tahto.model.spec-js.meta :refer :all])
  (:use code.test))

^{:refer tahto.model.spec-js.meta/js-module-import-async :added "4.0"}
(fact "helper for import")

^{:refer tahto.model.spec-js.meta/js-module-import :added "4.0"}
...
^{:refer tahto.model.spec-js.meta/js-module-import :added "4.1" :id scoped-package-import}
...
^{:refer tahto.model.spec-js.meta/js-module-export :added "4.0"}
...
^{:refer tahto.model.spec-js.meta/js-module-link :added "4.0"}
...
^{:refer tahto.model.spec-js.meta/js-transform-entry :added "4.0"}

(ns tahto.model.spec-ruby-test
  (:require [tahto.core :as l]
            [tahto.model.spec-ruby :as spec-ruby]
            [tahto.model.spec-ruby.rewrite :as rewrite]
            [tahto.model.annex.spec-xtalk.fn-ruby :as fn-ruby])
  (:use code.test))
...
^{:refer tahto.model.spec-ruby/ruby-symbol :added "4.1"}
...
^{:refer tahto.model.spec-ruby/ruby-destructure-key :added "4.1"}
(fact "rewrites destructuring keys for ruby")

^{:refer tahto.model.spec-ruby/ruby-method-ref :added "4.1"}
(fact "creates ruby method references")

^{:refer tahto.model.spec-ruby/ruby-symbol-global :added "4.1"}
...
^{:refer tahto.model.spec-ruby/ruby-var :added "4.1"}
...
^{:refer tahto.model.spec-ruby/ruby-map :added "4.1"}
(fact "emit ruby hash"
...
^{:refer tahto.model.spec-ruby/ruby-emit-args :added "4.1"}
(fact "emits ruby argument lists")

^{:refer tahto.model.spec-ruby/ruby-div :added "4.1"}
(fact "emits ruby division")

^{:refer tahto.model.spec-ruby/ruby-invoke :added "4.1"}
(fact "emits ruby invocations")

^{:refer tahto.model.spec-ruby/ruby-dot :added "4.1"}
(fact "emits ruby dot access")

^{:refer tahto.model.spec-ruby/ruby-emit-range :added "4.1"}
(fact "emits ruby ranges")

^{:refer tahto.model.spec-ruby/ruby-defn- :added "4.1"}
...
^{:refer tahto.model.spec-ruby/ruby-defgen :added "4.1"}
...
^{:refer tahto.model.spec-ruby/ruby-fn :added "4.1"}
(fact "basic transform for ruby blocks"

  (spec-ruby/ruby-fn '(fn [a] (+ a 1)))
  => '(:- "->(" "a" ") {\n" "(do (+ a 1))" "\n}"))

^{:refer tahto.model.spec-ruby/tf-for-array :added "4.1"}
...
^{:refer tahto.model.spec-ruby/tf-for-object :added "4.1"}
...
^{:refer tahto.model.spec-ruby/tf-for-iter :added "4.1"}
(fact "transforms for:iter loops")

^{:refer tahto.model.spec-ruby/tf-for-index :added "4.1"}
...
^{:refer tahto.model.spec-ruby/ruby-string :added "4.1"}
(fact "emits ruby strings")

^{:refer tahto.model.spec-ruby/ruby-throw :added "4.1"}
(fact "emits ruby exceptions")

^{:refer tahto.model.spec-ruby/ruby-def :added "4.1"}
(fact "emits ruby definitions")


^{:refer tahto.model.spec-ruby/ruby-emit-input-rest :added "4.1"}
(fact "emits a Ruby splat parameter"
  (with-redefs [tahto.base.emit-common/*emit-fn*

(ns tahto.model.annex.spec-php-test
  (:use code.test)
  (:require [tahto.core :as l]
            [tahto.core.impl :as impl]
            [tahto.model.annex.spec-php :as spec-php]))

(l/script :php)

^{:refer tahto.model.annex.spec-php/+grammar+ :added "4.1"}
...
^{:refer tahto.model.annex.spec-php/php-emit-input-rest :added "4.1"}

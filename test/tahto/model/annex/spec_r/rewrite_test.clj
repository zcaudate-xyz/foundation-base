(ns tahto.model.annex.spec-r.rewrite-test
  (:require [clojure.walk]
            [tahto.base.emit-preprocess :as preprocess]
            [tahto.model.annex.spec-r :as r]
            [tahto.model.annex.spec-r.rewrite :as rewrite])
  (:use code.test))

^{:refer tahto.model.annex.spec-r/tf-defn :added "4.1"}
...
^{:refer tahto.model.annex.spec-r.rewrite/r-rewrite-expression :added "4.1"}
(fact "rewrites r expressions")

^{:refer tahto.model.annex.spec-r.rewrite/r-rewrite-statement :added "4.1"}
(fact "rewrites r statements")

^{:refer tahto.model.annex.spec-r.rewrite/r-rewrite-statements :added "4.1"}
(fact "rewrites r statement blocks")

^{:refer tahto.model.annex.spec-r.rewrite/r-rewrite-stage :added "4.1"}

(ns tahto.model.annex.spec-php.rewrite-test
  (:use code.test)
  (:require [tahto.model.annex.spec-php.rewrite :as rewrite]))

^{:refer tahto.model.annex.spec-php.rewrite/php-rewrite-form :added "4.1"}
...
^{:refer tahto.model.annex.spec-php.rewrite/php-rewrite-stage :added "4.1"}
...
^{:refer tahto.model.annex.spec-php.rewrite/php-local-symbol? :added "4.1"}
...
^{:refer tahto.model.annex.spec-php.rewrite/php-prefix-local :added "4.1"}
...
^{:refer tahto.model.annex.spec-php.rewrite/php-rewrite-statements* :added "4.1"}

(ns tahto.model.annex.spec-xtalk.fn-r-test
  (:use code.test)
  (:require [tahto.core :as l]
             [tahto.model.annex.spec-xtalk.fn-r :refer :all]
...
^{:refer tahto.model.annex.spec-xtalk.fn-r/r-tf-x-lu-create :added "4.1"}
(fact "creates an environment-backed lookup"
  (l/emit-as :r [(r-tf-x-lu-create '(_))])
  => "new.env(hash=TRUE,parent=emptyenv())")

^{:refer tahto.model.annex.spec-xtalk.fn-r/r-tf-x-lu-get :added "4.1"}
...
^{:refer tahto.model.annex.spec-xtalk.fn-r/r-tf-x-str-char :added "4.1"}

...
^{:refer tahto.model.annex.spec-julia/tf-local :added "4.0"}
...
^{:refer tahto.model.annex.spec-julia/julia-map-key :added "3.0"}
...
^{:refer tahto.model.annex.spec-julia/julia-symbol-global :added "4.1"}
(fact "emits julia global symbol access")

^{:refer tahto.model.annex.spec-julia/tf-for-array :added "4.1"}
(fact "transforms for:array loops")

^{:refer tahto.model.annex.spec-julia/tf-for-object :added "4.1"}
(fact "transforms for:object loops")

^{:refer tahto.model.annex.spec-julia/tf-for-iter :added "4.1"}
(fact "transforms for:iter loops")

^{:refer tahto.model.annex.spec-julia/tf-for-index :added "4.0"}
...
^{:refer tahto.model.annex.spec-julia/tf-dict :added "4.0"}
(fact "dict transform"

  (tf-dict '(dict :a 1 :b 2))
  => '(Dict (=> "a" 1) (=> "b" 2)))

^{:refer tahto.model.annex.spec-julia/emit-to :added "4.1"}
...
^{:refer tahto.model.annex.spec-julia/julia-module-link :added "4.0"}
...
^{:refer tahto.model.annex.spec-julia/julia-module-export :added "4.0"}
...
^{:refer tahto.model.annex.spec-julia/tf-ternary :added "4.1"}
(fact "transforms ternary expressions")

^{:refer tahto.model.annex.spec-julia/emit-throw :added "4.1"}

(ns tahto.model.spec-postgres.form-defconst-test
  (:require [tahto.model.spec-postgres :as g]
            [tahto.model.spec-postgres.form-defconst :as form]
            [postgres.sample.scratch-v1 :as scratch]
            [tahto.core :as l])
  (:use code.test))

^{:refer tahto.model.spec-postgres.form-defconst/pg-defconst-hydrate :added "4.0"}
(fact "creates the "
...
^{:refer tahto.model.spec-postgres.form-defconst/pg-defconst :added "4.0"}

(ns tahto.model.spec-postgres.form-defrole-test
  (:require [tahto.model.spec-postgres.common :as common]
            [tahto.model.spec-postgres.form-defrole :refer :all]
            [tahto.core :as l])
  (:use code.test))

^{:refer tahto.model.spec-postgres.form-defrole/pg-defrole-access :added "4.0"}
(fact "creates defrole access form"

  (pg-defrole-access {:select ['table]} 'role {})
  => vector?)

^{:refer tahto.model.spec-postgres.form-defrole/pg-defrole :added "4.0"}

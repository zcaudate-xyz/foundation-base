(ns tahto.model.spec-postgres.form-defpartition-test
  (:require [tahto.model.spec-postgres.common :as common]
            [tahto.model.spec-postgres.form-defpartition :as form-defpartition])
  (:use code.test))

^{:refer tahto.model.spec-postgres.form-defpartition/pg-partition-name :added "4.1"}
(fact "constructs partition name"

  (form-defpartition/pg-partition-name "table" "val" ["stack"])
  => "table__stack__val")

^{:refer tahto.model.spec-postgres.form-defpartition/pg-partition-def :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-defpartition/pg-defpartition :added "4.1"}

(ns tahto.model.spec-postgres.meta-test
  (:require [tahto.model.spec-postgres.meta :refer :all]
...
^{:refer tahto.model.spec-postgres.meta/has-function :added "4.0"}
...
^{:refer tahto.model.spec-postgres.meta/has-table :added "4.0"}
...
^{:refer tahto.model.spec-postgres.meta/has-enum :added "4.0"}
...
^{:refer tahto.model.spec-postgres.meta/has-index :added "4.0"}
(fact "cheks for the existence of an index"
  (has-index "idx" "schema")
  => vector?)

^{:refer tahto.model.spec-postgres.meta/get-extensions :added "4.0"}
(fact "gets import forms"
  (get-extensions {:native {:ext {:seed true}}})
  => '(:ext))

^{:refer tahto.model.spec-postgres.meta/create-extension :added "4.0"}
(fact "makes create extension forms"
  (create-extension :ext)
  => vector?)

^{:refer tahto.model.spec-postgres.meta/drop-extension :added "4.0"}
(fact "makes drop extension forms"
  (drop-extension :ext)
  => vector?)

^{:refer tahto.model.spec-postgres.meta/has-policy :added "4.0"}
(fact "checks that a policy exists"
  (has-policy {:static/schema "s" :static/policy-name "p" :static/policy-table "t"})
  => vector?)

^{:refer tahto.model.spec-postgres.meta/drop-policy :added "4.0"}
(fact "drops a policy"
  (drop-policy {:static/schema "s" :static/policy-name "p" :static/policy-table "t"})
  => vector?)

^{:refer tahto.model.spec-postgres.meta/get-schema-seed :added "4.0"}
(fact "gets schema seed for a given module"

  (get-schema-seed (l/get-module (l/runtime-library)
                                 :postgres
                                 'tahto.model.spec-postgres.meta-test))
  => ["test/meta"])

^{:refer tahto.model.spec-postgres.meta/has-schema :added "4.0"}
(fact "checks that schema exists"
  (has-schema "schema")
  => list?)

^{:refer tahto.model.spec-postgres.meta/create-schema :added "4.0"}
(fact "creates a schema"
  (create-schema "schema")
  => vector?)

^{:refer tahto.model.spec-postgres.meta/drop-schema :added "4.0"}
(fact "drops a schema"
  (drop-schema "schema")
  => vector?)

^{:refer tahto.model.spec-postgres.meta/classify-ptr :added "4.0"}

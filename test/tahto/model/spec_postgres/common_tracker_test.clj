(ns tahto.model.spec-postgres.common-tracker-test
  (:require [tahto.model.spec-postgres.common-tracker :as tracker]
            [postgres.sample.scratch-v1 :as scratch])
  (:use code.test))

^{:refer tahto.model.spec-postgres.common-tracker/tracker-string :added "4.1"}
...
^{:refer tahto.model.spec-postgres.common-tracker/add-tracker :added "4.0"}
...
^{:refer tahto.model.spec-postgres.common-tracker/tracker-map-in :added "4.0"}
...
^{:refer tahto.model.spec-postgres.common-tracker/tracker-map-modify :added "4.0"}

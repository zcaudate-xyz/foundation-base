(ns tahto.model.spec-postgres.form-deftype-hydrate-test
  (:require [tahto.runtime.postgres.base.application :as app]
            [tahto.model.spec-postgres.form-deftype-hydrate :refer :all])
  (:use code.test))
                ...
                (fn [_ _]
                  {:modules {'demo {:code {'Task {:id 'Task
                                         ...
                                         'Status {:id 'Status
                                                  ...
                                                  :section :code
                                                  :static/dbtype :enum}}}}})
                tahto.common.book/get-base-entry
                (fn [book module id section]
                  (get-in book [:modules module section id]))]
    (f)))

^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-check-link :added "4.1"}
(fact "pg-deftype-hydrate-check-link validates snapshot links"
  ...
  (with-redefs [resolve (fn [sym]
                 ...
                 tahto.common.book/get-base-entry (constantly nil)]
    (pg-deftype-hydrate-check-link {}
                                    nil
                                    {:module 'demo :id 'Task :section :code}
                                    :table))
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-link :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-process-sql :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-process-foreign :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-process-ref :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-process-enum :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-attr :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-spec :added "4.1"}
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate :added "4.1"}
(fact "pg-deftype-hydrate adds schema metadata to the form"
  (with-demo-links
    #(with-redefs [tahto.model.spec-postgres.common/pg-hydrate-module-static
...
^{:refer tahto.model.spec-postgres.form-deftype-hydrate/pg-deftype-hydrate-hook :added "4.1"}

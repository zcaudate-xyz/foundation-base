(ns tahto.model.spec-xtalk-optional-test
  (:require [tahto.core :as l]
            [tahto.model.spec-xtalk.fn-js :refer [js-tf-x-str-substring]]
            [tahto.model.spec-xtalk.fn-python :refer [python-tf-x-str-substring]])
  (:use code.test))

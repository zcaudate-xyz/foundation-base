(ns tahto.model.spec-c-test
  (:require [tahto.core :as l]
            [tahto.model.spec-c :refer :all])
  (:use code.test))
...
^{:refer tahto.model.spec-c/tf-define :added "4.0"}
...
^{:refer tahto.model.spec-c/tf-struct :added "4.1"}
...
^{:refer tahto.model.spec-c/tf-arrow :added "4.1"}
(fact "transforms arrow ->"

  (tf-arrow '(arrow ptr field))
  => '(:% ptr (:- "->" field)))

^{:refer tahto.model.spec-c/tf-sizeof :added "4.1"}

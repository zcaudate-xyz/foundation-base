(ns tahto.model.spec-go-test
  (:require [code.test :as t]
            [tahto.core :as l]
            [tahto.base.emit :as emit]
            [tahto.model.spec-go :as spec-go])
  (:use code.test))
...
^{:refer tahto.model.spec-go/go-typesystem :added "4.1"}
...
^{:refer tahto.model.spec-go/go-vector :added "4.1"}
...
^{:refer tahto.model.spec-go/tf-go-arrow :added "4.1"}
...
^{:refer tahto.model.spec-go/go-defstruct :added "4.1"}
(fact "defstruct implementation"
  (spec-go/go-defstruct '(defstruct Person [[name string]]) spec-go/+grammar+ {})
  => "type Person struct {\n  name string\n}")

^{:refer tahto.model.spec-go/go-definterface :added "4.1"}

(ns tahto.model.spec-dart.rewrite-test
  (:require [tahto.core :as l]
             [tahto.model.spec-dart :as dart]
             [tahto.model.spec-dart.rewrite :as rewrite]
             [xt.lang.common-data]
             [std.string :as str])
  (:use code.test))
...
^{:refer tahto.model.spec-dart.rewrite/dart-rewrite-conditional-expression :added "4.1"}
(fact "rewrites dart conditional expressions")

^{:refer tahto.model.spec-dart.rewrite/dart-rewrite-expression :added "4.1"}
(fact "rewrites dart expressions")

^{:refer tahto.model.spec-dart.rewrite/dart-rewrite-statement :added "4.1"}
(fact "rewrites dart statements")

^{:refer tahto.model.spec-dart.rewrite/dart-rewrite-statements :added "4.1"}
(fact "rewrites dart statement blocks")

^{:refer tahto.model.spec-dart.rewrite/dart-rewrite-stage :added "4.1"}

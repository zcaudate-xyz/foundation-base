(ns tahto.model.spec-lua.rewrite-test
  (:require [tahto.core :as l]
            [tahto.core.script :as script]
            [tahto.model.spec-lua :as lua]
            [tahto.model.spec-lua.rewrite :as rewrite])
  (:use code.test))
...
^{:refer tahto.model.spec-lua.rewrite/lua-rewrite-form :added "4.1"}
(fact "rewrites lua forms")

^{:refer tahto.model.spec-lua.rewrite/lua-rewrite-statement :added "4.1"}
(fact "rewrites lua statements")

^{:refer tahto.model.spec-lua.rewrite/lua-rewrite-statements :added "4.1"}
(fact "rewrites lua statement blocks")

^{:refer tahto.model.spec-lua.rewrite/lua-rewrite-stage :added "4.1"}

(ns tahto.typed.xtalk-lint-test
  (:use code.test)
  (:require [tahto.typed.xtalk-lint :refer :all]))

(defn fixture
  [form]
  (with-meta form {:file "fixture.clj" :line 12 :column 4}))

^{:refer tahto.typed.xtalk-lint/canonical-head :added "4.1"}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1"}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id canonical-conditional}
(fact "accepts value conditionals"
  (lint-form (fixture '(var value (:? test 1 2))) :statement {})
  => [])

^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id redundant-access}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id nested-dot-access}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id defaulted-access}
(fact "keeps explicit x-get-key defaults"
  (lint-form '(return (xt/x:get-key m "name" "unknown")) :statement {})
  => [])

^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id redundant-dot-binding}
...
^{:refer tahto.typed.xtalk-lint/var-merge-diagnostics :added "4.1"}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id fn-arrow-canonical}
...
^{:refer tahto.typed.xtalk-lint/lint-top-form :added "4.1" :id fn-arrow-fact}
...
^{:refer tahto.typed.xtalk-lint/lint-top-form :added "4.1" :id nested-dot-fact}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id destructuring-collision}
...
^{:refer tahto.typed.xtalk-lint/simple-destructuring-source? :added "4.1"}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id destructuring-source}
...
^{:refer tahto.typed.xtalk-lint/lint-form :added "4.1" :id loop-context}
...
^{:refer tahto.typed.xtalk-lint/lint-file :added "4.1"}
...
^{:refer tahto.typed.xtalk-lint/summarize :added "4.1"}

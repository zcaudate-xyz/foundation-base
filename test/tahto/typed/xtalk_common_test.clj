(ns tahto.typed.xtalk-common-test
  (:use code.test)
  (:require [tahto.typed.xtalk-common :refer :all]))
...
^{:refer tahto.typed.xtalk-common/primitive-type :added "4.1"}
(fact "builds primitive type maps"
  (primitive-type :xt/str)
  => '{:kind :primitive :name :xt/str})

^{:refer tahto.typed.xtalk-common/snake-case-string :added "4.1"}
(fact "normalizes dash names to snake case"
  (snake-case-string "route-path")
  => "route_path")

^{:refer tahto.typed.xtalk-common/maybe-type :added "4.1"}
(fact "wraps maybe types"
  (maybe-type +str-type+)
  => '{:kind :maybe :item {:kind :primitive :name :xt/str}})

^{:refer tahto.typed.xtalk-common/union-type :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/source-loc :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/register-macro! :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/register-value! :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/make-spec-def :added "4.1"}
(fact "constructs spec defs"
  (sample-spec)
  => '{:ns "sample.route" :name "User" :type {:kind :primitive :name :xt/str} :spec-meta {:doc "user"}
       :file "sample.clj" :line 10 :column 5})

^{:refer tahto.typed.xtalk-common/make-arg :added "4.1"}
(fact "constructs args"
  (make-arg 'id +str-type+ [:rest])
  => '{:name id :type {:kind :primitive :name :xt/str} :modifiers [:rest]})

^{:refer tahto.typed.xtalk-common/make-fn-def :added "4.1"}
(fact "constructs fn defs"
  (:name (sample-fn))
  => "find-user")

^{:refer tahto.typed.xtalk-common/make-value-def :added "4.1"}
(fact "constructs value defs"
  (:raw-value (sample-value))
  => {:a 1})

^{:refer tahto.typed.xtalk-common/spec-def? :added "4.1"}
(fact "detects spec defs"
  (spec-def? (sample-spec))
  => true)

^{:refer tahto.typed.xtalk-common/fn-def? :added "4.1"}
(fact "detects non-macro fn defs"
  (fn-def? (sample-fn))
  => true)

^{:refer tahto.typed.xtalk-common/macro-def? :added "4.1"}
(fact "detects macro defs"
  (macro-def? (sample-macro))
  => true)

^{:refer tahto.typed.xtalk-common/generator-def? :added "4.1"}
(fact "detects generator defs"
  (generator-def? (sample-generator))
  => true)

^{:refer tahto.typed.xtalk-common/value-def? :added "4.1"}
(fact "detects value defs"
  (value-def? (sample-value))
  => true)

^{:refer tahto.typed.xtalk-common/declaration-kind :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/field-key :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/likely-type-symbol? :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/resolve-type-symbol :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/normalize-record-field :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/normalize-apply-target :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/normalize-type :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/normalize-return-meta :added "4.1"}
...
^{:refer tahto.typed.xtalk-common/fn-type :added "4.1"}

(ns tahto.typed.xtalk-intrinsic-test
  (:use code.test)
  (:require [tahto.typed.xtalk-common :as types]
            [tahto.typed.xtalk-intrinsic :refer :all]))
...
^{:refer tahto.typed.xtalk-intrinsic/first-item :added "4.1"}
(fact "returns first tuple item"
  (:type (first-item '(intrinsic pair) {} (callbacks)))
  => '{:kind :primitive :name :xt/str})

^{:refer tahto.typed.xtalk-intrinsic/second-item :added "4.1"}
(fact "returns second tuple item"
  (:type (second-item '(intrinsic pair) {} (callbacks)))
  => '{:kind :primitive :name :xt/int})

^{:refer tahto.typed.xtalk-intrinsic/const-fn :added "4.1"}
...
^{:refer tahto.typed.xtalk-intrinsic/obj-assign :added "4.1"}
...
^{:refer tahto.typed.xtalk-intrinsic/make-container :added "4.1"}
...
^{:refer tahto.typed.xtalk-intrinsic/blank-container :added "4.1"}
...
^{:refer tahto.typed.xtalk-intrinsic/infer-intrinsic :added "4.1"}
(fact "dispatches intrinsic rules by symbol"
  [(-> (infer-intrinsic '(tahto.typed.xtalk-intrinsic/arrayify numbers) {} (callbacks)) :type)
   (infer-intrinsic '(tahto.typed.xtalk-intrinsic/missing numbers) {} (callbacks))]

(ns tahto.typed.xtalk-call-test
  (:use code.test)
  (:require [tahto.typed.xtalk-call :refer :all]
            [tahto.typed.xtalk-common :as types]
            [tahto.typed.xtalk-compat :refer [result]]
...
^{:refer tahto.typed.xtalk-call/infer-op-spec-form :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/wildcard-callable? :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/callable-types :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/call-arg-errors :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/optional-arity? :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/infer-function-call :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/infer-builtin-form :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/rest-input-type? :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/split-call-inputs :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/call-arity? :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/expected-call-inputs :added "4.1"}
...
^{:refer tahto.typed.xtalk-call/expected-call-arity :added "4.1"}

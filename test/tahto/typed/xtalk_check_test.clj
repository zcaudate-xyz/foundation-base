(ns tahto.typed.xtalk-check-test
  (:use code.test)
  (:require [tahto.typed.xtalk-check :refer :all]
...
^{:refer tahto.typed.xtalk-check/function-env :added "4.1"}
...
^{:refer tahto.typed.xtalk-check/check-fn-def :added "4.1"}
...
^{:refer tahto.typed.xtalk-check/check-function :added "4.1"}
(fact "checks fn defs or symbols when registered"
  (do
    ...
    [(-> (check-function (fixture-function "find-user")) :function)
     (-> (check-function 'tahto.model.spec-xtalk-typed-fixture/find-user) :function)

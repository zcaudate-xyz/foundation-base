(ns tahto.typed.xtalk-ops-test
  (:use code.test)
  (:require [tahto.typed.xtalk-common :as types]
            [tahto.typed.xtalk-ops :refer :all]))

^{:refer tahto.typed.xtalk-ops/op-table-vars :added "4.1"}
(fact "finds grammar op table vars"
  (pos? (count (op-table-vars 'tahto.base.grammar-spec)))
  => true)

^{:refer tahto.typed.xtalk-ops/op-entries :added "4.1"}
(fact "collects builtin op entries"
  (boolean (some #(contains? (:symbol %) 'x:get-key) (op-entries)))
  => true)

^{:refer tahto.typed.xtalk-ops/canonical-symbol-from-entry :added "4.1"}
...
^{:refer tahto.typed.xtalk-ops/op-types :added "4.1"}
...
^{:refer tahto.typed.xtalk-ops/builtin-type :added "4.1"}
...
^{:refer tahto.typed.xtalk-ops/builtin? :added "4.1"}

(ns tahto.typed.xtalk-compat-test
  (:use code.test)
...
^{:refer tahto.typed.xtalk-compat/result :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/with-loc :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/merge-errors :added "4.1"}
(fact "merges error lists from inference results"
  (merge-errors (result types/+str-type+ [{:tag :a}])
                (result types/+int-type+ [{:tag :b}]))
  => '[{:tag :a} {:tag :b}])

^{:refer tahto.typed.xtalk-compat/resolve-local-symbol :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/compatible-type? :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/literal-type :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/field-literal :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/literal-key-type :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/field-access-type :added "4.1"}
...
^{:refer tahto.typed.xtalk-compat/object-value-type :added "4.1"}

(ns tahto.base.emit-helper-test
  (:require [tahto.base.emit-common :as common]
            [tahto.base.emit-helper :as helper :refer :all]
...
^{:refer tahto.base.emit-helper/default-emit-fn :added "4.0"}
(fact "the default emit function"
  (default-emit-fn 'abc {} {}) => "abc")

^{:refer tahto.base.emit-helper/pr-single :added "3.0"}
...
^{:refer tahto.base.emit-helper/get-option :added "3.0"}
...
^{:refer tahto.base.emit-helper/get-options :added "3.0"}
...
^{:refer tahto.base.emit-helper/form-key-base :added "4.0"}
...
^{:refer tahto.base.emit-helper/basic-typed-args :added "4.0"}
...
^{:refer tahto.base.emit-helper/emit-typed-allowed-args :added "4.0"}
(fact "allowed declared args other than symbols"
  (emit-typed-allowed-args [[{:modifiers [:int]}] {:modifiers [:int]}] {:allow {:assign #{:symbol}}})
  => throws)

^{:refer tahto.base.emit-helper/emit-typed-args :added "3.0"}
...
^{:refer tahto.base.emit-helper/emit-symbol-full :added "4.0"}
(fact "emits a full symbol"

  (emit-symbol-full 'hello 'ns +grammar+)
  => "ns____hello")

^{:refer tahto.base.emit-helper/emit-type-record :added "4.0"}
...
^{:refer tahto.base.emit-helper/rest-arg-form? :added "4.1"}
...
^{:refer tahto.base.emit-helper/rest-arg-symbol :added "4.1"}

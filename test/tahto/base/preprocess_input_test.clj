(ns tahto.base.preprocess-input-test
  (:use code.test)
  (:require [tahto.base.emit-preprocess :as preprocess] [tahto.base.preprocess-base :as preprocess-base]
            [tahto.base.preprocess-input :refer :all]))

^{:refer tahto.base.preprocess-input/to-input-form :added "4.1"}
(fact "processes a form"
  ...
  (to-input-form '@#'hello)
  => '(!:deref (var tahto.base.preprocess-input-test/hello))
...
^{:refer tahto.base.preprocess-input/to-input :added "4.1"}
...
^{:refer tahto.base.preprocess-input/eval-template-forms :added "4.1"}

...
^{:refer tahto.base.emit-block/test-fn-emit.fn :adopt true :added "4.0"}
(fact "emit do*"
...
^{:refer tahto.base.emit-block/test-fn-emit.name :adopt true :added "4.0"}
(fact "emit do*"

(ns tahto.base.preprocess-assign-test
  (:use code.test)
  (:require [tahto.base.emit-prep-lua-test :as prep]
            [tahto.base.preprocess-assign :refer :all]
...
^{:refer tahto.base.preprocess-assign/process-inline-assignment :added "4.1"}
...
^{:refer tahto.base.preprocess-assign/process-template-assignment :added "4.1"}
...
^{:refer tahto.base.preprocess-assign/protect-reserved-head :added "4.1"}

(ns tahto.base.emit-block-test
  (:require [tahto.base.emit-block :refer :all]
...
^{:refer tahto.base.emit-block/emit-statement :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-do :added "3.0"}
...
^{:refer tahto.base.emit-block/block-options :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-block-body :added "3.0"}
...
^{:refer tahto.base.emit-block/parse-params :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-params-statement :added "3.0"}
(fact "emits the params for statement"

  (emit-params-statement :for {} '[i v :in (pairs x)] +grammar+ {})
  => "i, v in (pairs x)")

^{:refer tahto.base.emit-block/emit-params :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-block-control :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-block-controls :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-block-setup :added "4.0"}
...
^{:refer tahto.base.emit-block/emit-block-inner :added "4.0"}
...
^{:refer tahto.base.emit-block/emit-block-standard :added "3.0"}
...
^{:refer tahto.base.emit-block/emit-block :added "3.0"}
...
^{:refer tahto.base.emit-block/test-block-loop :added "4.0"}
(fact "emits with blocks"
  (test-block-loop '(+ 1 2) +grammar+ {})
  => "1 + 2")

^{:refer tahto.base.emit-block/test-block-emit :added "4.0"}

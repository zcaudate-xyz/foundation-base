(ns tahto.base.emit-block-op-test
  (:require [tahto.base.emit-block :as block]
...
^{:refer tahto.base.emit-block/test-block-loop.do :adopt true :added "4.0"}
(fact "emit do"
...
^{:refer tahto.base.emit-block/test-block-loop.for :adopt true :added "4.0"}
(fact "emit for"
...
^{:refer tahto.base.emit-block/test-block-loop.forange
...
^{:refer tahto.base.emit-block/test-block-loop.if :adopt true :added "4.0"}
(fact "emit if"
...
^{:refer tahto.base.emit-block/test-block-loop.when :adopt true :added "4.0"}
(fact "emit if"
...
^{:refer tahto.base.emit-block/test-block-loop.switch :adopt true :added "4.0"}
(fact "emit switch"
...
^{:refer tahto.base.emit-block/test-block-loop.block :adopt true :added "4.0"}
(fact "emit block"
...
^{:refer tahto.base.emit-block/test-block-loop.try :adopt true :added "4.0"}
(fact "emit try"

(ns tahto.base.preprocess-resolve-test
  (:use code.test)
  (:require [tahto.common.book-entry :as entry]
            [tahto.base.emit-prep-js-test :as prep-js]
            ...
            [tahto.base.preprocess-resolve :refer :all]))

^{:refer tahto.base.preprocess-resolve/get-fragment :added "4.1"}
...
^{:refer tahto.base.preprocess-resolve/process-namespaced-resolve :added "4.1"}
...
^{:refer tahto.base.preprocess-resolve/process-namespaced-symbol :added "4.1"}
...
^{:refer tahto.base.preprocess-resolve/process-standard-symbol :added "4.1"}
...
^{:refer tahto.base.preprocess-resolve/find-natives :added "4.1"}

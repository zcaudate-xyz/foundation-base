(ns tahto.base.grammar-xtalk-system-test
  (:use code.test)
  (:require [tahto.base.grammar-xtalk-system :refer :all]))

^{:refer tahto.base.grammar-xtalk-system/xtalk-entry? :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-profiles :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-areas :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-area-profiles :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-profile-ops :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-op-profiles :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-op-entry :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-symbol-op :added "4.1"}
(fact "maps symbols back to xtalk ops"
  (xtalk-symbol-op 'x:add)
  => :x-add)

^{:refer tahto.base.grammar-xtalk-system/xtalk-symbol-entry :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-op-requires :added "4.1"}
(fact "returns direct required xtalk ops"
  (xtalk-op-requires :x-arr-map)
  => #{})

^{:refer tahto.base.grammar-xtalk-system/xtalk-op-closure :added "4.1"}
(fact "returns transitive op requirements including the op"
  (xtalk-op-closure :x-arr-map)
  => #{:x-arr-map})

^{:refer tahto.base.grammar-xtalk-system/xtalk-ops-profiles :added "4.1"}
(fact "returns the combined profile set for ops"
  (xtalk-ops-profiles #{:x-add :x-arr-map})
  => #{:xtalk-common
       :xtalk-functional})

^{:refer tahto.base.grammar-xtalk-system/scan-xtalk :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-ops-polyfill-symbols :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-grammar-supported-ops :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-grammar-supported-profiles :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-grammar-missing-profiles :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-library-profiles :added "4.1"}
(fact "returns required profiles for new xtalk library namespaces"
  (xtalk-library-profiles 'xtalk.lib.db.sql)
  => #{:xtalk-common
       :xtalk-runtime-specific})

^{:refer tahto.base.grammar-xtalk-system/xtalk-unclassified-ops :added "4.1"}
(fact "returns xtalk ops not assigned to any profile"
  (xtalk-unclassified-ops)
  => [])


^{:refer tahto.base.grammar-xtalk-system/xtalk-op-polyfill-symbol :added "4.1"}
...
^{:refer tahto.base.grammar-xtalk-system/xtalk-ops-polyfill-modules :added "4.1"}

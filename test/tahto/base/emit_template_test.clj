(ns tahto.base.emit-template-test
  (:use code.test)
  (:require [tahto.base.emit-template :refer :all]
            [tahto.model.spec-js :as js]))

^{:refer tahto.base.emit-template/entry-reserved :added "4.1"}
...
^{:refer tahto.base.emit-template/materialize-code-entry :added "4.1"}
...
^{:refer tahto.base.emit-template/create-code-state :added "4.1"}
...
^{:refer tahto.base.emit-template/cached-code-state :added "4.1"}
...
^{:refer tahto.base.emit-template/cached-entry-deps :added "4.1"}
...
^{:refer tahto.base.emit-template/code-state-computing? :added "4.1"}

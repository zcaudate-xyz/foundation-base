(ns tahto.base.emit-assign-test
  (:require [tahto.common.book :as b]
            [tahto.base.emit-assign :as assign :refer :all]
...
^{:refer tahto.base.emit-assign/emit-def-assign-inline :added "4.0"}
...
^{:refer tahto.base.emit-assign/assign-options :added "4.1"}
...
^{:refer tahto.base.emit-assign/assign-value :added "4.1"}
...
^{:refer tahto.base.emit-assign/emit-def-assign :added "3.0"}
...
^{:refer tahto.base.emit-assign/test-assign-loop :adopt true :added "4.0"}
(fact "emit do"
...
^{:refer tahto.base.emit-assign/test-assign-emit :added "4.0"}

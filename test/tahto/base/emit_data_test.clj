...
^{:refer tahto.base.emit-data/default-map-key :added "4.0"}
...
^{:refer tahto.base.emit-data/emit-map-key :added "4.0"}
...
^{:refer tahto.base.emit-data/emit-map-entry :added "3.0"}
...
^{:refer tahto.base.emit-data/emit-singleline-array? :added "4.0"}
...
^{:refer tahto.base.emit-data/emit-maybe-multibody :added "4.0"}
(fact "checks that array is all single lines"
...
^{:refer tahto.base.emit-data/emit-coll-layout :added "4.0"}
...
^{:refer tahto.base.emit-data/emit-coll :added "3.0"}
...
^{:refer tahto.base.emit-data/emit-data-standard :added "4.0"}
(fact "emits either a custom string or default coll"
  (emit-data-standard :vector [1 2 3] helper/+default+ {})
  => "[1,2,3]")

^{:refer tahto.base.emit-data/emit-data :added "3.0"}
...
^{:refer tahto.base.emit-data/emit-quote :added "4.0"}
(fact "emit quote structures"

  (emit-quote nil nil ''(1 2 3) +grammar+ {})
  => "(1,2,3)")

^{:refer tahto.base.emit-data/emit-table-group :added "4.0"}
(fact "gets table group"
  (emit-table-group [:a 1 :b 2 :c :d])
  => [[:a 1] [:b 2] 'c 'd])

^{:refer tahto.base.emit-data/emit-table :added "4.0"}
(fact "emit quote structures"

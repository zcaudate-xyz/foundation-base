(ns tahto.base.emit-common-op-test
...
^{:refer tahto.base.emit-common/emit-common-loop :adopt true :added "4.0"}
(fact "emit raw ops"
...
^{:refer tahto.base.emit-common/emit-common :adopt true :added "4.0"}
(fact "emit main raw"

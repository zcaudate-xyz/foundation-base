(ns lang.typed.xtalk-lower-test
  (:use code.test)
  (:require [lang.typed.xtalk-common :as types]
            [lang.typed.xtalk-infer :as infer]
            [lang.typed.xtalk-lower :refer :all]))

(def +ctx+ {:ns 'sample.route :aliases '{k xt.lang.common-lib}})

^{:refer lang.typed.xtalk-lower/intrinsic-sym :added "4.1"}
(fact "builds intrinsic symbols"
  (intrinsic-sym "arrayify")
  => 'lang.typed.xtalk-intrinsic/arrayify)

^{:refer lang.typed.xtalk-lower/resolve-op :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/access-kind :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-dot :id lower-dot-annotated :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-dot :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-dot :id lower-dot-method-call :added "4.1"}
(fact "preserves list-shaped native method calls"
  (lower-dot '(. arr (filter pred)))
  => '(. arr (filter pred)))

^{:refer lang.typed.xtalk-lower/lower-form :id lower-assignment-target :added "4.1"}
(fact "preserves structural access on assignment targets"
  (lower-form '(:= (. prev ["current"]) value) {})
  => '(:= (. prev ["current"]) value))

^{:refer lang.typed.xtalk-lower/lower-fn-shorthand :added "4.1"}
(fact "lowers fn:> shorthands"
  [(lower-fn-shorthand '(fn:>))
   (lower-fn-shorthand '(fn:> [x] x))
   (lower-fn-shorthand '(fn:> "ok"))]
  => '[(lang.typed.xtalk-intrinsic/const-fn nil)
       (fn [x] x)
       (lang.typed.xtalk-intrinsic/const-fn "ok")])

^{:refer lang.typed.xtalk-lower/lower-defaulted-target :added "4.1"}
(fact "applies defaulted targets"
  (lower-defaulted-target 'x:get-key '[obj "k" "fallback"])
  => '(x:get-key obj "k" "fallback"))

^{:refer lang.typed.xtalk-lower/lower-offset-index :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-list :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-list :id preserve-runtime-helpers :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-form :id preserve-structural-forms :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-list :id preserve-value-conditionals :added "4.1"}
(fact "leaves value conditionals for target-language staging"
  (lower-list '(:? test 1 2) {:preserve-unknown true})
  => '(:? test 1 2))

^{:refer lang.typed.xtalk-lower/lower-form :added "4.1"}
...
^{:refer lang.typed.xtalk-lower/lower-form

(ns lang.typed.xtalk-analysis-test
  (:use code.test)
  (:require [lang.typed.xtalk-analysis :refer :all]
...
(fact "returns raw parsed analysis without spec attachment"
  (let [result (analyze-file-raw "test/lang/model/spec_xtalk_typed_fixture.clj")]
    [(map? result)
     ...
     (= (:ns result) 'lang.model.builtin.spec-xtalk-typed-fixture)])
  => [true true true])

^{:refer lang.typed.xtalk-analysis/analyze-namespace :added "4.1"}
  ...
  => '{:ns lang.model.builtin.spec-xtalk-typed-fixture
       ...
       :functions [{:name "find-user"
                   ...
                   {:name "wrong-user-name"
                    ...
                    :output {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/User}}
...
^{:refer lang.typed.xtalk-analysis/analyze-namespace-raw :added "4.1"}
(fact "exposes raw analysis without same-name spec attachment"
  (let [analysis (analyze-namespace-raw 'lang.model.builtin.spec-xtalk-typed-fixture)
...
^{:refer lang.typed.xtalk-analysis/analyze-and-register! :added "4.1"}
(fact "registers analysis results"
  (do
    (types/clear-registry!)
    (analyze-and-register! 'lang.model.builtin.spec-xtalk-typed-fixture)
    (some? (types/get-function 'lang.model.builtin.spec-xtalk-typed-fixture/find-user)))
  => true)

^{:refer lang.typed.xtalk-analysis/resolve-function-def :added "4.1"}
(fact "resolves function defs from symbols"
  (do
    (types/clear-registry!)
    (:name (resolve-function-def 'lang.model.builtin.spec-xtalk-typed-fixture/find-user)))
  => "find-user")

^{:refer lang.typed.xtalk-analysis/get-function-report :added "4.1"}
(fact "provides function report examples"
  (do
    (types/clear-registry!)
    {:ok (get-function-report 'lang.model.builtin.spec-xtalk-typed-fixture/find-user)
     :bad (-> (get-function-report 'lang.model.builtin.spec-xtalk-typed-fixture/wrong-user-name)
              (update :errors
                      (fn [errors]
                        (mapv #(select-keys % [:tag :expected :actual])
                              errors))))})
  => '{:ok {:function lang.model.builtin.spec-xtalk-typed-fixture/find-user
            :declared {:inputs [{:name users
                                 :type {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/UserMap}}
                                {:name id
            ...
            :return {:kind :maybe
                     :item {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/User}}
            :errors []}
       :bad {:function lang.model.builtin.spec-xtalk-typed-fixture/wrong-user-name
             ...
             :errors [{:tag :return-type-mismatch
                       :expected {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/User}
                       :actual {:kind :primitive :name :xt/str}}]}})

^{:refer lang.typed.xtalk-analysis/get-function-input-type :added "4.1"}
(fact "returns named input types as data"
  (do
    (types/clear-registry!)
    (get-function-input-type 'lang.model.builtin.spec-xtalk-typed-fixture/find-user 'id))
  => '{:kind :primitive :name :xt/str})

^{:refer lang.typed.xtalk-analysis/get-function-output-type :added "4.1"}
(fact "returns function output types as data"
  (do
    (types/clear-registry!)
    (get-function-output-type 'lang.model.builtin.spec-xtalk-typed-fixture/find-user))
  => '{:kind :maybe :item {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/User}})

^{:refer lang.typed.xtalk-analysis/check-namespace :added "4.1"}
(fact "provides namespace report examples"
  (do
    (types/clear-registry!)
    (let [report (check-namespace 'lang.model.builtin.spec-xtalk-typed-fixture)]
      {:namespace (:namespace report)
       :functions (mapv (fn [{:keys [function return errors]}]
                        ...
                        (:functions report))}))
  => '{:namespace lang.model.builtin.spec-xtalk-typed-fixture
       :functions [{:function lang.model.builtin.spec-xtalk-typed-fixture/find-user
                    :return {:kind :maybe
                             :item {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/User}}
                    :error-tags []}
                   {:function lang.model.builtin.spec-xtalk-typed-fixture/wrong-user-name
                    :return {:kind :primitive :name :xt/str}
                    :error-tags [:return-type-mismatch]}
                   {:function lang.model.builtin.spec-xtalk-typed-fixture/find-user-wrong-key
                    :return {:kind :maybe
                             :item {:kind :named :name lang.model.builtin.spec-xtalk-typed-fixture/User}}
                    :error-tags [:call-arg-type-mismatch]}]})

^{:refer lang.typed.xtalk-analysis/report-json :added "4.1"}

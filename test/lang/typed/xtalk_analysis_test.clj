  ...
  => '{:ns lang.model.spec-xtalk-typed-fixture
       ...
       :functions [{:name "find-user"
                   ...
                   {:name "wrong-user-name"
                    ...
                    :output {:kind :named :name lang.model.spec-xtalk-typed-fixture/User}}
...
(fact "exposes raw analysis without same-name spec attachment"
  (let [analysis (analyze-namespace-raw 'lang.model.spec-xtalk-typed-fixture)
...
(fact "registers analysis results"
  (do
    ...
    (analyze-and-register! 'lang.model.spec-xtalk-typed-fixture)
...
(fact "resolves function defs from symbols"
  (do
    (types/clear-registry!)
    (:name (resolve-function-def 'lang.model.spec-xtalk-typed-fixture/find-user)))
  => "find-user")
...
(fact "provides function report examples"
  (do
    (types/clear-registry!)
    {:ok (get-function-report 'lang.model.spec-xtalk-typed-fixture/find-user)
     :bad (-> (get-function-report 'lang.model.spec-xtalk-typed-fixture/wrong-user-name)
              (update :errors
                      (fn [errors]
                        (mapv #(select-keys % [:tag :expected :actual])
                              errors))))})
  => '{:ok {:function lang.model.spec-xtalk-typed-fixture/find-user
            :declared {:inputs [{:name users
                                 :type {:kind :named :name lang.model.spec-xtalk-typed-fixture/UserMap}}
                                {:name id
            ...
            :return {:kind :maybe
                     :item {:kind :named :name lang.model.spec-xtalk-typed-fixture/User}}
            :errors []}
       :bad {:function lang.model.spec-xtalk-typed-fixture/wrong-user-name
             ...
             :errors [{:tag :return-type-mismatch
                       :expected {:kind :named :name lang.model.spec-xtalk-typed-fixture/User}
...
(fact "returns named input types as data"
  (do
    (types/clear-registry!)
    (get-function-input-type 'lang.model.spec-xtalk-typed-fixture/find-user 'id))
  => '{:kind :primitive :name :xt/str})
...
(fact "returns function output types as data"
  (do
    (types/clear-registry!)
    (get-function-output-type 'lang.model.spec-xtalk-typed-fixture/find-user))
...
(fact "provides namespace report examples"
  (do
    (types/clear-registry!)
    (let [report (check-namespace 'lang.model.spec-xtalk-typed-fixture)]
      {:namespace (:namespace report)
       :functions (mapv (fn [{:keys [function return errors]}]
                        ...
                        (:functions report))}))
  => '{:namespace lang.model.spec-xtalk-typed-fixture
       :functions [{:function lang.model.spec-xtalk-typed-fixture/find-user
                    :return {:kind :maybe
                             :item {:kind :named :name lang.model.spec-xtalk-typed-fixture/User}}
                    :error-tags []}
                   {:function lang.model.spec-xtalk-typed-fixture/wrong-user-name
                    :return {:kind :primitive :name :xt/str}
                    :error-tags [:return-type-mismatch]}
                   {:function lang.model.spec-xtalk-typed-fixture/find-user-wrong-key
                    :return {:kind :maybe
                             :item {:kind :named :name lang.model.spec-xtalk-typed-fixture/User}}

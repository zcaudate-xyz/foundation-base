(ns lang.seedgen.cli-test
  (:require [lang.seedgen.cli :as cli])
  (:use code.test))

^{:refer lang.seedgen.cli/collect-selector :added "4.1"}
...
^{:refer lang.seedgen.cli/parse-test-args :added "4.1"}
...
^{:refer lang.seedgen.cli/parse-command-args :added "4.1"}
...
^{:refer lang.seedgen.cli/seedgen-test :added "4.1"}
...
^{:refer lang.seedgen.cli/failure-tree :added "4.1"}
...
^{:refer lang.seedgen.cli/-main :added "4.1"}
(fact "is the CLI entry point"
  (var? #'cli/-main) => true
  (:doc (meta #'cli/-main)) => "main entry point for lein seedgen")

^{:refer lang.seedgen.cli/seedgen-todos :added "4.1"}

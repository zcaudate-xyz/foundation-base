(ns lang.seedgen.common-infile-test
  ...
  (:require [code.project :as project]
            [lang.seedgen.common-infile :as seed-infile]))

^{:refer lang.seedgen.common-infile/seedgen-root :added "4.1"}
...
^{:refer lang.seedgen.common-infile/seedgen-list :added "4.1"}
...
^{:refer lang.seedgen.common-infile/seedgen-incomplete :added "4.1"}

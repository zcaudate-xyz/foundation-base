...
^{:refer lang.seedgen.form-infile/root-script-meta-langs :added "4.1"}
...
^{:refer lang.seedgen.form-infile/render-top-level-target :added "4.1"}
(fact "renders a file for a single target language"
  (run-render-target) => [true true true true true true])

^{:refer lang.seedgen.form-infile/seedgen-langadd :added "4.1" :timeout 300000}
...
^{:refer lang.seedgen.form-infile/seedgen-langremove :added "4.1"}

(ns lang.seedgen.common-util-test
  ...
  (:require [clojure.string :as str]
            [lang.seedgen.common-util :refer :all]
            [std.fs :as fs]))

^{:refer lang.seedgen.common-util/require-alias :added "4.1"}
(fact "extracts the :as alias for a require target"
  (require-alias '[lang.core :as l] 'lang.core) => 'l
  (require-alias '[lang.core] 'lang.core) => nil
  (require-alias '[clojure.string :as str] 'lang.core) => nil
  (require-alias 'lang.core 'lang.core) => nil)

^{:refer lang.seedgen.common-util/seedgen-script-heads :added "4.1"}
(fact "discovers script- heads from a namespace form"
  (seedgen-script-heads '(ns sample
                           (:require [lang.core :as l])))
  => #{'lang.core/script- 'l/script-}

  (seedgen-script-heads '(ns sample)) => #{'lang.core/script-})

^{:refer lang.seedgen.common-util/seedgen-root-langs :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-dispatch-map :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-dispatch-tag-map :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-normalize-runtime-lang :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-dispatch-tag :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-default-runtime :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-dispatch-lang :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-runtime-reference-lang :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-runtime-dispatch-langs :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-form-lang :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-fact-forms :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-base-config :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-lang-config :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-lang-entry :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-root-entry :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-suppressed-langs :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-coverage-langs :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-display-lang :added "4.1"}
...
^{:refer lang.seedgen.common-util/seedgen-skip? :added "4.1"}

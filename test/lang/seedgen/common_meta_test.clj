(ns lang.seedgen.common-meta-test
  (:use code.test)
  (:require [lang.seedgen.common-meta :refer :all]))

^{:refer lang.seedgen.common-meta/normalize-runtime-lang :added "4.1"}
...
^{:refer lang.seedgen.common-meta/runtime-lang-config :added "4.1"}
...
^{:refer lang.seedgen.common-meta/runtime-script-lang :added "4.1"}
...
^{:refer lang.seedgen.common-meta/runtime-dispatch-symbol :added "4.1"}
...
^{:refer lang.seedgen.common-meta/runtime-suite-groups :added "4.1"}
...
^{:refer lang.seedgen.common-meta/runtime-lang-suffix :added "4.1"}

(ns lang.seedgen.metrics-test
  (:require [lang.seedgen.metrics :refer :all])
  (:use code.test))

^{:refer lang.seedgen.metrics/test-record :added "4.1"}
...
^{:refer lang.seedgen.metrics/aggregate-records :added "4.1"}
...
^{:refer lang.seedgen.metrics/update-index :added "4.1"}

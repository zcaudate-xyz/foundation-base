...
^{:refer lang.core.model-spec-bash/CANARY :guard true :adopt true :added "3.0"}
(fact "PRELIM CHECKS"
...
^{:refer lang.model.builtin.spec-bash/PLAYGROUND :adopt true :added "4.0"
  :setup [(lang.core.type-notify/clear-sink (l/default-notify)
                                                      "test")]}
(fact "various features"

  ;; NOTIFY
  (do (def +p+ (lang.core.type-notify/watch-oneshot (l/default-notify)
                                                             100
                                                             "test"))
...
^{:refer lang.model.builtin.spec-bash/bash-quote-item :added "4.0"}
(fact "quotes an item"

  (bash-quote-item "hello" +grammar+ {})
  => "\"\\\"hello\\\"\"")

^{:refer lang.model.builtin.spec-bash/bash-set :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-quote :added "4.0"}
(fact "quotes a string value"
...
^{:refer lang.model.builtin.spec-bash/bash-dash-param :added "4.0"}
(fact "if keyword, replace `:` with `-`"

  (bash-dash-param :hello)
  => "-hello")

^{:refer lang.model.builtin.spec-bash/bash-map :added "4.0"}
(fact "outputs a map"
...
^{:refer lang.model.builtin.spec-bash/bash-invoke :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-assign :added "4.0"}
(fact "outputs an assignment"

  (bash-assign '(:= a 1) +grammar+ {})
  => "a=1")

^{:refer lang.model.builtin.spec-bash/bash-var :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-defn :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-expand :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-subshell :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-test :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-pipeleft :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-piperight :added "4.0"}
(fact "constructs pipeleft syntax"
...
^{:refer lang.model.builtin.spec-bash/bash-here :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-check-fn :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-when :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-if :added "4.0"}
...
^{:refer lang.model.builtin.spec-bash/bash-cond :added "4.0"}

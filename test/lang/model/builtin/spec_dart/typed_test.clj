(ns lang.model.builtin.spec-dart.typed-test
  (:use code.test)
  (:require [clojure.string :as str]
            [lang.model.builtin.spec-dart.typed :refer :all]))
...
^{:refer lang.model.builtin.spec-dart.typed/sanitize-ident :added "4.1"}
(fact "sanitizes dart identifiers"
  [(sanitize-ident "hello-world")
   (sanitize-ident "123hello")]
  => ["hello_world" "_123hello"])

^{:refer lang.model.builtin.spec-dart.typed/lower-camel :added "4.1"}
(fact "converts identifiers to lower camel case"
  [(lower-camel "display-name")
   (lower-camel "UserMap")]
  => ["displayName" "userMap"])

^{:refer lang.model.builtin.spec-dart.typed/upper-camel :added "4.1"}
(fact "converts identifiers to upper camel case"
  [(upper-camel "display-name")
   (upper-camel "userMap")]
  => ["DisplayName" "UserMap"])

^{:refer lang.model.builtin.spec-dart.typed/named-dart-ident :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/lossy-dart-type :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/maybe-unwrapped :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/emit-class-field :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/emit-class-constructor :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/emit-record-class :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/emit-spec-declaration :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/emit-function-declaration :added "4.1"}
...
^{:refer lang.model.builtin.spec-dart.typed/emit-value-declaration :added "4.1"}

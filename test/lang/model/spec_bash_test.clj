(ns lang.model.spec-bash-test
  (:require [lang.core :as l]
            [lang.model.spec-bash :refer :all]
...
^{:refer lang.model.spec-bash/PLAYGROUND :adopt true :added "4.0"
...
^{:refer lang.model.spec-bash/bash-quote-item :added "4.0"}
(fact "quotes an item"

  (bash-quote-item "hello" +grammar+ {})
  => "\"\\\"hello\\\"\"")

^{:refer lang.model.spec-bash/bash-set :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-quote :added "4.0"}
(fact "quotes a string value"
...
^{:refer lang.model.spec-bash/bash-dash-param :added "4.0"}
(fact "if keyword, replace `:` with `-`"

  (bash-dash-param :hello)
  => "-hello")

^{:refer lang.model.spec-bash/bash-map :added "4.0"}
(fact "outputs a map"
...
^{:refer lang.model.spec-bash/bash-invoke :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-assign :added "4.0"}
(fact "outputs an assignment"

  (bash-assign '(:= a 1) +grammar+ {})
  => "a=1")

^{:refer lang.model.spec-bash/bash-var :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-defn :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-expand :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-subshell :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-test :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-pipeleft :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-piperight :added "4.0"}
(fact "constructs pipeleft syntax"
...
^{:refer lang.model.spec-bash/bash-here :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-check-fn :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-when :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-if :added "4.0"}
...
^{:refer lang.model.spec-bash/bash-cond :added "4.0"}

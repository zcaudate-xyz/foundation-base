(ns lang.model.annex.spec-rust-test
  (:require [std.fs :as fs]
            ...
            [lang.model.annex.spec-rust :refer :all]
            [std.lib.os :as os]
...
^{:refer lang.model.annex.spec-rust/rst-typesystem :added "4.0"}
(fact "emits rust typesystem syntax")

^{:refer lang.model.annex.spec-rust/rst-vector :added "4.0"}
(fact "emits rust vector syntax")

^{:refer lang.model.annex.spec-rust/rst-attributes :added "4.0"}
(fact "emits rust attributes")

^{:refer lang.model.annex.spec-rust/rst-defenum :added "4.0"}
(fact "emits rust enum definition")

^{:refer lang.model.annex.spec-rust/rst-deftrait :added "4.0"}
(fact "emits rust trait definition")

^{:refer lang.model.annex.spec-rust/rst-defimpl :added "4.0"}
(fact "emits rust impl definition")

^{:refer lang.model.annex.spec-rust/rst-new :added "4.0"}
(fact "emits rust new expression")

^{:refer lang.model.annex.spec-rust/rst-exec :added "4.0"}
(fact "emits rust exec block")

^{:refer lang.model.annex.spec-rust/rst-defstruct :added "4.0"}

...
^{:refer lang.model.spec-c/tf-define :added "4.0"}
...
^{:refer lang.model.spec-c/tf-struct :added "4.1"}
...
^{:refer lang.model.spec-c/tf-arrow :added "4.1"}
(fact "transforms arrow ->"

  (tf-arrow '(arrow ptr field))
  => '(:% ptr (:- "->" field)))

^{:refer lang.model.spec-c/tf-sizeof :added "4.1"}

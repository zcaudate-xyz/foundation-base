(ns lang.model.spec-lua.c-ffi-test
  (:require [lang.model.spec-lua.c-ffi :as c])
  (:use code.test))

^{:refer lang.model.spec-lua.c-ffi/c-ffi-type :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-sym :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-form? :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-fn-form? :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-forms :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-args :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-decl :added "4.1"}
...
^{:refer lang.model.spec-lua.c-ffi/c-ffi-body->string :added "4.1"}

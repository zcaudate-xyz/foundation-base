...
^{:refer lang.model.annex.spec-postgres/CANARY :adopt true :added "4.0"}
...
^{:refer lang.model.annex.spec-postgres/CANARY.select :adopt true :added "4.0"}
(fact "BASIC SELECT"
...
^{:refer lang.model.annex.spec-postgres/CANARY.json :adopt true :added "4.0"}

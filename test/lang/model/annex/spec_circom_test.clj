(ns lang.model.annex.spec-circom-test
  (:use code.test)
  (:require [clojure.string :as str]
            [lang.core.impl :as impl]
            [lang.model.annex.spec-circom :refer :all]))

^{:refer lang.model.annex.spec-circom/format-string :added "4.1"}
...
^{:refer lang.model.annex.spec-circom/tf-template :added "4.1"}
...
^{:refer lang.model.annex.spec-circom/tf-component :added "4.1"}
(fact "transforms component instantiation"
  (first (tf-component '(component c (MyTemplate 1 2))))
  => :%)

^{:refer lang.model.annex.spec-circom/tf-signal :added "4.1"}
...
^{:refer lang.model.annex.spec-circom/tf-constraint :added "4.1"}
...
^{:refer lang.model.annex.spec-circom/tf-for :added "4.1"}

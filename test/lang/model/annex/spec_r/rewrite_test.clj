(ns lang.model.annex.spec-r.rewrite-test
  (:require [clojure.walk]
            [lang.base.emit-preprocess :as preprocess]
            [lang.model.annex.spec-r :as r]
            [lang.model.annex.spec-r.rewrite :as rewrite])
  (:use code.test))

^{:refer lang.model.annex.spec-r/tf-defn :added "4.1"}
...
^{:refer lang.model.annex.spec-r.rewrite/r-rewrite-expression :added "4.1"}
(fact "rewrites r expressions")

^{:refer lang.model.annex.spec-r.rewrite/r-rewrite-statement :added "4.1"}
(fact "rewrites r statements")

^{:refer lang.model.annex.spec-r.rewrite/r-rewrite-statements :added "4.1"}
(fact "rewrites r statement blocks")

^{:refer lang.model.annex.spec-r.rewrite/r-rewrite-stage :added "4.1"}

(ns lang.model.annex.spec-php-test
  (:use code.test)
  (:require [lang.core :as l]
            [lang.core.impl :as impl]
            [lang.model.annex.spec-php :as spec-php]))

(l/script :php)

^{:refer lang.model.annex.spec-php/+grammar+ :added "4.1"}
...
^{:refer lang.model.annex.spec-php/php-emit-input-rest :added "4.1"}

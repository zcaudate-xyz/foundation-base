...
^{:refer lang.model.annex.spec-r/tf-for-iter :added "4.0"}
(fact "transform for `for:iter`"
  (tf-for-iter '(for:iter [e it]))
  => '(for [e :in (% it)]))

^{:refer lang.model.annex.spec-r/tf-for-index :added "4.0"}
(fact "transform for `for:index`"
  (tf-for-index '(for:index [i [0 10 3]]))
  => '(for [i :in (seq 0 10 3)]))


^{:refer lang.model.annex.spec-r/r-map :added "4.1"}
(fact "R empty map literal"
  (r-map {} nil nil)
  => "structure(list(), names=character())")

^{:refer lang.model.annex.spec-r/tf-formula :added "4.1"}
(fact "transform for formula"
  (tf-formula '(formula y x))
  => '(:- "y ~ x"))

^{:refer lang.model.annex.spec-r/tf-library :added "4.1"}
(fact "transform for library"
  (tf-library '(library jsonlite))
  => '(:- "library(\"jsonlite\")"))

^{:refer lang.model.annex.spec-r/tf-df :added "4.1"}

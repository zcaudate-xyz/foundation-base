(ns lang.model.spec-postgres.form-deftype-test
  (:require [lang.model.spec-postgres :as g]
            ...
            [lang.model.spec-postgres.form-deftype :refer :all]
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-enum-col :added "4.0"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-ref-link :added "4.0"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-ref-current :added "4.0"}
(fact "creates the ref entry for "

  (pg-deftype-ref-current :col {:current {:id "id" :schema "schema" :type :uuid}} {})
  => '["col_id" [:uuid] [((. #{"schema"} #{"id"}) #{"id"})]])

^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-ref :added "4.0"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-col-sql :added "4.0"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-col-fn :added "4.0"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-primaries :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-indexes :added "4.0"}
(fact "create index statements"

  (pg-deftype-indexes [[:col {:type :text :sql {:index true}}]] "table")
  => '[(% [:create-index :on "table" (quote (#{"col"}))])])

^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-foreign-groups :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-gen-constraint :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-foreigns :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-spec-normalize :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-partition :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype :added "4.0"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-format-fragment :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-format-generated :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-format-raw :added "4.1"}
...
^{:refer lang.model.spec-postgres.form-deftype/pg-deftype-format :added "4.0"}

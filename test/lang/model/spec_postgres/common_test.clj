...
^{:refer lang.model.spec-postgres.common/pg-type-alias :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-sym-meta :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-format :added "4.0"}
(fact "formats a form, extracting static components"

  (common/pg-format '(def ^{:- [:int]} hello 1))
  => vector?)

^{:refer lang.model.spec-postgres.common/pg-policy-format :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-hydrate-module-static :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-hydrate :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-link-symbol :added "4.1"}
(fact "resolves postgres link symbols")

^{:refer lang.model.spec-postgres.common/pg-resolve-entry :added "4.1"}
(fact "resolves postgres entries")

^{:refer lang.model.spec-postgres.common/pg-string :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-uuid :added "4.1"}
(fact "constructs a pg uuid"

  (common/pg-uuid "123")
  => "'123'::uuid")

^{:refer lang.model.spec-postgres.common/pg-map :added "4.0"}
(fact "creates a postgres json object"
  (with-redefs [emit-common/*emit-fn* (fn [& _] "jsonb")]
    (common/pg-map {:a 1} nil nil))
  => "jsonb")

^{:refer lang.model.spec-postgres.common/pg-set :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-linked :added "4.0"}
(fact "emits the linked symbol"
  ;; Skipping complex setup.
  )

^{:refer lang.model.spec-postgres.common/block-do-block :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/block-do-suppress :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/block-loop-block :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/block-while-block :added "4.1"}
(fact "emits while block"
  (common/block-while-block '(= 1 1) '(do-something))
  => '[:while (= 1 1) :loop \\ (\| (do (do-something))) \\ :end-loop \;])

^{:refer lang.model.spec-postgres.common/block-case-block :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-defenum :added "4.0"}
(fact "defenum block"
...
^{:refer lang.model.spec-postgres.common/pg-defindex :added "4.0"}
(fact "defindex block"

  (common/pg-defindex '(defindex hello [table cols] body))
  => '[:create-index :if-not-exists hello :on table (quote ([cols])) body \;])

^{:refer lang.model.spec-postgres.common/pg-defpolicy :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-publication-format :added "4.1"}
(fact "formats publication"
  (common/pg-publication-format '(defpublication pub [:all]))
  => vector?)

^{:refer lang.model.spec-postgres.common/pg-defpublication :added "4.1"}
(fact "defpublication block"
  (common/pg-defpublication '(defpublication pub [:all]))
  => '(do [:drop-publication-if-exists pub]
          [:create-publication pub :for :all :tables]))

^{:refer lang.model.spec-postgres.common/pg-subscription-format :added "4.1"}
(fact "formats subscription"
  (common/pg-subscription-format '(defsubscription sub [conn pub] {}))
  => vector?)

^{:refer lang.model.spec-postgres.common/pg-defsubscription :added "4.1"}
...
^{:refer lang.model.spec-postgres.common/pg-deftrigger :added "4.0"}
...
^{:refer lang.model.spec-postgres.common/pg-defblock :added "4.0"}

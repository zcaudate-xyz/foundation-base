(ns lang.model.spec-solidity-test
  (:require [lang.model.spec-solidity :as g]
            [lang.core :as l]
            [lang.base.emit :as emit]
            [std.string.prose :as prose])
  (:use code.test))

^{:refer lang.model.spec-solidity/sol-util-types :added "4.0"}
(fact "format sol types"

  (g/sol-util-types :hello)
  => "hello")

^{:refer lang.model.spec-solidity/sol-map-key :added "4.0"}
(fact "formats sol map key"

  (g/sol-map-key :hello g/+grammar+ {})
  => "hello")

^{:refer lang.model.spec-solidity/sol-keyword-fn :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-def :added "4.0"}
(fact "creates a definition string"

  (g/sol-def '(def ^{:- [:uint]} a 1) g/+grammar+ {})
  => "uint a = 1;")

^{:refer lang.model.spec-solidity/sol-emit-block :added "4.1"}
(fact "emits block with braces and binding"
  (emit/with:emit
    (g/sol-emit-block nil {:start "{" :end "}"} '((return 1)) g/+grammar+ {}))
  => "{\n  return 1;\n}")

^{:refer lang.model.spec-solidity/sol-fn-elements :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-emit-returns :added "4.0"}
(fact "emits returns"
...
^{:refer lang.model.spec-solidity/sol-defn :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-defconstructor :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-defevent :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-tf-var-ext :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-tf-mapping :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-defstruct :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-defaddress :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-defenum :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-defmapping :added "4.0"}
...
^{:refer lang.model.spec-solidity/sol-definterface :added "4.0"}

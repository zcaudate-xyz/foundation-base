(ns lang.model.spec-postgres-test
  ...
  (:require [postgres.core :as pg]
            [lang.model.spec-postgres :refer :all]
...
^{:refer lang.model.spec-postgres/CANARY :adopt true :added "4.0"}
...
^{:refer lang.model.spec-postgres/CANARY.select :adopt true :added "4.0"}
(fact "BASIC SELECT"
...
^{:refer lang.model.spec-postgres/CANARY.json :adopt true :added "4.0"}

...
^{:refer lang.model.builtin.spec-go.typed/sanitize-ident :added "4.1"}
(fact "sanitizes go identifiers"
  [(sanitize-ident "hello-world")
   (sanitize-ident "123hello")]
  => ["hello_world" "_123hello"])

^{:refer lang.model.builtin.spec-go.typed/capitalize-ident :added "4.1"}
(fact "capitalizes go identifiers"
  [(capitalize-ident "display-name")
   (capitalize-ident "")]
  => ["Display_name" "X"])

^{:refer lang.model.builtin.spec-go.typed/named-go-ident :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/maybe-go-type :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/lossy-go-type :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/emit-struct-field :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/emit-struct-type :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/emit-spec-declaration :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/emit-function-declaration :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/emit-value-declaration :added "4.1"}
...
^{:refer lang.model.builtin.spec-go.typed/emitted-specs :added "4.1"}

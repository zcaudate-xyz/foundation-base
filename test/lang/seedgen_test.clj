...
^{:refer lang.seedgen/seedgen-root :added "4.1"}
...
^{:refer lang.seedgen/seedgen-list :added "4.1"}
...
^{:refer lang.seedgen/seedgen-readforms :added "4.1"}
...
^{:refer lang.seedgen/seedgen-benchlist :added "4.1"}
...
^{:refer lang.seedgen/seedgen-incomplete :added "4.1"}
...
^{:refer lang.seedgen/seedgen-langremove :added "4.1"}
...
^{:refer lang.seedgen/seedgen-langadd :added "4.1"}
...
^{:refer lang.seedgen/seedgen-benchadd :added "4.1"}
  ...
  (let [root    (.toFile (java.nio.file.Files/createTempDirectory "seedgen-benchadd-summary"
    ...
    (try
      (spit path (str "(ns xt.sample.summary-test\n"
                      ...
                      "  (!.js (+ 1 2 3))\n"
                      "  => 6)\n"))
      (let [output (#'lang.seedgen/seedgen-benchadd-summary
...
^{:refer lang.seedgen.form-infile/apply-item-transform-form :added "4.1"}
(fact "form transforms rewrite each original match once while preserving layout"
  (#'lang.seedgen.form-infile/apply-item-transform-form
   "(fact \"single-pass\"\n  (!.js\n    +out+)\n  => +out+)"
   (symbol "+out+")
   '(l/as-lua +out+))
  => "(fact \"single-pass\"\n  (!.js\n    (l/as-lua +out+))\n  => (l/as-lua +out+))")
...
^{:refer lang.seedgen/seedgen-benchremove :added "4.1"}

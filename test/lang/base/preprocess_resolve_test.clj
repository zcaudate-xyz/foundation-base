(ns lang.base.preprocess-resolve-test
  ...
  (:require [lang.common.book-entry :as entry]
            ...
            [lang.base.preprocess-resolve :refer :all]))

^{:refer lang.base.preprocess-resolve/get-fragment :added "4.1"}
...
^{:refer lang.base.preprocess-resolve/process-namespaced-resolve :added "4.1"}
...
^{:refer lang.base.preprocess-resolve/process-namespaced-symbol :added "4.1"}
...
^{:refer lang.base.preprocess-resolve/process-standard-symbol :added "4.1"}
...
^{:refer lang.base.preprocess-resolve/find-natives :added "4.1"}

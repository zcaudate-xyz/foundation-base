(ns lang.base.emit-common-op-test
...
^{:refer lang.base.emit-common/emit-common-loop :adopt true :added "4.0"}
(fact "emit raw ops"
...
^{:refer lang.base.emit-common/emit-common :adopt true :added "4.0"}
(fact "emit main raw"

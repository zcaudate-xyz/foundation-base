(ns lang.base.preprocess-input-test
  (:use code.test)
  (:require [lang.base.emit-preprocess :as preprocess] [lang.base.preprocess-base :as preprocess-base]
...
(fact "processes a form"
  ...
  (to-input-form '@#'hello)
  => '(!:deref (var lang.base.preprocess-input-test/hello))

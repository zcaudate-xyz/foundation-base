(ns lang.base.emit-block-op-test
...
^{:refer lang.base.emit-block/test-block-loop.do :adopt true :added "4.0"}
(fact "emit do"
...
^{:refer lang.base.emit-block/test-block-loop.for :adopt true :added "4.0"}
(fact "emit for"
...
^{:refer lang.base.emit-block/test-block-loop.forange
...
^{:refer lang.base.emit-block/test-block-loop.if :adopt true :added "4.0"}
(fact "emit if"
...
^{:refer lang.base.emit-block/test-block-loop.when :adopt true :added "4.0"}
(fact "emit if"
...
^{:refer lang.base.emit-block/test-block-loop.switch :adopt true :added "4.0"}
(fact "emit switch"
...
^{:refer lang.base.emit-block/test-block-loop.block :adopt true :added "4.0"}
(fact "emit block"
...
^{:refer lang.base.emit-block/test-block-loop.try :adopt true :added "4.0"}
(fact "emit try"

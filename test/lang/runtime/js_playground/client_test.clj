(ns lang.runtime.js-playground.client-test
  (:use code.test)
  (:require [lang.runtime.js-playground :as playground]
            [lang.runtime.js-playground.client :refer :all]
...
(l/script- :js
  {:runtime :chromedriver.instance
   :require [[lang.runtime.js-playground.client :as client]
...
^{:refer lang.runtime.js-playground.client/mount! :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/get-config :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/App :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/TopMenu :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/TabBar :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/ActiveTabPanel :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/format-body :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/eval-body :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/make-add-message :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/make-tab-id :added "4.1" :timeout 60000}
(fact "make-tab-id returns a unique tab id"

  (!.js (client/make-tab-id "hello"))
  => #"tab-hello-")

^{:refer lang.runtime.js-playground.client/find-tab-index :added "4.1" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/has-tab? :added "4.1" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/run-eval :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/MessageItem :added "4.0" :timeout 60000}
(fact "MessageItem is a React component function"

  (!.js (typeof client/MessageItem))
  => "function")

^{:refer lang.runtime.js-playground.client/MessageList :added "4.0" :timeout 60000}
(fact "MessageList is a React component function"

  (!.js (typeof client/MessageList))
  => "function")

^{:refer lang.runtime.js-playground.client/send-response :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/make-websocket :added "4.0" :timeout 60000}
...
^{:refer lang.runtime.js-playground.client/DomNode :added "4.1" :timeout 60000}

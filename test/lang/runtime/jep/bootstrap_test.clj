(ns lang.runtime.jep.bootstrap-test
  (:require [lang.runtime.jep.bootstrap :refer :all]
            [std.fs :as fs]
            [std.lib.os :as os])
  (:use code.test))

^{:refer lang.runtime.jep.bootstrap/bootstrap-code :added "3.0"}
(fact "creates the bootstrap code"
  (bootstrap-code)
  => vector?)

^{:refer lang.runtime.jep.bootstrap/jep-bootstrap :added "3.0"}
...
^{:refer lang.runtime.jep.bootstrap/jep-available? :added "4.1"}
...
^{:refer lang.runtime.jep.bootstrap/init-paths :added "3.0"}

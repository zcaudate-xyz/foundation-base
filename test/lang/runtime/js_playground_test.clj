(ns lang.runtime.js-playground-test
  (:require [lang.runtime.js-playground :refer :all]
            [std.json :as json]
...
^{:refer lang.runtime.js-playground/rt-js-playground:create :added "4.0"}
...
^{:refer lang.runtime.js-playground/start-js-playground :added "4.0"}
...
^{:refer lang.runtime.js-playground/play-url :added "4.0"}
...
^{:refer lang.runtime.js-playground/raw-eval-js-playground :added "4.0"}
...
^{:refer lang.runtime.js-playground/rt-js-playground :added "4.0"}
...
^{:refer lang.runtime.js-playground/playground-client-script :added "4.0"}
...
^{:refer lang.runtime.js-playground/page-html :added "4.1"}
...
^{:refer lang.runtime.js-playground/stop-js-playground :added "4.1"}
...
^{:refer lang.runtime.js-playground/invoke-ptr-js-playground :added "4.1"}
...
^{:refer lang.runtime.js-playground/rt-js-playground-string :added "4.1"}
...
^{:refer lang.runtime.js-playground/play-file :added "4.1"}
(fact "play-file joins paths under the runtime root"

  (play-file {:root "/tmp/foo"} "bar" "baz.js")
  => "/tmp/foo/bar/baz.js")

^{:refer lang.runtime.js-playground/play-script :added "4.1"}
...
^{:refer lang.runtime.js-playground/play-page :added "4.1"}

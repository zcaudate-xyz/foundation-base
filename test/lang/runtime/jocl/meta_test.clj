...
^{:refer lang.runtime.jocl.meta/cl-size :added "3.0"}
(fact "helper for cl-types"

  (cl-size "float")
  => '(org.jocl.Sizeof/float))

^{:refer lang.runtime.jocl.meta/cl-types :added "3.0"}
(fact "creates a lookup of all standard cl sizes"

  (cl-types))

^{:refer lang.runtime.jocl.meta/lookup:fn :added "3.0"}
(fact "builds a lookup function"
  
  ((lookup:fn {:a 1 :b 2}) 1)
  => :a)

^{:refer lang.runtime.jocl.meta/lookup:flags :added "3.0"}
(fact "builds a flags function"

  ((lookup:flags {:hello 1 :world 2 :foo 4 :bar 8}) 13)
  => #{:bar :hello :foo})

^{:refer lang.runtime.jocl.meta/lookup:build :added "3.0"}
(fact "builds a lookup for the metadata"

  ((lookup:build [:enum :device-type]) [4])
  => :gpu)

^{:refer lang.runtime.jocl.meta/array-form :added "3.0"}
...
^{:refer lang.runtime.jocl.meta/to-ptr :added "3.0"}
(fact "pointer for array inputs")

^{:refer lang.runtime.jocl.meta/cl-call :added "3.0"}
...
^{:refer lang.runtime.jocl.meta/fn-call :added "3.0"}
...
^{:refer lang.runtime.jocl.meta/info-template:defn :added "3.0"}
...
^{:refer lang.runtime.jocl.meta/info-template:print :added "3.0"}
...
^{:refer lang.runtime.jocl.meta/info-template:gen :added "3.0"}
(fact "helper for `info-template`"

  (info-template:gen :platform nil))

^{:refer lang.runtime.jocl.meta/info-template :added "3.0"}
(fact "generates the info functions")

^{:refer lang.runtime.jocl.meta/info-gen :added "3.0"}
(fact "generates multiple info functions")

^{:refer lang.runtime.jocl.meta/list-platforms :added "3.0"}
(fact "lists all platforms"

  (list-platforms))

^{:refer lang.runtime.jocl.meta/platform:default :added "3.0"}
(fact "gets the default platform"

  (platform:default))

^{:refer lang.runtime.jocl.meta/list-devices :added "3.0"}
(fact "lists all devices"

  (list-devices (platform:default)))

^{:refer lang.runtime.jocl.meta/device-info :added "3.0"}
...
^{:refer lang.runtime.jocl.meta/device:cpu :added "3.0"}
(fact "gets the default cpu device")

^{:refer lang.runtime.jocl.meta/device:gpu :added "3.0"}

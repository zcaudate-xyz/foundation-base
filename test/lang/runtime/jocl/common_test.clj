(ns lang.runtime.jocl.common-test
  ...
  (:use code.test)
  (:require [lang.runtime.jocl :refer :all]
...
^{:refer lang.runtime.jocl.common/parse-spec :added "3.0"}
...
^{:refer lang.runtime.jocl.common/entry-spec :added "3.0"}
...
^{:refer lang.runtime.jocl.common/with-error :added "3.0"}
(fact "helper function for creation within context")

^{:refer lang.runtime.jocl.common/cl-context :added "3.0"}
(fact "creates a cl context"

  (cl-context)
  => org.jocl.cl_context)

^{:refer lang.runtime.jocl.common/cl-queue :added "3.0"}
(fact "creates a command queue (within a context)"

  (cl-queue (cl-context) (device:gpu))
  => org.jocl.cl_command_queue)

^{:refer lang.runtime.jocl.common/cl-program :added "3.0"}
...
^{:refer lang.runtime.jocl.common/cl-kernel :added "3.0"}

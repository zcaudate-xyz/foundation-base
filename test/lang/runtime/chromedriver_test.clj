(ns lang.runtime.chromedriver-test
  (:use code.test)
  (:require [lang.runtime.chromedriver :as chromedriver]
             [lang.core :as l]
             [std.lib :as h]
             [std.lib.env :as env]))
...
^{:refer lang.runtime.chromedriver-test/browser-eval :added "4.0"}
(fact "chromedriver evaluates !.js expressions"

  (!.js (+ 1 2 3))
  => 6)

^{:refer lang.runtime.chromedriver/goto :added "4.0"
...
^{:refer lang.runtime.chromedriver/tab-create :added "4.0"
...
^{:refer lang.runtime.chromedriver/with-tab :added "4.0"
  :setup [(def +main+
...
^{:refer lang.runtime.chromedriver/current-tab :added "4.0"
...
^{:refer lang.runtime.chromedriver/tab-list :added "4.0"
...
^{:refer lang.runtime.chromedriver/tab-switch :added "4.0"
...
^{:refer lang.runtime.chromedriver/tab-close :added "4.0"

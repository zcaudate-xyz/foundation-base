...
^{:refer lang.runtime.annex.jep.bootstrap/bootstrap-code :added "3.0"}
(fact "creates the bootstrap code"
  (bootstrap-code)
  => vector?)

^{:refer lang.runtime.annex.jep.bootstrap/jep-bootstrap :added "3.0"}
...
^{:refer lang.runtime.annex.jep.bootstrap/jep-available? :added "4.1"}
...
^{:refer lang.runtime.annex.jep.bootstrap/init-paths :added "3.0"}

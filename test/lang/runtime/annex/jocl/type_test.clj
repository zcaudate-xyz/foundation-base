...
^{:refer lang.runtime.annex.jocl.type/buffer-type :added "3.0"}
(fact "outputs type information for buffers"

  (buffer-type (float-array [1 2 3]))
  => {:buffer true :unit :float :dsize 4 :length 3})

^{:refer lang.runtime.annex.jocl.type/unit-type :added "3.0"}
(fact "outputs type information for unit inputs"

  (unit-type 1)
  => {:unit :long :dsize 8})

^{:refer lang.runtime.annex.jocl.type/type-args :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.type/to-array :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.type/unit-coerce :added "4.1"}

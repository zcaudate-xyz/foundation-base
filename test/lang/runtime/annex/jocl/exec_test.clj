...
^{:refer lang.runtime.annex.jocl.exec/CANARY :adopt true :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/exec-prep :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/exec-source :added "3.0"}
(fact "preps the source for the exec"
  ^:hidden
...
^{:refer lang.runtime.annex.jocl.exec/exec-start :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/exec-stop :added "3.0"}
(fact "stops the exec")

^{:refer lang.runtime.annex.jocl.exec/exec-invoke:worksize :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/set-kernel-buffer :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/set-kernel-value :added "3.0"}
(comment
...
^{:refer lang.runtime.annex.jocl.exec/set-kernel-value :added "4.1" :id test-scalar-kernel-arg-coercion}
...
^{:refer lang.runtime.annex.jocl.exec/exec-invoke:setup :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/exec-invoke:process :added "3.0"}
(fact "enqueues the kernel call")

^{:refer lang.runtime.annex.jocl.exec/exec-invoke:output :added "3.0"}
(fact "writes to output from buffer and release")

^{:refer lang.runtime.annex.jocl.exec/exec-invoke :added "3.0"}
...
^{:refer lang.runtime.annex.jocl.exec/exec? :added "3.0"}

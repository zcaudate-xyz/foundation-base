(ns lang.runtime.annex.nginx-test
  (:require [lua.nginx :as n]
            [net.http :as http]
            [lang.runtime.annex.nginx :refer :all]
...
^{:refer lang.runtime.annex.nginx/error-logs :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/access-logs :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/nginx-conf :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/dir-tree :added "4.0"}
(fact "gets the running nginx access log"
  (with-redefs [l/rt:inner (constantly {:state (atom [nil "path"])})
                fs/list (constantly [])]
    (dir-tree)
...
^{:refer lang.runtime.annex.nginx/all-nginx-ports :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/all-nginx-active :added "4.0"}
(fact "gets all active nginx processes for a port"
  (with-redefs [all-nginx-ports (constantly {80 #{123}})]
    (all-nginx-active 80)
    => #{123}))

^{:refer lang.runtime.annex.nginx/make-conf :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/make-temp :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/start-test-server-shell :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/start-test-server-container :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/start-test-server :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/kill-single-nginx :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/kill-all-nginx :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/stop-test-server :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/raw-eval-nginx :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/invoke-ptr-nginx :added "4.0"}
(fact "evaluates lua ptr and arguments"
  ;; delegates
  )

^{:refer lang.runtime.annex.nginx/nginx:create :added "4.0"}
...
^{:refer lang.runtime.annex.nginx/nginx :added "4.0"}

...
^{:refer lang.runtime.annex.neovim.impl/neovim-exec :added "4.1"}
(fact "resolves the neovim executable"
  (impl/neovim-exec)
  => string?)

^{:refer lang.runtime.annex.neovim.impl/lua-eval-wrap :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/start-neovim :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/invoke-ptr-neovim :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/neovim:create :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/value->clj :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/pack-request :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/stop-neovim :added "4.1"}
(fact "returns the runtime when stopping"
  (let [rt (impl/neovim:create {})]
    (identical? (impl/stop-neovim rt) rt))
  => true)

^{:refer lang.runtime.annex.neovim.impl/next-msgid :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/send-request :added "4.1"}
...
^{:refer lang.runtime.annex.neovim.impl/rt-neovim-string :added "4.1"}
(fact "produces the runtime string representation"
  (impl/rt-neovim-string {:id :foo})
  => "#rt.neovim[:foo]")

^{:refer lang.runtime.annex.neovim.impl/neovim-shared:create :added "4.1"}

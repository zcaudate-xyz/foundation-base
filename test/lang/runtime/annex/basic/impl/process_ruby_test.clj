...
^{:refer lang.runtime.basic.impl.process-ruby/CANARY :adopt true :added "4.0"}
...
^{:refer lang.core.runtime/return-wrap-invoke :added "4.1"}
(fact "wraps forms for invoke"
  (rt/return-wrap-invoke '[1 2 3])
  => seq?)

^{:refer lang.base.preprocess-staging/to-staging :added "4.1"}
...
^{:refer lang.runtime.basic.impl.process-ruby/default-body-wrap :added "4.1"}
...
^{:refer lang.runtime.basic.impl.process-ruby/normalize-forms :added "4.1"}
...
^{:refer lang.runtime.basic.impl.process-ruby/default-body-transform :added "4.1"}

...
^{:refer lang.runtime.annex.basic.impl.process-circom/sh-exec-circom :added "4.1"}
...
(fact "registers the circom twostep runtime"
  ...
  => 'lang.runtime.annex.basic.impl.process-circom)
...
(fact "wires sh-exec-circom into the twostep context options"
  (get-in (common/get-options :circom :twostep :default)
          [:exec-fn])
  => #'lang.runtime.annex.basic.impl.process-circom/sh-exec-circom)
^{:refer lang.runtime.annex.basic.impl.process-circom/transform-form :added "4.1"}

(ns lang.runtime.annex.haxe.impl-test
...
^{:refer lang.runtime.annex.haxe.impl/haxe-exec :added "4.1"}
...
^{:refer lang.runtime.annex.haxe.impl/start-haxe :added "4.1"}
...
^{:refer lang.runtime.annex.haxe.impl/stop-haxe :added "4.1"}
(fact "stops a haxe runtime without error"
  (let [rt (impl/haxe:create {})]
    (= rt (impl/stop-haxe rt)))
  => true)

^{:refer lang.runtime.annex.haxe.impl/haxe:create :added "4.1"}

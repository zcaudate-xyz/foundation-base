...
^{:refer lang.runtime.annex.gimp.impl/gimp-bootstrap :added "4.1"}
...
^{:refer lang.runtime.annex.gimp.impl/gimp-exec :added "4.1"}
(fact "resolves the gimp executable"
  (impl/gimp-exec)
  => string?)

^{:refer lang.runtime.annex.gimp.impl/start-gimp :added "4.1"}
...
^{:refer lang.runtime.annex.gimp.impl/stop-gimp :added "4.1"}
...
^{:refer lang.runtime.annex.gimp.impl/invoke-ptr-gimp :added "4.1"}
...
^{:refer lang.runtime.annex.gimp.impl/gimp:create :added "4.1"}

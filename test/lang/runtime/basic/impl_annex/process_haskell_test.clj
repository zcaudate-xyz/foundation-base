(ns lang.runtime.basic.impl-annex.process-haskell-test
  (:use code.test)
  (:require [lang.runtime.basic.impl-annex.process-haskell :refer :all]))

^{:refer lang.runtime.basic.impl-annex.process-haskell/transform-form :added "4.1"}

(ns lang.runtime.basic.docker.impl-php-test
...
;;
;; Uses the project-owned lang.runtime.basic PHP CLI image.
...
;; Run with: RT_BASIC_DOCKER_TESTS=true lein test :only lang.runtime.basic.docker.impl-php-test
;;

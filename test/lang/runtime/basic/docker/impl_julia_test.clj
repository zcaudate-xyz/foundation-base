(ns lang.runtime.basic.docker.impl-julia-test
...
;;
;; Uses the project-owned lang.runtime.basic Julia image with JSON preinstalled.
;;
...
;; Run with: RT_BASIC_DOCKER_TESTS=true lein test :only lang.runtime.basic.docker.impl-julia-test
;;

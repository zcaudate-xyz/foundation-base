(ns lang.runtime.basic.docker.registry-test
  (:use code.test)
  (:require [clojure.string :as str]
            [lang.runtime.basic.docker.registry :refer :all]))

^{:refer lang.runtime.basic.docker.registry/r-bootstrap :added "4.1"}
(fact "wraps the R bootstrap with jsonlite installation"
  (str/includes? (r-bootstrap 1234 {:host "host.docker.internal"})
                 "install.packages('jsonlite')")
  => true)

^{:refer lang.runtime.basic.docker.registry/registry-dockerfile-path :added "4.1"}
...
^{:refer lang.runtime.basic.docker.registry/registry-config :added "4.1"}
...
^{:refer lang.runtime.basic.docker.registry/registry-image :added "4.1"}
...
^{:refer lang.runtime.basic.docker.registry/registry-dockerfile :added "4.1"}

...
;;
;; Uses the project-owned lang.runtime.basic R image.
...
;; Run with: RT_BASIC_DOCKER_TESTS=true lein test :only lang.runtime.basic.docker.impl-r-test
;;
...
^{:refer lang.runtime.basic.docker.impl-r-test/r-docker-bootstrap :added "4.0"}

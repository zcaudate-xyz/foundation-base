(ns lang.runtime.basic.impl.process-js-playground-test
  (:require [lang.base.util :as ut]
            [lang.core :as l]
            [lang.runtime.js-playground :as playground]
            [std.json :as json])
  (:use code.test)
  (:import (java.net URI)
...
^{:refer lang.runtime.basic.impl.process-js-playground/CANARY :adopt true :added "4.0"}

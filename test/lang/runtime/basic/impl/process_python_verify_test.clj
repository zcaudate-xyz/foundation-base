(ns lang.runtime.basic.impl.process-python-verify-test
...
(l/script :python
  lang.runtime.basic.impl.process-python-verify-test
  {:runtime :verify})

^{:refer lang.runtime.basic.impl.process-python/CANARY :added "4.0"}
...
^{:refer lang.runtime.basic.impl.process-python/!.py :added "4.0"}

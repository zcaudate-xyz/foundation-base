(ns lang.runtime.basic.impl.process-python-test
  (:require [lang.runtime.basic.impl.process-python :refer :all]
...
^{:refer lang.runtime.basic.impl.process-python/CANARY :adopt true :added "4.0"}
...
^{:refer lang.runtime.basic.impl.process-python/default-oneshot-wrap :adopt true :added "4.0"}
(fact "creates the ws client connect code"

  (default-oneshot-wrap 1)
  => string?)

^{:refer lang.runtime.basic.impl.process-python/default-basic-client :added "4.1"}
...
^{:refer lang.runtime.basic.impl.process-python/default-body-wrap :added "4.0"}
...
^{:refer lang.runtime.basic.impl.process-python/default-body-transform :added "4.0"}

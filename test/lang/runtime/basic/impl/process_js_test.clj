(ns lang.runtime.basic.impl.process-js-test
  (:require [clojure.string]
            [lang.runtime.basic.impl.process-js :refer :all]
            [lang.core :as l]
            [std.lib.env :as env])
  (:use code.test))
...
^{:refer lang.runtime.basic.impl.process-js/CANARY :adopt true :added "4.0"}
...
^{:refer lang.runtime.basic.impl.process-js/node-path :added "4.1"}

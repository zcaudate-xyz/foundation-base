(ns lang.runtime.basic.type-container-test
  (:require [lang.runtime.basic.type-container :as container]
            [lang.runtime.basic.type-oneshot :as oneshot]
            [lib.docker :as docker])
  (:use code.test))

^{:refer lang.runtime.basic.type-container/start-container-process :added "4.0"}
...
^{:refer lang.runtime.basic.type-container/start-container :added "4.1"}
...
^{:refer lang.runtime.basic.type-container/stop-container :added "4.0"}

...
^{:refer lang.runtime.graal/eval-raw.test :adopt true :added "3.0"}
(fact "EVAL"
...
^{:refer lang.runtime.graal/add-resource-path :added "3.0"
...
^{:refer lang.runtime.graal/add-system-path :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer lang.runtime.graal/make-raw :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer lang.runtime.graal/close-raw :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
(fact "closes the base graal context"
  (close-raw +js+)
  => nil)

^{:refer lang.runtime.graal/raw-lang :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer lang.runtime.graal/eval-raw :added "3.0"
  :setup [(def +js+ (make-raw {:lang :js}))]}
...
^{:refer lang.runtime.graal/unwrap :added "4.1"}
...
^{:refer lang.runtime.graal/eval-graal :added "4.0"}
...
^{:refer lang.runtime.graal/invoke-graal :added "4.0"}
...
^{:refer lang.runtime.graal/start-graal :added "3.0"}
(fact "starts the graal runtime"
  (start-graal (rt-graal:create {:lang :js}))
  => rt-graal?)

^{:refer lang.runtime.graal/stop-graal :added "3.0"}
(fact "stops the graal runtime"
  (stop-graal (start-graal (rt-graal:create {:lang :js})))
  => rt-graal?)

^{:refer lang.runtime.graal/rt-graal:create :added "4.0"}
...
^{:refer lang.runtime.graal/rt-graal :added "3.0"}

(ns lang.runtime.nix.script-test
  (:require [lang.runtime.nix.script :refer :all])
  (:use code.test))

^{:refer lang.runtime.nix.script/emit-nix :added "4.0"}
...
^{:refer lang.runtime.nix.script/write :added "4.0"}
...
^{:refer lang.runtime.nix.script/write-fn :added "4.0"}
...
^{:refer lang.runtime.nix.script/write-full :added "4.0"}

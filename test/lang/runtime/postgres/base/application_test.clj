(ns lang.runtime.postgres.base.application-test
  (:require [lang.runtime.postgres.base.application :refer :all]
            [lang.core :as l])
  (:use code.test))

^{:refer lang.runtime.postgres.base.application/application-string :added "4.1"}
...
^{:refer lang.runtime.postgres.base.application/app-list-entries :added "4.1"}
...
^{:refer lang.runtime.postgres.base.application/app-get-entry :added "4.1"}
...
^{:refer lang.runtime.postgres.base.application/app-get-deps :added "4.1"}
...
^{:refer lang.runtime.postgres.base.application/app-modules :added "4.0"}
...
^{:refer lang.runtime.postgres.base.application/app-create-raw :added "4.0"}
...
^{:refer lang.runtime.postgres.base.application/module-typed :added "4.1"}
...
^{:refer lang.runtime.postgres.base.application/app-create-typed :added "4.1"}
...
^{:refer lang.runtime.postgres.base.application/app-create :added "4.0"}
(fact "makes the app graph schema"
  ...
  (with-redefs [app-modules (fn [_] [{:id 'test.module
                                      :code {:entry {:id 'test/entry
                                                     ...
                                                     :op 'deftype
                                                     :static/schema-seed []}}}])]
    (with-redefs-fn {#'lang.runtime.postgres.base.application/app-create-typed
...
^{:refer lang.runtime.postgres.base.application/app-clear :added "4.0"}
...
^{:refer lang.runtime.postgres.base.application/app-rebuild :added "4.0"}
...
^{:refer lang.runtime.postgres.base.application/app-rebuild-tables :added "4.0"}
...
^{:refer lang.runtime.postgres.base.application/app-list :added "4.0"}
(fact "rebuilds the app schema"
...
^{:refer lang.runtime.postgres.base.application/app :added "4.0"}
(fact "gets an app"
...
^{:refer lang.runtime.postgres.base.application/app-schema :added "4.0"}
...
^{:refer lang.runtime.postgres.base.application/app-typed :added "4.1"}

(ns lang.runtime.annex.postgres.base.client-test
...
^{:refer lang.runtime.annex.postgres.base.client/setup-module :adopt true :added "4.0"}
(fact "creates a postgres runtime"
  ;; Only checking function existance/stub as we mock everything
  )

^{:refer lang.runtime.annex.postgres.base.client/rt-pg-string :added "4.1"}
(fact "returns string representation of postgres runtime"
  (let [pg (client/rt-postgres:create {})]
    (client/rt-pg-string pg)
    => string?))

^{:refer lang.runtime.annex.postgres.base.client/rt-postgres:create :added "4.0"}
(fact "creates a postgres runtime"
  (client/rt-postgres:create {})
  => map?)

^{:refer lang.runtime.annex.postgres.base.client/rt-postgres :added "4.0"}
(fact "creates and startn a postgres runtime"
  (with-redefs [base/start-pg (fn [pg] (assoc pg :started true))]
    (client/rt-postgres {}))
  => (contains {:started true}))

^{:refer lang.runtime.annex.postgres.base.client/rt-add-notify :added "4.0"}
...
^{:refer lang.runtime.annex.postgres.base.client/rt-remove-notify :added "4.0"}
...
^{:refer lang.runtime.annex.postgres.base.client/rt-list-notify :added "4.0"}

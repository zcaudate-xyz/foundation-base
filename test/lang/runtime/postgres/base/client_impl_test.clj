(ns lang.runtime.postgres.base.client-impl-test
  (:require [lib.jdbc :as jdbc]
            ...
            [lang.runtime.postgres.base.client :as client]
...
^{:refer lang.runtime.postgres.base.client-impl/raw-eval-pg-return :added "4.0"}
...
^{:refer lang.runtime.postgres.base.client-impl/raw-eval-pg :added "4.0"
...
^{:refer lang.runtime.postgres.base.client-impl/init-ptr-pg :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"
                                         :mode :dev}))]
  :teardown (component/stop -pg-)}
...
^{:refer lang.runtime.postgres.base.client-impl/prepend-select-check-form :added "4.0"}
...
^{:refer lang.runtime.postgres.base.client-impl/prepend-select-check :added "4.0"}
(fact "checks if values needs a `SELECT` prepended"

  (client-impl/prepend-select-check builtin/cot [40])
  => true)

^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-single :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}
(fact "invokes single "
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-transform-let-fn :added "4.0"}
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-transform-try-fn :added "4.0"}
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-transform-prep :added "4.0"}
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-transform :added "4.0"}
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-block :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg :added "4.0"
  :setup [(def -pg- (client/rt-postgres {:dbname "test-scratch"}))]
  :teardown (component/stop -pg-)}
...
^{:refer lang.runtime.postgres.base.client-impl/invoke-ptr-pg-form :added "4.1"}

(ns lang.runtime.chromedriver.spec-test
  (:use code.test)
  (:require [lang.runtime.chromedriver.spec :as spec]
            [lang.runtime.chromedriver.util :as util]))

^{:refer lang.runtime.chromedriver.spec/spec-download :added "4.0"}
(fact "downloads the chrome devtools spec")

^{:refer lang.runtime.chromedriver.spec/list-domains :added "4.0"}
...
^{:refer lang.runtime.chromedriver.spec/get-domain-raw :added "4.0"}
...
^{:refer lang.runtime.chromedriver.spec/list-methods :added "4.0"}
...
^{:refer lang.runtime.chromedriver.spec/get-method :added "4.0"}
...
^{:refer lang.runtime.chromedriver.spec/tmpl-connection :added "4.0"}
(fact "creates a connection form given template"
  ...
  => '(defn page-navigate
       ...
       (lang.runtime.chromedriver.connection/send
        conn
        "Page.navigate"
        (merge {"url" url} m)
        timeout
...
^{:refer lang.runtime.chromedriver.spec/tmpl-browser :added "4.0"}
(fact "constructs the browser template"

  (spec/tmpl-browser ['browser-eval 'util/runtime-evaluate])
  => '(def browser-eval
       (lang.runtime.chromedriver.impl/wrap-browser-state util/runtime-evaluate))

(ns lang.runtime.chromedriver.connection-test
  (:use code.test)
  (:require [lang.runtime.chromedriver.connection :as conn]
            [lang.runtime.chromedriver.impl :as impl]
            [std.lib :as h]))
...
^{:refer lang.runtime.chromedriver.connection/gen-id :added "4.0"}
(fact "generates an id"

  (conn/gen-id {})
  => integer?)

^{:refer lang.runtime.chromedriver.connection/send :added "4.0"
  :setup [(def +conn+
...
^{:refer lang.runtime.chromedriver.connection/ws-url :added "4.0"}
(fact "gets the ws-url"

  (conn/ws-url {:port (:port (start-scaffold))})
  => string?)

^{:refer lang.runtime.chromedriver.connection/conn-process :added "4.0"}
...
^{:refer lang.runtime.chromedriver.connection/conn-attach :added "4.0"
  :setup [(def +conn+
...
^{:refer lang.runtime.chromedriver.connection/conn-create-raw :added "4.0"}
(fact "connection function (can error on OSX)")

^{:refer lang.runtime.chromedriver.connection/conn-create :added "4.0"
  :setup [(def +conn+
            (conn/conn-create {:port (:port (start-scaffold))
                               :attach :new}))
          (def +conn2+
...
^{:refer lang.runtime.chromedriver.connection/conn-close :added "4.0"}

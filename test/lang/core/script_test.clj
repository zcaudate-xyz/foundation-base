...
^{:refer lang.core.script/install :added "4.0"}
...
^{:refer lang.core.script/script-ns-import :added "4.0"}
...
^{:refer lang.core.script/script-macro-import :added "4.0"}
...
^{:refer lang.core.script/script-require-target-id :added "4.1"}
...
^{:refer lang.core.script/script-specialize-merge-contracts :added "4.1"}
...
^{:refer lang.core.script/script-specialize-require :added "4.1"}
...
^{:refer lang.core.script/script-specialize-config :added "4.1"}
...
^{:refer lang.core.script/script-fn-base :added "4.0"}
(fact "setup for the runtime"

  (impl/with:library [+library+]
    (binding [book/*skip-check* true]
      (keys (script/script-fn-base :lua 'lang.core.script-test
                                   {:require '[[xt.lang.common-data :as xtd]]}
                                   (l/runtime-library)))))
  => (contains [:module :module/internal :module/primary]))

^{:refer lang.core.script/script-fn :added "4.0"}
(fact "calls the regular setup script for the namespace"

  (script/script-fn :lua)
  => map?)

^{:refer lang.core.script/script :added "4.0"}
(fact "script macro"

  (script/script :lua)
  => map?)

^{:refer lang.core.script/script-test-prep :added "4.0"}
(fact "preps the current namespace"

  (script/script-test-prep :js {})
  => (contains {:module 'lang.core.script-test}))

^{:refer lang.core.script/resolve-runtime-config :added "4.1"}
...
^{:refer lang.core.script/script-test :added "4.0"}
...
^{:refer lang.core.script/script-test-mode? :added "4.0"}
...
^{:refer lang.core.script/script-ext :added "4.0"}
(fact "the `script+` function call"
...
^{:refer lang.core.script/script-ext-run :added "4.0"}
...
^{:refer lang.core.script/annex:start :added "4.0"}
(fact "starts an annex tag"

  (script/annex:start :LUA.0)
  => vector?)

^{:refer lang.core.script/annex:get :added "4.0"}
...
^{:refer lang.core.script/annex:stop :added "4.0"
...
^{:refer lang.core.script/annex:start-all :added "4.0"}
(fact "starts all the annex tags"

  (script/annex:start-all)
  => map?)

^{:refer lang.core.script/annex:stop-all :added "4.0"}
(fact "stops all annexs"

  (script/annex:stop-all)
  => map?)

^{:refer lang.core.script/annex:restart-all :added "4.0"}
(fact "stops and starts all annex runtimes"

  (script/annex:restart-all)
  => map?)

^{:refer lang.core.script/annex:list :added "4.0"

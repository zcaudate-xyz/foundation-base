(ns lang.core.script-lint-test
  (:require [xt.lang.common-data]
             ...
             [lang.core.script-lint :refer :all])
  (:use code.test))
...
^{:refer lang.core.script-lint/get-reserved-raw :added "4.0"}
(fact "gets all reserved symbols in the grammar"
  (get-reserved-raw :lua) => set?)

^{:refer lang.core.script-lint/collect-vars :added "4.0"}
(fact "collects all vars"

  (collect-vars '#{[hello #{world}]})
  => '#{hello world})

^{:refer lang.core.script-lint/collect-module-globals :added "4.0"}
...
^{:refer lang.core.script-lint/collect-sym-vars :added "4.0"}
...
^{:refer lang.core.script-lint/sym-check-linter :added "4.0"}
...
^{:refer lang.core.script-lint/lint-set :added "4.0"}
(fact "sets the linter for a namespace"
  (lint-set 'lang.core.script-lint-test) => map?)

^{:refer lang.core.script-lint/lint-clear :added "4.0"}
(fact "clears all linted namespaces"
  (lint-clear) => {})

^{:refer lang.core.script-lint/lint-needed? :added "4.0"}
(fact "checks if lint is needed"
  (lint-needed? 'lang.core.script-lint-test) => nil)

^{:refer lang.core.script-lint/lint-entry :added "4.0"}

(ns lang.core.impl-entry-test
  (:require [lang.common.book :as b]
              ...
              [lang.core.library-snapshot-prep-test :as lprep]
               [std.lib.env :as env])
  (:use code.test))
...
(fact "entry emit failures include entry context"
  ...
  => '{:probe true
        ...
        :line 42
        :stack [[:emit/form :lang.base.emit-top-level/emit-form]
                [:emit/entry :lang.core.impl-entry/emit-entry-raw]]})
...
^{:refer lang.core.impl-entry/create-common :added "4.0"}
...
^{:refer lang.core.impl-entry/create-code-raw :added "4.0"}
...
^{:refer lang.core.impl-entry/create-code-base :added "4.0"}
...
^{:refer lang.core.impl-entry/hydrate-form :added "4.1"}
...
^{:refer lang.core.impl-entry/create-code-hydrate :added "4.0"
  :setup [(def +entry+
            (entry/create-code-base
             '(defn add-fn
                [a b]
...
^{:refer lang.core.impl-entry/prepare-code-entry :added "4.1"}
...
^{:refer lang.core.impl-entry/create-code :added "4.0"}
...
^{:refer lang.core.impl-entry/create-fragment :added "4.0"}
...
^{:refer lang.core.impl-entry/create-fragment-hydrate :added "4.0"}
(fact "hydrates the forms"
  "placeholder for tests")

^{:refer lang.core.impl-entry/create-macro :added "4.0"}
...
^{:refer lang.core.impl-entry/with:cache-none :added "4.0"}
(fact "skips the cache"
  (entry/with:cache-none entry/*cache-none*) => true)

^{:refer lang.core.impl-entry/with:cache-force :added "4.0"}
(fact "forces the cache to update"
  (entry/with:cache-force entry/*cache-force*) => true)

^{:refer lang.core.impl-entry/emit-entry-raw :added "4.0"
...
^{:refer lang.core.impl-entry/emit-entry-cached :added "4.0"
  :setup [(def +book+
            (-> prep/+book-min+
...
^{:refer lang.core.impl-entry/emit-entry-label :added "4.0"}
...
^{:refer lang.core.impl-entry/emit-entry :added "4.0"}

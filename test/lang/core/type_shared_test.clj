(ns lang.core.type-shared-test
  (:require [lang.core :as l]
            [lang.core.type-shared :as shared])
  (:use code.test))

^{:refer lang.core.type-shared/get-groups :added "4.0"}
...
^{:refer lang.core.type-shared/update-group-count :added "4.0"
...
^{:refer lang.core.type-shared/rt-is-shared? :added "4.0"}
(fact "checks if a runtime is shared"
  (shared/rt-is-shared? (shared/rt-shared:create {}))
  => true)

^{:refer lang.core.type-shared/rt-get-inner :added "4.0"}
...
(comment
  ...
  (require '[lang.runtime.basic.impl.script :as script]))

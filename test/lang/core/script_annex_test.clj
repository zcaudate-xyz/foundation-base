...
^{:refer lang.core.script-annex/rt-annex? :added "4.0"}
(fact "checks that object is an annex"

  (annex/rt-annex? (annex/rt-annex:create {}))
  => true)

^{:refer lang.core.script-annex/rt-annex:create :added "4.0"}
...
^{:refer lang.core.script-annex/annex-current :added "4.0"}
(fact "gets the current annex. May not exist"

  (annex/annex-current)
  => any?)

^{:refer lang.core.script-annex/annex-reset :added "4.0"
...
^{:refer lang.core.script-annex/get-annex :added "4.0"}
(fact "gets the current annex in the namespace"

  (annex/get-annex)
  => map?)

^{:refer lang.core.script-annex/clear-annex :added "4.0"}
(fact "clears all runtimes in the annex"

  (annex/clear-annex)
  => map?)

^{:refer lang.core.script-annex/get-annex-library :added "4.0"}
(fact "gets the current annex library"

  (annex/get-annex-library (env/ns-sym))
  => lib/library?)

^{:refer lang.core.script-annex/get-annex-book :added "4.0"}
...
^{:refer lang.core.script-annex/add-annex-runtime :added "4.0"
...
^{:refer lang.core.script-annex/get-annex-runtime :added "4.0"}
(fact "gets the annex rutime"
  (annex/get-annex-runtime (env/ns-sym) :hello) => nil)

^{:refer lang.core.script-annex/remove-annex-runtime :added "4.0"}
(fact "removes the annex runtime"
  (annex/remove-annex-runtime (env/ns-sym) :hello) => nil)

^{:refer lang.core.script-annex/register-annex-tag :added "4.0"
...
^{:refer lang.core.script-annex/deregister-annex-tag :added "4.0"}
(fact "removes the config for the tag"
  (annex/deregister-annex-tag (env/ns-sym) :redis.0) => nil)

^{:refer lang.core.script-annex/start-runtime :added "4.0"}
(fact "starts the runtime in the annex"

  (annex/start-runtime :lua :default {}) => map?)

^{:refer lang.core.script-annex/same-runtime? :added "4.0"}

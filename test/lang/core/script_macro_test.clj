...
^{:refer lang.core.script-macro/intern-def$-fn :added "4.0"}
(fact "interns a fragment macro"
  ...
  => (contains {:section :fragment,
                ...
                :display :default,
                :form 'hello,
                :namespace 'lang.core.script-macro-test})
...
^{:refer lang.core.script-macro/intern-def$ :added "4.0"}
(fact "intern a def fragment macro"

  (macro/intern-def$ :x "hello")
  => #'lang.core.script-macro-test/def$.hello
...
^{:refer lang.core.script-macro/intern-defmacro-fn :added "4.0"}
  ...
  (impl/with:library [+library+]
    (macro/intern-defmacro-fn
     ...
     (with-meta
       ...
       '{:module L.core})
     {}))
  => #'lang.core.script-macro-test/make-array-0
...
^{:refer lang.core.script-macro/intern-defmacro :added "4.0"}
(fact "the intern macro function"

  (macro/intern-defmacro :x "hello")
  => #'lang.core.script-macro-test/defmacro.hello
  ...
  (impl/with:library [+library+]
    ...
    (defmacro.hello
      divide [x y]
      (list '/ x y)))
  => #'lang.core.script-macro-test/divide
...
^{:refer lang.core.script-macro/call-thunk :added "4.0"}
...
^{:refer lang.core.script-macro/intern-!-fn :added "4.0"}
...
^{:refer lang.core.script-macro/intern-! :added "4.0"}
...
^{:refer lang.core.script-macro/intern-top-level-fn :added "4.0"}
  ...
  (impl/with:library [+library+]
    (macro/intern-top-level-fn
     ...
     (with-meta
       ...
       {:module 'L.core})
     {}))
  => #'lang.core.script-macro-test/add-more
...
^{:refer lang.core.script-macro/intern-top-level :added "4.0"}
(fact "interns a top level macro"
  ...
  (impl/with:library [+library+]
    ^{:module L.core}
    (def.hello abc 1))
  => #'lang.core.script-macro-test/abc
...
^{:refer lang.core.script-macro/intern-defmacro-rt-fn :added "4.0"}
...
^{:refer lang.core.script-macro/defmacro.! :added "4.0"}
(fact "macro for runtime lang macros")


^{:refer lang.core.script-macro/hydrate-top-level-entry :added "4.0"}

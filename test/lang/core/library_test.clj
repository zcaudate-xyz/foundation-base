...
^{:refer lang.core.library/add-entry! :added "4.0"}
...
^{:refer lang.core.library/install-module-specialized! :added "4.1"}
...
(comment
  (comment
  ^{:refer lang.core.library/create-dispatch-handler :added "4.0"}
  (fact "the actual dispatch handler")

  ^{:refer lang.core.library/create-dispatch :added "4.0"}
  ...
  (atom/swap-return! (:instance +lib+)
    (fn [snapshot]
      [nil (snap/add-book snapshot
                          lang.base.emit-prep-lua-test/+book-min+)]))

...
^{:refer lang.core.workspace/rt-resolve :added "4.0"}
...
^{:refer lang.core.workspace/sym-entry :added "4.0"}
(fact "gets the entry using a symbol"

  (w/sym-entry :xtalk `cl/noop)
  => map?)

^{:refer lang.core.workspace/sym-pointer :added "4.0"}
...
^{:refer lang.core.workspace/module-entries :added "4.0"}
(fact "gets all module entries"

  (w/module-entries :xtalk 'xt.lang.common-lib identity)
  => coll?)

^{:refer lang.core.workspace/emit-ptr :added "4.0"}
(fact "emits the poiner as a string"

  (w/emit-ptr cl/noop)
  => string?)

^{:refer lang.core.workspace/ptr-display-str :added "4.0"}
...
^{:refer lang.core.workspace/ptr-clip :added "4.0"}
...
^{:refer lang.core.workspace/ptr-print :added "4.0"}
(fact "copies pointer text to clipboard"
...
^{:refer lang.core.workspace/ptr-setup :added "4.0"}
(fact "calls setup on a pointer"
  (w/ptr-setup cl/noop) => any?)

^{:refer lang.core.workspace/ptr-teardown :added "4.0"}
(fact "calls teardown on a pointer"
  (w/ptr-teardown cl/noop) => any?)

^{:refer lang.core.workspace/ptr-setup-deps :added "4.0"}
(fact "calls setup on a pointer and all dependencies"
  (w/ptr-setup-deps cl/noop) => any?)

^{:refer lang.core.workspace/ptr-teardown-deps :added "4.0"}
(fact "calls teardown on pointer all dependencies"
  (w/ptr-teardown-deps cl/noop) => any?)

^{:refer lang.core.workspace/emit-module :added "4.0"}
(fact "emits the entire module"

  (w/emit-module (l/rt 'lang.core.workspace-test :xtalk))
  => string?)

^{:refer lang.core.workspace/print-module :added "4.0"}
(fact "emits and prints out the module"

  (env/with-out-str
    (w/print-module (l/rt 'lang.core.workspace-test :xtalk)))
  => string?)

^{:refer lang.core.workspace/rt:module :added "4.0"}

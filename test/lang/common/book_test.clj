...
^{:refer lang.base.book/check-compatible-lang :added "4.0"
  :setup [(def +redis+
            (b/book-merge (b/book {:lang    :lua.redis
                                   :meta    (:meta +book+)
                                   :grammar (:grammar +book+)

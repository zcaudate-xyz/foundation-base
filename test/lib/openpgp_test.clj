...
(def +public-key+  (parse-public-key (common/joinl +public-key-string+ "\n")))

(def +secret-key+  (parse-secret-key (common/joinl +secret-key-string+ "\n")))
...
(fact "parses a public key ring from string"
  ...
  (-> (common/joinl +public-key-string+ "\n")
...
(fact "parses a secret key ring from string"
  ...
  (-> (common/joinl +secret-key-string+ "\n")

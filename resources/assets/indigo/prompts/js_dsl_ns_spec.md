...
* **(l/script :js ...)**: Top-level form defining a module. Configures requirements, imports, exports, and runtime behavior.  
  ...
  * **IGNORE** everything you know about clojure/clojurescript forms. It is only applicable in the first `ns` call. **FOLLOW THE tahto.core SPEC**
  * **DO NOT** be smart about replacement or take liberties with replacements. DO NOT try to replace with clojure idioms. **FOLLOW THE tahto.core SPEC**
  * String templating is not supported in the DSL. Use standard `+` notation for string concatentation.
  * **ALL** clojure.core and cljs.core functions and macro are not valid. do not use them. stick to the javascript interop and **FOLLOW THE tahto.core SPEC**
  * **Example:**
...
** (ns ..) and (l/script ...) forms serve different purposes. ns loads tahto.core

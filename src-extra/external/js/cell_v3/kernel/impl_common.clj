(ns js.cell-v3.kernel.impl-common
  (:require [std.lang :as l]))

(l/script :js
  {:require [[xt.lang.base-lib :as k]
             [xt.lang.event-common :as event-common]
             [js.cell-v3.kernel.base-util :as base-util]
...
(defn.js create-link
  "creates or normalizes a cell-v3 link source"
  {:added "4.0"}
  [link-source opts]
  (:= opts (or opts {}))
  (when (== "cell-v3.link" (k/get-key link-source "::"))
    (return link-source))
...
(defn.js new-cell
  ...
  [link-source opts]
  (var raw-link (-/create-link link-source opts))
  ...
  (link/add-callback
   ...
   (fn [data signal inner-link]
     (link/remove-callback inner-link base-util/EV_INIT)
     (. init (resolve true))))
  (return

(ns walkthrough.lang.core-01-multi
...
(fact "js runtime"
  ...
  (str hello)
  => (std.string/|
      "![:lang/js :default walkthrough.lang.core-01-multi/hello :code]"
      "function hello(){"
      "  return 1 + 2 + 3;"
      "}"))
...
(fact "lua runtime"
  ...
  (str world)
  => (std.string/|
      "![:lang/lua :default walkthrough.lang.core-01-multi/world :code]"
      "local function world()"
      "  return 1 + 2 + 3"
      "end"))
...
(fact "python runtime"
  ...
  (str again)
  => (std.string/|
      "![:lang/python :default walkthrough.lang.core-01-multi/again :code]"
      "def again():"
      "  return 1 + 2 + 3"))
...
(fact "r runtime"
  ...
  (str stuff)
  => (std.string/|
      "![:lang/r :default walkthrough.lang.core-01-multi/stuff :code]"
      "stuff <- function (){"
      "  return(1 + 2 + 3);"
      "};"))

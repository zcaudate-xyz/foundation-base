...
(fact "analyze an xtalk namespace"
  ...
  => '[lang.model.builtin.spec-xtalk-typed-fixture 3 3])
...
(fact "register and look up declarations"
  ...
  [(-> (types/get-spec 'lang.model.builtin.spec-xtalk-typed-fixture/User) :name)
   (-> (types/get-function 'lang.model.builtin.spec-xtalk-typed-fixture/find-user) :name)]
  => '["User" "find-user"])
...
(fact "extract a function type from a registered declaration"
  ...
  (types/type->data
   (types/fn-type
    (types/get-function 'lang.model.builtin.spec-xtalk-typed-fixture/find-user)))
  => '{:kind :fn

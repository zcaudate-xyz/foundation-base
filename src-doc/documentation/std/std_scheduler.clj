...
[[:hero {:title "std.scheduler"
         :subtitle "runner, program, spawn, and scheduled task lifecycle"
         :lead "`std.scheduler` is a higher-level standard library family in foundation-base. This page explains when to use it, how it fits internally, and where to find the API surface."}]]
...
;; sha256: 9b0c1f3d6e66f4cf2b4e7d52609ab56cf082bd85fef91c88dcbcfcc6f7a26730
[[:chapter {:title "std.scheduler: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-scheduler-summary-md"}]]
...
[[:section {:title "std.scheduler (Main Namespace)" :link "merged-plans-slop-summary-std-scheduler-summary-md-std-scheduler-main-namespace"}]]
...
[[:section {:title "std.scheduler.common (Common Scheduler Utilities)" :link "merged-plans-slop-summary-std-scheduler-summary-md-std-scheduler-common-common-scheduler-utilities"}]]
...
[[:section {:title "std.scheduler.spawn (Task Spawning and Management)" :link "merged-plans-slop-summary-std-scheduler-summary-md-std-scheduler-spawn-task-spawning-and-management"}]]
...
[[:section {:title "std.scheduler.types (Scheduler Contracts)" :link "merged-plans-slop-summary-std-scheduler-summary-md-std-scheduler-types-scheduler-contracts"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-scheduler-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_scheduler_summary.md

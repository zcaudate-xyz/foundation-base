...
[[:section {:title "Core Concepts:" :link "merged-plans-slop-summary-std-lib-collection-summary-md-core-concepts"}]]
...
[[:section {:title "Key Functions:" :link "merged-plans-slop-summary-std-lib-collection-summary-md-key-functions"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-lib-collection-summary-md-usage-pattern"}]]

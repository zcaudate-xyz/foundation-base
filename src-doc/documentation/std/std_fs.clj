...
;; BEGIN merged documentation: plans/slop/summary/std_fs_summary.md
;; sha256: 9528da51d51488a20a5c483611545fdae8b02840744659297255a45f9a51203b
[[:chapter {:title "std.fs: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-fs-summary-md"}]]
...
[[:section {:title "std.fs (Main Namespace)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-main-namespace"}]]
...
[[:section {:title "std.fs.api (High-Level File Operations)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-api-high-level-file-operations"}]]
...
[[:section {:title "std.fs.archive (Archive (ZIP/JAR) Manipulation)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-archive-archive-zip-jar-manipulation"}]]
...
[[:section {:title "std.fs.attribute (File Attributes)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-attribute-file-attributes"}]]
...
[[:section {:title "std.fs.common (Filesystem Common Utilities)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-common-filesystem-common-utilities"}]]
...
[[:section {:title "std.fs.interop (Filesystem Interoperability)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-interop-filesystem-interoperability"}]]
...
[[:section {:title "std.fs.path (Path Manipulation)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-path-path-manipulation"}]]
...
[[:section {:title "std.fs.walk (Filesystem Walking)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-walk-filesystem-walking"}]]
...
[[:section {:title "std.fs.watch (Filesystem Watching)" :link "merged-plans-slop-summary-std-fs-summary-md-std-fs-watch-filesystem-watching"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-fs-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_fs_summary.md

...
[[:section {:title "std.config (Main Namespace)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-main-namespace"}]]
...
[[:section {:title "std.config.common (Common Utilities and Multimethods)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-common-common-utilities-and-multimethods"}]]
...
[[:section {:title "std.config.ext.gpg (GPG Integration)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-ext-gpg-gpg-integration"}]]
...
[[:section {:title "std.config.ext.json (JSON Integration)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-ext-json-json-integration"}]]
...
[[:section {:title "std.config.ext.toml (TOML Integration)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-ext-toml-toml-integration"}]]
...
[[:section {:title "std.config.ext.yaml (YAML Integration)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-ext-yaml-yaml-integration"}]]
...
[[:section {:title "std.config.global (Global Configuration Sources)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-global-global-configuration-sources"}]]
...
[[:section {:title "std.config.resolve (Directive Resolution Engine)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-resolve-directive-resolution-engine"}]]
...
[[:section {:title "std.config.secure (Secure Configuration)" :link "merged-plans-slop-summary-std-config-summary-md-std-config-secure-secure-configuration"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-config-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_config_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_contract_summary.md
;; sha256: 8bb84a11bb8b0c4a85194abe15e860ff1c6581ca17abf425001030e365f71413
[[:chapter {:title "std.contract: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-contract-summary-md"}]]
...
[[:section {:title "std.contract (Main Namespace)" :link "merged-plans-slop-summary-std-contract-summary-md-std-contract-main-namespace"}]]
...
[[:section {:title "std.contract.sketch (Schema Sketching and Transformation)" :link "merged-plans-slop-summary-std-contract-summary-md-std-contract-sketch-schema-sketching-and-transformation"}]]
...
[[:section {:title "std.contract.type (Contract Definition and Validation)" :link "merged-plans-slop-summary-std-contract-summary-md-std-contract-type-contract-definition-and-validation"}]]
...
[[:section {:title "std.contract.binding (Function Contract Binding)" :link "merged-plans-slop-summary-std-contract-summary-md-std-contract-binding-function-contract-binding"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-contract-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_contract_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_dom_summary.md
;; sha256: 0e5c645a2c8c81321b49a27d67e77967dbdf4954981b0aced6d0893b306d9674
[[:chapter {:title "std.dom: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-dom-summary-md"}]]
...
[[:section {:title "std.dom (Main Namespace)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-main-namespace"}]]
...
[[:section {:title "std.dom.common (Core DOM Structure and Utilities)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-common-core-dom-structure-and-utilities"}]]
...
[[:section {:title "std.dom.component (Component-Based Development)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-component-component-based-development"}]]
...
[[:section {:title "std.dom.diff (DOM Diffing Algorithm)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-diff-dom-diffing-algorithm"}]]
...
[[:section {:title "std.dom.event (Event Handling)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-event-event-handling"}]]
...
[[:section {:title "std.dom.find (DOM Traversal and Querying)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-find-dom-traversal-and-querying"}]]
...
[[:section {:title "std.dom.impl (DOM Rendering and Manipulation)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-impl-dom-rendering-and-manipulation"}]]
...
[[:section {:title "std.dom.item (UI Element Abstraction)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-item-ui-element-abstraction"}]]
...
[[:section {:title "std.dom.local (Local State Management)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-local-local-state-management"}]]
...
[[:section {:title "std.dom.mock (Mock UI Elements)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-mock-mock-ui-elements"}]]
...
[[:section {:title "std.dom.react (Reactive State Management)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-react-reactive-state-management"}]]
...
[[:section {:title "std.dom.update (DOM Update and Patching)" :link "merged-plans-slop-summary-std-dom-summary-md-std-dom-update-dom-update-and-patching"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-dom-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_dom_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_html_summary.md
;; sha256: f6e5ebe2e2ead980c4a93b2842ca169bb896bf7a32f8ad775d4d749e0c2a1e92
[[:chapter {:title "std.html: A Comprehensive Summary" :link "merged-plans-slop-summary-std-html-summary-md"}]]
...
[[:section {:title "Core Concepts:" :link "merged-plans-slop-summary-std-html-summary-md-core-concepts"}]]
...
[[:section {:title "Key Functions:" :link "merged-plans-slop-summary-std-html-summary-md-key-functions"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-html-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_html_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_image_summary.md
;; sha256: b9367470292e093b4da600464af6a0e4a283c70bcef26af3b019c2c20f5b2d00
[[:chapter {:title "std.image: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-image-summary-md"}]]
...
[[:section {:title "std.image (Main Namespace)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-main-namespace"}]]
...
[[:section {:title "std.image.awt (AWT Integration)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-awt-awt-integration"}]]
...
[[:section {:title "std.image.awt.common (AWT Common Utilities)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-awt-common-awt-common-utilities"}]]
...
[[:section {:title "std.image.awt.display (AWT Image Display)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-awt-display-awt-image-display"}]]
...
[[:section {:title "std.image.awt.io (AWT Image I/O)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-awt-io-awt-image-i-o"}]]
...
[[:section {:title "std.image.awt.rendering (AWT Rendering Hints)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-awt-rendering-awt-rendering-hints"}]]
...
[[:section {:title "std.image.base (Base Image Representation)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-base-base-image-representation"}]]
...
[[:section {:title "std.image.base.common (Base Image Common Utilities)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-base-common-base-image-common-utilities"}]]
...
[[:section {:title "std.image.base.dislang-demos.gradient (ASCII Gradient Generation)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-base-display-gradient-ascii-gradient-generation"}]]
...
[[:section {:title "std.image.base.model (Image Color Models)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-base-model-image-color-models"}]]
...
[[:section {:title "std.image.base.size (Image Size Utilities)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-base-size-image-size-utilities"}]]
...
[[:section {:title "std.image.base.util (Base Image Low-Level Utilities)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-base-util-base-image-low-level-utilities"}]]
...
[[:section {:title "std.image.protocol (Image Protocols)" :link "merged-plans-slop-summary-std-image-summary-md-std-image-protocol-image-protocols"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-image-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_image_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_json_summary.md
;; sha256: 5b46a3e263433cf4f3df9211dae00e9f5ff6e8d9a177891176bb3f120f1ddf21
[[:chapter {:title "std.json: A Comprehensive Summary" :link "merged-plans-slop-summary-std-json-summary-md"}]]
...
[[:section {:title "Core Concepts:" :link "merged-plans-slop-summary-std-json-summary-md-core-concepts"}]]
...
[[:section {:title "Key Functions:" :link "merged-plans-slop-summary-std-json-summary-md-key-functions"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-json-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_json_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_lib_recommendations.md
;; sha256: d3b0b6b55ddf972ab2ed36ad16988825a11b24c5cc3cecb2922d5cb59f669bc3
[[:chapter {:title "std.lib Recommendations" :link "merged-plans-slop-summary-std-lib-recommendations-md"}]]
...
;; END merged documentation: plans/slop/summary/std_lib_recommendations.md

;; BEGIN merged documentation: plans/slop/summary/std_lib_summary.md
;; sha256: def46fe0c118100a50c436a946f310c0b5316111e03be084392f12553b483e81
[[:chapter {:title "std.lib Summary" :link "merged-plans-slop-summary-std-lib-summary-md"}]]
...
;; END merged documentation: plans/slop/summary/std_lib_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_log_summary.md
;; sha256: 9320765017d380d98395fd9fd5b158eef3273f084a6784457040b4150cfa7027
[[:chapter {:title "std.log: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-log-summary-md"}]]
...
[[:section {:title "std.log (Main Namespace)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-main-namespace"}]]
...
[[:section {:title "std.log.common (Common Logging Utilities)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-common-common-logging-utilities"}]]
...
[[:section {:title "std.log.console (Console Logger)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-console-console-logger"}]]
...
[[:section {:title "std.log.core (Core Logger Implementations)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-core-core-logger-implementations"}]]
...
[[:section {:title "std.log.element (Log Element Formatting)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-element-log-element-formatting"}]]
...
[[:section {:title "std.log.form (Log Form Macros)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-form-log-form-macros"}]]
...
[[:section {:title "std.log.match (Log Entry Matching)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-match-log-entry-matching"}]]
...
[[:section {:title "std.log.profile (Profiling and Tracing)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-profile-profiling-and-tracing"}]]
...
[[:section {:title "std.log.template (Log Message Templating)" :link "merged-plans-slop-summary-std-log-summary-md-std-log-template-log-message-templating"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-log-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_log_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_make_summary.md
;; sha256: 2462d6d224761582068f7b4a014ce76c010e4ea655e05e3e2e36d8f97661e3d1
[[:chapter {:title "std.make: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-make-summary-md"}]]
...
[[:section {:title "std.make (Main Namespace)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-main-namespace"}]]
...
[[:section {:title "std.make.bulk (Bulk Operations)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-bulk-bulk-operations"}]]
...
[[:section {:title "std.make.common (Common Makefile Utilities)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-common-common-makefile-utilities"}]]
...
[[:section {:title "std.make.compile (Compilation Utilities)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-compile-compilation-utilities"}]]
...
[[:section {:title "std.make.github (GitHub Integration)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-github-github-integration"}]]
...
[[:section {:title "std.make.makefile (Makefile Generation)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-makefile-makefile-generation"}]]
...
[[:section {:title "std.make.project (Project Management)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-project-project-management"}]]
...
[[:section {:title "std.make.readme (README Generation)" :link "merged-plans-slop-summary-std-make-summary-md-std-make-readme-readme-generation"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-make-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_make_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_math_summary.md
;; sha256: ec5ea6c3cc60c7e17877628d512019c8f79f2aa68287d8a3957c25deffec7db7
[[:chapter {:title "std.math: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-math-summary-md"}]]
...
[[:section {:title "std.math (Main Namespace)" :link "merged-plans-slop-summary-std-math-summary-md-std-math-main-namespace"}]]
...
[[:section {:title "std.math.aggregate (Aggregation Functions)" :link "merged-plans-slop-summary-std-math-summary-md-std-math-aggregate-aggregation-functions"}]]
...
[[:section {:title "std.math.common (Common Mathematical Functions)" :link "merged-plans-slop-summary-std-math-summary-md-std-math-common-common-mathematical-functions"}]]
...
[[:section {:title "std.math.markov (Markov Chain Analysis)" :link "merged-plans-slop-summary-std-math-summary-md-std-math-markov-markov-chain-analysis"}]]
...
[[:section {:title "std.math.random (Random Number Generation)" :link "merged-plans-slop-summary-std-math-summary-md-std-math-random-random-number-generation"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-math-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_math_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_object_summary.md
;; sha256: 5fd409be67597237879eee022f71c51328cd51da12c15a7b1a1382fc5002c4e9
[[:chapter {:title "std.object: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-object-summary-md"}]]
...
[[:section {:title "std.object (Main Namespace)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-main-namespace"}]]
...
[[:section {:title "std.object.element (Object Element Abstraction)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-object-element-abstraction"}]]
...
[[:section {:title "std.object.element.class (Class Conversion Utilities)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-class-class-conversion-utilities"}]]
...
[[:section {:title "std.object.element.common (Common Element Utilities)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-common-common-element-utilities"}]]
...
[[:section {:title "std.object.element.impl.constructor (Constructor Element Implementation)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-impl-constructor-constructor-element-implementation"}]]
...
[[:section {:title "std.object.element.impl.field (Field Element Implementation)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-impl-field-field-element-implementation"}]]
...
[[:section {:title "std.object.element.impl.hierarchy (Class Hierarchy Utilities)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-impl-hierarchy-class-hierarchy-utilities"}]]
...
[[:section {:title "std.object.element.impl.method (Method Element Implementation)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-impl-method-method-element-implementation"}]]
...
[[:section {:title "std.object.element.impl.multi (Multi-Element Handling)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-impl-multi-multi-element-handling"}]]
...
[[:section {:title "std.object.element.impl.type (Element Type Utilities)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-impl-type-element-type-utilities"}]]
...
[[:section {:title "std.object.element.modifier (Modifier Utilities)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-modifier-modifier-utilities"}]]
...
[[:section {:title "std.object.element.util (Element Utility Functions)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-element-util-element-utility-functions"}]]
...
[[:section {:title "std.object.framework (Object Framework)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-object-framework"}]]
...
[[:section {:title "std.object.framework.access (Object Accessors)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-access-object-accessors"}]]
...
[[:section {:title "std.object.framework.map-like (Map-Like Extension)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-map-like-map-like-extension"}]]
...
[[:section {:title "std.object.framework.print (Print Extension)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-print-print-extension"}]]
...
[[:section {:title "std.object.framework.read (Object Reading)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-read-object-reading"}]]
...
[[:section {:title "std.object.framework.string-like (String-Like Extension)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-string-like-string-like-extension"}]]
...
[[:section {:title "std.object.framework.struct (Struct-Like Access)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-struct-struct-like-access"}]]
...
[[:section {:title "std.object.framework.vector-like (Vector-Like Extension)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-vector-like-vector-like-extension"}]]
...
[[:section {:title "std.object.framework.write (Object Writing)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-framework-write-object-writing"}]]
...
[[:section {:title "std.object.query (Object Querying)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-query-object-querying"}]]
...
[[:section {:title "std.object.query.filter (Query Filtering)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-query-filter-query-filtering"}]]
...
[[:section {:title "std.object.query.input (Query Input Processing)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-query-input-query-input-processing"}]]
...
[[:section {:title "std.object.query.order (Query Ordering)" :link "merged-plans-slop-summary-std-object-summary-md-std-object-query-order-query-ordering"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-object-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_object_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_pretty_summary.md
;; sha256: a701bdd8f85ef981aa53df133ea39b56cc5c7a5092a7a8c10262d63383f5a897
[[:chapter {:title "std.pretty: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-pretty-summary-md"}]]
...
[[:section {:title "std.pretty (Main Namespace)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-main-namespace"}]]
...
[[:section {:title "std.pretty.color (Coloring Utilities)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-color-coloring-utilities"}]]
...
[[:section {:title "std.pretty.compare (Comparison Utilities)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-compare-comparison-utilities"}]]
...
[[:section {:title "std.pretty.deque (Deque Implementation)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-deque-deque-implementation"}]]
...
[[:section {:title "std.pretty.dispatch (Dispatch Mechanisms)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-dispatch-dispatch-mechanisms"}]]
...
[[:section {:title "std.pretty.edn (EDN Printing)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-edn-edn-printing"}]]
...
[[:section {:title "std.pretty.engine (Pretty-Printing Engine)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-engine-pretty-printing-engine"}]]
...
[[:section {:title "std.pretty.protocol (Pretty-Printing Protocols)" :link "merged-plans-slop-summary-std-pretty-summary-md-std-pretty-protocol-pretty-printing-protocols"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-pretty-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_pretty_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_print_summary.md
;; sha256: 7346c8ec490e0920caad30064cd478bd3015c08adf6653f369b50d368bb90eb7
[[:chapter {:title "std.print: A Comprehensive Summary (including submodules)" :link "merged-plans-slop-summary-std-print-summary-md"}]]
...
[[:section {:title "std.print (Main Namespace)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-main-namespace"}]]
...
[[:section {:title "std.print.ansi (ANSI Styling)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-ansi-ansi-styling"}]]
...
[[:section {:title "std.print.base.animate (Animation)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-base-animate-animation"}]]
...
[[:section {:title "std.print.base.report (Report Generation)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-base-report-report-generation"}]]
...
[[:section {:title "std.print.format (General Formatting)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-format-general-formatting"}]]
...
[[:section {:title "std.print.format.chart (Chart Formatting)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-format-chart-chart-formatting"}]]
...
[[:section {:title "std.print.format.common (Common Formatting Utilities)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-format-common-common-formatting-utilities"}]]
...
[[:section {:title "std.print.format.report (Report Formatting)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-format-report-report-formatting"}]]
...
[[:section {:title "std.print.format.time (Time Formatting)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-format-time-time-formatting"}]]
...
[[:section {:title "std.print.progress (Progress Indicators)" :link "merged-plans-slop-summary-std-print-summary-md-std-print-progress-progress-indicators"}]]
...
[[:section {:title "Usage Pattern:" :link "merged-plans-slop-summary-std-print-summary-md-usage-pattern"}]]
...
;; END merged documentation: plans/slop/summary/std_print_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_protocol_summary.md
;; sha256: 5188c4c43ee7c0520095d25313ef70cdf2cd2d1577cbf4e0438ad47c160f6371
[[:chapter {:title "std.protocol: A Comprehensive Summary" :link "merged-plans-slop-summary-std-protocol-summary-md"}]]
...
[[:section {:title "std.protocol.apply" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-apply"}]]
...
[[:section {:title "std.protocol.archive" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-archive"}]]
...
[[:section {:title "std.protocol.binary" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-binary"}]]
...
[[:section {:title "std.protocol.block" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-block"}]]
...
[[:section {:title "std.protocol.component" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-component"}]]
...
[[:section {:title "std.protocol.context" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-context"}]]
...
[[:section {:title "std.protocol.deps" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-deps"}]]
...
[[:section {:title "std.protocol.dispatch" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-dispatch"}]]
...
[[:section {:title "std.protocol.invoke" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-invoke"}]]
...
[[:section {:title "std.protocol.log" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-log"}]]
...
[[:section {:title "std.protocol.match" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-match"}]]

"Defines an interface for template matching."

"*   **`ITemplate` Protocol:**\n    *   `-match [template obj]`: Matches an object against a template."

[[:section {:title "std.protocol.object" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-object"}]]
...
[[:section {:title "std.protocol.request" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-request"}]]
...
[[:section {:title "std.protocol.return" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-return"}]]
...
[[:section {:title "std.protocol.state" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-state"}]]
...
[[:section {:title "std.protocol.stream" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-stream"}]]
...
[[:section {:title "std.protocol.string" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-string"}]]
...
[[:section {:title "std.protocol.time" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-time"}]]
...
[[:section {:title "std.protocol.track" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-track"}]]

"Defines an interface for tracking components."

"*   **`ITrack` Protocol:**\n    *   `-track-path [component]`: Returns the tracking path for a component."

[[:section {:title "std.protocol.watch" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-watch"}]]
...
[[:section {:title "std.protocol.wire" :link "merged-plans-slop-summary-std-protocol-summary-md-std-protocol-wire"}]]
...
;; END merged documentation: plans/slop/summary/std_protocol_summary.md

;; BEGIN merged documentation: plans/slop/summary/std_text_summary.md
;; sha256: c8fda2a53d60f3dcc915011c9776f4f46b2a05240cc83bef94c04d2df4c8b797
[[:chapter {:title "std.text: A Comprehensive Summary" :link "merged-plans-slop-summary-std-text-summary-md"}]]
...
[[:section {:title "std.text.diff" :link "merged-plans-slop-summary-std-text-summary-md-std-text-diff"}]]
...
[[:section {:title "std.text.index" :link "merged-plans-slop-summary-std-text-summary-md-std-text-index"}]]
...
;; END merged documentation: plans/slop/summary/std_text_summary.md

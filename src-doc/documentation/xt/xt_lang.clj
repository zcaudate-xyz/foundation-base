...
"A lang script requires the libraries it needs, then emitted xtalk code calls those portable helpers. Application examples in `src-build/projects/play/*xtalk*` and tests under `test-lang/xt/lang` show this pattern."

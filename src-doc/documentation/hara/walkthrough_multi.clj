tahto/walkthrough_multi.clj:1:(ns documentation.tahto-walkthrough-multi
...
"`l/script- :lua` does the same for Lua. The same tahto.core form now produces Lua syntax."

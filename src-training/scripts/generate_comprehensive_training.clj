(ns scripts.generate-comprehensive-training
  "Generates comprehensive training pairs showing full hara.lang grammar
   including script declarations, requires, defn.js definitions, and complete
   module transformation context.
   
   This exposes the actual hara.lang internals and grammar.
...
;; Shows the complete hara.lang grammar and transformation
;; ============================================================

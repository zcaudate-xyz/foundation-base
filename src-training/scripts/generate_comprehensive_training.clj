...
(def +comprehensive-pairs+
  ...
  [
   ...
   {:id 13
    ...
    :intent "Concatenate two arrays using k/arr-append"
    :xtalk-module (str "(ns my.module\n"
                        "  (:require [std.lang :as l]))\n\n"
                        "(l/script :js\n"
                        "  {:require [[xt.lang.base-lib :as k]]})\n\n"
                        "(defn.js combine\n"
                        "  [arr1 arr2]\n"
                        "  (return (k/arr-append arr1 arr2)))")
    :xtalk "(k/arr-append arr1 arr2)"
    :js "k.arr_append(arr1, arr2)"
    :python "k.arr_append(arr1, arr2)"
    :context "k/arr-append concatenates two arrays. Use instead of Array.prototype.concat or list concatenation."}

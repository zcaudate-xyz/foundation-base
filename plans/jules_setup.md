...
*   **`plans/action/js_dsl/`**: Documentation for the JS DSL (`hara.lang`). Essential if working on transpiled code.
...
### 4.3. Working with `hara.lang` DSL

If modifying JS/Lua/Python code generated by `hara.lang`:

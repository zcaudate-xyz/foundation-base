...
*   **`plans/action/js_dsl/`**: Documentation for the JS DSL (`lang.core`). Essential if working on transpiled code.
...
### 4.3. Working with `lang.core` DSL

If modifying JS/Lua/Python code generated by `lang.core`:

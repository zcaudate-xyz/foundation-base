...
*   **`plans/action/js_dsl/`**: Documentation for the JS DSL (`tahto.core`). Essential if working on transpiled code.
...
### 4.3. Working with `tahto.core` DSL

If modifying JS/Lua/Python code generated by `tahto.core`:

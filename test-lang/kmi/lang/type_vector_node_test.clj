(ns kmi.lang.type-vector-node-test
...
^{:refer kmi.lang.type-vector-node/impl-mask :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/impl-offset :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-create :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-clone :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-editable-root :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-editable :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/ensure-editable :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/ensure-persistent :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-new-path :added "4.0"}
(fact "new path"
...
^{:refer kmi.lang.type-vector-node/node-push-tail :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-pop-tail :added "4.0"}
...
^{:refer kmi.lang.type-vector-node/node-assoc :added "4.0"}
(fact "associates a given node without mutating the original"
  ...
  (!.js
   ...
   [(xt/x:get-key root "children")
    (xt/x:get-key out "children")])
  => [[1 2 3] [1 9 3]])

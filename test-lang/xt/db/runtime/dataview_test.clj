(ns xt.db.runtime.dataview-test
...
^{:refer xt.db.runtime.dataview/query-entry :added "4.1"}
(fact "normalizes inline query entries without a registry"

  (!.js
    (dataview/query-entry
     "UserAccount"
     {"input" [{"symbol" "i_organisation_id", "type" "uuid"}]
...
^{:refer xt.db.runtime.dataview/query-entries.inline :added "4.1"}
...
^{:refer xt.db.runtime.dataview/prepare-query.inline :added "4.1"}

...
^{:refer xt.db.node.query-view/get-views :added "4.1"}
...
^{:refer xt.db.node.query-view/get-schema :added "4.1"}
...
^{:refer xt.db.node.query-view/view-query-return-entry :added "4.1"}
...
^{:refer xt.db.node.query-view/view-query-return-combined :added "4.1"}
...
^{:refer xt.db.node.query-view/view-query-entries :added "4.1"}
...
^{:refer xt.db.node.query-view/view-triggers :added "4.1"}
...
^{:refer xt.db.node.query-view/view-overview :added "4.1"}
...
^{:refer xt.db.node.query-view/view-tables :added "4.1"}
...
^{:refer xt.db.node.query-view/view-methods :added "4.1"}
...
^{:refer xt.db.node.query-view/view-detail :added "4.1"}

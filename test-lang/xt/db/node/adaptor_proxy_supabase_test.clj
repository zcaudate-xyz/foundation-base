...
(defn.js connect-worker
  ...
  (var client (substrate/node-create {"id" "adaptor-proxy-supabase-client"}))
...
^{:refer xt.db.node.adaptor-proxy-supabase/set-default-transport :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/get-default-transport :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/get-transport-id :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/request-meta :added "4.1"}
(fact "builds request meta with an explicit transport_id"
  ...
  => {"transport_id" "worker"})
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-sign-up-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-sign-in-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-sign-out-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-refresh-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-signed-in-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-current-session-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-rpc-call-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-query-table-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-health-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-admin-create-user-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-admin-delete-user-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-admin-generate-link-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-admin-get-user-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-admin-list-users-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-admin-update-user-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-authorize-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-callback-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-invite-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-otp-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-recovery-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-settings-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-token-refresh-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-user-get-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-user-info-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-user-put-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-verify-get-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/supabase-verify-post-handler :added "4.1"}
...
^{:refer xt.db.node.adaptor-proxy-supabase/init-proxy-handlers :added "4.1"}

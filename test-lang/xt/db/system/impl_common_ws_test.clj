...
(l/script- :js
  {:runtime :basic
   :require [[xt.db.system.impl-common-ws :as common-ws]
...
^{:refer xt.db.system.impl-common-ws/create-ws-client :added "4.1"}
...
(fact "creates a websocket client"
  ...
  (!.js
   (var client (common-ws/create-ws-client {"host" "example.com"}))
   {"::" (xt/x:get-key client "::")

(ns xt.db.instance.cache-util-test
...
^{:refer xt.db.instance.cache-util/merge-single.python-data :added "4.0"}
...
^{:refer xt.db.instance.cache-util/merge-bulk.python-data :added "4.0"}

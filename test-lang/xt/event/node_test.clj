...
^{:refer xt.event.node/CANARY.00-create-node :adopt true :added "4.1"}
...
^{:refer xt.event.node/CANARY.00-create-space :adopt true :added "4.1"}
...
^{:refer xt.event.node/CANARY.00-create-space-map :adopt true :added "4.1"}
(fact "creates a space in the node"
...
^{:refer xt.event.node/CANARY.00-create-space-handler :adopt true :added "4.1"}
...
^{:refer xt.event.node/CANARY.01-register-handler :adopt true :added "4.1"}
(fact "registers a handler"
...
^{:refer xt.event.node/CANARY.01-register-trigger :adopt true :added "4.1"}
...
^{:refer xt.event.node/CANARY.02-request-publish-trigger-workflow :adopt true :added "4.1"}
...
^{:refer xt.event.node/CANARY.03-trigger-chain-workflow :adopt true :added "4.1"}

...
^{:refer postgres.core.impl/t:get-field :added "4.0"}
...
^{:refer postgres.core.impl/t:get :added "4.0"}
...
^{:refer postgres.core.impl/t:id :added "4.0"}
(fact "get id entry"
...
^{:refer postgres.core.impl/t:count :added "4.0"}
...
^{:refer postgres.core.impl/t:exists :added "4.0"}
...
^{:refer postgres.core.impl/t:delete :added "4.0"}
(fact "flat delete"
...
^{:refer postgres.core.impl/t:insert :added "4.0"}
(fact "flat insert"
...
^{:refer postgres.core.impl/t:upsert :added "4.0"}
(fact "flat upsert"
...
^{:refer postgres.core.impl/t:update :added "4.0"}
(fact "flat update"
...
^{:refer postgres.core.impl/t:modify :added "4.0"}
(fact "flat modify"
...
^{:refer postgres.core.impl/t:fields :added "4.0"}

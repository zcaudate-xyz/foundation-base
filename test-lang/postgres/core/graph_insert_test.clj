...
^{:refer postgres.core.graph-insert/insert-walk-ids :added "4.0"}
...
^{:refer postgres.core.graph-insert/insert-generate-graph-tree :added "4.0"}
...
^{:refer postgres.core.graph-insert/insert-associate-graph-data :added "4.0"}
...
^{:refer postgres.core.graph-insert/insert-gen-sql :added "4.0"}
...
^{:refer postgres.core.graph-insert/insert-fn-raw :added "4.0"}
...
^{:refer postgres.core.graph-insert/insert-fn :added "4.0"}
...
^{:refer postgres.core.graph-insert/insert-fn.assign :adopt true :added "4.0"}

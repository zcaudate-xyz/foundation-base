...
(comment
  ;; The following live Supabase API tests require a running Supabase local
  ;; stack and API client functions that were removed from
  ;; `postgres.core.supabase`. They are kept here as documentation but are not

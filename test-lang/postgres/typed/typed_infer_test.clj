(ns postgres.typed.typed-infer-test
  (:require [postgres.typed.typed-infer :refer :all]
...
^{:refer postgres.typed.typed-infer/select-shape-columns :added "4.1"}
...
^{:refer postgres.typed.typed-infer/resolve-table-def :added "4.1"}
...
^{:refer postgres.typed.typed-infer/form-uses-tracked? :added "4.1"}
...
^{:refer postgres.typed.typed-infer/form-uses-track-param? :added "4.1"}
...
^{:refer postgres.typed.typed-infer/find-table-op-in-body :added "4.1"}
...
^{:refer postgres.typed.typed-infer/find-table-update-spec-in-body :added "4.1"}
...
^{:refer postgres.typed.typed-infer/find-table-track-spec-in-body :added "4.1"}
...
^{:refer postgres.typed.typed-infer/infer-jsonb-arg-access-shape :added "4.1"}
...
^{:refer postgres.typed.typed-infer/infer-jsonb-arg-table-shape* :added "4.1"}
...
^{:refer postgres.typed.typed-infer/infer-jsonb-arg-shape :added "4.1"}

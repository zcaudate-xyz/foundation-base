(ns postgres.typed.export.server-db-test
  (:require [postgres.typed.export-test :as fixtures]
            [postgres.typed.export.server-db :refer :all])
  (:use code.test))

(fixtures/ensure-fixtures!)

^{:refer postgres.typed.export.server-db/collect-pg-ops :added "4.1"}
...
^{:refer postgres.typed.export.server-db/infer-sync-spec :added "4.1"}
...
^{:refer postgres.typed.export.server-db/db-sync-merge :added "4.1"}
...
^{:refer postgres.typed.export.server-db/supabase-db-input :added "4.1"}
...
^{:refer postgres.typed.export.server-db/target-entry :added "4.1"}
...
^{:refer postgres.typed.export.server-db/emit-target :added "4.1"}
...
^{:refer postgres.typed.export.server-db/emit-targets :added "4.1"}
...
^{:refer postgres.typed.export.server-db/list-targets :added "4.1"}

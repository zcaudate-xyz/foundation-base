...
(fact "extract-aliases builds alias map from require forms"
  ...
  ;; Multiple aliases
  (parse/extract-aliases '[[postgres.core :as pg] [lang.runtime.user :as user]])
  => '{pg postgres.core, user lang.runtime.user}

  ;; Ignores non-:as forms
  (parse/extract-aliases '[[postgres.core :as pg] [lang.runtime.util :refer [foo]]])
  => '{pg postgres.core}
...
(fact "parse-aliases extracts aliases from script form"
  ...
  (parse/parse-aliases '(script :postgres {:require [[postgres.core :as pg]
                                                     [lang.runtime.user :as u]]}))
  => '{pg postgres.core, u lang.runtime.user}

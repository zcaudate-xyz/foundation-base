...
(l/script :xtalk
  {:require [[xt.cell.binding.trigger :as binding-trigger] [xt.cell.service.db-query :as db-query] [xt.cell.service.db-remote :as db-remote] [xt.cell.service.db-supabase :as db-supabase] [xt.cell.service.db-sync :as db-sync] [xt.lang.spec-base :as xt] [xt.lang.common-data :as xtd]]})

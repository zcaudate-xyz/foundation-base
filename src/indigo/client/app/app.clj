...
(l/script :js
  {:require [[js.react :as r]
             ...
             [indigo.client.app.components.viewport-canvas :as vc]
             [indigo.client.app.components.properties-panel :as pp]
             [indigo.client.app.components.outliner-panel :as op]
             [indigo.client.app.components.top-bar :as tb]
             [indigo.client.app.components.theme-editor :as te]
             [js.lib.figma :as fg]]})

(def.js defaultTheme te/defaultTheme)

(def.js defaultComponents
...
(defn.js App []
  (var [components setComponents] (r/useState -/defaultComponents))
  ...
  ;; History management
  (var [history setHistory] (r/useState -/defaultHistory))

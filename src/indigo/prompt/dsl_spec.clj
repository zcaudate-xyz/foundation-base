...
(def +meta+
  ["# **lang.core (JS) DSL Specification**"
   ""
...
(comment
  ...
  "Given the spec in @translate_dsl, translate src/App.jsx and all files in src/components/** to the lang.core dsl to src-translated. follow the original directory layout. please generate file in compilation order"

  "Given the spec in @translate_dsl, translate src/App.jsx and all files in src/components/** and src/lib/** to the lang.core dsl to src-translated. follow the original directory layout. look at the dependency map for the project and generate file in compilation order from least dependent to most"


  "Given the spec in @translate_dsl, translate src/App.jsx and all files in src/lib/** and src/components/* to the lang.core dsl to src-translated. follow the original directory layout and do not translate the subdirectories. look at the dependency map for the project and generate file in compilation order from least dependent to most"

  "Given the spec in @translate_dsl, translate src/App.jsx and all files in src/lib/** and src/components/* (DO NOT FOLLOW SUBDIRECTORIES) to the lang.core dsl to src-translated. DO NOT translate src/components/ui/* follow the original directory layout.  generate file in compilation order from least dependent to most"

  "Given the spec in @translate_dsl, translate src/App.jsx and all files in src/lib/** and src/components/* (DO NOT FOLLOW SUBDIRECTORIES) to the lang.core dsl to src-translated. DO NOT translate src/components/ui/* follow the original directory layout. "

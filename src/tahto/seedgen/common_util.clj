(ns tahto.seedgen.common-util
  (:require [std.fs :as fs]
            [tahto.core.impl :as lang.impl]
            [tahto.core.library :as lang.lib]
...
(defn seedgen-script-heads
  ...
  (let [require-clause (some #(when (and (seq? %)
                                ...
                                %)
                             (nnext ns-form))
        tahto-lang-alias (some #(require-alias % 'tahto.core)
                             (rest require-clause))]

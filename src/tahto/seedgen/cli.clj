(ns tahto.seedgen.cli
  "CLI entry point for seedgen tasks.
   ...
   lein seedgen todos '[tahto.runtime]
   lein seedgen todos '[tahto.runtime] :write true"
  (:require [clojure.edn :as edn]
            ...
            [tahto.seedgen :as seedgen]
            [tahto.seedgen.metrics :as metrics]
            [tahto.seedgen.common-xtalk :as xtalk]

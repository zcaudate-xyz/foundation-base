...
(comment
  (tahto.core/with:no-cache
   (tahto.core/ptr-print statsdb.core.exchange/r-xch-service-default))
  
  (tahto.core/with:no-cache
   (tahto.core/ptr-print statsdb.core.account/email-registration-undo))
  )

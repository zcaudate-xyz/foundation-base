(ns tahto.seedgen
  (:require [code.manage :as manage]
            ...
            [tahto.seedgen.common-infile :as common-infile]
            [tahto.seedgen.common-util :as common]
            [tahto.seedgen.form-bench :as form-bench]
            [tahto.seedgen.form-parse :as form-parse]
...
(comment (tahto.seedgen/seedgen-root
...
(comment (tahto.seedgen/seedgen-list
          ['xt.sample]
          {:print {:item true :result true :summary true}}))
...
(comment (tahto.seedgen/seedgen-readforms
          ['xt.sample.train-002]
          {:print {:item true :result true :summary true}}))
...
(comment (tahto.seedgen/seedgen-benchlist
          ['xt.sample]
          {:print {:item true :result true :summary true}}))
...
(comment (tahto.seedgen/seedgen-incomplete
          ['xt.sample]
          {:print {:item true :result true :summary true}}))
...
(comment (tahto.seedgen/seedgen-langremove
          ['xt.sample]
          {:lang :js
...
(comment (tahto.seedgen/seedgen-langadd
          ['xt.sample]
          {:lang :lua
           :print {:function true :item true :result true :summary true}})
...
(comment (tahto.seedgen/seedgen-benchadd
          ['xt.sample]
          {:lang :python
           :print {:function true :item true :result true :summary true}})
...
(comment (tahto.seedgen/seedgen-benchremove
          ['xt.sample]
          {:lang :python
           :print {:function true :item true :result true :summary true}}))

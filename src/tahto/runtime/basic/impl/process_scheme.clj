(ns tahto.runtime.basic.impl.process-scheme
  (:require [clojure.string :as str]
            ...
            [tahto.model.spec-scheme :as spec]))
  ...
  (str/join
   "\n"
     ...
     "               [else x])))"
      ...
      "                                   [(string? out) \"string\"]"
      "                                   [(number? out) \"number\"]"
      "                                   [(procedure? out) \"function\"]"
      "                                   [(vector? out) \"array\"]"
      "                                   [(hash? out) \"object\"]"
      "                                   [else \"unknown\"])]"
      "                    [payload (hasheq 'type (if (equal? return-type \"function\") \"raw\" \"data\")"
      "                                     'return return-type"
      "                                     'value (if (equal? return-type \"function\")"
      "                                              (format \"~a\" out)"
      "                                              (xt-json-normalize out)))]"

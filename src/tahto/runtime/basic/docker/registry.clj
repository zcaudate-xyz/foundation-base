(ns tahto.runtime.basic.docker.registry
  (:require [clojure.java.io :as io]
            [tahto.runtime.basic.impl.process-js      :as js]
            [tahto.runtime.basic.impl.process-lua     :as lua]
            [tahto.runtime.basic.impl.process-python  :as python]
            [tahto.runtime.basic.impl.process-ruby    :as ruby]
            [tahto.runtime.basic.impl-annex.process-erlang :as erlang]
            [tahto.runtime.basic.impl-annex.process-julia  :as julia]
            [tahto.runtime.basic.impl-annex.process-perl   :as perl]
            [tahto.runtime.basic.impl-annex.process-php    :as php]

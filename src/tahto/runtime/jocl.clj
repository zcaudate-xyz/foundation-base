(ns tahto.runtime.jocl
  (:refer-clojure :exclude [meta to-array])
  (:require [tahto.runtime.jocl.env :as jocl-env]
...
(when +available?+
  (import-jocl-ns 'tahto.runtime.jocl.common)
  (import-jocl-ns 'tahto.runtime.jocl.meta)
  (import-jocl-ns 'tahto.runtime.jocl.exec)
  (import-jocl-ns 'tahto.runtime.jocl.type)
  (import-jocl-ns 'tahto.runtime.jocl.runtime))

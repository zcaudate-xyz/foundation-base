          ...
          mopts (-> mopts
                    ...
                    (provenance/with-provenance
                      {:tahto/phase :emit/entry
                       :tahto/subsystem :tahto.core.impl-entry/emit-entry-raw
                       :tahto/form form
                       :tahto/lang lang

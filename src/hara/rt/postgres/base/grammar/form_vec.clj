(ns hara.rt.postgres.base.grammar.form-vec
...
(comment
  (hara.lang/with:no-cache
   (hara.lang/ptr-print statsdb.core.exchange/r-xch-service-default))
  
  (hara.lang/with:no-cache
   (hara.lang/ptr-print statsdb.core.account/email-registration-undo))
  )

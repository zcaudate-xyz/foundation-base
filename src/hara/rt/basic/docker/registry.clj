(ns hara.rt.basic.docker.registry
  (:require [clojure.java.io :as io]
            [hara.rt.basic.impl.process-js      :as js]
            [hara.rt.basic.impl.process-lua     :as lua]
            [hara.rt.basic.impl.process-python  :as python]
            [hara.rt.basic.impl.process-ruby    :as ruby]
            [hara.rt.basic.impl-annex.process-erlang :as erlang]
            [hara.rt.basic.impl-annex.process-julia  :as julia]
            [hara.rt.basic.impl-annex.process-perl   :as perl]
            [hara.rt.basic.impl-annex.process-php    :as php]

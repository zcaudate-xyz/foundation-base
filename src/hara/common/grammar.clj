(ns hara.common.grammar
  (:require [clojure.set]
            [clojure.string]
            [hara.common.grammar-macro :as macro]
...
(def ^{:generator (fn []
                    (vec (concat (gen-ops 'hara.common.grammar-spec "spec")
                                 (gen-ops 'hara.common.grammar-macro "macro")
                                 (gen-ops 'hara.common.grammar-xtalk "xtalk"))))}
  +op-all+

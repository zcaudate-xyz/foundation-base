(ns hara.lang.seedgen
  (:require [code.manage :as manage]
            ...
            [hara.lang.seedgen.form-parse :as form-parse]
...
(comment (hara.lang.seedgen/seedgen-root
...
(comment (hara.lang.seedgen/seedgen-list
          ['xt.sample]
          {:print {:item true :result true :summary true}}))
...
(comment (hara.lang.seedgen/seedgen-readforms
          ['xt.sample.train-002]
          {:print {:item true :result true :summary true}}))
...
(comment (hara.lang.seedgen/seedgen-benchlist
          ['xt.sample]
          {:print {:item true :result true :summary true}}))
...
(comment (hara.lang.seedgen/seedgen-incomplete
          ['xt.sample]
          {:print {:item true :result true :summary true}}))
...
(comment (hara.lang.seedgen/seedgen-langremove
          ['xt.sample]
          {:lang :js
...
(comment (hara.lang.seedgen/seedgen-langadd
          ['xt.sample]
          {:lang :lua
           :print {:function true :item true :result true :summary true}})
...
(comment (hara.lang.seedgen/seedgen-benchadd
          ['xt.sample]
          {:lang :python
           :print {:function true :item true :result true :summary true}})
...
(comment (hara.lang.seedgen/seedgen-benchremove
          ['xt.sample]
          {:lang :python
           :print {:function true :item true :result true :summary true}}))

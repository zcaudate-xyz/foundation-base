(ns hara.lang.base.grammar
  (:require [clojure.set]
            [clojure.string]
            [hara.lang.base.grammar-macro :as macro]
...
(def ^{:generator (fn []
                    (vec (concat (gen-ops 'hara.lang.base.grammar-spec "spec")
                                 (gen-ops 'hara.lang.base.grammar-macro "macro")
                                 (gen-ops 'hara.lang.base.grammar-xtalk "xtalk"))))}
  +op-all+

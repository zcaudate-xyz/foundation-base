(ns hara.lang.seedgen.form-bench
  (:require [clojure.string :as str]
             [code.framework :as base]
             [code.project :as project]
             [std.fs :as fs]
             [hara.lang.seedgen.form-common :as form-common]
             [hara.lang.seedgen.form-infile :as form-infile]
             [hara.lang.seedgen.form-parse :as readforms]
...
(comment
  ...
  ;; ** seed-bench-list
  ;; should list a namespace for creation using the hara.lang.seedgen.* pipeline
  ...
  (code.project/in-context
   (hara.lang.seedgen.form-bench/seedgen-benchlist 'xt.sample.train-001-test
                                                   {:lang [:js :python]}))
  => )
...
(comment
  ...
  (code.project/in-context
   (hara.lang.seedgen.form-bench/seedgen-root 'xt.sample.train-001-test
                                                {}))
  => :js)

(ns hara.runtime.basic.docker.registry
  (:require [clojure.java.io :as io]
            [hara.runtime.basic.impl.process-js      :as js]
            [hara.runtime.basic.impl.process-lua     :as lua]
            [hara.runtime.basic.impl.process-python  :as python]
            [hara.runtime.basic.impl.process-ruby    :as ruby]
            [hara.runtime.basic.impl-annex.process-erlang :as erlang]
            [hara.runtime.basic.impl-annex.process-julia  :as julia]
            [hara.runtime.basic.impl-annex.process-perl   :as perl]
            [hara.runtime.basic.impl-annex.process-php    :as php]

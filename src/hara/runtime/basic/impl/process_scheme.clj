(ns hara.runtime.basic.impl.process-scheme
   ...
   "\n"
    ...
    "      [(hash? x)"
     ...
     "      [else \"unknown\"]))"
       ...
       "  (define (xt-proto-create m)"
       "    m)"
       "  (define (xt-proto-get obj)"
       "    (hash-ref obj \"_xt_proto\" #f))"
       "  (define (xt-proto-set obj proto)"
       "    (hash-set! obj \"_xt_proto\" proto)"
       "    obj)"
       "  (define (xt-proto-method obj key)"
       "    (let ([direct (hash-ref obj key #f)])"
       "      (if (equal? #f direct)"
       "        (let ([proto (hash-ref obj \"_xt_proto\" #f)])"
       "          (if (equal? #f proto)"
       "            #f"
       "            (hash-ref proto key #f)))"
       "        direct)))"
      ...
      "                 (unless resolved"
      "                   (set! resolved #t)"
      "                   (set! result (xt-promise-resolved value))))"
      "               (lambda (err)"
      "                 (unless resolved"
      "                   (set! resolved #t)"
      "                   (set! result (xt-promise-rejected err)))))"
      "        (if resolved"
      "          result"
      "          (xt-promise-rejected \"promise-new did not resolve synchronously\")))))"
      ...
      "  (namespace-set-variable-value! 'xt-type-native xt-type-native #t XT_NAMESPACE)"
       ...
       "  (namespace-set-variable-value! 'xt-proto-create xt-proto-create #t XT_NAMESPACE)"
       "  (namespace-set-variable-value! 'xt-proto-get xt-proto-get #t XT_NAMESPACE)"
       "  (namespace-set-variable-value! 'xt-proto-set xt-proto-set #t XT_NAMESPACE)"
       "  (namespace-set-variable-value! 'xt-proto-method xt-proto-method #t XT_NAMESPACE)"
       "  (namespace-set-variable-value! 'xt-promise xt-promise #t XT_NAMESPACE)"
       "  (namespace-set-variable-value! 'xt-promise-new xt-promise-new #t XT_NAMESPACE)"

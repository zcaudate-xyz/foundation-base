...
(comment
  (code.project/in-context
   (hara.seedgen.common-infile/seedgen-root 'xt.sample.train-001-test
                                              {}))
  => :js)
...
(comment
  (code.project/in-context
   (hara.seedgen.common-infile/seedgen-list '<sample>
                                              {}))
  => [:lua :python])
...
(comment
  (code.project/in-context
   (hara.seedgen.common-infile/seedgen-incomplete <sample>
                                                    {}))

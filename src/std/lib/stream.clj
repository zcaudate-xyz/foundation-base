(ns std.lib.stream
  ...
  (:import (clojure.lang IPersistentCollection IPersistentList ITransientCollection) (java.util.function Supplier) (java.util Collection Spliterator) (java.util.stream Stream StreamSupport Collector Collectors) (java.util.concurrent Callable Future) (newlisp.lib.stream ISeqSpliterator)))

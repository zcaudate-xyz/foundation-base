(ns std.concurrent.queue
  (:import (java.util.concurrent BlockingQueue BlockingDeque ArrayBlockingQueue LinkedBlockingQueue LinkedBlockingDeque SynchronousQueue TimeUnit) (newlisp.lib.concurrent LimitedQueue))

(ns lang.model.annex.spec-postgres.form-vec
...
(comment
  (lang.core/with:no-cache
   (lang.core/ptr-print statsdb.core.exchange/r-xch-service-default))
  
  (lang.core/with:no-cache
   (lang.core/ptr-print statsdb.core.account/email-registration-undo))
  )

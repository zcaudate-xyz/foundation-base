...
(comment
  ...
  ;; ** seed-bench-list
  ;; should list a namespace for creation using the lang.seedgen.* pipeline
  ...
  (code.project/in-context
   (lang.seedgen.form-bench/seedgen-benchlist 'xt.sample.train-001-test
                                                   {:lang [:js :python]}))
  => )
...
(comment
  ...
  ;; - look at the namespace form for [lang.core :as <ns>]
  ...
  (code.project/in-context
   (lang.seedgen.form-bench/seedgen-root 'xt.sample.train-001-test
                                                {}))
  => :js)

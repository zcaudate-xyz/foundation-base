(ns lang.runtime.js-playground
  "Browser playground runtime backed by a WebSocket connection.

   Unlike the runtimes in `lang.runtime.basic`, which target generic JS
  ...
  (:require [clojure.string]
            ...
            [lang.runtime.js-playground.client]))
...
(defn playground-client-script
  "emits the browser-side React playground app as JS via lang.core.

   The client lives in `lang.runtime.js-playground.client` and is compiled to
   a single ES module with `js.react` for the UI and
   `xt.lang.common-lib/return-eval` for safe eval."
  {:added "4.0"}
  []
  (l/emit-script
   '(lang.runtime.js-playground.client/mount!)
   {:lang :js
    :layout :flat
    :module 'lang.runtime.js-playground.client
    :emit {:lang/jsx false

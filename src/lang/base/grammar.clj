(ns lang.base.grammar
  (:require [clojure.set]
            [clojure.string]
            [lang.base.grammar-macro :as macro]
            [lang.base.grammar-spec :as spec]
            [lang.base.grammar-xtalk :as xtalk]
...
(def ^{:generator (fn []
                    (vec (concat (gen-ops 'lang.base.grammar-spec "spec")
                                 (gen-ops 'lang.base.grammar-macro "macro")
                                 (gen-ops 'lang.base.grammar-xtalk "xtalk"))))}
  +op-all+

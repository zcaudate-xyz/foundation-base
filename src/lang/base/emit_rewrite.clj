(ns lang.base.emit-rewrite
  (:require [lang.typed.xtalk-analysis :as xtalk-analysis]
            [lang.typed.xtalk-infer :as xtalk-infer]
            [lang.typed.xtalk-lower :as xtalk-lower]))

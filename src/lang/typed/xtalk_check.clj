...
(defn check-fn-def
  ...
  (let [ctx {:env (function-env fn-def)
             ...
             :function fn-def
             :infer (requiring-resolve 'lang.typed.xtalk-infer/infer-type)
...
(defn check-function
  [fn-ref]
  (let [fn-def (cond
                 (instance? lang.typed.xtalk_common.XtFnDef fn-ref)
                 fn-ref

...
(defmacro.js  ^{:style/indent 1}
  ...
  {:added "4.0"}
  [[ms] & body]
  (template/$ (setInterval (fn [] (new Promise (fn []
                                          ~@body)))
                    ~ms)))
...
(f/template-entries [l/tmpl-macro {:base "Number"
                                   :inst "num"
                                   :tag "js"}]
  [[toExponetial [d]]
   [toFixed [d]]
...
(f/template-entries [l/tmpl-macro {:base "Object"
                                   :inst "obj"
                                    :tag "js"}]
  [[hasOwnProperty [prop]]
   [isPrototypeOf  [type]]
...
(f/template-entries [l/tmpl-macro {:base "Function"
                                   :inst "func"
                                   :tag "js"}]
...
(f/template-entries [l/tmpl-macro {:base "Iterable"
                                   :inst "seq"
                                   :empty []
                                   :tag "js"}]
...
(f/template-entries [l/tmpl-macro {:base "Array"
                                   :inst "arr"
                                   :empty []
                                   :tag "js"}]
...
(f/template-entries [l/tmpl-macro {:base "PArray"
                                   :inst "arr"
                                   :empty []
                                   :tag "js"}]
  [[pop []]
...
(f/template-entries [l/tmpl-macro {:base "TArray"
                                   :inst "tarr"
                                    :tag "js"}]
  [[[setTArr set] [arr] {:optional [offset]}]
   [subarray [] {:optional [start end]}]])

(f/template-entries [l/tmpl-macro {:base "String"
                                   :inst  "s"
                                   :empty ""
                                   :tag "js"}]
  [[charAt [idx]]
...
(f/template-entries [l/tmpl-macro {:base "Map"
                                   :inst "h"
                                   :tag "js"}]
  [[[hGet get] [key]]
   [[hHas has] [key]]
...
(f/template-entries [l/tmpl-macro {:base "Date"
                                   :inst "func"
                                    :tag "js"}]
  [[getDate []]
   [getDay []]
...
(f/template-entries [l/tmpl-macro {:base "Generator"
                                   :inst "gen"
                                   :tag "js"}]
  [[[genNext next]  []]
   [[genReturn return]   []]
...
(f/template-entries [l/tmpl-macro {:base "Promise"
                                   :inst "p"
                                   :tag "js"}]
  [[catch [onError]]
...
(f/template-entries [l/tmpl-macro {:base "DataView"
                                   :inst "dv"
                                   :tag "js"}]
  [[getUint8 [idx]]
   [getInt16 [idx]]

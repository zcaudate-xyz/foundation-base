...
(l/script :xtalk
  {:export [MODULE] :require [[js.cell.service.db-view :as db-view] [xt.lang.spec-base :as xt] [xt.lang.common-data :as xtd] [xt.lib.db :as xdb] [xt.lib.db.base-check :as check] [xt.lib.db.cache-view :as cache-view]]})

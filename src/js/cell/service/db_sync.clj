...
(l/script :xtalk
  {:export [MODULE] :require [[js.cell.service.db-view :as db-view] [xt.db :as xdb] [xt.db.base-flatten :as flatten] [xt.lang.common-spec :as xt] [xt.lang.common-data :as xtd]]})

...
(l/script :xtalk
  {:export [MODULE] :require [[js.cell.service.db-view :as db-view] [xt.db :as xdb] [xt.db.schema.base-flatten :as flatten] [xt.lang.spec-base :as xt] [xt.lang.common-data :as xtd]]})

(ns js.cell.service.db-view
  (:require [std.lang :as l]))

(l/script :xtalk
  {:export [MODULE] :require [[xt.lang.spec-base :as xt] [xt.lang.common-data :as xtd] [xt.old.db.base-scope :as base-scope] [xt.old.db.base-view :as base-view]]})

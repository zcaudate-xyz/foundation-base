...
(l/script :js
  {:require [[js.core :as j] [js.cell.kernel.base-util :as util] [js.cell.kernel.worker-state :as state] [xt.lang.spec-base :as xt] [xt.lang.common-runtime :as rt :with [defvar.js]]]})

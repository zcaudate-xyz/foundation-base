...
(l/script :js
  {:require [[xt.lang.common-runtime :as rt] [xt.lang.spec-base :as xt] [xt.lang.common-data :as xtd] [xt.lang.event-view :as event-view] [js.cell.kernel.base-link :as raw] [js.cell.kernel.base-impl :as impl-common] [js.cell.kernel.base-model :as impl-model] [js.core :as j]]})

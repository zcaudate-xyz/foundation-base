...
(l/script :js
  {:require [[xt.lang.common-runtime :as rt] [xt.lang.spec-base :as xt] [js.cell.kernel :as kernel] [js.cell.kernel.base-link-local :as base-link-local] [js.cell.kernel.worker-local :as worker-local] [js.cell.kernel.worker-state :as worker-state]]})

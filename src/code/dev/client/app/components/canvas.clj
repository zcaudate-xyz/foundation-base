(ns smalltalkinterfacedesign.components.canvas
...
(defn.js Canvas [#{:# [components selectedComponent onSelectComponent onAddComponent]}]
  (var renderComponent (fn [component]
                         (var isSelected (== component.id selectedComponent))
                         (var baseClasses (:? isSelected
                         ...
                         (var handleClick (fn [e]
                                            (. e (stopPropagation))
                                            (onSelectComponent component.id)))

                         (var renderChildren (fn []

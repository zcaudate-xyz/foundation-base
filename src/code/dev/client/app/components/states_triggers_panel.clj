...
(defn.js StatesTab [{:# [component onUpdateStates]}]
  ...
  (var handleAddState (fn []
                        ...
                        (var updatedStates
                          (Object.assign {} (or component.states {})
                            {(newStateName) (do {:type newStateType
  ...
  (var handleRemoveState (fn [stateName]
                           (var updatedStates (Object.assign {} (or component.states {})))
                           (del (. updatedStates [stateName]))
                           (onUpdateStates component.id updatedStates)))

  (var handleUpdateStateDescription (fn [stateName description]
                                      (var updatedStates
                                        (Object.assign {} (or component.states {})
  ...
  (var handleUpdateStateDefault (fn [stateName defaultValue]
                                  (var updatedStates
                                    (Object.assign {} (or component.states {})
                                      {(stateName) (Object.assign {} (. component.states [stateName])
                                         {:default defaultValue})}))
        ...
        [:div
          ...
          (:? (and component.states (> (Object.keys component.states).length 0))
              [:div {:className "space-y-3"}
                (. (Object.entries component.states) (map (fn [[stateName stateDef]]
                                                            (return
...
(defn.js TriggersTab [{:# [component onUpdateTriggers]}]
  ...
  (var handleRemoveTrigger (fn [triggerName]
                             (var updatedTriggers (Object.assign {} (or component.triggers {})))
                             (del (. updatedTriggers [triggerName]))
                             (onUpdateTriggers component.id updatedTriggers)))

  (var handleUpdateTrigger (fn [triggerName field value]
                             (var updatedTriggers
                               (Object.assign {} (or component.triggers {})
  ...
  (var availableActions (:? component.actions (Object.keys component.actions) []))
    ...
    [:% fg/ScrollArea {:className "h-full"}
      [:div {:className "p-4 space-y-4"}
        ...
        [:div
          ...
          (:? (and component.triggers (> (Object.keys component.triggers).length 0))
              [:div {:className "space-y-3"}
                (. (Object.entries component.triggers) (map (fn [[triggerName triggerDef]]
                                                              (return
...
(defn.js ActionsTab [{:# [component onUpdateActions]}]
  ...
  (var handleRemoveAction (fn [actionName]
                            (var updatedActions (Object.assign {} (or component.actions {})))
                            (del (. updatedActions [actionName]))
                            (onUpdateActions component.id updatedActions)))

  (var handleUpdateAction (fn [actionName field value]
                            (var updatedActions
                              (Object.assign {} (or component.actions {})
    ...
    [:% fg/ScrollArea {:className "h-full"}
      [:div {:className "p-4 space-y-4"}
        ...
        [:div
          ...
          (:? (and component.actions (> (Object.keys component.actions).length 0))
              [:div {:className "space-y-3"}
                (. (Object.entries component.actions) (map (fn [[actionName actionDef]]
                                                              (return

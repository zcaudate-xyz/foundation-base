...
(defn.js InputsPanel
  [{:# [component onUpdateInputs onUpdateInputValues]}]
  ...
  (var handleUpdateInputDescription
       (fn [inputName description]
         (var updatedInputs
  ...
  (var renderInputValueEditor
       (fn [inputName inputDef]

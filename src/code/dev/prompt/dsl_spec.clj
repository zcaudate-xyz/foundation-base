...
(defn spec-example-files
  ...
  {:library-browser
   [(slurp "src/code/dev/webapp/layout_library_browser.clj")
    (slurp ".build/code.dev/src/webapp/layout-library-browser.jsx")]})
...
(defn create-spec
  ...
  (create-spec-main (str/join-lines +meta+)
                    (spec-example-forms)
                    ["resources/assets/code.dev/prompts/js_dsl_ns_spec.md"
                     "resources/assets/code.dev/prompts/js_dsl_figma_amendments.md"
                     "resources/assets/code.dev/prompts/js_dsl_amendments.md"
                     "resources/assets/code.dev/prompts/js_dsl_amendments_2.md"
                     "resources/assets/code.dev/prompts/js_dsl_amendments_3.md"
                     "resources/assets/code.dev/prompts/js_dsl_amendments_4.md"]

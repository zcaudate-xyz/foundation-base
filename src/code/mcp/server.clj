...
(defn default-instructions
  ...
  (str "Use the project-specific tools before falling back to generic evaluation.\n\n"
       ...
       "- Use `lang-emit-as` and `lang.core-*` for language inventories, emit probes, and module inspection.\n"
...
(defn default-tools
  ...
  [basic/echo-tool
   ...
   lang.core/lang-emit-as-tool
   lang.core/list-languages-tool
   lang.core/list-modules-tool

...
(l/script :lua.nginx
  {:import [["resty.websocket.server" :as ngxwsserver] ["cjson" :as cjson] ["resty.websocket.server" :as ngxwsserver]] :require [[xt.lang.spec-base :as xt] [xt.old.sys.cache-common :as cache] [lua.nginx :as n]]})

...
(l/script :lua
  {:require [[lua.nginx.openssl :as ssl] [lua.nginx :as n] [lua.nginx.http-client :as http] [lua.core :as u] [xt.lang.common-lib :as k] [xt.lib.util-xml :as xml] [xt.lang.common-data :as xtd] [xt.lang.spec-base :as xt]]})
